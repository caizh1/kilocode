/**
 * Custom OAuth handler for ChipMate Gateway
 *
...
import { DialogChipMateOrganization } from "./dialog-chipmate-organization.js"
...
interface ChipMateAutoMethodProps {
  index: number
  providerID: string
  title: string
...
export function ChipMateAutoMethod(props: ChipMateAutoMethodProps) {
  ...
  onMount(async () => {
    try {
      ...
      const profileResponse = await sdk.client.chipmate.profile()
      ...
      console.warn("Failed to fetch ChipMate profile, using personal account:", error)
      setStatus("error")
