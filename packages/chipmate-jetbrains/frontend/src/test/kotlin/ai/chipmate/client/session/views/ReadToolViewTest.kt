...
class ReadToolViewTest : BasePlatformTestCase() {
    ...
    fun `test read file output renders filename hyperlink`() {
        ...
        val path = "/Users/kirillk/work/chipmate/.chipmate/worktrees/agreeable-marlin/packages/chipmate-jetbrains/frontend/src/test/kotlin/ai/chipmate/client/session/SessionUiLayoutTest.kt"
        val t = tool().also {
            it.output = """
                <path>$path</path>
                <type>file</type>
    ...
    fun `test read directory output remains plain text`() {
        val path = "/Users/kirillk/work/chipmate/packages/chipmate-jetbrains"
        val t = tool().also {
            it.output = """
                <path>$path</path>
                <type>directory</type>
