...
const layout = layoutFingerprint({ width: 800, ratio: 2, font: "ChipMate Sans", size: "13px", line: "20px" })
...
describe("transcript measurement cache", () => {
  ...
  it("invalidates a measurement when layout changes", () => {
    ...
    const changed = layoutFingerprint({ width: 801, ratio: 2, font: "ChipMate Sans", size: "13px", line: "20px" })
