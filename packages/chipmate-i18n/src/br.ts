...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Para mais estatísticas de uso, utilize ",
  ...
  "settings.providers.note.chipmate": "Acesso a mais de 500 modelos de IA",
  ...
  "marketplace.install.about.mcp":
    "Um servidor MCP fornece ao ChipMate ferramentas adicionais para trabalhar com serviços externos ou programas locais.",
  "marketplace.install.about.agent": "Um agente adiciona uma função reutilizável com instruções e permissões próprias.",
  "marketplace.install.about.skill":
    "Uma habilidade adiciona instruções e recursos específicos para tarefas que o ChipMate pode carregar quando necessário.",
  "marketplace.install.mcp.warning":
    "Servidores MCP podem executar comandos locais ou se conectar a serviços externos. O ChipMate solicitará permissão antes de usar suas ferramentas, a menos que suas permissões permitam isso automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Desligue os snapshots do ChipMate para este projeto. Você perde desfazer/refazer das mudanças feitas pelo ChipMate, mas o git continua rastreando tudo.",
  ...
  "marketplace.aligned.unpublish": "Despublicar Skill",
  "marketplace.aligned.unpublished": "Não publicado",
}
