...
import { Chunker } from "@/chipmate/session-export/worker/chunks"
import { Scrubber } from "@/chipmate/session-export/worker/scrub"
import { handleEvent } from "@/chipmate/session-export/worker/handlers"
import type {
  CompactionCaptured,
  LlmRequestCompleted,
  LlmRequestStarted,
...
} from "@/chipmate/session-export/events"
...
function started(id: string, input: Partial<LlmRequestStarted["input"]>): LlmRequestStarted {
  return {
    ...
    agent: "claude",
    modeId: "build",
    model: { providerId: "chipmate", modelId: "free-1", isFree: true },
