...
const ProfileView: Component<ProfileViewProps> = (props) => {
  ...
  const handleDashboard = () => {
    if (!gateway) return
    vscode.postMessage({ type: "openExternal", url: "https://app.chipmate.ai/profile" })
  }

  const handleTopUp = () => {
    vscode.postMessage({ type: "openExternal", url: "https://app.chipmate.ai/credits" })
  }

  const handleGetPass = () => {
    vscode.postMessage({ type: "openExternal", url: "https://chipmate.ai/pricing/chipmate-pass" })
  }
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%" }}>
      ...
      >
        <h2 style={{ "font-size": "var(--chipmate-font-size-16)", "font-weight": "600", margin: 0 }}>
                  ...
                  <Card style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
                    <div style={{ display: "flex", "align-items": "center", "justify-content": "space-between" }}>
                      <div>
                        ...
                        <p
                          style={{
                            "font-size": "var(--chipmate-font-size-18)",
                            "font-weight": "600",
                            color: "var(--vscode-foreground)",
                            margin: 0,
                          }}
                    ...
                    {/* ChipMate Pass is part of personal credits, so only show it on the personal account */}
                    <Show
                      when={
                    ...
                    {/* No active ChipMate Pass on the personal account — nudge to subscribe */}
                    <Show
                      when={
