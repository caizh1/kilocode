---
title: "Using Vercel v0 with ChipMate"
description: "Connect Vercel's v0 models to ChipMate for UI-focused code generation. Setup guide for VS Code and the CLI."
sidebar_label: v0
---

# Using v0 With ChipMate

ChipMate supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with ChipMate through the familiar OpenAI API interface.

## Prerequisites

To use v0 with ChipMate, you'll need:
