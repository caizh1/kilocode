...
export const dict = {
  ...
  "settings.indexing.documents.description": "将工作区中已配置的文档目录索引到独立的 RAG 存储中。",
  "settings.indexing.documents.folders.title": "文档目录",
  "settings.indexing.documents.folders.description": "扫描工作区相对目录以建立文档 RAG。",
  "settings.indexing.documents.folders.empty": "尚未添加目录",
  "settings.indexing.documents.folders.add": "添加目录",
