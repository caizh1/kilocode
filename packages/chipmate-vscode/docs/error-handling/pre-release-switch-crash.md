...
**Priority:** P0
**Issue:** [#6083](https://github.com/ChipMate-Org/chipmate/issues/6083)
...
- Check if both versions attempt to spawn `chipmate serve` simultaneously causing port/race conflicts
