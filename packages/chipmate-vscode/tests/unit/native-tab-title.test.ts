...
import { nativeTitle } from "../../src/chipmate-provider/native-tab-title"
...
describe("nativeTitle", () => {
  ...
  it("truncates long session titles", () => {
    expect(nativeTitle(session("Dynamic VS Code tab titles for ChipMate sessions"))).toBe("Dynamic VS Code tab...")
  })
})
