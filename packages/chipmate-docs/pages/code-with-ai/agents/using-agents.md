---
title: "Using Agents"
description: "Understanding and using different agents in ChipMate"
---

# Using Agents

Agents in ChipMate are specialized personas that tailor the assistant's behavior to your current task. Each agent offers different capabilities, expertise, and access levels to help you accomplish specific goals.
...
| **Tool Access** | Read-only tools plus restricted file editing (plan files in `.chipmate/plans/` only) |
