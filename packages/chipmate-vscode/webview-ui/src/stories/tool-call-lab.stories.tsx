...
import { writeToolOpen } from "../../../../chipmate-ui/src/components/tool-open-state"
...
const hits = [
  'packages/chipmate-ui/src/components/message-part.tsx:1847: <div data-component="tool-output">',
  'packages/chipmate-ui/src/components/basic-tool.css:250: [data-component="tool-output"]',
  "packages/chipmate-vscode/webview-ui/src/components/chat/VscodeToolOverrides.tsx:141: background process output",
].join("\n")
...
const proc = [
  ...
  "status: running",
  "cwd: /project",
  "command: bun run --cwd packages/chipmate-vscode storybook",
  "last_output:",
...
const gapPatch = [
  "===================================================================",
  "--- packages/chipmate-ui/src/components/message-part.css",
  "+++ packages/chipmate-ui/src/components/message-part.css",
  "@@ -560,5 +560,5 @@",
  ' html[data-theme="chipmate-vscode"] [data-component="reasoning-part"] {',
...
const writePatch = [
  "===================================================================",
  "--- packages/chipmate-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "+++ packages/chipmate-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "@@ -1,3 +1,4 @@",
  " /** @jsxImportSource solid-js */",
...
const permissions: PermissionRequest[] = [
  {
    ...
    always: ["bun *"],
    args: {
      command: "bun test packages/chipmate-vscode/tests/unit",
  ...
  },
  {
    ...
    sessionID: SID,
    toolName: "edit",
    patterns: ["packages/chipmate-ui/src/components/message-part.css"],
    always: ["packages/chipmate-ui/src/components/*"],
    args: {
      filediff: {
        file: "packages/chipmate-ui/src/components/message-part.css",
        patch: gapPatch,
        additions: 1,
        deletions: 1,
      },
...
const blocks: SDKPart[] = [
  ...
  bash(
    ...
    "matrix-call-bash",
    "Run visual check",
    "bun run --cwd packages/chipmate-vscode build-storybook",
    ...
    { outputPath: "/tmp/chipmate-tool-output.log" },
  ),
  done(
    "read",
    "read",
    { filePath: "packages/chipmate-ui/src/components/message-part.tsx", offset: 1788, limit: 80 },
    "Read tool renderers",
  ),
  done(
    "glob",
    "glob",
    { pattern: "webview-ui/src/**/*.tsx", path: "packages/chipmate-vscode" },
    "Find webview files",
    [
      "packages/chipmate-vscode/webview-ui/src/components/chat/AssistantMessage.tsx",
      "packages/chipmate-vscode/webview-ui/src/components/chat/QuestionDock.tsx",
    ].join("\n"),
  ),
  done(
    "grep",
    "grep",
    { pattern: "tool-collapsible", include: "*.css", path: "packages/chipmate-ui/src/components" },
    "Find gaps",
    hits,
  ),
  done(
  ...
  tool("matrix-edit", "matrix-call-edit", "edit", {
    status: "completed",
    input: {
      filePath: "packages/chipmate-ui/src/components/message-part.css",
      oldString: "gap: 4px;",
      newString: "gap: 8px;",
    },
    output: "",
    ...
    metadata: {
      ...
      diagnostics: {
        "/project/packages/chipmate-ui/src/components/message-part.css": [
          {
            severity: 2,
    ...
    "write",
    {
      filePath: "packages/chipmate-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  ...
  tool("matrix-write", "matrix-call-write", "write", {
    ...
    metadata: {
      filediff: {
        file: "packages/chipmate-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
        patch: writePatch,
        additions: 1,
        deletions: 0,
      },
  ...
  tool("matrix-patch", "matrix-call-patch", "apply_patch", {
    ...
    input: {
      patchText:
        "*** Begin Patch\n*** Update File: packages/chipmate-ui/src/components/message-part.css\n@@\n-gap: 4px;\n+gap: 8px;\n*** End Patch",
    },
    output: "",
    ...
    metadata: {
      files: [
        {
          filePath: "/project/packages/chipmate-ui/src/components/message-part.css",
          relativePath: "packages/chipmate-ui/src/components/message-part.css",
          type: "update",
          patch: gapPatch,
          diff: gapPatch,
          additions: 1,
        ...
        {
          filePath: "/project/packages/chipmate-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          relativePath: "packages/chipmate-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          type: "update",
          patch: writePatch,
          diff: writePatch,
          additions: 1,
  ...
  tool("matrix-task-explore", "matrix-call-task-explore", "task", {
    ...
    metadata: {
      parentSessionId: SID,
      sessionId: CHILD,
      model: { providerID: "chipmate", modelID: "anthropic/claude-sonnet-4-6" },
      truncated: false,
    },
  ...
  tool(
    ...
    "repo-clone",
    "repo_clone",
    { repository: "ChipMate-Org/chipmate" },
    "Clone repository",
    "Repository ready: ChipMate-Org/chipmate\nStatus: cached\nLocal path: /cache/chipmate",
    { repository: "ChipMate-Org/chipmate", status: "cached", localPath: "/cache/chipmate" },
  ),
  done(
    "repo-overview",
    "repo_overview",
    ...
    "Search codebase",
    "### packages/chipmate-ui/src/components/message-part.tsx\nThe registry selects a renderer by exact tool ID.",
    { count: 1 },
  ),
  done(
    "semantic-search",
    "semantic_search",
    { query: "tool renderer selection", path: "packages/chipmate-ui" },
    "Semantic code search",
    "Found 1 result in packages/chipmate-ui/src/components/message-part.tsx",
    {
      results: [
        {
          filePath: "packages/chipmate-ui/src/components/message-part.tsx",
          score: 0.92,
          startLine: 1210,
          endLine: 1220,
    ...
    "Legacy code search",
    "https://github.com/ChipMate-Org/chipmate/blob/main/packages/chipmate-ui/src/components/message-part.tsx",
  ),
  tool(
    "matrix-tool-hint",
    "matrix-call-tool-hint",
    "edit",
    failed({ filePath: "packages/chipmate-ui/src/components/message-part.css" }, "oldString and newString are identical"),
  ),
  tool(
    "matrix-tool-error",
...
for (const key of [
  ...
  "chipmate_local_recall:matrix-call-local-recall",
          ...
          <div class="tool-call-lab-search-previews">
            ...
            <section class="tool-call-lab-panel tool-call-lab-panel-wide">
              ...
              <div class="tool-call-lab-stack">
                ...
                <div class="tool-call-lab-example">
                  ...
                  <StartupErrorBanner
                    errorMessage="Failed to start the ChipMate CLI"
                    errorDetails="spawn /path/to/chipmate ENOENT"
                  />
                </div>
              </div>
            </section>
            <section class="tool-call-lab-panel tool-call-lab-panel-wide">
              <div class="tool-call-lab-panel-header">
                ...
                <span class="tool-call-lab-panel-note">
                  Generic provider errors and ChipMate authentication or promotion actions.
                </span>
              </div>
              <div class="tool-call-lab-stack">
                <div class="tool-call-lab-example">
