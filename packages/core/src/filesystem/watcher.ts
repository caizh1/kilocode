...
declare const CHIPMATE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CHIPMATE_LIBC === "undefined" ? undefined : CHIPMATE_LIBC
...
const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CHIPMATE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.CHIPMATE_EXPERIMENTAL_FILEWATCHER) {
