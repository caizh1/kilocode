...
import { legacyReviewMessage, parseReviewCommand, reviewCommand } from "../../src/chipmate/review/command"
...
describe("review command parsing", () => {
  test("parses every supported review invocation", () => {
    ...
    expect(parseReviewCommand("/review https://github.com/ChipMate-Org/chipmate/pull/11084")).toBe("review")
