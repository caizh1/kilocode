...
import ai.chipmate.client.session.SessionFileLinks
import ai.chipmate.client.session.SessionFileOpener
import ai.chipmate.client.session.openSessionLink
...
open class TextView(
    ...
    private val toolbar = MessageToolbar(
        text = { copyText() },
        tooltip = ChipMateBundle.message("session.copy.response"),
    )
