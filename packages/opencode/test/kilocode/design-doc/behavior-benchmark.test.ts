...
import { discoverDesignDocModule, extractBehaviorEvidence } from "@kilocode/kilo-indexing/design-doc"
import { buildBehaviorEvidencePack, hasSufficientBehaviorEvidence } from "../../../src/kilocode/design-doc/evidence"
...
const root = await mkdtemp(path.join(tmpdir(), "kilo-design-doc-behavior-benchmark-"))
