...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installez Anaconda Desktop sur cette machine, puis revenez ici. ChipMate n’exécute pas l’installateur à votre place.",
  ...
  "provider.anaconda.state.signedOut": "Ouvrez Anaconda Desktop et connectez-vous avant de connecter ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate n’a pas pu accéder à Anaconda Desktop. Ouvrez Desktop, reconnectez-vous et redémarrez-le si nécessaire.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate a trouvé un serveur local sain de génération de texte et peut importer ses paramètres de connexion actuels.",
  ...
  "provider.anaconda.toast.refreshed.description": "Le serveur local actif et les modèles sont à jour dans ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate n’a pas pu vérifier les compétences disponibles.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate n’a pas pu vérifier l’état du serveur MCP.",
  "agentRequirements.error.scopeMismatch": "Cette vérification des prérequis de l’agent n’est plus active.",
  "agentRequirements.error.requestFailed": "ChipMate n’a pas pu vérifier les prérequis de l’agent.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans ChipMate.",
  ...
  "prompt.ultra.confirm.title": "Passer en mode Ultra",
  "prompt.ultra.confirm.description":
    "Ultra commence par explorer plus largement, puis présente des conclusions appuyées par des preuves vérifiables.",
  "prompt.ultra.confirm.benefit.explore": "Explorer plus complètement la base de code",
  "prompt.ultra.confirm.benefit.verify": "Vérifier d’abord les conclusions clés",
  "prompt.ultra.confirm.benefit.cost": "Nécessite généralement plus de temps et de tokens",
  "prompt.ultra.confirm.note": "Idéal pour les diagnostics complexes, l’analyse d’architecture et les revues à haut risque.",
  "prompt.ultra.confirm.action": "Confirmer et passer en Ultra",
  ...
  "prompt.panel.collapse": "Réduire le panneau de saisie",
  "prompt.panel.expand": "Développer le panneau de saisie",
  "prompt.panel.collapsed": "Panneau de saisie réduit",
  "prompt.panel.responding": "Réponse en cours…",
  ...
  "prompt.action.sandbox.enabled":
    "Le sandbox est activé. Les commandes shell de l'agent sont limitées aux répertoires du projet et de ChipMate.",
  "prompt.action.sandbox.disabled":
    "Le sandbox est désactivé. Cliquez pour limiter les écritures des commandes shell de l'agent aux répertoires du projet et de ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "Les écritures sont limitées aux répertoires du projet et de ChipMate.",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à ChipMate pour utiliser la saisie vocale.",
  ...
  "dialog.server.description": "Changez le serveur ChipMate auquel cette application se connecte.",
  ...
  "toast.update.description": "Une nouvelle version d'ChipMate ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe ChipMate",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'ChipMate ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "ChipMate inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour ChipMate",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'ChipMate sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'ChipMate.",
  ...
  "settings.indexing.chipmateModel.title": "Préréglage de modèle ChipMate",
  "settings.indexing.chipmateModel.description": "Choisissez un modèle d'embedding hébergé par ChipMate pris en charge.",
  "settings.indexing.chipmateSignIn.title": "Connexion à ChipMate requise",
  "settings.indexing.chipmateSignIn.description": "Connectez-vous à ChipMate pour utiliser les embeddings hébergés.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'ChipMate",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'ChipMate.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur ChipMate Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir ChipMate ouvert, sans enfermement propriétaire.",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles ChipMate Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration ChipMate {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration ChipMate local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration ChipMate {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeChipMate": "Configuration .chipmate de Home",
  "settings.config.source.homeOpencode": "Configuration .opencode de Home",
  "settings.config.source.envFile": "Fichier d'environnement CHIPMATE_CONFIG",
  ...
  "settings.config.source.projectChipMate": "Configuration .chipmate du projet",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description":
    "ChipMate s'interrompt et vous présente son plan au fil de son travail.",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande chipmate import",
  ...
  "deviceAuth.title": "Se connecter à ChipMate",
  ...
  "profile.action.login": "Se connecter avec ChipMate",
  ...
  "profile.pass.subscribe": "Obtenez ChipMate Pass pour ajouter des crédits et gagner des bonus",
  ...
  "settings.indexing.documents.description": "Index text documents from the current workspace and approved external folders into a separate RAG store.",
  ...
  "settings.indexing.documents.folders.description": "Approved external folders indexed in addition to the current workspace.",
  ...
  "settings.aboutChipMate.title": "À propos de ChipMate",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "ChipMate est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutChipMate.status.connected": "Connecté",
  "settings.aboutChipMate.status.connecting": "Connexion en cours...",
  "settings.aboutChipMate.status.disconnected": "Déconnecté",
  "settings.aboutChipMate.status.error": "Erreur",
  "settings.aboutChipMate.cliServer": "Serveur CLI",
  "settings.aboutChipMate.status.label": "Statut :",
  "settings.aboutChipMate.port.label": "Port :",
  "settings.aboutChipMate.versionInfo": "Informations de version",
  "settings.aboutChipMate.version.label": "Version :",
  "settings.aboutChipMate.extensionName": "Extension ChipMate",
  "settings.aboutChipMate.community": "Communauté et support",
  ...
  "settings.aboutChipMate.feedback.or": "ou",
  "settings.aboutChipMate.support.prefix":
    "Pour les questions de facturation ou de compte, contactez le support client à",
  "settings.aboutChipMate.resetSettings.title": "Réinitialiser les paramètres",
  ...
  "settings.aboutChipMate.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutChipMate.exportSettings": "Exporter",
  "settings.aboutChipMate.importSettings": "Importer",
  ...
  "settings.aboutChipMate.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres ChipMate valides.",
  "settings.aboutChipMate.importSettings.tooLarge":
  ...
  "settings.aboutChipMate.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de ChipMate. Certains paramètres pourraient être ignorés.",
  "settings.aboutChipMate.importSettings.success":
    "Paramètres importés. Vérifiez les modifications ci-dessus, puis cliquez sur Enregistrer.",

  "settings.aboutChipMate.telemetry.title": "Télémétrie",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de ChipMate. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Activez la saisie vocale dans les champs de prompt en utilisant votre compte ChipMate via ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur ChipMate pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.models.speechToTextModel.description":
    "Choisissez le modèle de transcription ChipMate Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via ChipMate Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que ChipMate utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans chipmate.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.sandboxing.enabled.description":
    "Exécuter les commandes shell de l'agent dans un sandbox au niveau du système d'exploitation qui restreint les écritures aux répertoires d'état du projet et de ChipMate",
  ...
  "chat.memory.project.empty": "This project doesn't have any memory yet. It will start showing after you use ChipMate.",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de ChipMate indépendamment de VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutChipMate.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de ChipMate, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  "settings.aboutChipMate.rooImport.description":
    "Importer l'historique des conversations depuis une installation de Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Importer les sessions depuis Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits ChipMate. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par ChipMate pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
  ...
  "settings.experimental.dsml.title": "Réparation des appels d’outil DSML",
  "settings.experimental.dsml.description":
    "Réparer les appels DeepSeek DSML divulgués uniquement pour le fournisseur et le modèle sélectionnés",
  "settings.experimental.dsmlModel.title": "Modèle cible DSML",
  "settings.experimental.dsmlModel.description": "Sélectionnez l’unique fournisseur et modèle autorisé à analyser DSML",
}
