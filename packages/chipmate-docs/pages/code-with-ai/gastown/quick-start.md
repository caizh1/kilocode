...
- A [ChipMate account](https://app.chipmate.ai) (free tier works)
...
{% browserFrame url="app.chipmate.ai/gastown" caption="The new town onboarding flow" %}
...
Gastown uses the [ChipMate GitHub App](https://github.com/apps/chipmate-code) to access your repository. You'll be prompted to install it if you haven't already.

{% browserFrame url="app.chipmate.ai/gastown/town/rigs/new" caption="Adding a new rig — connect your repository" %}
...
{% browserFrame url="app.chipmate.ai/gastown/town/rigs/main" caption="The rig page — convoy tracker and kanban board showing beads in various states" %}
...
{% browserFrame url="app.chipmate.ai/gastown/town" caption="The Mayor — your conversational interface to the town" %}
