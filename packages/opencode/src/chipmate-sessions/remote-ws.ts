...
export namespace RemoteWS {
  ...
  export type Options = {
    ...
    // chipmate_change - K1 W1: widened return type so the optional `instance`
        ...
        withContext(async () => {
          while (queued && !closed) {
            ...
            if (fresh !== undefined) {
              ...
              // chipmate_change - K1 W1: spread optional `instance` so the
              ...
              if (sentLive) {
                ...
                //
                // chipmate_change - K1 W1: a `detachSessionId` waiter
