...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Для отримання додаткової статистики використання використовуйте ",
  ...
  "settings.providers.note.chipmate": "Доступ до 500+ моделей ШІ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер надає ChipMate додаткові інструменти для роботи із зовнішніми сервісами або локальними програмами.",
  "marketplace.install.about.agent": "Агент додає багаторазову роль із власними інструкціями та дозволами.",
  "marketplace.install.about.skill":
    "Навичка додає інструкції та ресурси для певних завдань, які ChipMate може завантажити за потреби.",
  "marketplace.install.mcp.warning":
    "MCP-сервери можуть виконувати локальні команди або підключатися до зовнішніх сервісів. ChipMate запитає дозвіл перед використанням їхніх інструментів, якщо ваші дозволи не дають змоги робити це автоматично.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Вимкніть знімки ChipMate для цього проєкту. Ви втратите скасування/повторення для змін ChipMate, але git продовжить відстежувати все.",
  ...
  "marketplace.aligned.unpublish": "Зняти Skill з публікації",
  "marketplace.aligned.unpublished": "Знято з публікації",
}
