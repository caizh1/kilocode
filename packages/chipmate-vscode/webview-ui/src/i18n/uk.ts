...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Встановіть Anaconda Desktop на цьому комп'ютері, а потім поверніться сюди. ChipMate не запускає інсталятор за вас.",
  ...
  "provider.anaconda.state.signedOut": "Відкрийте Anaconda Desktop та увійдіть перед підключенням ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate не вдалося отримати доступ до Anaconda Desktop. Відкрийте Desktop, увійдіть знову та перезапустіть його за потреби.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate знайшов справний локальний сервер генерації тексту та може імпортувати його поточні налаштування підключення.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активний локальний сервер та моделі актуальні в ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate не зміг перевірити доступні навички.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate не зміг перевірити стан сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Ця перевірка вимог агента більше не активна.",
  "agentRequirements.error.requestFailed": "ChipMate не зміг перевірити вимоги агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у ChipMate.",
  ...
  "prompt.panel.collapse": "Згорнути панель введення",
  "prompt.panel.expand": "Розгорнути панель введення",
  "prompt.panel.collapsed": "Панель введення згорнута",
  "prompt.panel.responding": "Формується відповідь…",
  ...
  "prompt.action.sandbox.enabled": "Пісочницю увімкнено. Команди оболонки агента обмежені каталогами проєкту та ChipMate.",
  "prompt.action.sandbox.disabled":
    "Пісочницю вимкнено. Натисніть, щоб обмежити запис команд оболонки агента каталогами проєкту та ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "Запис дозволено лише в каталогах проєкту та ChipMate.",
  ...
  "speechToText.tooltip.start": "Почати голосове введення з ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Увійдіть до ChipMate, щоб використовувати голосове введення.",
  ...
  "dialog.server.description": "Змінити, до якого сервера ChipMate підключається цей додаток.",
  ...
  "toast.update.description": "Нова версія ChipMate ({{version}}) готова до встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді ChipMate",
  ...
  "error.chain.mcpFailed": 'MCP-сервер "{{name}}" зазнав помилки. Примітка: ChipMate поки не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate включає безкоштовні моделі, тому ви можете почати відразу.",
  ...
  "settings.general.row.language.description": "Змінити мову відображення ChipMate",
  "settings.general.row.appearance.title": "Вигляд",
  "settings.general.row.appearance.description": "Налаштувати вигляд ChipMate на вашому пристрої",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштувати тему ChipMate.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти оновлення при запуску ChipMate",
  ...
  "settings.updates.toast.latest.description": "У вас встановлена остання версія ChipMate.",
  ...
  "settings.providers.betaNotice":
    "Наразі в інтерфейсі налаштувань можна налаштувати лише провайдера ChipMate Gateway. Підтримка інших провайдерів з'явиться в бета-версії найближчим часом. Тим часом ви можете налаштовувати провайдерів через CLI або файл конфігурації. ChipMate залишається відкритим — без прив'язки.",
  ...
  "settings.config.title": "Відкрити файл конфігурації ChipMate ({{scope}})",
  "settings.config.placeholder":
    "Файли конфігурації об'єднуються по порядку; файли, позначені як завантажені, наразі впливають на налаштування.",
  "settings.config.noWorkspace": "Відкрийте папку робочої області, щоб відредагувати локальний файл конфігурації ChipMate.",
  "settings.config.openFailed": "Не вдалося відкрити файл конфігурації ChipMate ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальна конфігурація XDG",
  "settings.config.source.homeChipMate": "Конфігурація .chipmate (Home)",
  "settings.config.source.homeOpencode": "Конфігурація .opencode (Home)",
  "settings.config.source.envFile": "Файл середовища CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Вбудована конфігурація середовища",
  "settings.config.source.projectChipMate": "Конфігурація .chipmate проєкту",
  ...
  "workStyle.onboarding.welcome": "Ласкаво просимо до ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate призупиняється та показує свій план у процесі роботи.",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда chipmate import",
  ...
  "deviceAuth.title": "Увійти до ChipMate",
  ...
  "profile.action.login": "Увійти через ChipMate",
  ...
  "profile.pass.subscribe": "Отримайте ChipMate Pass, щоб додати кредити та заробляти бонуси",
  ...
  "settings.aboutChipMate.title": "Про ChipMate",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "ChipMate — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutChipMate.status.connected": "Підключено",
  "settings.aboutChipMate.status.connecting": "Підключення...",
  "settings.aboutChipMate.status.disconnected": "Відключено",
  "settings.aboutChipMate.status.error": "Помилка",
  "settings.aboutChipMate.cliServer": "CLI-сервер",
  "settings.aboutChipMate.status.label": "Статус:",
  "settings.aboutChipMate.port.label": "Порт:",
  "settings.aboutChipMate.versionInfo": "Інформація про версію",
  "settings.aboutChipMate.version.label": "Версія:",
  "settings.aboutChipMate.extensionName": "Розширення ChipMate",
  "settings.aboutChipMate.community": "Спільнота і підтримка",
  "settings.aboutChipMate.feedback.prefix": "Якщо у вас є питання або відгуки, будь ласка, відкрийте тікет на:",
  "settings.aboutChipMate.feedback.or": "або",
  "settings.aboutChipMate.support.prefix": "З питань виставлення рахунків або акаунту зверніться до служби підтримки:",
  "settings.aboutChipMate.resetSettings.title": "Скидання налаштувань",
  ...
  "settings.aboutChipMate.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutChipMate.exportSettings": "Експортувати",
  "settings.aboutChipMate.importSettings": "Імпортувати",
  "settings.aboutChipMate.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Файл не містить дійсних налаштувань ChipMate.",
  "settings.aboutChipMate.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії ChipMate. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutChipMate.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutChipMate.telemetry.title": "Телеметрія",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу ChipMate.',
  ...
  "settings.experimental.speechToText.description":
    "Увімкніть голосове введення в полях запитів, використовуючи ваш обліковий запис ChipMate через ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Увімкніть провайдер ChipMate та виконайте вхід, щоб використовувати Speech to Text. Наразі Speech to Text підтримується лише з ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Модель мовлення в текст",
  "settings.models.speechToTextModel.description": "Виберіть модель транскрипції ChipMate Gateway для голосового введення.",
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через ChipMate Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.sandboxing.enabled.description":
    "Виконувати команди оболонки агента в пісочниці на рівні ОС, яка обмежує запис до каталогів стану проєкту та ChipMate",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб ChipMate використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до chipmate.jsonc або попросіть агента додати їх.",
  ...
  "settings.display.fontSize.description": "Налаштуйте розмір шрифту webview UI для ChipMate незалежно від VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Приховувати моделі ChipMate Gateway, постачальники яких можуть використовувати ваші запити для навчання.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutChipMate.legacyMigration.description":
    "Перенести налаштування з попередньої версії ChipMate, включаючи API-ключі провайдерів та стандартну модель.",
  "settings.aboutChipMate.rooImport.description": "Імпортувати історію розмов з інсталяції Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Імпортувати сесії з Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті ChipMate. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
  ...
  "settings.indexing.chipmateModel.title": "Пресет моделі ChipMate",
  "settings.indexing.chipmateModel.description": "Виберіть підтримувану модель ChipMate-hosted embeddings.",
  "settings.indexing.chipmateSignIn.title": "Потрібен вхід у ChipMate",
  "settings.indexing.chipmateSignIn.description": "Увійдіть у ChipMate, щоб використовувати hosted embeddings.",
  ...
  "diffViewer.source.session.tooltip":
    "Файли, змінені ChipMate під час поточної сесії, на основі знімків по ходу. Скидається при старті нової сесії.",
  ...
  "settings.experimental.dsml.title": "Відновлення викликів інструментів DSML",
  "settings.experimental.dsml.description":
    "Відновлювати витіклі виклики DeepSeek DSML лише для вибраного провайдера й моделі",
  "settings.experimental.dsmlModel.title": "Цільова модель DSML",
  "settings.experimental.dsmlModel.description": "Виберіть єдиного провайдера й модель, яким дозволено розбір DSML",
}
