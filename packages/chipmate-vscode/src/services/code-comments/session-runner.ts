import type { ChipMateClient, Message } from "@chipmate/sdk/v2/client"
...
export class CodeCommentSessionRunner {
  constructor(
    private readonly connection: Pick<ChipMateConnectionService, "getClientAsync" | "onEventFiltered">,
...
function waitForCompletion(input: {
  connection: Pick<ChipMateConnectionService, "onEventFiltered">
