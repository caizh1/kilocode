...
export const dict = {
  ...
  "provider.connect.chipmateGateway.line1": "ChipMate Gateway 為您提供一組精選的可靠優化模型，專為編碼代理設計。",
  "provider.connect.chipmateGateway.line2": "只需一個 API 金鑰，您就可以使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.chipmateGateway.visit.prefix": "訪問 ",
  "provider.connect.chipmateGateway.visit.link": "ChipMate",
  "provider.connect.chipmateGateway.visit.suffix": " 獲取您的 API 金鑰。",
  "provider.connect.chipmateGateway.byok.prefix": "如需更多使用統計資訊，請",
  "provider.connect.chipmateGateway.byok.link": "透過 ChipMate Gateway 進行 BYOK",
  "provider.connect.chipmateGateway.byok.suffix": "。",

  // Provider settings translations
  "settings.providers.group.recommended": "推薦",
  "settings.providers.note.chipmate": "存取 500+ AI 模型",
  ...
  "marketplace.install.about.mcp": "MCP 伺服器為 ChipMate 提供用於處理外部服務或本機程式的額外工具。",
  "marketplace.install.about.agent": "智能體會新增一個具有專屬指示和權限的可重複使用角色。",
  "marketplace.install.about.skill": "技能會新增特定任務的指示和資源，ChipMate 可在需要時載入它們。",
  "marketplace.install.mcp.warning":
    "MCP 伺服器可以執行本機命令或連線至外部服務。除非你的權限允許自動使用，否則 ChipMate 會在使用其工具前請求許可。",
  ...
  "marketplace.install.identityMismatch":
    "市場 Skill 的條目 ID 與套件內身分不一致，未安裝任何檔案。請聯絡發佈者修復市場條目後重試。",
