...
description: "Connect your ChipMateClaw agent to 1Password to securely manage credentials"
---

# 1Password Integration Guide

Connect your ChipMateClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `ChipMate-Agent-Vault`).
...
## Step 3: Configure ChipMateClaw

1. Navigate to your ChipMateClaw dashboard: [app.chipmate.ai/claw](https://app.chipmate.ai/claw).
