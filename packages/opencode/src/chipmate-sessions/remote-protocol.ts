...
export namespace RemoteProtocol {
  ...
  export const SessionInfo = z.object({
    ...
    // chipmate_change - K1 W1: per-session platform advertises the platform the
  ...
  // chipmate_change - K1 W1: instance advertisement. Presence on a heartbeat
  ...
  export const Heartbeat = z.object({
    ...
    instance: InstanceAdvertisement.optional(), // chipmate_change - K1 W1
