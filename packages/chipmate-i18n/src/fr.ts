...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Pour plus de statistiques d'utilisation, utilisez ",
  "provider.connect.chipmateGateway.byok.link": "BYOK via ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recommandés",
  "settings.providers.note.chipmate": "Accès à plus de 500 modèles d'IA",
  ...
  "marketplace.install.about.mcp":
    "Un serveur MCP fournit à ChipMate des outils supplémentaires pour interagir avec des services externes ou des programmes locaux.",
  "marketplace.install.about.agent":
    "Un agent ajoute un rôle réutilisable avec ses propres instructions et autorisations.",
  "marketplace.install.about.skill":
    "Une compétence ajoute des instructions et des ressources propres à une tâche que ChipMate peut charger en cas de besoin.",
  "marketplace.install.mcp.warning":
    "Les serveurs MCP peuvent exécuter des commandes locales ou se connecter à des services externes. ChipMate demandera votre autorisation avant d'utiliser leurs outils, sauf si vos autorisations le permettent automatiquement.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Désactivez les instantanés ChipMate pour ce projet. Vous perdez l'annulation/restauration des modifications faites par ChipMate, mais git continue de tout suivre.",
  ...
  "marketplace.aligned.unpublish": "Dépublier le Skill",
  "marketplace.aligned.unpublished": "Dépublié",
}
