...
export const ChipMatePassState = Schema.Struct({
...
export const ProfileWithBalance = Schema.Struct({
  ...
  chipmatePass: Schema.NullOr(ChipMatePassState),
...
export const ChipMateGatewayPaths = {
  modes: `${root}/modes`,
...
export const ChipMateGatewayApi = HttpApi.make("chipmate")
  .add(
    HttpApiGroup.make("gateway")
      .add(
        HttpApiEndpoint.get("profile", ChipMateGatewayPaths.profile, {
          query: WorkspaceRoutingQuery,
          success: described(ProfileWithBalance, "Profile data"),
          error: [HttpApiError.BadRequest, HttpApiError.Unauthorized],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "chipmate.profile",
            summary: "Get ChipMate Gateway profile",
            description: "Fetch user profile and organizations from ChipMate Gateway",
          }),
        ),
        HttpApiEndpoint.get("authStatus", ChipMateGatewayPaths.authStatus, {
          query: WorkspaceRoutingQuery,
          success: described(AuthStatus, "ChipMate authentication status"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "chipmate.authStatus",
            summary: "Get ChipMate authentication status",
            description: "Check whether a locally stored ChipMate credential can authenticate Gateway requests",
          }),
        ),
        HttpApiEndpoint.get("modes", ChipMateGatewayPaths.modes, {
          query: WorkspaceRoutingQuery,
          success: described(OrganizationModes, "Organization modes list"),
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "chipmate.modes",
            summary: "Get organization custom modes",
            description: "Fetch custom modes defined for the current organization",
          }),
        ),
        HttpApiEndpoint.post("fim", ChipMateGatewayPaths.fim, {
          query: WorkspaceRoutingQuery,
          payload: FimBody,
        ...
        HttpApiEndpoint.post("edit", ChipMateGatewayPaths.edit, {
          query: WorkspaceRoutingQuery,
          payload: EditBody,
        ...
        HttpApiEndpoint.post("audioTranscriptions", ChipMateGatewayPaths.audioTranscriptions, {
          query: WorkspaceRoutingQuery,
        ...
        HttpApiEndpoint.get("clawChatCredentials", ChipMateGatewayPaths.clawChatCredentials, {
          query: WorkspaceRoutingQuery,
          success: described(ClawChatCredentials, "ChipMate Chat credentials or null"),
          error: HttpApiError.Unauthorized,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "chipmate.claw.chatCredentials",
        ...
        HttpApiEndpoint.get("cloudSessions", ChipMateGatewayPaths.cloudSessions, {
          query: {
            ...WorkspaceRoutingQueryFields,
          ...
          OpenApi.annotations({
            identifier: "chipmate.cloudSessions",
            summary: "Get cloud sessions",
            description: "Fetch cloud CLI sessions from ChipMate API",
          }),
        ),
        HttpApiEndpoint.get("cloudSession", ChipMateGatewayPaths.cloudSession, {
          ...
          OpenApi.annotations({
            identifier: "chipmate.cloud.session.get",
            summary: "Get cloud session",
            description: "Fetch full session data from the ChipMate cloud for preview",
          }),
        ),
        HttpApiEndpoint.post("cloudSessionImport", ChipMateGatewayPaths.cloudSessionImport, {
          query: WorkspaceRoutingQuery,
          ...
          OpenApi.annotations({
            identifier: "chipmate.cloud.session.import",
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "chipmate",
          description: "ChipMate Gateway routes.",
        }),
      )
