---
title: "Collaborate"
description: "Work together with ChipMate team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
ChipMate makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}

## Sessions & Sharing

Sessions are your platform-agnostic interaction with ChipMate. They remember your repository, task, and conversation so you can pause and resume work without losing context.

- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on ChipMate sessions
...
ChipMate's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://chipmate.ai/contact-sales))** — Model controls, audit logs, SSO, dedicated support
...
1. [Install ChipMate](/docs/getting-started/installing) in your preferred environment
