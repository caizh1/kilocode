...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Voor meer gebruiksstatistieken, gebruik ",
  ...
  "settings.providers.note.chipmate": "Toegang tot 500+ AI modellen",
  ...
  "marketplace.install.about.mcp":
    "Een MCP-server geeft ChipMate extra hulpmiddelen om met externe diensten of lokale programma's te werken.",
  "marketplace.install.about.agent": "Een agent voegt een herbruikbare rol toe met eigen instructies en machtigingen.",
  "marketplace.install.about.skill":
    "Een vaardigheid voegt taakspecifieke instructies en bronnen toe die ChipMate indien nodig kan laden.",
  "marketplace.install.mcp.warning":
    "MCP-servers kunnen lokale opdrachten uitvoeren of verbinding maken met externe diensten. ChipMate vraagt toestemming voordat hun hulpmiddelen worden gebruikt, tenzij je machtigingen dit automatisch toestaan.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Zet ChipMate-snapshots uit voor dit project. Je verliest ongedaan maken/opnieuw doen van ChipMate-wijzigingen, maar git blijft alles volgen.",
