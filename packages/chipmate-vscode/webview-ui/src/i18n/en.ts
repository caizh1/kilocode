...
export const dict = {
  ...
  "agentConsole.mode.label": "Agent Console mode",
  "agentConsole.mode.shell": "Shell",
  "agentConsole.mode.agent": "Agent",
  "agentConsole.connection.connected": "Connected",
  "agentConsole.connection.connecting": "Connecting",
  "agentConsole.action.newSession": "New Agent session",
  "agentConsole.action.clear": "Clear Agent timeline",
  "agentConsole.action.restartShell": "Restart Shell",
  "agentConsole.action.closeShell": "Close Shell",
  "agentConsole.shell.directWarning": "Shell commands run directly as the current user and do not use Agent approval.",
  "agentConsole.shell.starting": "Starting local shell…",
  "agentConsole.empty.title": "Agent Console",
  "agentConsole.empty.description":
    "Describe a task in natural language. Commands proposed by the Agent remain subject to the real permission flow.",
  "agentConsole.permission.directory": "Working directory",
