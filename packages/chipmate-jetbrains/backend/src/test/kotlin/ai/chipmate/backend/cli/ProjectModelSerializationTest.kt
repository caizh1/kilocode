...
import ai.chipmate.jetbrains.api.model.AppSkills200ResponseInner
import ai.chipmate.jetbrains.api.model.Command
import ai.chipmate.jetbrains.api.model.ProviderList200Response
...
class ProjectModelSerializationTest {
    ...
    fun `provider list with isFree and status`() {
        ...
        assertEquals(
            ai.chipmate.jetbrains.api.model.Model.Status.BETA,
            model.status,
        )
    }
