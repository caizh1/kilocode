...
- Consider reusing chipmate-ui's `MessageNav` component
- Evaluate whether CLI session undo/redo/revert maps to ChipMate's checkpoint model or if extension needs its own git-based implementation
