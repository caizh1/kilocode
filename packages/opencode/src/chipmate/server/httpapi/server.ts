...
import * as AnacondaDesktop from "@/chipmate/anaconda-desktop/service"
import { EffectFlock } from "@opencode-ai/core/util/effect-flock"
import { AppNodeBuilderV1 } from "@/effect/app-node-builder-v1" // chipmate_change - defaultLayer aliases are gone
...
import { chipmateGatewayHandlers } from "./handlers/chipmate-gateway"
...
export function provideListener(opts?: CorsOptions) {
  ...
  return Layer.provide([
    ...
    fenceLayer,
    cors,
    ChipMateViewers.defaultLayer, // chipmate_change
