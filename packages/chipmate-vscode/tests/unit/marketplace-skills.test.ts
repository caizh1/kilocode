...
describe("Marketplace Skill merge", () => {
      ...
      [
        {
          ...
          location: "/workspace/.chipmate/skills/code-review/SKILL.md",
          content: "# Code Review",
        },
        {
          name: "Local Guide",
          description: "Only installed locally",
          location: "/home/user/.config/chipmate/skills/local-guide/SKILL.md",
          content: "# Local Guide",
        },
      ],
      metadata,
  ...
  it("deduplicates local Skills and keeps them visible but not uploadable when the remote catalog fails", () => {
    const result = mergeMarketplaceSkills(
      ...
      [
        {
          name: "Local Guide",
          location: "/workspace/.chipmate/skills/local-guide/SKILL.md",
          content: "# Local Guide",
        },
        {
          name: "local guide",
  ...
  it("does not mark unreadable local entries as uploadable", () => {
    const result = mergeMarketplaceSkills(
      [],
      [{ name: "Metadata Only", location: "/workspace/.chipmate/skills/metadata-only/README.md" }],
