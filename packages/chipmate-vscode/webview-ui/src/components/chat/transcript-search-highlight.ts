 ...
 * using the CSS Custom Highlight API (same technique as chipmate-ui's code find
...
const MATCH_NAME = "chipmate-transcript-search-match"
const ACTIVE_NAME = "chipmate-transcript-search-match-active"
