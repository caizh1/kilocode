---
title: "Using Synthetic with ChipMate"
description: "Access open-source AI models through Synthetic in ChipMate. Setup guide for getting an API key and configuring models."
sidebar_label: Synthetic
---

# Using Synthetic With ChipMate
...
ChipMate supports all "always on" Synthetic AI models. The available models include various open-source options optimized for different use cases.
