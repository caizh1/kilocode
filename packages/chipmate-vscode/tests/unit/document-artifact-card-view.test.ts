  ...
  test("extracts Word render artifact links and distinguishes warning from failed", () => {
    const card = documentArtifactCardFromToolPart({
      ...
      state: {
        ...
        metadata: {
          artifactDir: ".chipmate/artifacts/render-1",
          pdfPath: ".chipmate/artifacts/render-1/design.pdf",
          diagnosticsPath: ".chipmate/artifacts/render-1/render-diagnostics.json",
        },
        output: JSON.stringify({
          artifactDir: ".chipmate/artifacts/render-1",
          pdfPath: ".chipmate/artifacts/render-1/design.pdf",
          pagePngPaths: [".chipmate/artifacts/render-1/rendered/page-001.png"],
  ...
  test("extracts Mermaid artifact links and marks errors as failed", () => {
    const card = documentArtifactCardFromToolPart({
      ...
      state: {
        ...
        metadata: {
          artifactDir: ".chipmate/artifacts/mermaid-1",
          sourcePath: ".chipmate/artifacts/mermaid-1/flow.mmd",
          diagnosticsPath: ".chipmate/artifacts/mermaid-1/mermaid-diagnostics.json",
        },
        output: JSON.stringify({
          rendered: false,
          artifactDir: ".chipmate/artifacts/mermaid-1",
  ...
  test("marks a clean legacy Mermaid render as ok without an explicit quality field", () => {
    const card = documentArtifactCardFromToolPart({
      ...
      state: {
        ...
        metadata: {
          rendered: true,
          artifactDir: ".chipmate/artifacts/mermaid-2",
          pngPath: ".chipmate/artifacts/mermaid-2/flow.png",
        },
        output: JSON.stringify({
          rendered: true,
          artifactDir: ".chipmate/artifacts/mermaid-2",
  ...
  test("keeps a successful fallback Mermaid render at warning instead of failed", () => {
    ...
    const card = documentArtifactCardFromToolPart({
      ...
      state: {
        ...
        metadata: {
          rendered: true,
          artifactDir: ".chipmate/artifacts/mermaid-3",
          warnings: [warning],
        },
        output: JSON.stringify({
          rendered: true,
