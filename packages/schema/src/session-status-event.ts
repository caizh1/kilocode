...
const QuestionID = Schema.String.check(Schema.isStartsWith("que")).pipe(Schema.brand("QuestionID")) // chipmate_change
...
export const Info = Schema.Union([
  ...
  // chipmate_change start - represent a session paused for an offline ChipMate question
  Schema.Struct({
