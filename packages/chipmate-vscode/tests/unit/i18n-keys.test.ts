 ...
 *   - Webview (sidebar + agent manager): merged from app, ui, chipmate-i18n, agent-manager dicts
...
// Layer 2: upstream UI (@opencode-ai/ui re-exported via @chipmate/chipmate-ui)
...
// Layer 3: chipmate-i18n overrides
import { dict as chipmateEn } from "../../../chipmate-i18n/src/en"
import { dict as chipmateZh } from "../../../chipmate-i18n/src/zh"
import { dict as chipmateZht } from "../../../chipmate-i18n/src/zht"
import { dict as chipmateKo } from "../../../chipmate-i18n/src/ko"
import { dict as chipmateDe } from "../../../chipmate-i18n/src/de"
import { dict as chipmateEs } from "../../../chipmate-i18n/src/es"
import { dict as chipmateFr } from "../../../chipmate-i18n/src/fr"
import { dict as chipmateDa } from "../../../chipmate-i18n/src/da"
import { dict as chipmateJa } from "../../../chipmate-i18n/src/ja"
import { dict as chipmatePl } from "../../../chipmate-i18n/src/pl"
import { dict as chipmateRu } from "../../../chipmate-i18n/src/ru"
import { dict as chipmateAr } from "../../../chipmate-i18n/src/ar"
import { dict as chipmateNo } from "../../../chipmate-i18n/src/no"
import { dict as chipmateBr } from "../../../chipmate-i18n/src/br"
import { dict as chipmateTh } from "../../../chipmate-i18n/src/th"
import { dict as chipmateBs } from "../../../chipmate-i18n/src/bs"
import { dict as chipmateTr } from "../../../chipmate-i18n/src/tr"
import { dict as chipmateNl } from "../../../chipmate-i18n/src/nl"
import { dict as chipmateUk } from "../../../chipmate-i18n/src/uk"
import { dict as chipmateIt } from "../../../chipmate-i18n/src/it"
...
const chipmateLocales: Record<string, Record<string, string>> = {
  en: chipmateEn,
  zh: chipmateZh,
  zht: chipmateZht,
  ko: chipmateKo,
...
const webviewKeys = new Set(Object.keys({ ...appEn, ...uiEn, ...chipmateEn, ...amEn }))
...
describe("i18n locale completeness — every English key exists in all locales", () => {
  ...
  it("chipmate-i18n: every English key has a translation in all locales", () => {
    const missing = findMissingLocaleKeys(chipmateEn, chipmateLocales)
    if (missing.length > 0) {
      expect(
        missing,
        `Found ${missing.length} missing chipmate-i18n translation(s):\n${formatLocaleReport(missing)}`,
      ).toEqual([])
    }
    expect(missing).toEqual([])
  })
