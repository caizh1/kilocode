...
const CHIPMATE_NEXTEDIT_URL = CHIPMATE_API_BASE + "/api/edit/completions"

/**
 * Pick the upstream edit endpoint for a (provider, model) pair. Today this is
 * either Inception's `/v1/edit/completions` (direct BYOK) or the ChipMate Gateway's
