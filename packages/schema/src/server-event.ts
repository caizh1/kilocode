...
// chipmate_change start - emitted (via GlobalBus) when config updates without a full dispose
export const ConfigUpdated = Event.define({ type: "global.config.updated", schema: {} })
// chipmate_change end

export const Definitions = Event.inventory(Connected, Disposed, ConfigUpdated) // chipmate_change
