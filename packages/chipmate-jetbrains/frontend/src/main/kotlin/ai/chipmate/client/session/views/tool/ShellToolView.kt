...
import ai.chipmate.client.ui.md.hybrid.MdTerminal
...
private data class ShellContent(
    ...
    val markdown: String = buildString {
        section(ChipMateBundle.message("session.part.tool.shell.command"), command, "bash")
        section(ChipMateBundle.message("session.part.tool.shell.output"), rawOutput, outputLang(rawOutput))
        section(ChipMateBundle.message("session.part.tool.shell.error"), rawError, "ansi-stderr")
    }
}
