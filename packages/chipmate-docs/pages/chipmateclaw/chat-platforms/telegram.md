---
title: "Telegram"
description: "Use ChipMateClaw with Telegram: setup, DM access control, and group chat configuration"
---

# Telegram

This page covers everything you need to use ChipMateClaw with Telegram: connecting your bot and adding it to group chats.

## Connecting ChipMateClaw to Telegram

{% youtube url="https://youtu.be/hIfKz073hGw" title="Telegram Setup Guide" caption="How to connect your ChipMateClaw agent to Telegram" /%}

Create a bot via BotFather and link it to your ChipMateClaw dashboard.

1. Open Telegram and search for [@BotFather](https://t.me/BotFather)
2. Send `/newbot` and follow the prompts to create your bot
3. Copy the **Bot Token** that BotFather gives you
4. Go to the **Settings** tab on your [ChipMateClaw dashboard](/docs/chipmateclaw/dashboard)
5. Paste the token into the **Telegram Bot Token** field
6. Click **Save**
7. Redeploy your ChipMateClaw instance
8. Send a direct message to your bot in Telegram: `/start`

{% image src="/docs/img/chipmateclaw/telegram.png" alt="Connect account screen" width="800" caption="Telegram bot token entry" /%}

You can remove or replace a configured token at any time.

## Adding ChipMateClaw to a Telegram Group Chat

By default, ChipMateClaw will not participate in a group chat, even if added. If you would like to use your ChipMateClaw in a group chat, you must configure the ChipMateClaw settings.
...
Tell your ChipMateClaw bot to add the group to its configuration. You can do this via DM:
