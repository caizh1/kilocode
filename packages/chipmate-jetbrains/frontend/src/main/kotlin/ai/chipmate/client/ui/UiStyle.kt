...
object UiStyle {
    ...
    object Badge {
        ...
        object Primary : Style {
            override fun bg(): Color = JBColor.namedColor(
                "ChipMate.History.activityBadgeBackground",
                JBUI.CurrentTheme.Link.Foreground.ENABLED,
            )

            override fun fg(): Color = JBColor.namedColor(
                "ChipMate.History.activityBadgeForeground",
                Color.WHITE,
            )
        }
        ...
        object Highlight : Style {
            override fun bg(): Color = JBColor.namedColor(
                "ChipMate.ModelPicker.freeBadgeBackground",
                JBColor(0x95D6AC, 0x7FCA99),
            )

            override fun fg(): Color = JBColor.namedColor(
                "ChipMate.ModelPicker.freeBadgeForeground",
                JBColor.WHITE,
            )
        }
        ...
        object Alert : Style {
            override fun bg(): Color = JBColor.namedColor(
                "ChipMate.History.runningBadgeBackground",
                JBColor(0xF5C542, 0x7A5A00),
            )

            override fun fg(): Color = JBColor.namedColor(
                "ChipMate.History.runningBadgeForeground",
    ...
    object Colors {
        ...
        fun floatingPanel(): Color = JBColor.namedColor(
            "ChipMate.FloatingPanel.background",
