...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installieren Sie Anaconda Desktop auf diesem Computer und kehren Sie dann hierher zurück. ChipMate führt das Installationsprogramm nicht für Sie aus.",
  ...
  "provider.anaconda.state.signedOut": "Öffnen Sie Anaconda Desktop und melden Sie sich an, bevor Sie ChipMate verbinden.",
  "provider.anaconda.state.unauthorized":
    "ChipMate konnte nicht auf Anaconda Desktop zugreifen. Öffnen Sie Desktop, melden Sie sich erneut an und starten Sie es bei Bedarf neu.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate hat einen funktionsfähigen lokalen Textgenerierungsserver gefunden und kann dessen aktuelle Verbindungseinstellungen importieren.",
  ...
  "provider.anaconda.toast.refreshed.description":
    "Der aktive lokale Server und die Modelle sind in ChipMate auf dem neuesten Stand.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate konnte die verfügbaren Skills nicht prüfen.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate konnte den MCP-Serverstatus nicht prüfen.",
  "agentRequirements.error.scopeMismatch": "Diese Prüfung der Agentenanforderungen ist nicht mehr aktiv.",
  "agentRequirements.error.requestFailed": "ChipMate konnte die Agentenanforderungen nicht prüfen.",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ChipMate zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in ChipMate zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ChipMate zu nutzen.",
  ...
  "prompt.ultra.confirm.title": "Ultra-Modus aktivieren",
  "prompt.ultra.confirm.description":
    "Ultra untersucht zunächst umfassender und liefert anschließend Schlussfolgerungen mit überprüfbaren Belegen.",
  "prompt.ultra.confirm.benefit.explore": "Die Codebasis umfassender untersuchen",
  "prompt.ultra.confirm.benefit.verify": "Wichtige Schlussfolgerungen zuerst prüfen",
  "prompt.ultra.confirm.benefit.cost": "Benötigt in der Regel mehr Zeit und Tokens",
  "prompt.ultra.confirm.note": "Geeignet für komplexe Fehlersuche, Architekturanalysen und risikoreiche Reviews.",
  "prompt.ultra.confirm.action": "Bestätigen und Ultra aktivieren",
  ...
  "prompt.panel.collapse": "Eingabebereich einklappen",
  "prompt.panel.expand": "Eingabebereich ausklappen",
  "prompt.panel.collapsed": "Eingabebereich eingeklappt",
  "prompt.panel.responding": "Antwort wird erstellt…",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ist aktiviert. Shell-Befehle des Agenten sind auf die Projekt- und ChipMate-Verzeichnisse beschränkt.",
  "prompt.action.sandbox.disabled":
    "Sandbox ist deaktiviert. Klicken, um Schreibvorgänge der Shell-Befehle des Agenten auf die Projekt- und ChipMate-Verzeichnisse zu beschränken.",
  ...
  "prompt.action.sandbox.description.enabled":
    "Schreibvorgänge sind auf die Projekt- und ChipMate-Verzeichnisse beschränkt.",
  ...
  "speechToText.tooltip.start": "Spracheingabe mit ChipMate Gateway starten",
  ...
  "speechToText.error.loginRequired": "Melden Sie sich bei ChipMate an, um die Spracheingabe zu verwenden.",
  ...
  "dialog.server.description": "Wechseln Sie den ChipMate-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von ChipMate ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem ChipMate-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: ChipMate unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für ChipMate ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie ChipMate auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von ChipMate anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von ChipMate automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von ChipMate.",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate-Modellvoreinstellung",
  "settings.indexing.chipmateModel.description": "Wählen Sie ein unterstütztes von ChipMate gehostetes Embedding-Modell.",
  "settings.indexing.chipmateSignIn.title": "ChipMate-Anmeldung erforderlich",
  "settings.indexing.chipmateSignIn.description": "Melden Sie sich bei ChipMate an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.models.hidePromptTraining.description":
    "Blendet ChipMate-Gateway-Modelle aus, deren Anbieter Ihre Prompts möglicherweise zum Training verwenden.",
  ...
  "settings.config.title": "{{scope}} ChipMate-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale ChipMate-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} ChipMate-Konfigurationsdatei: {{message}}",
  "settings.config.source.xdg": "Globale XDG-Konfiguration",
  "settings.config.source.homeChipMate": "Home .chipmate-Konfiguration",
  "settings.config.source.homeOpencode": "Home .opencode-Konfiguration",
  "settings.config.source.envFile": "CHIPMATE_CONFIG Umgebungsdatei",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Inline-Umgebungskonfiguration",
  "settings.config.source.projectChipMate": "Projekt .chipmate-Konfiguration",
  ...
  "workStyle.onboarding.welcome": "Willkommen bei ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate pausiert und zeigt dir während der Arbeit seinen Plan.",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder chipmate import-Befehl",
  ...
  "deviceAuth.title": "Bei ChipMate anmelden",
  ...
  "profile.action.login": "Mit ChipMate anmelden",
  ...
  "profile.pass.subscribe": "Hol dir ChipMate Pass, um Guthaben hinzuzufügen und Boni zu verdienen",
  ...
  "settings.aboutChipMate.title": "Über ChipMate",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "ChipMate ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutChipMate.status.connected": "Verbunden",
  "settings.aboutChipMate.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutChipMate.status.disconnected": "Getrennt",
  "settings.aboutChipMate.status.error": "Fehler",
  ...
  "settings.aboutChipMate.versionInfo": "Versionsinformationen",
  "settings.aboutChipMate.version.label": "Version:",
  "settings.aboutChipMate.extensionName": "ChipMate Erweiterung",
  "settings.aboutChipMate.community": "Community & Support",
  "settings.aboutChipMate.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutChipMate.feedback.or": "oder",
  "settings.aboutChipMate.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutChipMate.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutChipMate.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutChipMate.exportSettings": "Exportieren",
  "settings.aboutChipMate.importSettings": "Importieren",
  ...
  "settings.aboutChipMate.importSettings.invalidConfig": "Die Datei enthält keine gültigen ChipMate-Einstellungen.",
  ...
  "settings.aboutChipMate.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von ChipMate exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die ChipMate Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivieren Sie die Spracheingabe in Prompt-Feldern mit Ihrem ChipMate-Konto über ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivieren Sie den ChipMate-Anbieter und melden Sie sich an, um Speech to Text zu verwenden. Speech to Text wird derzeit nur mit ChipMate Gateway unterstützt.",
  "settings.models.speechToTextModel.title": "Sprache-zu-Text-Modell",
  "settings.models.speechToTextModel.description":
    "Wählen Sie das ChipMate Gateway-Transkriptionsmodell für die Spracheingabe.",
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über ChipMate Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn ChipMate Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in chipmate.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-Befehle des Agenten in einer Sandbox auf Betriebssystemebene ausführen, die Schreibvorgänge auf die Projekt- und ChipMate-Statusverzeichnisse beschränkt",
  ...
  "settings.display.fontSize.description": "Passen Sie die Schriftgröße der ChipMate webview UI unabhängig von VS Code an.",
  ...
  "settings.aboutChipMate.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von ChipMate, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  "settings.aboutChipMate.rooImport.description":
    "Importieren Sie den Konversationsverlauf von einer Installation von Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Sitzungen aus Roo Code importieren",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle ChipMate-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von ChipMate während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
