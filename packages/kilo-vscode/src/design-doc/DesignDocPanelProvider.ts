...
import type { DesignDocArtifactContent } from "@kilocode/sdk/v2/client"
...
export class DesignDocPanelProvider implements vscode.Disposable {
  ...
  private async mutate(
    jobID: string,
    action: (client: Awaited<ReturnType<KiloConnectionService["getClientAsync"]>>, directory: string) => Promise<{ data?: unknown; error?: unknown }>,
  ): Promise<void> {
