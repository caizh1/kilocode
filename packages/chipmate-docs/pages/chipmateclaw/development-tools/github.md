...
description: "Connect a GitHub account to your ChipMateClaw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your ChipMateClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
ChipMateClaw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:

| Setting | Recommended Value |
|---|---|
| **Token name** | `chipmateclaw-bot` (or any descriptive name) |
...
### Step 3: Enter credentials in ChipMateClaw
...
ChipMateClaw accepts both GitHub token formats:
...
When your instance starts, ChipMateClaw automatically:
...
- Tokens are encrypted at rest using ChipMateClaw's secret management system
