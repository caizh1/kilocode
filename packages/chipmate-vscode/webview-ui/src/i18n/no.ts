...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskinen, og kom deretter tilbake hit. ChipMate kjører ikke installasjonsprogrammet for deg.",
  ...
  "provider.anaconda.state.signedOut": "Åpne Anaconda Desktop og logg inn før du kobler til ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate fikk ikke tilgang til Anaconda Desktop. Åpne Desktop, logg inn på nytt, og start det på nytt om nødvendig.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate fant en sunn lokal tekstgenereringsserver og kan importere de gjeldende tilkoblingsinnstillingene.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale serveren og modellene er oppdatert i ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate kunne ikke sjekke tilgjengelige skills.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate kunne ikke sjekke MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne sjekken av agentkrav er ikke lenger aktiv.",
  "agentRequirements.error.requestFailed": "ChipMate kunne ikke sjekke agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ChipMate.",
  ...
  "prompt.ultra.confirm.title": "Gå inn i Ultra-modus",
  "prompt.ultra.confirm.description":
    "Ultra utforsker først bredere og presenterer deretter konklusjoner støttet av verifiserbare bevis.",
  "prompt.ultra.confirm.benefit.explore": "Utforsk kodebasen mer grundig",
  "prompt.ultra.confirm.benefit.verify": "Verifiser viktige konklusjoner først",
  "prompt.ultra.confirm.benefit.cost": "Krever vanligvis mer tid og flere tokens",
  "prompt.ultra.confirm.note":
    "Passer for kompleks feilsøking, arkitekturanalyse og høyrisikovurderinger.",
  "prompt.ultra.confirm.action": "Bekreft og gå inn i Ultra",
  ...
  "prompt.panel.collapse": "Skjul inndatapanel",
  "prompt.panel.expand": "Vis inndatapanel",
  "prompt.panel.collapsed": "Inndatapanelet er skjult",
  "prompt.panel.responding": "Svarer…",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktivert. Shell-kommandoer for agenten er begrenset til prosjekt- og ChipMate-mappene.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktivert. Klikk for å begrense skriving av shell-kommandoer for agenten til prosjekt- og ChipMate-mappene.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivetilgang er begrenset til prosjekt- og ChipMate-mappene.",
  ...
  "speechToText.tooltip.start": "Start taleinndata med ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Logg på ChipMate for å bruke taleinndata.",
  ...
  "dialog.server.description": "Bytt hvilken ChipMate-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av ChipMate ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ChipMate-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ChipMate ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ChipMate",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ChipMate ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan ChipMate er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ChipMate starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ChipMate.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun ChipMate Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde ChipMate åpent, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul ChipMate Gateway-modeller der leverandørene kan bruke ledetekstene dine til trening.",
  ...
  "settings.config.title": "Åpne {{scope}} ChipMate-konfigurasjonsfil",
  "settings.config.placeholder":
    "Konfigurasjonsfiler slås sammen i rekkefølge; filer merket som lastet påvirker for øyeblikket innstillingene.",
  "settings.config.noWorkspace": "Åpne en arbeidsområdemappe for å redigere den lokale ChipMate-konfigurasjonsfilen.",
  "settings.config.openFailed": "Klarte ikke å åpne {{scope}} ChipMate-konfigurasjonsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfigurasjon",
  "settings.config.source.homeChipMate": "Home .chipmate-konfigurasjon",
  "settings.config.source.homeOpencode": "Home .opencode-konfigurasjon",
  "settings.config.source.envFile": "CHIPMATE_CONFIG miljøfil",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Innebygd miljøkonfigurasjon",
  "settings.config.source.projectChipMate": "Prosjekt .chipmate-konfigurasjon",
  ...
  "workStyle.onboarding.welcome": "Velkommen til ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate tar pause og viser deg planen sin mens den arbeider.",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller chipmate import-kommando",
  ...
  "deviceAuth.title": "Logg inn på ChipMate",
  ...
  "profile.action.login": "Logg inn med ChipMate",
  ...
  "profile.pass.subscribe": "Få ChipMate Pass for å legge til kreditt og tjene bonuser",
  ...
  "settings.aboutChipMate.title": "Om ChipMate",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "ChipMate er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutChipMate.status.connected": "Tilkoblet",
  "settings.aboutChipMate.status.connecting": "Kobler til...",
  "settings.aboutChipMate.status.disconnected": "Frakoblet",
  "settings.aboutChipMate.status.error": "Feil",
  ...
  "settings.aboutChipMate.versionInfo": "Versjonsinformasjon",
  "settings.aboutChipMate.version.label": "Versjon:",
  "settings.aboutChipMate.extensionName": "ChipMate-utvidelse",
  "settings.aboutChipMate.community": "Fellesskap og støtte",
  "settings.aboutChipMate.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutChipMate.feedback.or": "eller",
  "settings.aboutChipMate.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutChipMate.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutChipMate.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutChipMate.exportSettings": "Eksporter",
  "settings.aboutChipMate.importSettings": "Importer",
  "settings.aboutChipMate.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Filen inneholder ikke gyldige ChipMate-innstillinger.",
  "settings.aboutChipMate.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av ChipMate. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutChipMate.telemetry.title": "Telemetri",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for ChipMate-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.speechToText.description":
    "Aktiver taleinndata i prompt-felt ved å bruke din ChipMate-konto gjennom ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktiver og logg på ChipMate-leverandøren for å bruke Speech to Text. Speech to Text støttes for øyeblikket bare med ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Tale-til-tekst-modell",
  "settings.models.speechToTextModel.description": "Velg ChipMate Gateway-transkripsjonsmodellen for taleinndata.",
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via ChipMate Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate-modellforhåndsvalg",
  "settings.indexing.chipmateModel.description": "Velg en støttet ChipMate-hostet embedding-modell.",
  "settings.indexing.chipmateSignIn.title": "ChipMate-pålogging kreves",
  "settings.indexing.chipmateSignIn.description": "Logg inn på ChipMate for å bruke hostede embeddings.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at ChipMate skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i chipmate.jsonc, eller be agenten om å legge dem til.",
  ...
  "settings.sandboxing.enabled.description":
    "Kjør shell-kommandoer for agenten i en sandbox på operativsystemnivå som begrenser skriving til prosjekt- og ChipMate-tilstandsmapper",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for ChipMate webview UI uavhengig av VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutChipMate.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av ChipMate, inkludert API-nøkler for leverandører og standardmodell.",
  "settings.aboutChipMate.rooImport.description": "Importer samtalehistorikk fra en installasjon av Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Importer økter fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle ChipMate-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer endret av ChipMate i løpet av gjeldende økt, basert på øyeblikksbilder per tur. Tilbakestilles når du starter en ny økt.",
