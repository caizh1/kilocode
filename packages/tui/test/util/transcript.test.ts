...
import type { AssistantMessage, Part, Provider, UserMessage } from "@chipmate/sdk/v2"
...
describe("transcript", () => {
  ...
  describe("formatMessage", () => {
    ...
    test("formats assistant message with metadata", () => {
      ...
      const result = formatMessage(msg, parts, options)
      expect(result).toContain("## Assistant (Code · Claude Sonnet 4 · 5.4s)") // chipmate_change
  ...
  describe("formatTranscript", () => {
    test("formats complete transcript", () => {
      ...
      expect(result).toContain("## User")
      expect(result).toContain("Hello")
      expect(result).toContain("## Assistant (Code · Claude Sonnet 4 · 0.5s)") // chipmate_change
    ...
    test("formats transcript without assistant metadata", () => {
      ...
      expect(result).not.toContain("Code") // chipmate_change
