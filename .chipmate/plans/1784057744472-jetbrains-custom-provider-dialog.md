...
All work is in `packages/chipmate-jetbrains/frontend/`. No backend, RPC, or DTO changes. `saveCustom` already upserts, and `ProviderSettingsDto.config[id]` already carries the fields needed to prefill an edit. No `chipmate_change` markers are needed (all files are under ChipMate-owned `packages/chipmate-jetbrains/`).
...
Only edit the base `ChipMateBundle.properties`; other locale files fall back to base for missing keys.

### 2. `packages/chipmate-jetbrains/frontend/src/main/kotlin/ai/chipmate/client/settings/providers/ProviderCatalog.kt`
...
### 3. `packages/chipmate-jetbrains/frontend/src/main/kotlin/ai/chipmate/client/settings/providers/ProviderListRows.kt`
...
### 4. `packages/chipmate-jetbrains/frontend/src/main/kotlin/ai/chipmate/client/settings/providers/ProvidersSettingsUi.kt`
...
## Tests — `packages/chipmate-jetbrains/frontend/src/test/kotlin/ai/chipmate/client/settings/providers/ProvidersSettingsUiTest.kt`
