...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "For flere brugsstatistikker, brug ",
  ...
  "settings.providers.note.chipmate": "Adgang til 500+ AI-modeller",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server giver ChipMate yderligere værktøjer til at arbejde med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent tilføjer en genanvendelig rolle med egne instruktioner og tilladelser.",
  "marketplace.install.about.skill":
    "En færdighed tilføjer opgavespecifikke instruktioner og ressourcer, som ChipMate kan indlæse efter behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan køre lokale kommandoer eller oprette forbindelse til eksterne tjenester. ChipMate beder om tilladelse, før deres værktøjer bruges, medmindre dine tilladelser automatisk tillader det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå ChipMates snapshots fra for dette projekt. Du mister fortryd/gentag for ChipMate-ændringer, men git sporer stadig alt.",
  ...
  "marketplace.aligned.unpublish": "Fjern udgivelse af Skill",
  "marketplace.aligned.unpublished": "Ikke udgivet",
}
