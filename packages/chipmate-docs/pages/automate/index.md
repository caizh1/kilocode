---
title: "Automate"
description: "Automate your development workflows with ChipMate"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend ChipMate's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect ChipMate to external tools and services:
...
- [**Using MCP in ChipMate**](/docs/automate/mcp/using-in-chipmate-code) — Configuration guide
...
Connect ChipMate with your development tools:
...
Customize and extend ChipMate's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-chipmate-code) for external integrations
