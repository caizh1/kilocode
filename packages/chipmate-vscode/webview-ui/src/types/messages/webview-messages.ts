...
export interface OpenChipMateClawRequest {
  type: "openChipMateClaw"
}
...
export interface RequestChipMateEmbeddingModelsMessage {
  type: "requestChipMateEmbeddingModels"
}
...
export interface UpdateConfigMessage {
  type: "updateConfig"
  requestId?: string
  /** Global config patch written to ~/.config/chipmate/chipmate.json. */
  config: Partial<Config>
  globalUnset?: string[][]
  /** Project config patch written to the workspace's .chipmate/chipmate.jsonc or existing project config. */
...
export type WebviewMessage =
  ...
  | RequestChipMateEmbeddingModelsMessage
  | UpdateConfigMessage
