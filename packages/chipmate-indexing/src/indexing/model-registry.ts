 ...
 * metadata. ChipMate-hosted embedding catalog metadata is fetched from Cloud so the
...
export function normalizeChipMateModelId(modelId: string | undefined): string | undefined {
  return modelId
}
