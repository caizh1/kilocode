...
import { ConfigRow, SectionTitle } from "@chipmate/chipmate-web-ui/console"
...
export function FormattersRoute() {
  ...
  return (
    <ConfigPage
      ...
      description="Control native and custom formatters ChipMate can run after editing files."
      actions={
        <>
          <Button
            variant="secondary"
