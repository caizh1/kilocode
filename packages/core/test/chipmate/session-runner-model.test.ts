...
describe("SessionRunnerModel ChipMate credentials", () => {
  it.effect("maps OAuth account IDs to ChipMate organization routing", () =>
    Effect.gen(function* () {
      const model = ModelV2.Info.make({
        ...
        api: {
          ...
          url: "https://api.chipmate.ai/openrouter",
        },
      ...
      const credential = Credential.Info.make({
        ...
        integrationID: Integration.ID.make("chipmate"),
        label: "Work",
      ...
      expect(resolved.route.defaults.http?.body).toMatchObject({ chipmateOrganizationId: "org-enterprise" })
