...
/**
 * Port of packages/chipmate-vscode/src/legacy-migration/provider-mapping.ts
 *
...
val PROVIDER_MAP: Map<String, ProviderMapping> = mapOf(
    ...
    "chipmate" to ProviderMapping(id = "chipmate", key = "chipmateToken", name = "ChipMate (Gateway)", modelField = "chipmateModel", organizationIdField = "chipmateOrganizationId"),
