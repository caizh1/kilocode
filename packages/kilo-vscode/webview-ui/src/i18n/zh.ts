...
export const dict = {
  ...
  "settings.indexing.kiloModel.title": "ChipMate 模型预设",
  "settings.indexing.kiloModel.description": "选择受支持的 ChipMate 托管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登录 ChipMate",
  "settings.indexing.kiloSignIn.description": "登录 ChipMate 以使用托管嵌入。",
  ...
  "settings.aboutKiloCode.title": "关于 ChipMate",
  ...
  "settings.aboutKiloCode.extensionName": "ChipMate 扩展",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "文件不包含有效的 ChipMate 设置。",
  "settings.aboutKiloCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此文件由较新版本的 ChipMate 导出。部分设置可能会被忽略。",
