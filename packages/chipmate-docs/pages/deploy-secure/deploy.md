---
title: "Deploy"
description: "Deploy your applications with ChipMate"
---

# Deploy

ChipMate Deploy lets you ship **Next.js** and **static sites** directly from ChipMate, with:

- **One-click deployment** from the ChipMate dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to ChipMate
...
- Navigate to your [Organization dashboard](https://app.chipmate.ai/organizations) or [Profile](https://app.chipmate.ai/profile)
...
ChipMate Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

ChipMate Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
