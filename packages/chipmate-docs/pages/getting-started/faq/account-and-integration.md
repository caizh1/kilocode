...
description: "Questions about accounts and integrations in ChipMate"
tocDepth: 2
---

# Account and Integration

This section contains questions about accounts and integrations in ChipMate.
...
This process involves removing the **ChipMate Connect** application from your GitHub account settings.
...
2. Find **ChipMate Connect** in the list of installed applications
3. Click **Configure** next to ChipMate Connect
4. From the configuration page, you can either:
   - **Uninstall** the integration completely, or
   - **Edit** which repositories are connected

{% callout type="tip" %}
If you'd like to reconnect GitHub later, simply open your ChipMate profile, go to **Integrations**, and connect GitHub again.
{% /callout %}
