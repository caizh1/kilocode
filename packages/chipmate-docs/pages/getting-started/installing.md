---
title: "Installation"
description: "How to install ChipMate on your system"
---

# Installation

Get started with ChipMate by installing it on your preferred platform. Choose your development environment below:
...
The current ChipMate extension is built on the [ChipMate CLI](https://github.com/ChipMate-Org/chipmate) and is distributed as the **pre-release version** on the VS Code Marketplace.
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [ChipMate page on Open VSX Registry](https://open-vsx.org/extension/chipmate/ChipMate-Code).
...
4. Search for "ChipMate"
5. Select "ChipMate" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [ChipMate GitHub Releases page](https://github.com/ChipMate-Org/chipmate/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/ChipMate-Org/chipmate/releases/latest)
...
1. Open the [ChipMate GitHub Releases page](https://github.com/ChipMate-Org/chipmate/releases)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing ChipMate using VS Code's Install from VSIX dialog" width="600px" caption="Installing ChipMate using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify ChipMate is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "ChipMate")
...
2. **[Run your first task](/docs/getting-started/quickstart)** — Learn how to chat with ChipMate to complete tasks
...
- Submit issues on [GitHub](https://github.com/ChipMate-Org/chipmate/issues)
