...
export const assets = [
  "chipmate-darwin-arm64.zip",
  "chipmate-darwin-x64.zip",
  "chipmate-linux-arm64.tar.gz",
  "chipmate-linux-x64.tar.gz",
  "chipmate-windows-arm64.zip",
  "chipmate-windows-x64.zip",
]
