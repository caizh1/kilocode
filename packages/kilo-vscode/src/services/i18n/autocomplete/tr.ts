export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(chipmate-v2-logo) Otomatik tamamlama",
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Kilo Code otomatik tamamlama (devre dışı)",
  ...
  "kilocode:autocomplete.toggleMessage": "Kilo Code otomatik tamamlama {{status}}",
  ...
  "kilocode:autocomplete.chatParticipant.fullName": "Kilo Code aracı",
