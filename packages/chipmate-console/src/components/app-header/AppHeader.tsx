...
export function AppHeader() {
  return (
    <header class="app-header">
      <A class="header-brand" href="/projects" aria-label="ChipMate Console home">
        <img class="header-mark header-mark-logo" src={`${import.meta.env.BASE_URL}chipmate-logo.svg`} alt="" width="28" height="28" />
