...
class ConnectionDelayTest : SessionControllerTestBase() {
    ...
    fun `test short connecting state does not fire connection banner`() {
        ...
        appRpc.state.value = ChipMateAppStateDto(ChipMateAppStatusDto.CONNECTING)
        pause(25)
        appRpc.state.value = ChipMateAppStateDto(ChipMateAppStatusDto.READY)
        pause(150)
    ...
    fun `test short app error is suppressed`() {
        ...
        appRpc.state.value = ChipMateAppStateDto(ChipMateAppStatusDto.ERROR, error = "boom")
        pause(25)
        appRpc.state.value = ChipMateAppStateDto(ChipMateAppStatusDto.READY)
        pause(150)
    ...
    fun `test changed error restarts delay and shows latest state`() {
        ...
        appRpc.state.value = ChipMateAppStateDto(ChipMateAppStatusDto.ERROR, error = "first")
        pause(50)
        appRpc.state.value = ChipMateAppStateDto(ChipMateAppStatusDto.ERROR, error = "second")
        pause(150)
    ...
    fun `test persistent workspace error is delayed`() {
        ...
        projectRpc.state.value = ChipMateWorkspaceStateDto(
    ...
    fun `test config warning remains immediate`() {
        ...
        appRpc.state.value = ChipMateAppStateDto(
            ...
            warnings = listOf(ConfigWarningDto(path = ".chipmate/chipmate.json", message = "Invalid JSON")),
        )
        pause(10)
        ...
        assertEquals(".chipmate/chipmate.json: Invalid JSON", event.detail)
    }
