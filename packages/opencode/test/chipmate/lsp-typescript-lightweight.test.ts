...
// chipmate integration in shared LSP files, these tests catch it.

import { describe, test, expect, spyOn, afterEach } from "bun:test"
import path from "path"
import * as LSPServer from "../../src/lsp/server"
import { TsClient } from "../../src/chipmate/ts-client"
import { TsCheck } from "../../src/chipmate/ts-check"
import { Flag } from "@opencode-ai/core/flag/flag"
import { Instance, type InstanceContext } from "../../src/chipmate/instance"
...
describe("typescript lightweight mode", () => {
  ...
  describe("source integration guards", () => {
    // These tests verify that chipmate integration code exists in shared
    ...
    test("lsp/server.ts gates Typescript.spawn behind flag", async () => {
      ...
      expect(src).toContain("CHIPMATE_EXPERIMENTAL_LSP_TOOL")
