...
import ai.chipmate.client.settings.base.SettingsRows
import ai.chipmate.client.settings.models.ModelSettingPicker
...
internal class AgentEditDialog(
    ...
    private val model = ModelSettingPicker().apply {
        picker.emptyText = ChipMateBundle.message("settings.agentBehavior.agents.edit.default")
    ...
    private val mode = ComboBox(arrayOf(ChipMateCliParser.MODE_PRIMARY, ChipMateCliParser.MODE_SUBAGENT, ChipMateCliParser.MODE_ALL)).apply {
    ...
    init {
        title = ChipMateBundle.message("settings.agentBehavior.agents.edit.title", agent.displayName ?: agent.name)
        init()
        initValidation()
    }
    ...
    override fun createCenterPanel(): JComponent {
        ...
        SettingsRows().apply {
            row(SettingsStackedRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.name"),
                value = identity(),
                action = exportButton().takeIf { !agent.native },
            ))
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.mode"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.mode.description"),
                mode,
            ))
            panel.next(this)
        }
        SettingsRows().apply {
            row(SettingsStackedRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.description"),
                if (canEditDescription(agent)) {
                    ChipMateBundle.message("settings.agentBehavior.agents.edit.description.description")
                } else {
                    ChipMateBundle.message("settings.agentBehavior.agents.edit.description.native.description")
                },
                scroll(description),
            ))
            row(SettingsStackedRow(
                if (agent.native) {
                    ChipMateBundle.message("settings.agentBehavior.agents.edit.prompt.native")
                } else {
                    ChipMateBundle.message("settings.agentBehavior.agents.edit.prompt")
                },
                if (agent.native) {
                    ChipMateBundle.message("settings.agentBehavior.agents.edit.prompt.native.description")
                } else {
                    ChipMateBundle.message("settings.agentBehavior.agents.edit.prompt.description")
                },
                scroll(prompt),
            ))
            panel.next(this)
        }
        panel.section(ChipMateBundle.message("settings.agentBehavior.agents.edit.model")).apply {
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.model.override"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.model.override.description"),
                model,
            ))
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.variant"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.variant.description"),
                variant,
            ))
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.temperature"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.temperature.description"),
                temperature,
            ))
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.topP"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.topP.description"),
                top,
            ))
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.steps"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.steps.description"),
                steps,
            ))
        }
        if (canEditVisibility(agent)) panel.section(ChipMateBundle.message("settings.agentBehavior.agents.edit.visibility")).apply {
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.hidden"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.hidden.description"),
                SettingsToggle(hidden) { hidden = it },
            ))
            row(SettingsRow(
                ChipMateBundle.message("settings.agentBehavior.agents.edit.disabled"),
                ChipMateBundle.message("settings.agentBehavior.agents.edit.disabled.description"),
    ...
    override fun getDimensionServiceKey(): String = "ChipMate.AgentEditDialog"
    ...
    private fun validateMode(): ValidationInfo? {
        ...
        if (value == ChipMateCliParser.MODE_PRIMARY || value == ChipMateCliParser.MODE_SUBAGENT || value == ChipMateCliParser.MODE_ALL) return null
        return ValidationInfo(ChipMateBundle.message("settings.agentBehavior.agents.edit.mode.invalid"), mode)
    }
    ...
    private fun validateNumber(field: NumericField, key: String, min: Double? = null, max: Double? = null): ValidationInfo? {
        ...
        if (parsed == null || !parsed.isFinite()) return ValidationInfo(ChipMateBundle.message(key), field)
        if (min != null && parsed < min) return ValidationInfo(ChipMateBundle.message(key), field)
        if (max != null && parsed > max) return ValidationInfo(ChipMateBundle.message(key), field)
        return null
    }
    ...
    private fun validateSteps(): ValidationInfo? {
        ...
        return ValidationInfo(ChipMateBundle.message("settings.agentBehavior.agents.edit.steps.invalid"), steps)
    }

    private class NumericField(value: String, decimal: Boolean) : JBTextField(value) {
        init {
            columns = NUMERIC_COLUMNS
            emptyText.text = ChipMateBundle.message("settings.agentBehavior.agents.edit.default")
    ...
    private fun identity(): JComponent {
        val badges = listOfNotNull(
            badge(
                ChipMateBundle.message("settings.agentBehavior.badge.subagent"),
                UiStyle.Badge.Primary,
            ).takeIf { ChipMateCliParser.isSubagent(agent.mode) },
            badge(
                ChipMateBundle.message("settings.agentBehavior.badge.custom"),
                UiStyle.Badge.Primary,
            ).takeIf { canDelete(agent) },
            badge(ChipMateBundle.message("settings.agentBehavior.badge.hidden")).takeIf { agent.hidden },
            badge(ChipMateBundle.message("settings.agentBehavior.badge.disabled")).takeIf { agent.disable },
            badge(
                ChipMateBundle.message("settings.agentBehavior.badge.deprecated"),
                UiStyle.Badge.Alert,
    ...
    private fun export() {
        ...
        val descriptor = FileSaverDescriptor(
            ChipMateBundle.message("settings.agentBehavior.agents.edit.export.title"),
            ChipMateBundle.message("settings.agentBehavior.agents.edit.export.description"),
            "agent.json",
        )
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            runCatching {
                ...
                notify(NotificationType.INFORMATION, ChipMateBundle.message("settings.agentBehavior.agents.edit.export.success", wrapper.file.name))
            }.onFailure { err ->
                notify(NotificationType.ERROR, ChipMateBundle.message("settings.agentBehavior.agents.edit.export.failed"), err.message)
            }
        }
    }
    ...
    private fun notify(type: NotificationType, title: String, content: String? = null) {
        ApplicationManager.getApplication().invokeLater {
            val notification = NotificationGroupManager.getInstance()
                .getNotificationGroup("ChipMate")
                ?.createNotification(title, content.orEmpty(), type)
                ?: Notification("ChipMate", title, content.orEmpty(), type)
    ...
    private class PromptField(value: String) : EditorTextField(
        ...
        init {
            ...
            setPlaceholder(ChipMateBundle.message("settings.agentBehavior.agents.edit.prompt.placeholder"))
