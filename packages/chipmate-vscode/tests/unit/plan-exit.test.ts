...
describe("planDisplayPath", () => {
  it("returns a relative path unchanged", () => {
    expect(planDisplayPath(".chipmate/plans/my-plan.md", "/repo")).toBe(".chipmate/plans/my-plan.md")
  })

  it("returns absolute path inside repo as repo-relative", () => {
    expect(planDisplayPath("/repo/.chipmate/plans/my-plan.md", "/repo")).toBe(".chipmate/plans/my-plan.md")
  })
  ...
  it("handles Windows absolute paths inside root", () => {
    expect(planDisplayPath("C:\\repo\\.chipmate\\plans\\plan.md", "C:\\repo")).toBe(".chipmate\\plans\\plan.md")
  })
