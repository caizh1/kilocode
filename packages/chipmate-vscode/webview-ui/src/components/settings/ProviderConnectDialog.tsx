    ...
    return (
      ...
      >
              ...
              <Match when={prompt.type === "select"}>
                <div style={{ display: "flex", "flex-direction": "column", gap: "4px" }}>
                  ...
                  <Show when={state.field === prompt.key && state.error}>
                    <span style={{ "font-size": "var(--chipmate-font-size-12)", color: "var(--vscode-errorForeground)" }}>
                      {state.error}
                    </span>
                  </Show>
                </div>
        ...
        <Show when={state.error && !state.field}>
          <div style={{ color: "var(--vscode-errorForeground)", "font-size": "var(--chipmate-font-size-13)" }}>
            {state.error}
          </div>
        </Show>
