import type { TuiPluginApi, TuiSlotContext, TuiSlotMap, TuiSlotProps } from "@chipmate/plugin/tui"
import { createSlot, createSolidSlotRegistry, type JSX, type SolidPlugin } from "@opentui/solid"
import { children, createSignal, mergeProps } from "solid-js" // chipmate_change
...
export function createSlots() {
  ...
  // chipmate_change start - keep stateful fallback children mounted while preserving reactive slot props
