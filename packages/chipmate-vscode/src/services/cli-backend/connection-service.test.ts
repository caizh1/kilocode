...
import { ChipMateConnectionService } from "./connection-service"
...
describe("ChipMateConnectionService sandbox preference", () => {
  test("uses workspace state instead of extension-global state", () => {
    const service = new ChipMateConnectionService({
...
describe("ChipMateConnectionService clients", () => {
...
describe("ChipMateConnectionService viewed sessions", () => {
...
describe("ChipMateConnectionService drainPendingPrompts", () => {
  test("ignores stale NotFoundError replies while draining permissions", async () => {
    const service = new ChipMateConnectionService({
      subscriptions: [],
      globalStorageUri: { fsPath: "/tmp/chipmate-connection-test" },
    } as any)
    const client = {
      project: {
        list: async () => ({ data: [] }),
...
describe("ChipMateConnectionService connect", () => {
