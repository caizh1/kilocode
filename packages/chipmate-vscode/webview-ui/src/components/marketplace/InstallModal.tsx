...
const MARKETPLACE_DOCS = "https://chipmate.ai/docs/customize/marketplace"
const MCP_DOCS = "https://chipmate.ai/docs/automate/mcp/what-is-mcp"
...
export const InstallModal = (props: Props) => {
  ...
  const destination = (target = scope().value) => {
    ...
    if (props.item.type === "mcp") return `${base}/chipmate.json`
