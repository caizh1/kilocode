...
const root = "/chipmate/session-import"

const ResultSchema = Schema.Struct({
  ok: Schema.Boolean,
  id: Schema.String,
  skipped: Schema.optional(Schema.Boolean),
}).annotate({ identifier: "ChipmateSessionImportResult" })
    ...
    HttpApiGroup.make("session-import")
      .add(
        HttpApiEndpoint.post("project", SessionImportPaths.project, {
          ...
          OpenApi.annotations({
            identifier: "chipmate.sessionImport.project",
        ...
        HttpApiEndpoint.post("session", SessionImportPaths.session, {
          ...
          OpenApi.annotations({
            identifier: "chipmate.sessionImport.session",
        ...
        HttpApiEndpoint.post("message", SessionImportPaths.message, {
          ...
          OpenApi.annotations({
            identifier: "chipmate.sessionImport.message",
        ...
        HttpApiEndpoint.post("part", SessionImportPaths.part, {
          ...
          OpenApi.annotations({
            identifier: "chipmate.sessionImport.part",
      ...
      .annotateMerge(
        OpenApi.annotations({
          ...
          description: "ChipMate legacy session import routes.",
        }),
      )
