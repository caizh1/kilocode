package ai.chipmate.client.session.ui.mode

import ai.chipmate.client.plugin.ChipMateBundle
import ai.chipmate.client.session.ui.PickerRow
...
internal class ModePickerRenderer(
    ...
    private val badge = JBLabel(FilledBadgeIcon(ChipMateBundle.message("mode.picker.deprecated"), UiStyle.Badge.Alert)).apply {
