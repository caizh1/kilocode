...
import * as EventWire from "../../src/chipmate/event-wire"
...
describe("SyncEvent encoding", () => {
  test("preserves JSON values nested under unknown schemas", () => {
    ...
    expect(EventWire.encode(schema, { value: new URL("https://chipmate.ai/docs") })).toEqual({
      value: "https://chipmate.ai/docs",
    })
  })
