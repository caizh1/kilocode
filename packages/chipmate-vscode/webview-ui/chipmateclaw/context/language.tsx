// ChipMateClaw lightweight language context
//
// Self-contained i18n for the ChipMateClaw panel. Does not depend on
...
export function ChipMateClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useChipMateClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useChipMateClawLanguage must be used within ChipMateClawLanguageProvider")
  return ctx
}
