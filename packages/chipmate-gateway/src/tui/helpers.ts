/**
 * TUI-specific helper functions for ChipMate Gateway integration
 *
...
import type { ChipMateProfile, ChipMateBalance, Organization } from "../types.js"
...
export function formatProfileInfo(
  ...
  const usageUrl = currentOrgId
    ? `https://app.chipmate.ai/organizations/${currentOrgId}/usage-details`
