...
import type { Event, Message, Part, Session } from "@chipmate/sdk/v2"
import { createSignal } from "solid-js"
import { MemorySidebar } from "@/chipmate/cli/cmd/tui/component/memory-status"
    ...
    setParts([
      {
        ...
        type: "text",
        text: "",
        metadata: { chipmateMemory: { type: "recall", count: 2 } },
      },
    ])
