...
const STYLE_ID = "storybook-chipmate-theme"
...
export function applyChipMateTheme(themeId: string, colorScheme: "light" | "dark") {
...
export function ThemeDecorator(props: ThemeDecoratorProps): JSX.Element {
  createEffect(() => {
    applyChipMateTheme(props.theme, props.colorScheme)
  })
  return <props.Story />
}
