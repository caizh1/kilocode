...
const TIPS = [
  ...
  "ChipMate can {highlight}configure itself{/highlight} if you ask it",
  "Ask ChipMate to {highlight}add Supabase MCP globally{/highlight}",
  "Ask ChipMate to {highlight}create a review agent for this project{/highlight}",
  "Ask ChipMate to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask ChipMate to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask ChipMate to {highlight}make my review agent read-only{/highlight}",
  "Ask ChipMate to {highlight}require approval before git push{/highlight}",
  "Ask ChipMate to {highlight}turn off auto-formatting{/highlight}",
  "Ask ChipMate to {highlight}block access to .env files{/highlight}",
  "Ask ChipMate to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask ChipMate to {highlight}match my terminal theme{/highlight}",
  "Ask ChipMate to {highlight}disable sharing for all sessions{/highlight}",
  "Ask ChipMate to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask ChipMate to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask ChipMate to {highlight}save this workflow as a /command{/highlight}",
  "ChipMate auto-handles OAuth for remote MCP servers requiring auth",
  "ChipMate auto-formats files using prettier, gofmt, ruff, and more",
  "ChipMate uses LSP servers for intelligent code analysis",
  "Use {highlight}chipmate run{/highlight} for non-interactive scripting",
  "Use {highlight}chipmate --continue{/highlight} to resume the last session",
  "Use {highlight}chipmate run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}chipmate serve{/highlight} for headless API access to ChipMate",
  "Use {highlight}chipmate run --attach{/highlight} to connect to a running server",
  "Run {highlight}chipmate upgrade{/highlight} to update to the latest version",
  "Run {highlight}chipmate auth list{/highlight} to see all configured providers",
