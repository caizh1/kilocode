...
import type { PluginContext } from "@chipmate/plugin/v2/effect"
  ...
  Effect.gen(function* () {
    ...
    yield* State.batch(
      Effect.gen(function* () {
        ...
        // chipmate_change - ChipMate's CLI registry supplies `chipmate-config`; do not register the redundant opencode skill.
