...
const terminalContent = {
  installation: (
    <>
      <span className="terminal-comment"># Install ChipMate VS Code Extension</span>
      {"\n"}
      <span className="terminal-prompt">$</span> code --install-extension chipmate.chipmate-code
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or install via CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> npm install -g @chipmate/cli
    </>
  ),
  gateway: (
    <>
      <span className="terminal-comment"># Call ChipMate Gateway with a quick curl script</span>
      {"\n"}
      <span className="terminal-prompt">$</span> export CHIPMATE_API_KEY="YOUR_API_KEY"
      {"\n"}
      <span className="terminal-prompt">$</span> curl https://api.chipmate.ai/api/gateway/chat/completions \{"\n"}
      -H "Authorization: Bearer $CHIPMATE_API_KEY" \{"\n"}
      -H "Content-Type: application/json" \{"\n"}
      {`  -d '{"model":"anthropic/claude-sonnet-4.5","messages":[{"role":"user","content":"Say hi from ChipMate Gateway"}]}'`}
    </>
  ),
  firstTask: (
    <>
      <span className="terminal-comment"># Start a new task with ChipMate</span>
      {"\n"}
      <span className="terminal-prompt">$</span> chipmate "Create a React component for a user profile"
      {"\n"}
      {"\n"}
      <span className="terminal-comment">
        # Or for interactive sessions, just run the ChipMate CLI in your project folder
      </span>
      {"\n"}
      <span className="terminal-prompt">$</span> chipmate
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Run in architect mode for planning</span>
      {"\n"}
      <span className="terminal-prompt">$</span> chipmate --mode architect "Design a REST API"
    </>
  ),
  customRules: (
    <>
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> touch .chipmate/rules.md
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or use the CLI to add rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> chipmate rules add "Always use TypeScript"
      {"\n"}
      <span className="terminal-prompt">$</span> chipmate rules add "Follow React best practices"
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># List all active rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> chipmate rules list
    </>
  ),
  chipmateclaw: (
    <>
      <span className="terminal-comment"># Chat with your ChipMateClaw agent from the CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> chipmate /claw
      {"\n"}
      {"\n"}
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> curl -X POST https://your-instance.chipmateclaw.ai/webhook \{"\n"}
      -H "Content-Type: application/json" \{"\n"}
...
const categories = [
  {
    title: "Get Started",
    description: "Install ChipMate and get up and running in minutes",
  ...
  {
    title: "Code with AI",
    description: "Learn how to use ChipMate to write, edit, and understand code",
    href: "/code-with-ai",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    links: [
      { title: "Overview", href: "/chipmateclaw/overview" },
      { title: "Chat Platforms", href: "/chipmateclaw/chat-platforms" },
      { title: "Development Tools", href: "/chipmateclaw/development-tools" },
    ],
  },
  {
    title: "Collaborate",
    ...
    links: [
      ...
      { title: "ChipMate for Teams", href: "/collaborate" },
  ...
  {
    title: "Contributing",
    description: "Help improve ChipMate and learn about its architecture",
    href: "/contributing",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path
...
export default function HomePage() {
  const [activeTab, setActiveTab] = useState<"installation" | "firstTask" | "customRules" | "gateway" | "chipmateclaw">(
    "installation",
  )
  ...
  return (
    <div className="homepage">
      <Head>
        <title>ChipMate Docs: Setup, Models, MCP, Custom Modes & CLI</title>
      </Head>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">ChipMate Documentation</h1>
          <p className="hero-subtitle">
            Explore guides and examples for the ChipMate platform — from coding agents and AI-powered development to hosted
            agentic infrastructure with ChipMateClaw.
          </p>
          <div className="hero-buttons">
            <Link href="/getting-started" className="btn btn-primary">
              Get started with ChipMate →
            </Link>
            <Link href="/chipmateclaw/overview" className="btn btn-secondary">
              Explore ChipMateClaw
            </Link>
          </div>
        </div>
        ...
        <div className="quick-panel">
          <div className="quick-section">
            <h3 className="quick-title">CHIPMATE</h3>
          ...
          <div className="quick-section">
            <h3 className="quick-title">CHIPMATECLAW</h3>
            <div className="quick-links">
              <Link href="/chipmateclaw/overview" className="quick-link">
                Overview
              </Link>
              <Link href="/chipmateclaw/chat-platforms" className="quick-link">
                Chat Platforms
              </Link>
              <Link href="/chipmateclaw/development-tools" className="quick-link">
                Development Tools
              </Link>
            </div>
          </div>
      ...
      <section className="terminal-section">
        <div className="terminal-intro">
          ...
          <p className="terminal-description">Get started quickly with ChipMate, ChipMateClaw, and ChipMate Gateway</p>
        </div>
        <div className="terminal-container">
          <div className="terminal-tabs">
            ...
            <button
              className={`terminal-tab ${activeTab === "chipmateclaw" ? "active" : ""}`}
              onClick={() => setActiveTab("chipmateclaw")}
            >
              ChipMateClaw
            </button>
            <button
        ...
        <div className="footer-grid">
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://chipmate.ai/discord" className="footer-link">
                Join our Discord
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/ChipMate-Org/chipmate/releases" className="footer-link">
                Changelog
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/ChipMate-Org/chipmate/issues" className="footer-link">
                Report an issue
              </Link>
            </div>
          </div>
