...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Zainstaluj Anaconda Desktop na tym komputerze, a następnie wróć tutaj. ChipMate nie uruchamia instalatora za Ciebie.",
  ...
  "provider.anaconda.state.signedOut": "Otwórz Anaconda Desktop i zaloguj się przed połączeniem ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate nie mógł uzyskać dostępu do Anaconda Desktop. Otwórz Desktop, zaloguj się ponownie i w razie potrzeby uruchom ją ponownie.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate znalazł sprawny lokalny serwer generowania tekstu i może zaimportować jego bieżące ustawienia połączenia.",
  ...
  "provider.anaconda.toast.refreshed.description": "Aktywny serwer lokalny i modele są aktualne w ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate nie mógł sprawdzić dostępnych umiejętności.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate nie mógł sprawdzić stanu serwera MCP.",
  "agentRequirements.error.scopeMismatch": "To sprawdzenie wymagań agenta nie jest już aktywne.",
  "agentRequirements.error.requestFailed": "ChipMate nie mógł sprawdzić wymagań agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w ChipMate.",
  ...
  "prompt.ultra.confirm.title": "Przejdź do trybu Ultra",
  "prompt.ultra.confirm.description":
    "Ultra najpierw prowadzi szerszą eksplorację, a następnie przedstawia wnioski poparte weryfikowalnymi dowodami.",
  "prompt.ultra.confirm.benefit.explore": "Dokładniej zbadaj bazę kodu",
  "prompt.ultra.confirm.benefit.verify": "Najpierw zweryfikuj kluczowe wnioski",
  "prompt.ultra.confirm.benefit.cost": "Zwykle wymaga więcej czasu i tokenów",
  "prompt.ultra.confirm.note":
    "Sprawdza się przy złożonym debugowaniu, analizie architektury i przeglądach wysokiego ryzyka.",
  "prompt.ultra.confirm.action": "Potwierdź i przejdź do Ultra",
  ...
  "prompt.panel.collapse": "Zwiń panel wprowadzania",
  "prompt.panel.expand": "Rozwiń panel wprowadzania",
  "prompt.panel.collapsed": "Panel wprowadzania jest zwinięty",
  "prompt.panel.responding": "Odpowiadanie…",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox jest włączony. Polecenia shell agenta są ograniczone do katalogów projektu i ChipMate.",
  "prompt.action.sandbox.disabled":
    "Sandbox jest wyłączony. Kliknij, aby ograniczyć zapisy poleceń shell agenta do katalogów projektu i ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "Zapisy są ograniczone do katalogów projektu i ChipMate.",
  ...
  "speechToText.tooltip.start": "Rozpocznij wprowadzanie głosowe z ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Zaloguj się do ChipMate, aby korzystać z wprowadzania głosowego.",
  ...
  "dialog.server.description": "Przełącz serwer ChipMate, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja ChipMate ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu ChipMate",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, ChipMate nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla ChipMate",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd ChipMate na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw ChipMate.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania ChipMate",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji ChipMate.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę ChipMate Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości ChipMate, bez lock-inu.",
  ...
  "settings.models.hidePromptTraining.description":
    "Ukryj modele ChipMate Gateway, których dostawcy mogą używać Twoich promptów do trenowania.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny ChipMate ({{scope}})",
  "settings.config.placeholder":
    "Pliki konfiguracyjne są scalane po kolei; pliki oznaczone jako wczytane mają obecnie wpływ na ustawienia.",
  "settings.config.noWorkspace": "Otwórz folder obszaru roboczego, aby edytować lokalny plik konfiguracyjny ChipMate.",
  "settings.config.openFailed": "Nie udało się otworzyć pliku konfiguracyjnego ChipMate ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Globalna konfiguracja XDG",
  "settings.config.source.homeChipMate": "Konfiguracja .chipmate (Home)",
  "settings.config.source.homeOpencode": "Konfiguracja .opencode (Home)",
  "settings.config.source.envFile": "Plik środowiskowy CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Wbudowana konfiguracja środowiska",
  "settings.config.source.projectChipMate": "Konfiguracja .chipmate projektu",
  ...
  "workStyle.onboarding.welcome": "Witamy w ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate wstrzymuje pracę i pokazuje swój plan w trakcie działania.",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie chipmate import",
  ...
  "deviceAuth.title": "Zaloguj się do ChipMate",
  ...
  "profile.action.login": "Zaloguj się przez ChipMate",
  ...
  "profile.pass.subscribe": "Zdobądź ChipMate Pass, aby dodać środki i zdobywać bonusy",
  ...
  "settings.aboutChipMate.title": "O ChipMate",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "ChipMate to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutChipMate.status.connected": "Połączono",
  "settings.aboutChipMate.status.connecting": "Łączenie...",
  "settings.aboutChipMate.status.disconnected": "Rozłączono",
  "settings.aboutChipMate.status.error": "Błąd",
  "settings.aboutChipMate.cliServer": "Serwer CLI",
  "settings.aboutChipMate.status.label": "Status:",
  "settings.aboutChipMate.port.label": "Port:",
  "settings.aboutChipMate.versionInfo": "Informacje o wersji",
  "settings.aboutChipMate.version.label": "Wersja:",
  "settings.aboutChipMate.extensionName": "Rozszerzenie ChipMate",
  "settings.aboutChipMate.community": "Społeczność i wsparcie",
  "settings.aboutChipMate.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutChipMate.feedback.or": "lub",
  "settings.aboutChipMate.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutChipMate.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutChipMate.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutChipMate.exportSettings": "Eksportuj",
  "settings.aboutChipMate.importSettings": "Importuj",
  "settings.aboutChipMate.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień ChipMate.",
  "settings.aboutChipMate.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji ChipMate. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu ChipMate. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Włącz wprowadzanie głosowe w polach promptów przy użyciu konta ChipMate za pośrednictwem ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Włącz i zaloguj się do dostawcy ChipMate, aby korzystać ze Speech to Text. Speech to Text jest obecnie obsługiwane tylko z ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Model mowy na tekst",
  "settings.models.speechToTextModel.description":
    "Wybierz model transkrypcji ChipMate Gateway dla wprowadzania głosowego.",
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem ChipMate Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.chipmateModel.title": "Preset modelu ChipMate",
  "settings.indexing.chipmateModel.description": "Wybierz obsługiwany model osadzania hostowany przez ChipMate.",
  "settings.indexing.chipmateSignIn.title": "Wymagane logowanie do ChipMate",
  "settings.indexing.chipmateSignIn.description": "Zaloguj się do ChipMate, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby ChipMate korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w chipmate.jsonc lub poproś agenta o ich dodanie.",
  ...
  "settings.sandboxing.enabled.description":
    "Uruchamiaj polecenia shell agenta w sandboxie na poziomie systemu operacyjnego, który ogranicza zapisy do katalogów stanu projektu i ChipMate",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI ChipMate niezależnie od VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutChipMate.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji ChipMate, w tym klucze API dostawców i domyślny model.",
  "settings.aboutChipMate.rooImport.description": "Importuj historię rozmów z instalacji Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Importuj sesje z Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach ChipMate. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez ChipMate w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
  ...
  "settings.experimental.dsml.title": "Naprawa wywołań narzędzi DSML",
  "settings.experimental.dsml.description":
    "Naprawiaj ujawnione wywołania DeepSeek DSML tylko dla wybranego dostawcy i modelu",
  "settings.experimental.dsmlModel.title": "Docelowy model DSML",
  "settings.experimental.dsmlModel.description": "Wybierz jedynego dostawcę i model uprawniony do analizowania DSML",
}
