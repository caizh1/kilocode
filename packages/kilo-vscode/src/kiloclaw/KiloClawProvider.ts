...
export class KiloClawProvider implements vscode.Disposable {
  static readonly viewType = "chipmate.v2.KiloClawPanel"
  ...
  openPanel(): void {
    ...
    const panel = vscode.window.createWebviewPanel(KiloClawProvider.viewType, "ChipMateClaw", vscode.ViewColumn.One, {
      enableScripts: true,
