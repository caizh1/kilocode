...
import { isFileExtension } from "@chipmate/chipmate-indexing/file-extensions"

export { parseFileExtensions } from "@chipmate/chipmate-indexing/file-extensions"
...
export function providerPatch(provider: IndexingConfig["provider"] | "", model?: string): IndexingConfig {
  return {
    ...
    model: provider === "chipmate" ? model || undefined : undefined,
    dimension: undefined,
  }
}
