...
// Used by both `chipmate remote` (explicit CLI) and `enableRemote()` (covers `/remote`
// and CHIPMATE_REMOTE / remote_control auto-enable) so all enable paths advertise
// identically.
import { InstallationVersion } from "@opencode-ai/core/installation/version"
import os from "node:os"
import path from "node:path"
import type { RemoteProtocol } from "@/chipmate-sessions/remote-protocol"
