...
describe("buildFeedbackProperties — non-ChipMate providers", () => {
...
describe("buildFeedbackProperties — ChipMate Gateway", () => {
  it("includes sessionID, messageID, parentMessageID", () => {
    const props = buildFeedbackProperties({ ...baseInput, providerID: "chipmate", next: "up" })
    expect(props).toEqual({
      providerID: "chipmate",
      modelID: "claude-sonnet-4-5",
      rating: "up",
