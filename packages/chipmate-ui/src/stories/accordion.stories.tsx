  ...
  render: () => (
    <Accordion collapsible defaultValue={["item-1"]}>
      <Accordion.Item value="item-1">
        <Accordion.Header>
          <Accordion.Trigger>What is ChipMate?</Accordion.Trigger>
        </Accordion.Header>
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            ChipMate is an AI-powered coding assistant that helps you write, debug, and understand code.
          </div>
        </Accordion.Content>
      </Accordion.Item>
      <Accordion.Item value="item-2">
        ...
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            ChipMate uses large language models to understand your codebase and provide intelligent suggestions.
          </div>
        </Accordion.Content>
      </Accordion.Item>
      <Accordion.Item value="item-3">
        ...
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            ChipMate supports all major programming languages including TypeScript, Python, Go, Rust, and more.
          </div>
        </Accordion.Content>
      </Accordion.Item>
    </Accordion>
