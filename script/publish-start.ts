...
const skipNotes = process.env["CHIPMATE_SKIP_NOTES"] === "1" // chipmate_change
if (skipNotes) console.log("changelog skipped: CHIPMATE_SKIP_NOTES=1") // chipmate_change
...
if (!Script.preview) {
  ...
  // chipmate_change start - skip draft flag when CHIPMATE_SKIP_NOTES=1 (used by publish-stable.yml which doesn't have a publish-complete step)
