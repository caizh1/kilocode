...
## Why ChipMate Uses MCP

ChipMate leverages MCP to provide:
...
MCP creates a universal connector between ChipMate and external services, with REST APIs often powering those services behind the scenes.
