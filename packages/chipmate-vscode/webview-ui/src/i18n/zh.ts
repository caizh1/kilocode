...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "请在此设备上安装 Anaconda Desktop，然后返回此处。ChipMate 不会为你运行安装程序。",
  ...
  "provider.anaconda.state.signedOut": "请打开 Anaconda Desktop 并登录，然后再连接 ChipMate。",
  "provider.anaconda.state.unauthorized":
    "ChipMate 无法访问 Anaconda Desktop。请打开 Desktop，重新登录，并在需要时重新启动它。",
  ...
  "provider.anaconda.state.ready": "ChipMate 找到了一个健康的本地文本生成服务器，可以导入其当前的连接设置。",
  ...
  "provider.anaconda.toast.refreshed.description": "当前本地服务器和模型在 ChipMate 中已是最新。",
...
export const dict = {
  ...
  "session.compaction.confirm.title": "精简此会话的上下文？",
  "session.compaction.confirm.description": "精简会把较早内容转换为摘要，让当前任务获得更多可用上下文。",
  "session.compaction.confirm.flowLabel": "精简前后的会话上下文变化",
  "session.compaction.confirm.before": "精简前",
  "session.compaction.confirm.beforeDescription": "较早对话 + 最近对话",
  "session.compaction.confirm.after": "精简后",
  "session.compaction.confirm.afterDescription": "模型摘要 + 最近对话",
  "session.compaction.confirm.riskDetails": "摘要可能遗漏细节、约束或中间结论。",
  "session.compaction.confirm.riskToolsAndUsage": "较早的工具输出可能被清理，并会产生模型用量。",
  "session.compaction.confirm.acknowledge": "我已了解精简可能丢失细节",
  "session.compaction.confirm.confirm": "确认并精简",
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate 无法检查可用技能。",
  "agentRequirements.error.mcpStatusFailed": "ChipMate 无法检查 MCP 服务器状态。",
  "agentRequirements.error.scopeMismatch": "此代理要求检查已不再有效。",
  "agentRequirements.error.requestFailed": "ChipMate 无法检查代理要求。",
  ...
  "dialog.model.unpaid.freeModels.title": "ChipMate 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 ChipMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 ChipMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 ChipMate 中使用 {{provider}} 模型。",
  ...
  "prompt.ultra.confirm.description": "Ultra 让三个 Explore 会话并行验证冻结的 Code 答案，最后独立综合。",
  "prompt.ultra.confirm.flow.label":
    "Code 生成并冻结完整答案，三个互相隔离的 Explore 会话并行验证，最后由独立 Ask 会话综合全部报告并生成最终答案。",
  "prompt.ultra.confirm.flow.question": "用户问题",
  "prompt.ultra.confirm.flow.code": "Code 生成完整答案",
  "prompt.ultra.confirm.flow.frozen": "冻结 Code 答案",
  "prompt.ultra.confirm.flow.verify": "独立验证",
  "prompt.ultra.confirm.flow.ask": "独立 Ask 综合会话",
  "prompt.ultra.confirm.flow.final": "最终答案",
  "prompt.ultra.confirm.flow.finalNote": "综合三份独立验证",
  ...
  "prompt.ultra.confirm.note": "适合复杂排障、架构分析和高风险评审，通常需要更多时间与 Token。",
  "prompt.ultra.confirm.action": "确认并进入 Ultra",
  "prompt.embeddedReview.title": "嵌入式审查",
  "prompt.embeddedReview.experimental": "实验性",
  "prompt.embeddedReview.summary": "仅覆盖 C/C++ 变更中的高置信严重问题和 6 项机械编码规则。",
  "prompt.embeddedReview.scope": "嵌入式审查范围",
  "prompt.embeddedReview.fact.logic": "5 类严重逻辑",
  "prompt.embeddedReview.fact.rules": "6 项机械规则",
  "prompt.embeddedReview.fact.lines": "仅变更行",
  "prompt.embeddedReview.supported.title": "可检查",
  "prompt.embeddedReview.supported.integer": "整数溢出与边界",
  "prompt.embeddedReview.supported.condition": "条件与实际使用矛盾",
  "prompt.embeddedReview.supported.resource": "局部资源闭环",
  "prompt.embeddedReview.supported.error": "错误码冲突",
  "prompt.embeddedReview.supported.unit": "单位/位宽/端序冲突",
  "prompt.embeddedReview.unsupported.title": "不检查 · 需人工审查",
  "prompt.embeddedReview.unsupported.badge": "6 类盲区",
  "prompt.embeddedReview.unsupported.description": "以下风险不会被本次审查覆盖",
  "prompt.embeddedReview.unsupported.concurrent": "并发与中断",
  "prompt.embeddedReview.unsupported.state": "复杂状态机",
  "prompt.embeddedReview.unsupported.power": "掉电恢复",
  "prompt.embeddedReview.unsupported.hardware": "硬件隐含行为",
  "prompt.embeddedReview.unsupported.toolchain": "IAR/GCC 工具链",
  "prompt.embeddedReview.unsupported.requirements": "需求符合性",
  "prompt.embeddedReview.warning": "PASS 不代表整体安全，仍须人工复核、编译和硬件验证。",
  "prompt.embeddedReview.action.collapse": "收起审查范围",
  "prompt.embeddedReview.action.expand": "展开审查范围",
  ...
  "prompt.thinking.description": "推理强度：{{value}}",
  "prompt.thinking.variant.none": "关闭",
  ...
  "prompt.action.send.selectModel": "请先选择模型再发送",
  "prompt.action.send.recording": "转录并发送",
  "prompt.action.stop": "停止",
  "prompt.panel.collapse": "收起输入面板",
  "prompt.panel.expand": "展开输入面板",
  "prompt.panel.collapsed": "输入面板已收起",
  "prompt.panel.responding": "正在回答…",
  ...
  "prompt.action.sandbox.enabled": "沙盒已启用。代理 shell 命令被限制在项目和 ChipMate 状态目录内。",
  "prompt.action.sandbox.disabled": "沙盒已禁用。点击以将代理 shell 命令的写入限制在项目和 ChipMate 状态目录内。",
  ...
  "prompt.action.sandbox.description.enabled": "写入仅限项目和 ChipMate 状态目录。",
  "prompt.action.sandbox.description.disabled": "点击以限制文件系统写入和网络访问。",
  "prompt.action.sandbox.description.disabledNetworkAllowed":
    "点击以限制文件系统写入。根据你的沙盒设置，网络访问仍然允许。",

  "speechToText.tooltip.start": "使用 ChipMate Gateway 开始语音输入",
  ...
  "speechToText.error.loginRequired": "登录 ChipMate 以使用语音输入。",
  ...
  "dialog.server.description": "切换此应用连接的 ChipMate 服务器。",
  ...
  "toast.update.description": "ChipMate 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 ChipMate 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: ChipMate 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "ChipMate 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 ChipMate 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 ChipMate 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 ChipMate 的主题。",
  ...
  "settings.updates.row.startup.description": "在 ChipMate 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 ChipMate。",
  ...
  "settings.patentCenter.title": "专利中心",
  "settings.patentCenter.description": "集中配置内网专利库、本地 Patent Radar 扫描、评审操作和数据边界。",
  "settings.patentCenter.connection.title": "内网专利库",
  "settings.patentCenter.connection.description": "ChipMate 只向只读服务发送技术检索特征，不发送完整工作区快照。",
  "settings.patentCenter.localOnly": "源码证据留在本机",
  "settings.patentCenter.server.title": "Patent Server 地址",
  "settings.patentCenter.server.description": "支持 HTTP 和 HTTPS；HTTP 仅建议用于受控内网。",
  "settings.patentCenter.server.placeholder": "http://patent-server.company.example:6020",
  "settings.patentCenter.test.action": "测试连接",
  "settings.patentCenter.test.testing": "正在测试…",
  "settings.patentCenter.automation.title": "扫描与隐私",
  "settings.patentCenter.automation.description": "修改后通过页面底部的设置保存栏统一保存。",
  "settings.patentCenter.enabled.title": "自动补跑扫描",
  "settings.patentCenter.enabled.description": "打开工作区时，如果扫描已过期且专利库已配置，则自动补跑。",
  "settings.patentCenter.schedule.title": "扫描间隔",
  "settings.patentCenter.schedule.description": "两次自动补跑之间的最少天数。",
  "settings.patentCenter.schedule.unit": "天",
  "settings.patentCenter.analysisModel.title": "分析模型",
  "settings.patentCenter.analysisModel.description": "从已连接的提供商中选择 Patent Radar 使用的模型。",
  "settings.patentCenter.analysisModel.empty": "请先连接模型提供商",
  "settings.patentCenter.analysisModel.helper": "由提供商统一管理连接与凭据",
  "settings.patentCenter.snapshot.title": "完整工作区快照上传（预留）",
  "settings.patentCenter.snapshot.description":
    "为未来上传流程预留的项目级显式开关。当前 Patent Server 没有源码上传接口，开启后也不会上传源码。",
  "settings.patentCenter.actions.title": "Patent Radar",
  "settings.patentCenter.actions.description": "无需打开命令面板，直接在这里完成常用流程。",
  "settings.patentCenter.actions.scan": "扫描当前工作区",
  "settings.patentCenter.actions.scanModule": "扫描模块",
  "settings.patentCenter.actions.manageModules": "管理模块",
  "settings.patentCenter.actions.open": "查看候选",
  "settings.patentCenter.actions.research": "重新检索",
  "settings.patentCenter.actions.export": "导出证据包",
  "settings.patentCenter.actions.importReviews": "导入盲审结果",
  "settings.patentCenter.status.ready": "专利语料已就绪，可以进行检索。",
  "settings.patentCenter.status.notReady": "连接成功，但语料状态为 {{state}}；正面结论将保持关闭。",
  "settings.patentCenter.status.http": "Patent Server 返回 HTTP {{status}}。",
  "settings.patentCenter.status.timeout": "连接 Patent Server 超时。",
  "settings.patentCenter.status.network": "无法连接 Patent Server。",
  "settings.patentCenter.status.identity": "该地址不是 ChipMate Patent Server。",
  "settings.patentCenter.status.unhealthy": "Patent Server 可以访问，但数据库或检索索引当前不可用。",
  "settings.patentCenter.status.invalidJson": "Patent Server 返回的状态数据无效。",
  "settings.patentCenter.status.invalid": "Patent Server 配置无效。",
  "settings.patentCenter.status.documents": "{{count}} 篇专利文档",
  "settings.patentCenter.status.jurisdictions": "{{ready}}/{{total}} 个地区具备历史基线",
  "settings.patentCenter.status.vectorCoverage": "向量覆盖率 {{percent}}%",
  "settings.patentCenter.status.generation": "索引代次 {{generation}}",
  "settings.patentCenter.status.quarantined": "{{count}} 个导入批次处于隔离状态",
  "settings.indexing.description": "配置本地索引、文档检索与高级搜索行为。",
  "settings.indexing.documentsSection": "文档分块与检索",
  "settings.indexing.advancedSection": "高级检索",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate 模型预设",
  "settings.indexing.chipmateModel.description": "选择受支持的 ChipMate 托管嵌入模型。",
  "settings.indexing.chipmateSignIn.title": "需要登录 ChipMate",
  "settings.indexing.chipmateSignIn.description": "登录 ChipMate 以使用托管嵌入。",
  ...
  "settings.indexing.pipeline.codeGraph": "代码图谱",
  "settings.indexing.pipeline.rag": "代码 RAG",
  "settings.indexing.pipeline.documents": "文档 RAG",
  "settings.indexing.pipeline.short.codeGraph": "图谱",
  "settings.indexing.pipeline.short.rag": "RAG",
  "settings.indexing.pipeline.short.documents": "文档",
  "settings.indexing.pipeline.issues": "{{errors}} 个错误 / {{stale}} 个过期 / {{skipped}} 个跳过",
  "settings.indexing.pipeline.diagnostics": "{{name}}诊断",
  "settings.indexing.scope.title": "配置范围",
  "settings.indexing.inheritance.enabled": "继承全局配置（{{state}}），保存项目值后将改用项目配置。",
  "settings.indexing.inheritance.inherited": "{{description}} 当前继承自全局配置。",
  "settings.indexing.inheritance.partial": "{{description}} 部分值继承自全局配置。",
  "settings.indexing.source.global": "全局",
  "settings.indexing.source.local": "本地",
  "settings.indexing.source.mixed": "全局 + 本地",
  "settings.indexing.source.default": "默认",
  "settings.indexing.state.on": "开启",
  "settings.indexing.state.off": "关闭",
  "settings.indexing.state.disabled": "已禁用",
  "settings.indexing.state.standby": "待命",
  "settings.indexing.state.inProgress": "进行中",
  "settings.indexing.state.complete": "已完成",
  "settings.indexing.state.error": "错误",
  "settings.indexing.status.badge": "索引",
  "settings.indexing.term.indexing": "索引",
  "settings.indexing.term.index": "索引",
  "settings.indexing.term.ragIndexing": "代码 RAG 索引",
  "settings.indexing.term.codeGraphIndexing": "代码图谱索引",
  "settings.indexing.provider.local": "{{name}}（本地）",
  "settings.indexing.store.default": "{{name}}（默认）",
  "settings.indexing.tuning.searchMinScore": "搜索最低分数",
  "settings.indexing.tuning.searchMaxResults": "搜索结果上限",
  "settings.indexing.tuning.embeddingBatchSize": "嵌入批次大小",
  "settings.indexing.tuning.scannerMaxBatchRetries": "扫描批次最大重试次数",
  "settings.indexing.field.apiKey": "API 密钥",
  "settings.indexing.field.baseUrl": "基础 URL",
  "settings.indexing.field.awsRegion": "AWS 区域",
  "settings.indexing.field.awsProfile": "AWS 配置文件",
  "settings.indexing.field.specificProvider": "指定提供商",
  "settings.indexing.field.optional": "可选",
  "settings.indexing.field.optionalSuffix": "（可选）",
  "settings.indexing.model.select": "选择模型",
  "settings.indexing.model.enter": "输入模型 ID",
  "settings.indexing.model.provided": "由 ChipMate 提供",
  "settings.indexing.documents.title": "文档索引",
  "settings.indexing.documents.description": "将当前工作区及已授权外部目录中的文本文档索引到独立的 RAG 存储中。",
  "settings.indexing.documents.workspace.title": "当前工作区",
  "settings.indexing.documents.workspace.description": "启用文档 RAG 后始终索引。",
  "settings.indexing.documents.folders.title": "额外目录",
  "settings.indexing.documents.folders.description": "在当前工作区之外，额外索引已授权的外部目录。",
  "settings.indexing.documents.folders.empty": "尚未添加额外目录",
  "settings.indexing.documents.folders.add": "添加外部目录",
  "settings.indexing.documents.folders.remove": "移除",
  "settings.indexing.documents.rebuild": "重新构建",
  "settings.indexing.documents.include.title": "包含规则",
  "settings.indexing.documents.include.description": "可选，用逗号分隔要纳入索引的文档 glob 模式。",
  "settings.indexing.documents.exclude.title": "排除规则",
  "settings.indexing.documents.exclude.description": "可选，用逗号分隔文档 RAG 应跳过的 glob 模式。",
  "settings.indexing.documents.maxFileBytes.title": "文件大小上限（字节）",
  "settings.indexing.documents.maxFileBytes.description": "超过此大小的文档将被跳过。",
  "settings.indexing.documents.chunkChars.title": "分块字符数",
  "settings.indexing.documents.chunkChars.description": "每个文档分块的大致字符预算。",
  "settings.indexing.documents.chunkOverlapChars.title": "分块重叠字符数",
  "settings.indexing.documents.chunkOverlapChars.description": "相邻文档分块之间重叠的字符数。",
  "settings.indexing.documents.searchMaxResults.title": "搜索结果上限",
  "settings.indexing.documents.searchMaxResults.description": "document_search 默认返回的片段数量。",
  "settings.indexing.message.unknownError": "未知索引错误",
  "settings.indexing.message.disabled": "{{pipeline}}已禁用。",
  "settings.indexing.message.notConfigured": "{{pipeline}}未配置。",
  "settings.indexing.message.failed": "{{pipeline}}失败。",
  "settings.indexing.message.blockedBy": "{{pipeline}}被{{dependency}}阻塞。",
  "settings.indexing.message.waitingFor": "{{pipeline}}正在等待{{dependency}}。",
  "settings.indexing.message.recoverBefore": "{{pipeline}}恢复后才能启动{{target}}。",
  "settings.indexing.message.waitingFinish": "正在等待{{pipeline}}索引完成。",
  "settings.indexing.message.previousRecover": "前一索引阶段恢复后才能启动文档 RAG。",
  "settings.indexing.message.documentOrder": "代码图谱和代码 RAG 完成后才会启动文档 RAG。",
  "settings.indexing.message.inProgress": "{{pipeline}}正在进行。",
  "settings.indexing.message.paused": "索引已暂停。",
  "settings.indexing.message.upToDate": "{{pipeline}}已是最新状态。",
  "settings.indexing.message.waitingFiles": "代码图谱正在等待 C/C++ 文件。",
  "settings.indexing.message.waitingStorage": "代码图谱正在等待存储就绪。",
  "settings.indexing.message.needsRebuild": "代码图谱需要重新构建。",
  "settings.indexing.message.graphEmpty": "代码图谱已完成，但未发现受支持的文件。",
  "settings.indexing.message.noSupportedFiles": "本次扫描未发现受支持的 C/C++ 文件。",
  "settings.indexing.message.noGraphRecords": "尚未写入代码图谱记录。",
  "settings.indexing.message.graphRecords": "{{valid}}/{{total}} 条代码图谱记录有效。",
  "settings.indexing.message.documentInactive": "文档 RAG 服务尚未启用。",
  "settings.indexing.message.documentEmpty": "文档 RAG 已完成，共 0 个文件。",
  "settings.indexing.message.documentIssues": "文档 RAG 已建立索引，但存在问题。",
  "settings.indexing.message.documentDiscovering": "正在查找文档文件……",
  "settings.indexing.message.documentStarting": "正在启动文档 RAG 索引……",
  "settings.indexing.message.documentLimit":
    "发现的文档超过 {{max}} 个，文档 RAG 已暂停。请缩小文档目录或排除规则后重新构建。",
  "settings.indexing.message.documentExtraction": "文档提取出现问题：{{file}}",
  "settings.indexing.message.documentLarge": "已跳过过大的文档：{{file}}",
  "settings.indexing.message.documentUnchanged": "文档未变化：{{file}}",
  "settings.indexing.message.documentIndexed": "已索引文档：{{file}}",
  "settings.indexing.message.documentStats":
    "已索引 {{indexed}} 个，跳过 {{skipped}} 个，错误 {{errors}} 个，共 {{chunks}} 个分块。",
  "settings.indexing.message.initializing": "{{pipeline}}正在初始化。",
  "settings.indexing.message.unavailable": "{{pipeline}}不可用。",
  "settings.indexing.message.waitingWorker": "正在等待索引工作进程。",
  "settings.indexing.message.lowMemoryRestart": "索引工作进程正以低内存模式重启，已提交的索引仍然可用。",
  "settings.indexing.message.openTarget": "请在目标工作区中打开文件以查看索引状态。",
  "settings.indexing.message.loadingProject": "正在加载当前项目的索引状态。",
  "settings.indexing.message.openWorkspace": "请在工作区中打开文件以选择项目。",
  "settings.indexing.message.noWorkspace": "未打开工作区目录",
  "settings.indexing.message.ragNotConfiguredGraph": "代码 RAG 尚未配置，代码图谱仍可用。",
  "settings.indexing.message.ragDisabledGraph": "代码 RAG 已禁用，代码图谱仍可用。",
  "settings.indexing.message.waitingBaseline": "正在等待主工作树索引可用。",
  "settings.indexing.message.documentNotInitialized": "文档 RAG 尚未初始化。",
  "settings.indexing.message.documentDisabledByRag": "代码 RAG 已禁用，因此文档 RAG 也已禁用。",
  "settings.indexing.message.noDocumentFolders": "尚未配置文档目录。",
  "settings.indexing.message.documentEmbeddingsBlocked": "嵌入尚未配置，文档 RAG 已被阻塞。",
  "settings.indexing.message.documentStartingShort": "文档 RAG 正在启动。",
  "settings.indexing.message.documentStoreRequired": "文档 RAG 需要已配置的嵌入向量存储。",
  "settings.indexing.message.documentEmbeddingsRequired": "文档 RAG 需要已配置的嵌入。",
  "settings.indexing.message.documentReady": "文档 RAG 已就绪。",
  "settings.indexing.message.documentWaitingRun": "文档 RAG 正在等待另一次文档索引完成。",
  "settings.indexing.message.documentWaitingPipelines": "文档 RAG 正在等待代码图谱和代码 RAG 完成。",
  "settings.indexing.message.documentRagDidNotRun": "代码 RAG 未运行，文档 RAG 已被阻塞。",
  "settings.indexing.message.processingChanges": "正在处理文件变更……",
  "settings.indexing.message.changesProcessed": "文件变更已处理，索引已是最新状态。",
  "settings.indexing.message.queueEmpty": "索引已是最新状态，文件队列为空。",
  "settings.indexing.message.watcherStarted": "文件监视器已启动，索引已是最新状态。",
  "settings.indexing.message.graphWatcherStarted": "代码图谱监视器已启动，代码图谱已是最新状态。",
  "settings.indexing.message.watcherUnavailable": "索引已是最新状态。文件监视器不可用，变更将在下次扫描时处理。",
  "settings.indexing.message.watcherStarting": "索引已是最新状态，文件监视器正在启动。",
  "settings.indexing.message.graphWatcherStarting": "代码图谱已是最新状态，文件监视器正在启动。",
  "settings.indexing.message.workspaceRequired": "索引需要打开一个工作区目录。",
  "settings.indexing.message.configRequired": "缺少配置，请保存设置以启动索引。",
  "settings.indexing.message.ragConfigRequired": "缺少配置，请保存设置以启动代码 RAG 索引。",
  "settings.indexing.message.initializingServices": "正在初始化服务……",
  "settings.indexing.message.cancelled": "索引已取消。",
  "settings.indexing.message.startingCodeGraph": "正在启动代码图谱索引……",
  "settings.indexing.message.startingCodeGraphBeforeRag": "正在代码 RAG 之前启动代码图谱索引……",
  "settings.indexing.message.codeGraphCompleteStartingRag": "代码图谱已完成，正在启动代码 RAG 索引……",
  "settings.indexing.message.codeGraphCompleteValidating": "代码图谱已完成，正在验证嵌入配置……",
  "settings.indexing.message.checkingFiles": "正在检查新增或修改的文件……",
  "settings.indexing.message.servicesReady": "服务已就绪，正在启动工作区扫描……",
  "settings.indexing.message.embeddingChanged": "嵌入设置已更改，正在启动代码 RAG 索引……",
  "settings.indexing.message.validatingBeforeRag": "正在启动代码 RAG 索引前验证嵌入配置……",
  "settings.indexing.message.runActive": "此工作区已有另一个索引任务正在运行。",
  "settings.indexing.message.runActiveRetrying": "此工作区已有另一个索引任务正在运行，正在自动重试……",
  "settings.indexing.message.reconciling": "工作区变化过快，稍后将再次协调索引。",
  "settings.indexing.message.watcherStopped": "文件监视器已停止。",
  "settings.indexing.message.cleared": "索引数据已成功清除。",
  "settings.indexing.message.indexingFiles": "正在索引文件……",
  "settings.indexing.message.ready": "已就绪。",
  "settings.indexing.message.errorOccurred": "发生错误。",
  "settings.indexing.message.currentFile": " 当前：{{file}}",
  "settings.indexing.message.filesProcessed": "已处理 {{processed}} / {{total}} 个文件（{{percent}}%）。{{current}}",
  "settings.indexing.message.graphFilesBuilt":
    "已构建 {{processed}} / {{total}} 个代码图谱文件（{{percent}}%）。{{current}}",
  "settings.indexing.message.documentBlockedBecause": "文档 RAG 已被阻塞，因为{{pipeline}} {{reason}}。",
  "settings.indexing.message.reasonFailed": "失败",
  "settings.indexing.message.reasonCancelled": "已取消",
  "settings.indexing.message.failedInitialize": "初始化失败：{{error}}",
  "settings.indexing.message.failedChanges": "处理文件变更失败：{{error}}",
  "settings.indexing.message.failedInitialScan": "初始扫描失败：{{error}}",
  "settings.indexing.message.failedRagScan": "代码 RAG 扫描失败：{{error}}",
  "settings.indexing.message.failedRecovery": "恢复失败：{{error}}",
  "settings.indexing.message.failedClear": "清除向量集合失败：{{error}}",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 ChipMate Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 ChipMate 开放，无锁定。",
  ...
  "settings.models.hidePromptTraining.description": "隐藏提供商可能会使用您的提示词进行训练的 ChipMate Gateway 模型。",
  ...
  "provider.custom.quick.title": "连接 ChipMate",
  "provider.custom.quick.description": "输入 API Key，ChipMate 将校验服务端模型列表并自动完成 QA 配置。",
  "provider.custom.quick.models.waiting": "输入 API Key 后将检查 /models。",
  "provider.custom.quick.models.verified": "已找到配置的 DeepSeek 模型。",
  "provider.custom.quick.models.missing": "服务端未返回配置模型，也没有可选的 DeepSeek 模型。",
  "provider.custom.quick.models.choose": "服务端未返回配置模型，请选择一个 DeepSeek 模型后继续。",
  "provider.custom.quick.models.selected": "已选择 {{model}}。",
  "provider.custom.quick.models.confirm": "使用所选模型",
  "provider.custom.quick.models.ready": "可使用",
  "provider.custom.quick.autocomplete.ready": "自动补全 · {{model}}",
  "provider.custom.quick.autocomplete.enable": "保存 Provider 后将自动启用。",
  "provider.custom.quick.autocomplete.preserve": "模型已配置；将保留当前手动选择的补全模型。",
  "provider.custom.quick.autocomplete.missing": "服务端未返回自动补全模型 {{model}}。",
  "provider.custom.quick.autocomplete.qaOnly": "仍可保存 QA；现有自动补全设置不会改变。",
  "provider.custom.quick.autocomplete.missingToast.title": "QA 已连接，自动补全未启用",
  "provider.custom.quick.autocomplete.missingToast.description": "服务端未返回配置的自动补全模型。",
  "provider.custom.quick.autocomplete.failedToast.title": "QA 已连接，自动补全启用失败",
  "provider.custom.quick.autocomplete.failedToast.description": "自动补全设置保存失败：{{error}}",
  "provider.custom.quick.reasoning.title": "推理 · low",
  "provider.custom.quick.reasoning.description": "默认开启；可在 QA 中切换 medium、high 或 max。",
  "provider.custom.quick.advanced": "高级设置",
  "provider.custom.quick.save": "保存并在 QA 中使用",
  ...
  "provider.custom.error.apiKey.originChanged": "请为这个地址重新输入 API Key 或环境变量凭据",
  ...
  "settings.config.title": "打开 {{scope}} ChipMate 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 ChipMate 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} ChipMate 配置文件：{{message}}",
  "settings.config.source.xdg": "XDG 全局配置",
  "settings.config.source.homeChipMate": "主目录 .chipmate 配置",
  "settings.config.source.homeOpencode": "主目录 .opencode 配置",
  "settings.config.source.envFile": "CHIPMATE_CONFIG 环境变量文件",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "内联环境配置",
  "settings.config.source.projectChipMate": "项目 .chipmate 配置",
  ...
  "session.surface.owner.main": "当前界面拥有会话操作权",
  "session.surface.mirror": "实时镜像 · 操作权在主编辑区",
  "session.surface.focusMain": "前往主区",
  "session.surface.returnSidebar": "收回侧栏",
  "session.surface.status.opening": "正在准备主编辑区…",
  "session.surface.status.returning": "正在收回侧栏…",
  "session.surface.status.restoring": "正在恢复当前会话…",
  "session.surface.status.disconnected": "连接已断开，完成对账前不可编辑",
  "session.surface.status.deleted": "当前会话已删除",
  "session.surface.deleted.title": "会话已删除",
  "session.surface.deleted.detail": "此标签已进入只读终态，可以安全关闭。",
  ...
  "workStyle.onboarding.welcome": "欢迎使用 ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate 会在工作过程中暂停并向你展示其计划。",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 chipmate import 命令",
  ...
  "settings.aboutChipMate.title": "关于 ChipMate",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "ChipMate 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "session.turn.completedDuration": "已完成 · 本轮耗时 {{duration}}",
  "session.turn.duration.seconds": "{{seconds}}秒",
  "session.turn.duration.minutes": "{{minutes}}分{{seconds}}秒",
  "session.compaction.active": "正在压缩上下文…",
  "session.compaction.description": "整理较早的对话，以继续当前任务",
  "session.compaction.retryingWithoutThinking": "本次压缩未生成有效摘要，正在关闭思考后重试…",
  "session.compaction.status.running": "正在精简会话…",
  "session.compaction.status.autoRunning": "正在自动精简会话…",
  "session.compaction.status.retrying": "正在重试精简…",
  "session.compaction.status.runningDescription": "正在把较早内容转换为摘要。",
  "session.compaction.status.succeeded": "会话精简完成",
  "session.compaction.status.autoSucceeded": "已自动精简会话",
  "session.compaction.status.succeededDescription": "较早内容已转换为摘要，最近对话已保留。",
  "session.compaction.status.failed": "会话精简失败",
  "session.compaction.status.failedDescription": "本次精简未完成，请勿将其视为已成功压缩。",
  "session.compaction.status.interrupted": "会话精简已中断",
  "session.compaction.status.interruptedDescription": "本次精简未完成。",
  "session.compaction.phase.preparing": "正在分析会话并规划压缩任务。",
  "session.compaction.phase.generating": "模型正在生成摘要；此阶段无法预测剩余时间。",
  "session.compaction.phase.chunk": "正在并行压缩较早内容。",
  "session.compaction.phase.reduce": "正在合并第 {{depth}} 层摘要。",
  "session.compaction.phase.replay": "正在压缩需要在精简后继续处理的请求。",
  "session.compaction.phase.retrying": "正在关闭思考并从头重启完整压缩流程。",
  "session.compaction.phase.committing": "摘要已生成，正在提交压缩边界。",
  "session.compaction.phase.splitting": "当前摘要单元超出模型上下文，正在安全细分。",
  "session.compaction.progress.stage": "当前阶段 {{completed}}/{{total}} · {{percent}}%",
  "session.compaction.elapsed.running": "已等待 {{duration}}",
  "session.compaction.elapsed.completed": "总耗时 {{duration}}",
  ...
  "context.usage.billing.pending": "计费中…",
  "context.usage.billing.unavailable": "费用暂不可用",
  "context.usage.billing.group": "实际分组",
  "context.usage.billing.steps": "{{count}} 次请求",
  ...
  "settings.aboutChipMate.status.connected": "已连接",
  "settings.aboutChipMate.status.connecting": "连接中...",
  "settings.aboutChipMate.status.disconnected": "已断开",
  "settings.aboutChipMate.status.error": "错误",
  "settings.aboutChipMate.cliServer": "CLI 服务器",
  "settings.aboutChipMate.status.label": "状态：",
  "settings.aboutChipMate.port.label": "端口：",
  "settings.aboutChipMate.versionInfo": "版本信息",
  "settings.aboutChipMate.version.label": "版本：",
  "settings.aboutChipMate.extensionName": "ChipMate 扩展",
  "settings.aboutChipMate.community": "社区与支持",
  "settings.aboutChipMate.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutChipMate.feedback.or": "或",
  "settings.aboutChipMate.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutChipMate.resetSettings.title": "重置设置",
  "settings.aboutChipMate.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutChipMate.resetSettings.button": "重置所有设置",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "设置迁移",
  "settings.aboutChipMate.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutChipMate.exportSettings": "导出",
  "settings.aboutChipMate.importSettings": "导入",
  "settings.aboutChipMate.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutChipMate.importSettings.invalidConfig": "文件不包含有效的 ChipMate 设置。",
  "settings.aboutChipMate.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutChipMate.importSettings.newerVersion": "此文件由较新版本的 ChipMate 导出。部分设置可能会被忽略。",
  "settings.aboutChipMate.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutChipMate.telemetry.title": "遥测",
  "settings.aboutChipMate.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutChipMate.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 ChipMate 界面的语言。',
  ...
  "settings.experimental.dsml.title": "DSML 工具调用兼容解析",
  "settings.experimental.dsml.description": "仅为选定的 Provider 和模型修复泄漏的 DeepSeek DSML 工具调用",
  "settings.experimental.dsmlModel.title": "DSML 目标模型",
  "settings.experimental.dsmlModel.description": "选择唯一允许使用 DSML 兼容解析的 Provider 和模型",
  ...
  "settings.models.speechToTextModel.description": "选择用于语音输入的 ChipMate Gateway 转录模型。",
  ...
  "settings.agentBehaviour.removeSkill.phase.refreshing": "正在刷新 ChipMate Skills…",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 ChipMate 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。在 chipmate.jsonc 中添加 MCP 服务器，或让代理为您添加。",
  ...
  "settings.sandboxing.enabled.description":
    "在操作系统级沙盒中运行代理 shell 命令，将写入限制在项目和 ChipMate 状态目录内",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 ChipMate webview UI 的字体大小。",
  ...
  "settings.display.tokenThroughput.title": "显示响应性能",
  "settings.display.tokenThroughput.description":
    "在最新完成的回答下显示解码速度，以及从模型步骤开始到首个正文或推理增量的延时。",

  "chat.throughput.tooltip": "本轮解码速度为 {{speed}}。包含正文和推理 token，不包含首词等待、工具执行和步骤间等待。",
  "chat.throughput.tooltip.missing": "本轮响应性能数据不可用。",
  "chat.throughput.ttft.label": "首词 {{latency}}",
  "chat.throughput.ttft.tooltip": "从模型步骤开始到首个非空正文或推理增量用时 {{latency}}。",
  ...
  "dialog.model.noneSelected": "未选择模型",
  ...
  "settings.aboutChipMate.legacyMigration.title": "旧版迁移",
  "settings.aboutChipMate.legacyMigration.description": "从旧版 ChipMate 安装迁移设置，包括提供商 API 密钥和默认模型。",
  "settings.aboutChipMate.rooImport.description": "从 Roo Code 安装导入对话历史记录。",
  "settings.aboutChipMate.rooImport.button": "从 Roo Code 导入会话",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 ChipMate 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "settings.saveBar.saveTimedOut": "保存状态未确认，可重试",
  "settings.saveBar.saveTimedOutDetails": "本次保存耗时过长，全部更改仍保留在草稿中。",
  "settings.saveBar.protocolMismatch": "扩展与后台版本不一致",
  "settings.saveBar.protocolMismatchDetails": "请重载 VS Code 窗口或安装匹配版本。全部更改仍保留在草稿中。",
  ...
  "diffViewer.source.session.tooltip": "ChipMate 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
  ...
  "chat.navigation.title": "对话导航",
  "chat.navigation.close": "关闭对话导航",
  "chat.navigation.inputs": "我的输入",
  "chat.navigation.search": "全文搜索",
  "chat.navigation.count": "{{count}} 条输入",
  "chat.navigation.filter": "筛选我的输入…",
  "chat.navigation.attachment": "附件",
  "chat.navigation.today": "今天",
  "chat.navigation.yesterday": "昨天",
  "chat.navigation.justNow": "刚刚",
  "chat.navigation.loadingEarlier": "正在载入更早输入…",
  "chat.navigation.empty": "当前对话还没有用户输入",
  "chat.navigation.noMatches": "没有匹配的输入",
  "permission.directory": "执行目录",
  ...
  "prompt.deepseekHarness.confirm.title": "启动 ChipMate DeepSeek Harness",
  "prompt.deepseekHarness.confirm.description":
    "QA 只负责界面；固定的官方 DSH 运行时从 ChipMate Server 下载并在本机校验。Windows 使用官方 standard preset，Linux 使用官方 minimal preset，均原样执行。",
  "prompt.deepseekHarness.confirm.flow.label":
    "QA 输入与展示由扩展宿主按官方协议转发给官方 DSH 0.1.0 候选版本 6，再由当前平台的官方 preset 管理会话、工具和审批。",
  "prompt.deepseekHarness.confirm.flow.qa": "QA 输入与展示",
  "prompt.deepseekHarness.confirm.flow.bridge": "官方协议转发",
  "prompt.deepseekHarness.confirm.flow.dsh": "官方 DSH 0.1.0-rc.6",
  "prompt.deepseekHarness.confirm.flow.runtime": "Windows 标准模式 · Linux 极简模式",
  "prompt.deepseekHarness.confirm.native":
    "Windows 标准模式保留官方 Windows 工具、Skill、Goal、子 Agent、Workflow 和压缩；Linux 极简模式仅保留持久 Bash 与 str_replace_editor。两者都不接入 ChipMate 的 Prompt、工具、Memory、索引、RAG、重试或结果改写。",
  "prompt.deepseekHarness.confirm.home":
    "使用插件私有且持久化的 DSH_HOME，隔离全局插件、Skill 和历史，同时保留官方工作区发现机制。",
  "prompt.deepseekHarness.confirm.start":
    "确认后才启动本地 127.0.0.1 服务。Windows 不要求 /bin/bash；Linux 极简模式会严格验证官方要求的 /bin/bash。",
  "prompt.deepseekHarness.confirm.action": "确认并启动 ChipMate DeepSeek Harness",
  "chat.deepseekHarness.session.opening": "正在打开官方会话…",
  "chat.deepseekHarness.session.untitled": "未命名官方会话",
