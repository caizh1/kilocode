...
internal fun diffRequest(
    ...
    dto: DiffFileDto,
    branch: String? = null,
    labels: Pair<String, String> = ChipMateBundle.message("diff.editor.side.base") to ChipMateBundle.message("diff.editor.side.current"),
): DiffRequest {
    ...
    val fallback = patch ?: ChipMateBundle.message("diff.editor.patch.unavailable")
...
internal fun diffTitle(file: String, branch: String?): String {
    ...
    return ChipMateBundle.message("diff.editor.file.title", file, name)
}
