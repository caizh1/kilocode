...
import { buildEvidencePack, hasSufficientLifecycleEvidence } from "../../../src/chipmate/design-doc/evidence"
...
const root = await mkdtemp(path.join(tmpdir(), "chipmate-design-doc-benchmark-"))
