...
export const IndexingConfig = z
  .object({
    ...
    chipmate: z
      ...
      .strict()
      .optional()
      .describe("ChipMate-hosted embedding provider options"),
    openai: z
...
export const IndexingSchema = Schema.Struct({
  ...
  chipmate: Schema.optional(
    Schema.Struct({
      apiKey: Schema.optional(Schema.String),
      baseUrl: Schema.optional(Schema.String),
      organizationId: Schema.optional(Schema.String),
    }),
  ).annotate({ description: "ChipMate-hosted embedding provider options" }),
...
export function toIndexingConfigInput(cfg: IndexingConfig | undefined): IndexingConfigInput {
  ...
  return {
    ...
    chipmateApiKey: cfg?.chipmate?.apiKey,
    chipmateBaseUrl: cfg?.chipmate?.baseUrl,
    chipmateOrganizationId: cfg?.chipmate?.organizationId,
