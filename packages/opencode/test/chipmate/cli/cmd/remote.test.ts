...
// Shared helper lives in chipmate-sessions; remote.ts re-exports for the CLI path.
import { buildInstanceAdvertisement } from "../../../../src/chipmate-sessions/instance-advertisement"
