...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Anaconda Desktop'ı bu makineye kurun, ardından buraya dönün. ChipMate kurulumu sizin için çalıştırmaz.",
  ...
  "provider.anaconda.state.signedOut": "ChipMate'yu bağlamadan önce Anaconda Desktop'ı açın ve oturum açın.",
  "provider.anaconda.state.unauthorized":
    "ChipMate Anaconda Desktop'a erişemedi. Desktop'ı açın, tekrar oturum açın ve gerekirse yeniden başlatın.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate sağlıklı bir yerel metin üretme sunucusu buldu ve mevcut bağlantı ayarlarını içe aktarabilir.",
  ...
  "provider.anaconda.toast.refreshed.description": "Etkin yerel sunucu ve modeller ChipMate'da güncel.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate mevcut yetenekleri denetleyemedi.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate MCP sunucu durumunu denetleyemedi.",
  "agentRequirements.error.scopeMismatch": "Bu ajan gereksinimi denetimi artık etkin değil.",
  "agentRequirements.error.requestFailed": "ChipMate ajan gereksinimlerini denetleyemedi.",
  ...
  "dialog.model.unpaid.freeModels.title": "ChipMate tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve ChipMate'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve ChipMate'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ChipMate'da {{provider}} modellerini kullanın.",
  ...
  "prompt.panel.collapse": "Giriş panelini daralt",
  "prompt.panel.expand": "Giriş panelini genişlet",
  "prompt.panel.collapsed": "Giriş paneli daraltıldı",
  "prompt.panel.responding": "Yanıtlanıyor…",
  ...
  "prompt.action.sandbox.enabled": "Sandbox etkin. Agent shell komutları proje ve ChipMate dizinleriyle sınırlıdır.",
  "prompt.action.sandbox.disabled":
    "Sandbox devre dışı. Agent shell komut yazma işlemlerini proje ve ChipMate dizinleriyle sınırlamak için tıklayın.",
  ...
  "prompt.action.sandbox.description.enabled": "Yazma işlemleri proje ve ChipMate dizinleriyle sınırlıdır.",
  ...
  "speechToText.tooltip.start": "ChipMate Gateway ile sesli girişi başlatın",
  ...
  "speechToText.error.loginRequired": "Sesli girişi kullanmak için ChipMate'ya giriş yapın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ChipMate sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "ChipMate'nun yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ChipMate ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: ChipMate henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ChipMate Masaüstü",
  ...
  "settings.general.row.language.description": "ChipMate'nun görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "ChipMate'nun cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ChipMate'nun temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ChipMate başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ChipMate'nun en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.betaNotice":
    "Şu anda yalnızca ChipMate Gateway sağlayıcısı ayarlar arayüzünde yapılandırılabilir. Diğer sağlayıcılar için destek beta döneminde yakında gelecek. Bu arada CLI veya yapılandırma dosyası ile sağlayıcıları yapılandırabilirsiniz. ChipMate'yu açık tutmaya kararlıyız, kilitlenme yok.",
  ...
  "settings.config.title": "{{scope}} ChipMate yapılandırma dosyasını aç",
  "settings.config.placeholder":
    "Yapılandırma dosyaları sırayla birleştirilir; yüklendi olarak işaretlenen dosyalar şu anda ayarları etkiler.",
  "settings.config.noWorkspace": "Yerel ChipMate yapılandırma dosyasını düzenlemek için bir çalışma alanı klasörü açın.",
  "settings.config.openFailed": "{{scope}} ChipMate yapılandırma dosyası açılamadı: {{message}}",
  "settings.config.source.xdg": "XDG küresel yapılandırma",
  "settings.config.source.homeChipMate": "Home .chipmate yapılandırması",
  "settings.config.source.homeOpencode": "Home .opencode yapılandırması",
  "settings.config.source.envFile": "CHIPMATE_CONFIG ortam dosyası",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Satır içi ortam yapılandırması",
  "settings.config.source.projectChipMate": "Proje .chipmate yapılandırması",
  ...
  "workStyle.onboarding.welcome": "ChipMate'ya hoş geldiniz",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate çalışırken duraklar ve planını size gösterir.",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya chipmate import komutu",
  ...
  "deviceAuth.title": "ChipMate'a giriş yap",
  ...
  "profile.action.login": "ChipMate ile giriş yap",
  ...
  "profile.pass.subscribe": "Kredi eklemek ve bonus kazanmak için ChipMate Pass edinin",
  ...
  "settings.aboutChipMate.title": "ChipMate Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "ChipMate bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutChipMate.status.connected": "Bağlı",
  "settings.aboutChipMate.status.connecting": "Bağlanıyor...",
  "settings.aboutChipMate.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutChipMate.status.error": "Hata",
  "settings.aboutChipMate.cliServer": "CLI Sunucusu",
  "settings.aboutChipMate.status.label": "Durum:",
  "settings.aboutChipMate.port.label": "Port:",
  "settings.aboutChipMate.versionInfo": "Sürüm Bilgisi",
  "settings.aboutChipMate.version.label": "Sürüm:",
  "settings.aboutChipMate.extensionName": "ChipMate Uzantısı",
  "settings.aboutChipMate.community": "Topluluk ve Destek",
  "settings.aboutChipMate.feedback.prefix":
    "Herhangi bir sorunuz veya geri bildiriminiz varsa, lütfen şu adreste bir sorun açın:",
  "settings.aboutChipMate.feedback.or": "veya",
  "settings.aboutChipMate.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutChipMate.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutChipMate.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutChipMate.exportSettings": "Dışa Aktar",
  "settings.aboutChipMate.importSettings": "İçe Aktar",
  "settings.aboutChipMate.importSettings.invalidJson": "Geçersiz JSON dosyası. Lütfen geçerli bir ayar dosyası seçin.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Dosya geçerli ChipMate ayarları içermiyor.",
  "settings.aboutChipMate.importSettings.tooLarge": "Dosya çok büyük. Ayar dosyaları 1 MB altında olmalıdır.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Bu dosya ChipMate'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. ChipMate arayüzü için dil seçin.',
  ...
  "settings.experimental.speechToText.description":
    "ChipMate Gateway üzerinden ChipMate hesabınızı kullanarak komut alanlarında sesli girişi etkinleştirin.",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text kullanmak için ChipMate sağlayıcısını etkinleştirin ve giriş yapın. Speech to Text şu anda yalnızca ChipMate Gateway ile desteklenmektedir.",
  "settings.models.speechToTextModel.title": "Sesten metne modeli",
  "settings.models.speechToTextModel.description": "Sesli giriş için ChipMate Gateway transkripsiyon modelini seçin.",
  ...
  "settings.experimental.remote.description":
    "ChipMate Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.sandboxing.enabled.description":
    "Agent shell komutlarını, proje ve ChipMate durum dizinlerine yazmaları kısıtlanan işletim sistemi düzeyinde bir sandbox içinde çalıştırın",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. ChipMate'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. chipmate.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  ...
  "settings.display.fontSize.description": "ChipMate webview UI yazı tipi boyutunu VS Code'dan bağımsız olarak ayarlayın.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sağlayıcıları istemlerinizi eğitim için kullanabilecek ChipMate Gateway modellerini gizleyin.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutChipMate.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere ChipMate'un önceki yüklemesinden ayarları taşıyın.",
  "settings.aboutChipMate.rooImport.description": "Bir Roo Code yüklemesinden konuşma geçmişini içe aktarın.",
  "settings.aboutChipMate.rooImport.button": "Roo Code'dan Oturumları İçe Aktar",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ChipMate'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her ChipMate ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate model önayarı",
  "settings.indexing.chipmateModel.description": "Desteklenen bir ChipMate-hosted embeddings modeli seçin.",
  "settings.indexing.chipmateSignIn.title": "ChipMate oturumu açmak gerekiyor",
  "settings.indexing.chipmateSignIn.description": "Hosted embeddings kullanmak için ChipMate'da oturum açın.",
  ...
  "diffViewer.source.session.tooltip":
    "Geçerli oturum sırasında ChipMate tarafından değiştirilen dosyalar, tur başı anlık görüntülere dayanır. Yeni bir oturum başlatıldığında sıfırlanır.",
