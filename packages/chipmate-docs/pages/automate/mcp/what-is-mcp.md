...
ChipMate implements the Model Context Protocol to:
...
- [Using MCP in ChipMate](using-in-chipmate-code) - Get started with MCP in ChipMate, including creating simple servers
