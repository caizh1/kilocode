...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Aby uzyskać więcej statystyk użycia, użyj ",
  "provider.connect.chipmateGateway.byok.link": "BYOK przez ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Polecane",
  "settings.providers.note.chipmate": "Dostęp do ponad 500 modeli AI",
  ...
  "marketplace.install.about.mcp":
    "Serwer MCP zapewnia ChipMate dodatkowe narzędzia do pracy z usługami zewnętrznymi lub programami lokalnymi.",
  "marketplace.install.about.agent": "Agent dodaje rolę wielokrotnego użytku z własnymi instrukcjami i uprawnieniami.",
  "marketplace.install.about.skill":
    "Umiejętność dodaje instrukcje i zasoby dotyczące określonych zadań, które ChipMate może wczytać w razie potrzeby.",
  "marketplace.install.mcp.warning":
    "Serwery MCP mogą uruchamiać lokalne polecenia lub łączyć się z usługami zewnętrznymi. ChipMate poprosi o pozwolenie przed użyciem ich narzędzi, chyba że uprawnienia zezwalają na to automatycznie.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Wyłącz snapshoty ChipMate dla tego projektu. Stracisz cofanie/przywracanie zmian ChipMate, ale git nadal śledzi wszystko.",
  ...
  "marketplace.aligned.unpublish": "Wycofaj publikację Skill",
  "marketplace.aligned.unpublished": "Wycofano",
}
