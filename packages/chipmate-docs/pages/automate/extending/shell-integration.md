...
description: "Integrate ChipMate with your shell environment"
---

# Terminal Shell Integration

Terminal Shell Integration is a key feature that enables ChipMate to execute commands in your terminal and intelligently process their output. This bidirectional communication between the AI and your development environment unlocks powerful automation capabilities.
...
When using the ChipMate VS Code extension with the Agent Manager, each agent session gets its own dedicated VS Code terminal.
...
1. Check the [ChipMate GitHub Issues](https://github.com/ChipMate-Org/chipmate/issues) to see if others have reported similar problems
2. If not, create a new issue with details about your operating system, VS Code/Cursor version, and the steps you've tried

For additional help, join our [Discord](https://chipmate.ai/discord).
