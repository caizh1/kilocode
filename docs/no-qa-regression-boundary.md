...
- [x] Existing ChipMate file tools remain responsible for reading known local files directly.
...
- [x] New filesystem writes must use workspace-safe paths and the existing ChipMate permission model.
