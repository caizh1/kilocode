...
export const dict = {
  ...
  "session.compaction.confirm.title": "Compact this session's context?",
  "session.compaction.confirm.description":
    "Compaction turns earlier content into a summary so the current task has more context available.",
  "session.compaction.confirm.flowLabel": "How session context changes after compaction",
  "session.compaction.confirm.before": "Before",
  "session.compaction.confirm.beforeDescription": "Earlier conversation + recent conversation",
  "session.compaction.confirm.after": "After",
  "session.compaction.confirm.afterDescription": "Model summary + recent conversation",
  "session.compaction.confirm.riskDetails": "The summary may omit details, constraints, or intermediate conclusions.",
  "session.compaction.confirm.riskToolsAndUsage":
    "Earlier tool output may be cleared, and compaction uses model tokens.",
  "session.compaction.confirm.acknowledge": "I understand that compaction may lose details",
  "session.compaction.confirm.confirm": "Confirm and compact",
  ...
  "prompt.ultra.confirm.title": "Enter Ultra mode",
  "prompt.ultra.confirm.description":
    "Ultra verifies one frozen Code answer in three parallel Explore sessions, then synthesizes independently.",
  "prompt.ultra.confirm.flow.label":
    "Code generates and freezes a complete answer. Three isolated Explore sessions verify it in parallel. An independent Ask session synthesizes the final answer.",
  "prompt.ultra.confirm.flow.question": "User question",
  "prompt.ultra.confirm.flow.code": "Code generates complete answer",
  "prompt.ultra.confirm.flow.frozen": "Freeze Code answer",
  "prompt.ultra.confirm.flow.verify": "Independent verification",
  "prompt.ultra.confirm.flow.ask": "Independent Ask synthesis",
  "prompt.ultra.confirm.flow.final": "Final answer",
  "prompt.ultra.confirm.flow.finalNote": "Three independent verification reports",
  "prompt.ultra.confirm.benefit.explore": "Explore the codebase more thoroughly",
  "prompt.ultra.confirm.benefit.verify": "Verify key conclusions first",
  "prompt.ultra.confirm.benefit.cost": "Usually requires more time and tokens",
  "prompt.ultra.confirm.note":
    "Best for complex troubleshooting, architecture analysis, and high-risk reviews. Usually requires more time and tokens.",
  "prompt.ultra.confirm.action": "Confirm and enter Ultra",
  "prompt.embeddedReview.title": "Embedded review",
  "prompt.embeddedReview.experimental": "Experimental",
  "prompt.embeddedReview.summary":
    "Covers only high-confidence severe issues in C/C++ changes and 6 mechanical coding rules.",
  "prompt.embeddedReview.scope": "Embedded review scope",
  "prompt.embeddedReview.fact.logic": "5 severe logic classes",
  "prompt.embeddedReview.fact.rules": "6 mechanical rules",
  "prompt.embeddedReview.fact.lines": "Changed lines only",
  "prompt.embeddedReview.supported.title": "Reviewed",
  "prompt.embeddedReview.supported.integer": "Integer overflow and bounds",
  "prompt.embeddedReview.supported.condition": "Condition and use conflicts",
  "prompt.embeddedReview.supported.resource": "Local resource closure",
  "prompt.embeddedReview.supported.error": "Error-code conflicts",
  "prompt.embeddedReview.supported.unit": "Unit, width, and endianness conflicts",
  "prompt.embeddedReview.unsupported.title": "Not reviewed · Manual review required",
  "prompt.embeddedReview.unsupported.badge": "6 blind spots",
  "prompt.embeddedReview.unsupported.description": "These risks are not covered by this review",
  "prompt.embeddedReview.unsupported.concurrent": "Concurrency and interrupts",
  "prompt.embeddedReview.unsupported.state": "Complex state machines",
  "prompt.embeddedReview.unsupported.power": "Power-loss recovery",
  "prompt.embeddedReview.unsupported.hardware": "Implicit hardware behavior",
  "prompt.embeddedReview.unsupported.toolchain": "IAR/GCC toolchains",
  "prompt.embeddedReview.unsupported.requirements": "Requirements compliance",
  "prompt.embeddedReview.warning":
    "PASS does not mean the code is safe. Manual review, compilation, and hardware validation are still required.",
  "prompt.embeddedReview.action.collapse": "Collapse review scope",
  "prompt.embeddedReview.action.expand": "Expand review scope",
  ...
  "prompt.thinking.description": "Reasoning effort: {{value}}",
  "prompt.thinking.variant.none": "Off",
  ...
  "provider.custom.error.apiKey.originChanged": "Enter a new API key or environment credential for this address",
  "provider.custom.error.required": "Required",
  "provider.custom.error.duplicate": "Duplicate",
  "settings.openLocalConfig": "Open Project Config",
  "settings.openGlobalConfig": "Open Global Config",
  ...
  "settings.config.source.homeChipMate": "Home .chipmate config",
  "settings.config.source.homeOpencode": "Home .opencode config",
  "settings.config.source.envFile": "CHIPMATE_CONFIG environment file",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Inline environment config",
  "settings.config.source.projectChipMate": "Project .chipmate config",
  ...
  "session.surface.owner.main": "This surface controls the session",
  "session.surface.mirror": "Live mirror · controls are available in the main editor",
  "session.surface.focusMain": "Go to main editor",
  "session.surface.returnSidebar": "Return to sidebar",
  "session.surface.status.opening": "Preparing the main editor…",
  "session.surface.status.returning": "Returning to the sidebar…",
  "session.surface.status.restoring": "Restoring this chat…",
  "session.surface.status.disconnected": "Disconnected — reconciling before edits resume",
  "session.surface.status.deleted": "This chat was deleted",
  "session.surface.deleted.title": "Chat deleted",
  "session.surface.deleted.detail": "This tab is read-only and can be closed.",
  ...
  "workStyle.onboarding.welcome": "Welcome to ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate pauses and shows you its plan as it works.",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or chipmate import command",
  ...
  "settings.patentCenter.title": "Patent Center",
  "settings.patentCenter.description":
    "Configure the private patent corpus, local Patent Radar scans, review actions, and data boundaries in one place.",
  "settings.patentCenter.connection.title": "Private patent corpus",
  "settings.patentCenter.connection.description":
    "ChipMate sends technical search features to this read-only service, never the complete workspace snapshot.",
  "settings.patentCenter.localOnly": "Evidence stays local",
  "settings.patentCenter.server.title": "Patent Server address",
  "settings.patentCenter.server.description": "HTTP and HTTPS are supported; use HTTP only on a controlled intranet.",
  "settings.patentCenter.server.placeholder": "http://patent-server.company.example:6020",
  "settings.patentCenter.test.action": "Test connection",
  "settings.patentCenter.test.testing": "Testing…",
  "settings.patentCenter.automation.title": "Scanning and privacy",
  "settings.patentCenter.automation.description": "These settings are saved with the Settings save bar below.",
  "settings.patentCenter.enabled.title": "Catch up scans automatically",
  "settings.patentCenter.enabled.description":
    "When this workspace opens, run an overdue scan if the private corpus is configured.",
  "settings.patentCenter.schedule.title": "Scan interval",
  "settings.patentCenter.schedule.description": "Minimum number of days between automatic catch-up scans.",
  "settings.patentCenter.schedule.unit": "days",
  "settings.patentCenter.analysisModel.title": "Analysis model",
  "settings.patentCenter.analysisModel.description":
    "Choose the model Patent Radar uses from your connected providers.",
  "settings.patentCenter.analysisModel.empty": "Connect a provider first",
  "settings.patentCenter.analysisModel.helper": "Connections and credentials are managed by Providers",
  "settings.patentCenter.snapshot.title": "Full workspace snapshot upload (reserved)",
  "settings.patentCenter.snapshot.description":
    "Explicit project switch reserved for a future upload flow. The current Patent Server has no source upload endpoint, so enabling it does not upload source code.",
  "settings.patentCenter.actions.title": "Patent Radar",
  "settings.patentCenter.actions.description": "Run the complete workflow here without opening the Command Palette.",
  "settings.patentCenter.actions.scan": "Scan current workspace",
  "settings.patentCenter.actions.scanModule": "Scan module",
  "settings.patentCenter.actions.manageModules": "Manage modules",
  "settings.patentCenter.actions.open": "View candidates",
  "settings.patentCenter.actions.research": "Research again",
  "settings.patentCenter.actions.export": "Export evidence package",
  "settings.patentCenter.actions.importReviews": "Import blind review",
  "settings.patentCenter.status.ready": "Patent corpus is ready for retrieval.",
  "settings.patentCenter.status.notReady":
    "Connection succeeded, but the corpus is {{state}}; positive conclusions stay disabled.",
  "settings.patentCenter.status.http": "Patent Server returned HTTP {{status}}.",
  "settings.patentCenter.status.timeout": "Patent Server connection timed out.",
  "settings.patentCenter.status.network": "Patent Server could not be reached.",
  "settings.patentCenter.status.identity": "The endpoint is not a ChipMate Patent Server.",
  "settings.patentCenter.status.unhealthy":
    "Patent Server is reachable, but its database or search index is unavailable.",
  "settings.patentCenter.status.invalidJson": "Patent Server returned an invalid status document.",
  "settings.patentCenter.status.invalid": "Patent Server configuration is invalid.",
  "settings.patentCenter.status.documents": "{{count}} documents",
  "settings.patentCenter.status.jurisdictions": "{{ready}}/{{total}} jurisdictions with historical baselines",
  "settings.patentCenter.status.vectorCoverage": "{{percent}}% vector coverage",
  "settings.patentCenter.status.generation": "Generation {{generation}}",
  "settings.patentCenter.status.quarantined": "{{count}} quarantined import batches",
  "settings.indexing.description": "Configure local indexing, document retrieval, and advanced search behavior.",
  "settings.indexing.documentsSection": "Document chunking and retrieval",
  "settings.indexing.advancedSection": "Advanced retrieval",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate model preset",
  "settings.indexing.chipmateModel.description": "Choose a supported ChipMate-hosted embedding model.",
  "settings.indexing.chipmateSignIn.title": "ChipMate Gateway sign-in required",
  "settings.indexing.chipmateSignIn.description": "Sign in to ChipMate Gateway to use hosted embeddings.",
  ...
  "settings.indexing.pipeline.codeGraph": "Code Graph",
  "settings.indexing.pipeline.rag": "Code RAG",
  "settings.indexing.pipeline.documents": "Document RAG",
  "settings.indexing.pipeline.short.codeGraph": "CG",
  "settings.indexing.pipeline.short.rag": "RAG",
  "settings.indexing.pipeline.short.documents": "DOC",
  "settings.indexing.pipeline.issues": "{{errors}} err / {{stale}} stale / {{skipped}} skipped",
  "settings.indexing.pipeline.diagnostics": "{{name}} diagnostics",
  "settings.indexing.scope.title": "Configuration scope",
  "settings.indexing.inheritance.enabled": "Inherited from global config ({{state}}) until a project value is saved.",
  "settings.indexing.inheritance.inherited": "{{description}} Inherited from global config.",
  "settings.indexing.inheritance.partial": "{{description}} Some values are inherited from global config.",
  "settings.indexing.source.global": "Global",
  "settings.indexing.source.local": "Local",
  "settings.indexing.source.mixed": "Global + Local",
  "settings.indexing.source.default": "Default",
  "settings.indexing.state.on": "on",
  "settings.indexing.state.off": "off",
  "settings.indexing.state.disabled": "Disabled",
  "settings.indexing.state.standby": "Standby",
  "settings.indexing.state.inProgress": "In Progress",
  "settings.indexing.state.complete": "Complete",
  "settings.indexing.state.error": "Error",
  "settings.indexing.status.badge": "IDX",
  "settings.indexing.term.indexing": "Indexing",
  "settings.indexing.term.index": "Index",
  "settings.indexing.term.ragIndexing": "RAG indexing",
  "settings.indexing.term.codeGraphIndexing": "Code Graph indexing",
  "settings.indexing.provider.local": "{{name}} (local)",
  "settings.indexing.store.default": "{{name}} (default)",
  "settings.indexing.tuning.searchMinScore": "Search Min Score",
  "settings.indexing.tuning.searchMaxResults": "Search Max Results",
  "settings.indexing.tuning.embeddingBatchSize": "Embedding Batch Size",
  "settings.indexing.tuning.scannerMaxBatchRetries": "Scanner Max Batch Retries",
  "settings.indexing.field.apiKey": "API Key",
  "settings.indexing.field.baseUrl": "Base URL",
  "settings.indexing.field.awsRegion": "AWS Region",
  "settings.indexing.field.awsProfile": "AWS Profile",
  "settings.indexing.field.specificProvider": "Specific Provider",
  "settings.indexing.field.optional": "optional",
  "settings.indexing.field.optionalSuffix": "(optional)",
  "settings.indexing.model.select": "Select a model",
  ...
  "settings.indexing.documents.include.description": "Optional comma-separated glob patterns for document files.",
  "settings.indexing.documents.exclude.title": "Exclude",
  "settings.indexing.documents.exclude.description": "Optional comma-separated glob patterns skipped by Document RAG.",
  "settings.indexing.documents.maxFileBytes.title": "Max File Bytes",
  "settings.indexing.documents.maxFileBytes.description": "Documents larger than this are skipped.",
  "settings.indexing.documents.chunkChars.title": "Chunk Chars",
  "settings.indexing.documents.chunkChars.description": "Approximate character budget for each document chunk.",
  "settings.indexing.documents.chunkOverlapChars.title": "Chunk Overlap Chars",
  "settings.indexing.documents.chunkOverlapChars.description": "Character overlap between adjacent document chunks.",
  "settings.indexing.documents.searchMaxResults.title": "Search Max Results",
  "settings.indexing.documents.searchMaxResults.description": "Default number of snippets returned by document_search.",
  "settings.indexing.message.unknownError": "Unknown indexing error",
  "settings.indexing.message.disabled": "{{pipeline}} disabled.",
  "settings.indexing.message.notConfigured": "{{pipeline}} not configured.",
  "settings.indexing.message.failed": "{{pipeline}} failed.",
  "settings.indexing.message.blockedBy": "{{pipeline}} blocked by {{dependency}}.",
  "settings.indexing.message.waitingFor": "{{pipeline}} waiting for {{dependency}}.",
  "settings.indexing.message.recoverBefore": "{{pipeline}} must recover before {{target}} can start.",
  "settings.indexing.message.waitingFinish": "Waiting for {{pipeline}} indexing to finish.",
  "settings.indexing.message.previousRecover":
    "The preceding indexing stage must recover before Document RAG can start.",
  "settings.indexing.message.documentOrder": "Document RAG starts only after Code Graph and Code RAG complete.",
  "settings.indexing.message.inProgress": "{{pipeline}} in progress.",
  "settings.indexing.message.paused": "Indexing paused.",
  "settings.indexing.message.upToDate": "{{pipeline}} up-to-date.",
  "settings.indexing.message.waitingFiles": "Code Graph waiting for C/C++ files.",
  "settings.indexing.message.waitingStorage": "Code Graph waiting for storage.",
  "settings.indexing.message.needsRebuild": "Code Graph needs rebuild.",
  "settings.indexing.message.graphEmpty": "Code Graph complete, 0 supported files.",
  "settings.indexing.message.noSupportedFiles": "The completed scan found no supported C/C++ files.",
  "settings.indexing.message.noGraphRecords": "No graph records have been written yet.",
  "settings.indexing.message.graphRecords": "{{valid}}/{{total}} graph records valid.",
  "settings.indexing.message.documentInactive": "Document RAG service is not active.",
  "settings.indexing.message.documentEmpty": "Document RAG complete: 0 files.",
  "settings.indexing.message.documentIssues": "Document RAG indexed with issues.",
  "settings.indexing.message.documentDiscovering": "Discovering document files...",
  "settings.indexing.message.documentStarting": "Starting Document RAG indexing...",
  "settings.indexing.message.documentLimit":
    "Document RAG paused after finding more than {{max}} documents. Narrow document paths or excludes before rebuilding.",
  "settings.indexing.message.documentExtraction": "Document extraction issue: {{file}}",
  "settings.indexing.message.documentLarge": "Skipped large document: {{file}}",
  "settings.indexing.message.documentUnchanged": "Document unchanged: {{file}}",
  "settings.indexing.message.documentIndexed": "Indexed document: {{file}}",
  "settings.indexing.message.documentStats":
    "{{indexed}} indexed, {{skipped}} skipped, {{errors}} errors, {{chunks}} chunks.",
  "settings.indexing.message.initializing": "{{pipeline}} is initializing.",
  "settings.indexing.message.unavailable": "{{pipeline}} unavailable.",
  "settings.indexing.message.waitingWorker": "Waiting for indexing worker.",
  ...
  "settings.indexing.message.openTarget": "Open a file in the target workspace to view indexing status.",
  "settings.indexing.message.loadingProject": "Loading indexing status for the current project.",
  "settings.indexing.message.openWorkspace": "Open a file in a workspace to select a project.",
  "settings.indexing.message.noWorkspace": "No workspace folder open",
  "settings.indexing.message.ragNotConfiguredGraph": "RAG indexing is not configured. Code Graph is available.",
  "settings.indexing.message.ragDisabledGraph": "RAG indexing is disabled. Code Graph is available.",
  "settings.indexing.message.waitingBaseline": "Waiting for the primary worktree index to become available.",
  "settings.indexing.message.documentNotInitialized": "Document RAG is not initialized.",
  "settings.indexing.message.documentDisabledByRag": "Document RAG disabled because Code RAG is disabled.",
  "settings.indexing.message.noDocumentFolders": "No document folders configured.",
  "settings.indexing.message.documentEmbeddingsBlocked": "Document RAG blocked: embeddings are not configured.",
  "settings.indexing.message.documentStartingShort": "Document RAG starting.",
  "settings.indexing.message.documentStoreRequired": "Document RAG requires a configured embedding vector store.",
  "settings.indexing.message.documentEmbeddingsRequired": "Document RAG requires configured embeddings.",
  "settings.indexing.message.documentReady": "Document RAG ready.",
  "settings.indexing.message.documentWaitingRun": "Document RAG waiting for another document indexing run.",
  "settings.indexing.message.documentWaitingPipelines": "Document RAG waiting for Code Graph and Code RAG to finish.",
  "settings.indexing.message.documentRagDidNotRun": "Document RAG blocked because Code RAG did not run.",
  "settings.indexing.message.processingChanges": "Processing file changes...",
  "settings.indexing.message.changesProcessed": "File changes processed. Index up-to-date.",
  "settings.indexing.message.queueEmpty": "Index up-to-date. File queue empty.",
  "settings.indexing.message.watcherStarted": "File watcher started. Index up-to-date.",
  "settings.indexing.message.graphWatcherStarted": "Code Graph watcher started. Code Graph up-to-date.",
  ...
  "settings.indexing.message.watcherStarting": "Index up-to-date. File watcher starting.",
  "settings.indexing.message.graphWatcherStarting": "Code Graph up-to-date. File watcher starting.",
  "settings.indexing.message.workspaceRequired": "Indexing requires a workspace folder.",
  "settings.indexing.message.configRequired": "Missing configuration. Save your settings to start indexing.",
  "settings.indexing.message.ragConfigRequired": "Missing configuration. Save your settings to start RAG indexing.",
  "settings.indexing.message.initializingServices": "Initializing services...",
  "settings.indexing.message.cancelled": "Indexing cancelled.",
  "settings.indexing.message.startingCodeGraph": "Starting Code Graph indexing...",
  "settings.indexing.message.startingCodeGraphBeforeRag": "Starting Code Graph indexing before RAG...",
  "settings.indexing.message.codeGraphCompleteStartingRag": "Code Graph complete. Starting RAG indexing...",
  "settings.indexing.message.codeGraphCompleteValidating": "Code Graph complete. Validating embedding configuration...",
  "settings.indexing.message.checkingFiles": "Checking for new or modified files...",
  "settings.indexing.message.servicesReady": "Services ready. Starting workspace scan...",
  "settings.indexing.message.embeddingChanged": "Embedding settings changed. Starting RAG indexing...",
  "settings.indexing.message.validatingBeforeRag": "Validating embedding configuration before RAG indexing...",
  "settings.indexing.message.runActive": "Another indexing run is already active for this workspace.",
  ...
  "settings.indexing.message.reconciling": "Workspace changed too quickly; reconciling again shortly.",
  "settings.indexing.message.watcherStopped": "File watcher stopped.",
  "settings.indexing.message.cleared": "Index data cleared successfully.",
  "settings.indexing.message.indexingFiles": "Indexing files...",
  "settings.indexing.message.ready": "Ready.",
  "settings.indexing.message.errorOccurred": "An error occurred.",
  "settings.indexing.message.currentFile": " Current: {{file}}",
  "settings.indexing.message.filesProcessed": "Processed {{processed}} / {{total}} files ({{percent}}%).{{current}}",
  "settings.indexing.message.graphFilesBuilt":
    "Built {{processed}} / {{total}} code graph files ({{percent}}%).{{current}}",
  "settings.indexing.message.documentBlockedBecause": "Document RAG blocked because {{pipeline}} {{reason}}.",
  "settings.indexing.message.reasonFailed": "failed",
  "settings.indexing.message.reasonCancelled": "was cancelled",
  "settings.indexing.message.failedInitialize": "Failed to initialize: {{error}}",
  "settings.indexing.message.failedChanges": "Failed to process file changes: {{error}}",
  "settings.indexing.message.failedInitialScan": "Failed during initial scan: {{error}}",
  "settings.indexing.message.failedRagScan": "Failed during RAG scan: {{error}}",
  "settings.indexing.message.failedRecovery": "Failed during recovery: {{error}}",
  "settings.indexing.message.failedClear": "Failed to clear vector collection: {{error}}",
  "settings.experimental.title": "Experimental",
  "settings.language.title": "Language",
  "settings.aboutChipMate.title": "About ChipMate",
  ...
  "session.compaction.active": "Compressing context…",
  "session.compaction.description": "Organizing earlier conversation to continue the current task",
  "session.compaction.retryingWithoutThinking":
    "Compaction did not produce a usable summary; retrying with thinking disabled…",
  "session.compaction.status.running": "Compacting session…",
  "session.compaction.status.autoRunning": "Automatically compacting session…",
  "session.compaction.status.retrying": "Retrying compaction…",
  "session.compaction.status.runningDescription": "Converting earlier content into a summary.",
  "session.compaction.status.succeeded": "Session compaction completed",
  "session.compaction.status.autoSucceeded": "Session automatically compacted",
  "session.compaction.status.succeededDescription": "Earlier content was summarized and recent conversation was kept.",
  "session.compaction.status.failed": "Session compaction failed",
  "session.compaction.status.failedDescription": "This compaction did not complete. Do not treat it as successful.",
  "session.compaction.status.interrupted": "Session compaction interrupted",
  "session.compaction.status.interruptedDescription": "This compaction did not complete.",
  "session.compaction.phase.preparing": "Analyzing the session and planning the compaction work.",
  "session.compaction.phase.generating": "The model is generating a summary; remaining time cannot be predicted.",
  "session.compaction.phase.chunk": "Compressing earlier content in parallel summary units.",
  "session.compaction.phase.reduce": "Merging summary layer {{depth}}.",
  "session.compaction.phase.replay": "Compressing the request that must continue after compaction.",
  "session.compaction.phase.retrying": "Restarting the complete compaction pipeline without thinking.",
  "session.compaction.phase.committing": "The summary is ready; committing the compaction boundary.",
  "session.compaction.phase.splitting": "A summary unit exceeded the model context; splitting that unit safely.",
  "session.compaction.progress.stage": "Current stage {{completed}}/{{total}} · {{percent}}%",
  "session.compaction.elapsed.running": "Waiting {{duration}}",
  "session.compaction.elapsed.completed": "Total time {{duration}}",
  ...
  "context.usage.billing.pending": "Billing…",
  "context.usage.billing.unavailable": "Cost unavailable",
  "context.usage.billing.group": "Actual group",
  "context.usage.billing.steps": "{{count}} request(s)",
  ...
  "settings.aboutChipMate.status.connected": "Connected",
  "settings.aboutChipMate.status.connecting": "Connecting...",
  "settings.aboutChipMate.status.disconnected": "Disconnected",
  "settings.aboutChipMate.status.error": "Error",
  "settings.aboutChipMate.cliServer": "CLI Server",
  "settings.aboutChipMate.status.label": "Status:",
  "settings.aboutChipMate.port.label": "Port:",
  "settings.aboutChipMate.versionInfo": "Version Information",
  "settings.aboutChipMate.version.label": "Version:",
  "settings.aboutChipMate.extensionName": "ChipMate Extension",
  "settings.aboutChipMate.community": "Community & Support",
  "settings.aboutChipMate.feedback.prefix":
    "For questions or feedback, use your team's preferred support channel for this local ChipMate build.",
  "settings.aboutChipMate.feedback.or": "or",
  "settings.aboutChipMate.support.prefix": "Support channels are not configured in this local build.",
  "settings.aboutChipMate.resetSettings.title": "Reset Settings",
  "settings.aboutChipMate.resetSettings.description":
  ...
  "settings.aboutChipMate.resetSettings.button": "Reset All Settings",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Settings Transfer",
  "settings.aboutChipMate.settingsTransfer.description":
    "Export or import your settings to transfer them between VS Code instances.",
  "settings.aboutChipMate.exportSettings": "Export",
  "settings.aboutChipMate.importSettings": "Import",
  "settings.aboutChipMate.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutChipMate.importSettings.invalidConfig": "File does not contain valid ChipMate settings.",
  "settings.aboutChipMate.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "This file was exported from a newer version of ChipMate. Some settings may be ignored.",
  "settings.aboutChipMate.importSettings.success": "Settings imported. Review the changes above, then click Save.",

  "settings.aboutChipMate.telemetry.title": "Telemetry",
  "settings.aboutChipMate.telemetry.description":
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Open Telemetry Settings",
  ...
  "settings.experimental.dsml.title": "DSML Tool Call Repair",
  "settings.experimental.dsml.description":
    "Repair leaked DeepSeek DSML tool calls only for the selected provider and model",
  "settings.experimental.dsmlModel.title": "DSML Target Model",
  "settings.experimental.dsmlModel.description":
    "Select the only provider and model allowed to use DSML compatibility parsing",
  ...
  "settings.models.speechToTextModel.description": "Choose the ChipMate Gateway transcription model for voice input.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in chipmate.jsonc, or ask the agent to add them for you.",
  ...
  "settings.display.tokenThroughput.title": "Show Response Performance",
  "settings.display.tokenThroughput.description":
    "Show decode speed and time to first text or reasoning token on the latest completed response.",

  "chat.throughput.tooltip":
    "{{speed}} for this turn. Includes output and reasoning tokens; excludes first-token latency, tool execution, and waiting time.",
  "chat.throughput.tooltip.missing": "Throughput metrics unavailable for this turn.",
  "chat.throughput.ttft.label": "First token {{latency}}",
  "chat.throughput.ttft.tooltip": "{{latency}} from model-step start to the first non-empty text or reasoning delta.",
  ...
  "dialog.model.noneSelected": "No model selected",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Legacy Migration",
  "settings.aboutChipMate.legacyMigration.description":
    "Migrate settings from a previous compatible installation, including provider API keys and default model.",
  "settings.aboutChipMate.rooImport.description": "Import conversation history from a Roo Code installation.",
  "settings.aboutChipMate.rooImport.button": "Import Sessions from Roo Code",
  ...
  "settings.saveBar.saveTimedOut": "Save status couldn't be confirmed",
  "settings.saveBar.saveTimedOutDetails": "The save took too long. Your changes are still here; retry when ready.",
  "settings.saveBar.protocolMismatch": "Extension and backend versions don't match",
  "settings.saveBar.protocolMismatchDetails":
    "Reload the VS Code window or install the matching version. Your changes are still preserved as a draft.",
  ...
  "chat.navigation.title": "Conversation navigation",
  "chat.navigation.close": "Close conversation navigation",
  "chat.navigation.inputs": "My inputs",
  "chat.navigation.search": "Full-text search",
  "chat.navigation.count": "{{count}} inputs",
  "chat.navigation.filter": "Filter my inputs…",
  "chat.navigation.attachment": "Attachment",
  "chat.navigation.today": "Today",
  "chat.navigation.yesterday": "Yesterday",
  "chat.navigation.justNow": "Just now",
  "chat.navigation.loadingEarlier": "Loading earlier inputs…",
  "chat.navigation.empty": "No user inputs in this conversation yet",
  "chat.navigation.noMatches": "No matching inputs",
  "permission.directory": "Working directory",
  ...
  "prompt.deepseekHarness.confirm.title": "Start ChipMate DeepSeek Harness",
  "prompt.deepseekHarness.confirm.description":
    "QA is only the interface. The fixed official DSH runtime is downloaded from ChipMate Server and verified locally. Windows runs the official standard preset; Linux runs the official minimal preset, both unchanged.",
  "prompt.deepseekHarness.confirm.flow.label":
    "QA input and display are relayed by the extension host to official DSH 0.1.0 release candidate 6, whose platform-selected official preset owns sessions, tools, and approvals.",
  "prompt.deepseekHarness.confirm.flow.qa": "QA input and display",
  "prompt.deepseekHarness.confirm.flow.bridge": "Official protocol relay",
  "prompt.deepseekHarness.confirm.flow.dsh": "Official DSH 0.1.0-rc.6",
  "prompt.deepseekHarness.confirm.flow.runtime": "Windows standard · Linux minimal",
  "prompt.deepseekHarness.confirm.native":
    "Windows standard mode retains official Windows tools, Skills, Goals, sub-agents, Workflows, and compaction. Linux minimal mode keeps only persistent Bash and str_replace_editor. Neither uses ChipMate prompts, tools, Memory, indexes, RAG, retries, or result rewriting.",
  "prompt.deepseekHarness.confirm.home":
    "A private persistent DSH_HOME isolates global plugins, skills, and history while preserving official workspace discovery.",
  "prompt.deepseekHarness.confirm.start":
    "The local 127.0.0.1 service starts only after confirmation. Windows does not require /bin/bash; Linux minimal mode strictly verifies the official /bin/bash requirement.",
  "prompt.deepseekHarness.confirm.action": "Confirm and start ChipMate DeepSeek Harness",
  "chat.deepseekHarness.session.opening": "Opening official session…",
  "chat.deepseekHarness.session.untitled": "Untitled official session",
}
