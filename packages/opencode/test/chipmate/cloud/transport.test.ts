...
import {
  ...
  MessageIdSchema,
} from "../../../src/chipmate/cloud/contracts"
import { parseServiceOrigin } from "../../../src/chipmate/cloud/origin"
import { MAX_CLOUD_AGENT_RESPONSE_BYTES } from "../../../src/chipmate/cloud/response-json"
import { createCloudAgentClient } from "../../../src/chipmate/cloud/trpc"
  ...
  test("places bearer auth only in headers and correlates generated message identities", async () => {
    ...
    try {
      ...
      const start = await agent.start({
        ...
        options: { createdOnPlatform: "chipmate-cli" },
      })
