---
title: Semantic Search Tool | ChipMate Docs
...
- When ChipMate needs to find code related to specific functionality across your project
...
- When implementing a new feature, ChipMate searches for "authentication middleware" to understand existing patterns before writing new code.
- When debugging an issue, ChipMate searches for "error handling in API calls" to find related error patterns across the codebase.
- When refactoring code, ChipMate searches for "database transaction patterns" to ensure consistency across all database operations.
- When onboarding to a new codebase, ChipMate searches for "configuration loading" to understand how the application bootstraps.
