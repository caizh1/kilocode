...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "للحصول على المزيد من إحصائيات الاستخدام، استخدم ",
  "provider.connect.chipmateGateway.byok.link": "BYOK عبر ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "موصى به",
  "settings.providers.note.chipmate": "الوصول إلى أكثر من 500 نموذج ذكاء اصطناعي",
  ...
  "marketplace.install.about.mcp": "يمنح خادم MCP منصة ChipMate أدوات إضافية للعمل مع الخدمات الخارجية أو البرامج المحلية.",
  "marketplace.install.about.agent": "يضيف الوكيل دورًا قابلاً لإعادة الاستخدام بتعليماته وأذوناته الخاصة.",
  "marketplace.install.about.skill": "تضيف المهارة تعليمات وموارد خاصة بمهام معينة يمكن لـ ChipMate تحميلها عند الحاجة.",
  "marketplace.install.mcp.warning":
    "يمكن لخوادم MCP تشغيل أوامر محلية أو الاتصال بخدمات خارجية. ستطلب ChipMate الإذن قبل استخدام أدواتها ما لم تسمح أذوناتك بذلك تلقائيًا.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "أوقف لقطات ChipMate لهذا المشروع. ستفقد ميزة التراجع/الإعادة لتعديلات ChipMate، لكن git سيستمر في تتبع كل شيء.",
