 ...
 * Uses chipmate-ui List component for keyboard navigation and accessibility.
...
import { ContextMenu } from "@chipmate/chipmate-ui/context-menu"
...
const SessionList: Component<SessionListProps> = (props) => {
  ...
  onMount(() => {
    console.log("[ChipMate New] SessionList mounted, loading sessions")
