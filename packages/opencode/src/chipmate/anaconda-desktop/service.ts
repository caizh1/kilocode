...
import { invalidateAfterProviderAuthChange } from "@/chipmate/server/provider-auth-lifecycle"
...
export class Service extends Context.Service<Service, Interface>()("@chipmate/AnacondaDesktop") {}
