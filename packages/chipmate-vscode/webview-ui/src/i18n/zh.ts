...
export const dict = {
  ...
  "agentConsole.mode.label": "Agent Console 模式",
  "agentConsole.mode.shell": "Shell",
  "agentConsole.mode.agent": "Agent",
  "agentConsole.connection.connected": "已连接",
  "agentConsole.connection.connecting": "连接中",
  "agentConsole.action.newSession": "新建 Agent 会话",
  "agentConsole.action.clear": "清空 Agent 时间线",
  "agentConsole.action.restartShell": "重启 Shell",
  "agentConsole.action.closeShell": "关闭 Shell",
  "agentConsole.shell.directWarning": "Shell 命令将以当前用户身份直接执行，不经过 Agent 审批。",
  "agentConsole.shell.starting": "正在启动本地 Shell…",
  "agentConsole.empty.title": "Agent Console",
  "agentConsole.empty.description": "用自然语言描述任务；Agent 提议的命令仍会经过真实权限审批链。",
  "agentConsole.permission.directory": "执行目录",
