...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Za više statistika korištenja, koristite ",
  "provider.connect.chipmateGateway.byok.link": "BYOK putem ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Preporučeno",
  "settings.providers.note.chipmate": "Pristup za 500+ AI modela",
  ...
  "marketplace.install.about.skill":
    "Vještina dodaje upute i resurse za određene zadatke koje ChipMate može učitati kada su potrebni.",
  "marketplace.install.mcp.warning":
    "MCP serveri mogu pokretati lokalne naredbe ili se povezivati s vanjskim servisima. ChipMate će zatražiti dozvolu prije korištenja njihovih alata, osim ako vaše dozvole to automatski dopuštaju.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Isključi ChipMate snapshotove za ovaj projekat. Izgubićete poništi/vrati za izmjene koje napravi ChipMate, ali git i dalje prati sve.",
  ...
  "marketplace.aligned.unpublish": "Povuci Skill",
  "marketplace.aligned.unpublished": "Povučeno",
}
