...
import type { Resolved } from "@/chipmate/reference"

export namespace ChipMateReference {
  export const contains = Effect.fn("ChipMateReference.contains")(function* (input: {
  ...
  export const path = Effect.fn("ChipMateReference.path")(function* (
    fs: Pick<FSUtil.Interface, "realPath">,
    reference: string,
    target: string,
  ) {
