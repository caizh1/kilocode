...
class RulesSettingsUiTest : BasePlatformTestCase() {
    ...
    private lateinit var agent: ChipMateAgentBehaviorService
    ...
    fun `test content scroll renders an editor field`() {
        edt {
            val field = ai.chipmate.client.settings.base.SettingsContentField(
                "# Rules",
                ai.chipmate.client.settings.base.settingsEditorFileType("./RULES.md", "# Rules"),
                true,
            )
            val scroll = ai.chipmate.client.settings.base.settingsContentScroll(field)
    ...
    private fun install() {
        ...
        app = ChipMateAppService(appCoroutines.scope, rpc)
        workspaces = ChipMateWorkspaceService(appCoroutines.scope, workspaceRpc)
        agent = ChipMateAgentBehaviorService(appCoroutines.scope, agentRpc)
