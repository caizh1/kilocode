...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Für weitere Nutzungsstatistiken ",
  "provider.connect.chipmateGateway.byok.link": "BYOK via ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": " nutzen.",

  // Provider settings translations
  "settings.providers.group.recommended": "Empfohlen",
  "settings.providers.note.chipmate": "Zugriff auf 500+ KI-Modelle",
  ...
  "marketplace.install.about.mcp":
    "Ein MCP-Server stellt ChipMate zusätzliche Werkzeuge für die Arbeit mit externen Diensten oder lokalen Programmen bereit.",
  ...
  "marketplace.install.about.skill":
    "Ein Skill fügt aufgabenspezifische Anweisungen und Ressourcen hinzu, die ChipMate bei Bedarf laden kann.",
  "marketplace.install.mcp.warning":
    "MCP-Server können lokale Befehle ausführen oder eine Verbindung zu externen Diensten herstellen. ChipMate fragt vor der Verwendung ihrer Werkzeuge um Erlaubnis, sofern Ihre Berechtigungen dies nicht automatisch erlauben.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "ChipMate-Snapshots für dieses Projekt ausschalten. Rückgängig/Wiederherstellen für ChipMate-Änderungen ist nicht mehr möglich, aber git verfolgt weiterhin alles.",
  ...
  "marketplace.aligned.unpublish": "Skill zurückziehen",
  "marketplace.aligned.unpublished": "Zurückgezogen",
}
