...
const icons: Record<string, { path: string; viewBox: string }> = {
  ...
  "liquid-file": {
    viewBox: "0 0 24 24",
    path: `<path d="M7.2 4.2h6.6l4 4v10c0 1-.8 1.8-1.8 1.8H7.2c-1 0-1.8-.8-1.8-1.8V6c0-1 .8-1.8 1.8-1.8Z" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M13.6 4.4v4h4" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 12.1l-1.7 1.7 1.7 1.7M14 12.1l1.7 1.7-1.7 1.7" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/>`,
  },
  "liquid-server": {
    viewBox: "0 0 24 24",
    path: `<path d="M6.8 4.8h10.4c1 0 1.8.8 1.8 1.8v3.1c0 1-.8 1.8-1.8 1.8H6.8C5.8 11.5 5 10.7 5 9.7V6.6c0-1 .8-1.8 1.8-1.8Z" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M6.8 12.5h10.4c1 0 1.8.8 1.8 1.8v3.1c0 1-.8 1.8-1.8 1.8H6.8c-1 0-1.8-.8-1.8-1.8v-3.1c0-1 .8-1.8 1.8-1.8Z" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M8.3 8.2h.1M8.3 15.8h.1M11 8.2h5M11 15.8h5" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/>`,
  },
  globe: {
    viewBox: "0 0 20 20",
