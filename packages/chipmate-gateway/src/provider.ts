...
import type { ChipMateProvider, ChipMateProviderOptions } from "./types.js"
...
/**
 * Create a ChipMate provider instance
 *
 * This provider wraps the OpenRouter SDK with ChipMate-specific configuration
 * including custom authentication, headers, and base URL.
 *
 * @example
 * ```typescript
 * const provider = createChipMate({
 *   chipmateToken: "your-token-here",
 ...
 * ```
 */
export function createChipMate(options: ChipMateProviderOptions = {}): ChipMateProvider {
