 ...
 *
 * Both [ai.chipmate.client.session.views.question.QuestionView] and
 * [ai.chipmate.client.session.views.LoginRequiredView] use this as their
...
class BaseQuestionView(
     ...
     * [ai.chipmate.client.session.views.question.QuestionView]). Calling with
