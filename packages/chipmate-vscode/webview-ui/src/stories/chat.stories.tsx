...
import type { AssistantMessage, Part as SDKPart } from "@chipmate/sdk/v2"
import { createSignal, onCleanup, onMount, type Component } from "solid-js"
import { MemoryContract } from "@chipmate/chipmate-memory/effect/httpapi"
...
export const UserMessageReviewComments: Story = {
  ...
  render: () => {
    const comments: ReviewComment[] = [
      {
        id: "review-1",
        file: "src/components/chat/ChipMateBackendChatManager.kt",
        side: "additions",
        line: 114,
      ...
      {
        id: "review-2",
        file: "resources/messages/ChipMateBundle_bs.properties",
        side: "deletions",
        line: 235,
  ...
  [toolAssistantID]: [
    ...
    },
    {
      ...
      state: {
        ...
        output: "/Users/marius/Documents/git/chipmate/.chipmate/worktrees/zest-kettledrum",
        title: "pwd",
        metadata: {},
  ...
  const render = (event: Event) => {
    ...
    const timer = setTimeout(() => {
      ...
      window.dispatchEvent(
        new CustomEvent("chipmate:plantuml-rendered", {
          detail: broken
            ? {
...
const headerParts: Record<string, Part[]> = {
  ...
  [headerAssistantID]: [
    ...
    },
    {
      ...
      state: {
        ...
        output: JSON.stringify({
          artifactDir: ".chipmate/artifacts/mp-cp-design",
          sourcePath: ".chipmate/artifacts/mp-cp-design/control-flow.mmd",
          pngPath: ".chipmate/artifacts/mp-cp-design/control-flow.png",
          quality: "ok",
        }),
    ...
    },
    {
      ...
      state: {
        status: "completed",
        input: { query: "ChipMate CLI documentation" },
        output: "https://chipmate.ai/docs",
...
function IntegratedTaskHudStory() {
  ...
  return (
    <StoryProviders
      ...
      noPadding
      locale="zh"
      config={{ plugin: ["@chipmate/chipmate-indexing"] } as Config}
    >
      <SessionContext.Provider value={session as any}>
...
const usageProvider = {
  ...
  connected: () => ["chipmate", "minimax"],
  defaults: () => ({}),
  defaultSelection: () => ({ providerID: "chipmate", modelID: "qwen/qwen3.7-plus" }),
  models: () => [],
  findModel: () => undefined,
  authMethods: () => ({}),
  authStates: () => ({}),
...
// ---------------------------------------------------------------------------
// Welcome screen with AccountSwitcher + ChipMateNotifications
// ---------------------------------------------------------------------------

const MOCK_NOTIFICATION = {
  id: "notif-1",
  title: "Try BYOK for ChipMate Gateway",
  message: "Bring your own API key for even more flexibility with ChipMate Gateway models.",
  action: { actionText: "Learn more", actionURL: "https://chipmate.ai/docs" },
}
...
const mockServer = {
  ...
  profileData: () => ({
    profile: {
      email: "dev@chipmate.dev",
      name: "Dev User",
      organizations: [{ id: "org-1", name: "ChipMate Org", role: "member" }],
    },
    balance: { balance: 5.0 },
    currentOrgId: "org-1",
  }),
