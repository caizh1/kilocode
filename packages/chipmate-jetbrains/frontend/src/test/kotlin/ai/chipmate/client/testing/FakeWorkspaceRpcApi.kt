...
/**
 * Fake [ChipMateWorkspaceRpcApi] for testing.
 *
 ...
 */
class FakeWorkspaceRpcApi : ChipMateWorkspaceRpcApi {

    var directory = "/test"
    val state = MutableStateFlow(ChipMateWorkspaceStateDto(ChipMateWorkspaceStatusDto.PENDING))
    var reloads = 0
        private set
    ...
    var openResult = true
    var localConfigPath = "/test/.chipmate/chipmate.jsonc"
    var globalConfigPath = "/config/chipmate.jsonc"
