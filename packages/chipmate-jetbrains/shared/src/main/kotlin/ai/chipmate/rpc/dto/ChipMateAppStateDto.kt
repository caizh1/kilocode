...
@Serializable
enum class ChipMateAppStatusDto {
    DISCONNECTED,
    DOWNLOADING,
    CONNECTING,
    LOADING,
...
@Serializable
data class ProfileChipMatePassDto(
...
data class ProfileDto(
    ...
    val chipmatePass: ProfileChipMatePassDto? = null,
...
@Serializable
data class ChipMateAppStateDto(
    val status: ChipMateAppStatusDto,
