...
//          persist `"snapshot": false` to `.chipmate/chipmate.json`, and skip. All
...
//     Instead we write the file directly via `ChipMateConfig.updateProjectConfig`
...
//
// All of this is ChipMate-specific — the upstream snapshot module remains a thin
...
export namespace ChipMateSnapshotTrack {
  ...
  export const TIMEOUT_MS = duration("CHIPMATE_SNAPSHOT_TRACK_TIMEOUT_MS", 10_000)
  export const TURN_TIMEOUT_MS = duration("CHIPMATE_SNAPSHOT_TURN_TIMEOUT_MS", 120_000)
  ...
  export const progressPart = (input: {
    ...
    text: input.text,
    synthetic: true,
    metadata: { [ChipMatePartLifecycle.key]: "transient" },
  })
              ...
              questions: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      description:
                        "Turn off ChipMate's snapshots for this project. You will lose undo/redo of ChipMate file changes, but git still tracks everything.",
