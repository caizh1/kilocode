...
- [ ] Confirm whether the change belongs in ChipMate-owned code or shared upstream code.
...
- Prefer ChipMate-owned directories for ChipMate-specific behavior.
- If shared upstream files must be edited, keep the change narrow and add `chipmate_change` markers where required.
