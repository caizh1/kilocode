...
- ChipMate native terminal/session behavior must not be replaced.
...
- Installed VSIX: current ChipMate/ChipMate offline package under test.
...
5. Confirm native ChipMate terminal/session behavior still exists and is not replaced by Agent Terminal.
