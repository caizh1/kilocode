...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "詳細な使用統計については、",
  "provider.connect.chipmateGateway.byok.link": "ChipMate's Gateway経由でBYOK",
  "provider.connect.chipmateGateway.byok.suffix": "をご利用ください。",

  // Provider settings translations
  "settings.providers.group.recommended": "おすすめ",
  "settings.providers.note.chipmate": "500以上のAIモデルにアクセス",
  ...
  "marketplace.install.about.mcp":
    "MCPサーバーは、外部サービスやローカルプログラムを操作するための追加ツールをChipMateに提供します。",
  "marketplace.install.about.agent": "エージェントは、独自の指示と権限を持つ再利用可能な役割を追加します。",
  "marketplace.install.about.skill": "スキルは、必要に応じてChipMateが読み込めるタスク固有の指示とリソースを追加します。",
  "marketplace.install.mcp.warning":
    "MCPサーバーはローカルコマンドを実行したり、外部サービスに接続したりできます。権限で自動的に許可されていない限り、ChipMateはツールを使用する前に許可を求めます。",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "このプロジェクトでは ChipMate のスナップショットを無効にします。ChipMate による変更の取り消し/やり直しはできなくなりますが、git は引き続きすべてを追跡します。",
  ...
  "marketplace.aligned.unpublish": "Skill の公開を取り下げる",
  "marketplace.aligned.unpublished": "公開停止",
}
