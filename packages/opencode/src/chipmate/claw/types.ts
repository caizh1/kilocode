...
/**
 * ChipMateClaw TUI types — ChipMate Chat protocol.
 *
 * Mirrors `@chipmate/chipmate-chat` from the cloud monorepo. We carry our own
...
export type ClawStatus = {
  ...
  secretCount?: number
  userId?: string
  // User-chosen name for the ChipMateClaw bot, set during onboarding via the
  ...
  // literal string "ChipMateClaw" when null.
  botName?: string | null
}
