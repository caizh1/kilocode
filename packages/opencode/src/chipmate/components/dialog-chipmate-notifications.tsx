/**
 * ChipMate Notifications Dialog
 *
 * Displays all notifications from ChipMate API in a scrollable dialog.
...
interface DialogChipMateNotificationsProps {
  notifications: ChipMateNotification[]
}

export function DialogChipMateNotifications(props: DialogChipMateNotificationsProps) {
