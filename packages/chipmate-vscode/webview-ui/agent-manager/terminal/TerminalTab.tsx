...
export const TerminalTab: Component<Props> = (props) => {
  ...
  const log = (...args: unknown[]) => console.warn(`[ChipMate New][XTerm][${props.terminalId}]`, ...args)
  ...
  onMount(() => {
    ...
    // `ChipMateProvider.handleWebviewMessage` path which already calls
    ...
    const fontSub = vscode.onMessage((message) => {
      ...
      // fontSizeChanged/ready control the ChipMate chat UI font — do not apply
