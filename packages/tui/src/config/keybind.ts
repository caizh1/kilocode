...
export const Definitions = {
  ...
  "prompt.vim.toggle": keybind("none", "Toggle vim modal editing in the prompt input"), // chipmate_change
  ...
  news_toggle: keybind("none", "Toggle news on home screen"), // chipmate_change
...
export const CommandMap = {
  ...
  news_toggle: "news.toggle", // chipmate_change
