...
const file = "packages/chipmate-jetbrains/package.json"
...
if (values.help) {
  console.log(`
Usage: bun .chipmate/skills/release-jetbrains/script/set-pin.ts (--latest | --version <x.y.z>) [--pr]
...
console.log("Test locally with: cd packages/chipmate-jetbrains && ./gradlew typecheck && ./gradlew test")
