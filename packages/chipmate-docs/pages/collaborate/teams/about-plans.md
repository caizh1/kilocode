---
title: "About Plans"
description: "Overview of ChipMate plans and pricing"
---

# About Plans

ChipMate accelerates development with AI-driven code generation and task automation. You can use ChipMate as an open source extension in VS Code or JetBrains IDEs.
...
ChipMate's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of ChipMate's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from ChipMate Teams
...
## What You Get from ChipMate Enterprise
...
**Cost:** [Contact Sales](https://chipmate.ai/contact-sales)
