...
import type { ChipMateNotification, ExtensionMessage } from "../types/messages"

interface NotificationsContextValue {
  notifications: Accessor<ChipMateNotification[]>
  filteredNotifications: Accessor<ChipMateNotification[]>
