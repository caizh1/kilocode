...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ثبّت Anaconda Desktop على هذا الجهاز، ثم عُد إلى هنا. لا يقوم ChipMate بتشغيل المثبّت نيابةً عنك.",
  ...
  "provider.anaconda.state.signedOut": "افتح Anaconda Desktop وسجّل الدخول قبل توصيل ChipMate.",
  "provider.anaconda.state.unauthorized":
    "تعذّر على ChipMate الوصول إلى Anaconda Desktop. افتح Desktop، وسجّل الدخول مرة أخرى، وأعد تشغيله إذا لزم الأمر.",
  ...
  "provider.anaconda.state.ready":
    "عثر ChipMate على خادم محلي سليم لتوليد النصوص ويمكنه استيراد إعدادات الاتصال الحالية الخاصة به.",
  ...
  "provider.anaconda.toast.refreshed.description": "الخادم المحلي النشط والنماذج محدّثة في ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "تعذر على ChipMate فحص المهارات المتاحة.",
  "agentRequirements.error.mcpStatusFailed": "تعذر على ChipMate فحص حالة خادم MCP.",
  "agentRequirements.error.scopeMismatch": "لم يعد فحص متطلبات هذا الوكيل نشطًا.",
  "agentRequirements.error.requestFailed": "تعذر على ChipMate فحص متطلبات الوكيل.",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من ChipMate",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في ChipMate.",
  ...
  "prompt.panel.collapse": "طي لوحة الإدخال",
  "prompt.panel.expand": "توسيع لوحة الإدخال",
  "prompt.panel.collapsed": "لوحة الإدخال مطوية",
  "prompt.panel.responding": "جارٍ الرد…",
  ...
  "prompt.action.sandbox.enabled": "sandbox مُفعّل. أوامر shell الخاصة بالوكيل مقتصرة على مجلدات المشروع و ChipMate.",
  "prompt.action.sandbox.disabled":
    "sandbox مُعطّل. انقر لتقييد كتابة أوامر shell الخاصة بالوكيل على مجلدات المشروع و ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "تقتصر عمليات الكتابة على مجلدات المشروع و ChipMate.",
  ...
  "speechToText.tooltip.start": "بدء الإدخال الصوتي باستخدام ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "قم بتسجيل الدخول إلى ChipMate لاستخدام الإدخال الصوتي.",
  ...
  "dialog.server.description": "تبديل خادم ChipMate الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من ChipMate ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق ChipMate",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن ChipMate لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن ChipMate نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ ChipMate",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور ChipMate على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة ChipMate.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل ChipMate",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من ChipMate.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود ChipMate Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء ChipMate مفتوحاً، دون تقييد.",
  ...
  "settings.models.hidePromptTraining.description":
    "إخفاء نماذج ChipMate Gateway التي قد يستخدم مزودوها مطالباتك لأغراض التدريب.",
  ...
  "settings.config.title": "فتح ملف تكوين ChipMate {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين ChipMate المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين ChipMate {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeChipMate": "تكوين .chipmate في Home",
  "settings.config.source.homeOpencode": "تكوين .opencode في Home",
  "settings.config.source.envFile": "ملف بيئة CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectChipMate": "تكوين .chipmate للمشروع",
  ...
  "workStyle.onboarding.welcome": "مرحبًا بك في ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف ChipMate مؤقتًا ويعرض لك خطته أثناء العمل.",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر chipmate import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى ChipMate",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام ChipMate",
  ...
  "profile.pass.subscribe": "احصل على ChipMate Pass لإضافة رصيد وكسب مكافآت",
  ...
  "settings.indexing.chipmateModel.title": "إعداد مسبق لنموذج ChipMate",
  "settings.indexing.chipmateModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة ChipMate.",
  "settings.indexing.chipmateSignIn.title": "تسجيل الدخول إلى ChipMate مطلوب",
  "settings.indexing.chipmateSignIn.description": "سجّل الدخول إلى ChipMate لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutChipMate.title": "حول ChipMate",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "ChipMate هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutChipMate.status.connected": "متصل",
  "settings.aboutChipMate.status.connecting": "جارٍ الاتصال...",
  "settings.aboutChipMate.status.disconnected": "غير متصل",
  "settings.aboutChipMate.status.error": "خطأ",
  "settings.aboutChipMate.cliServer": "خادم CLI",
  "settings.aboutChipMate.status.label": "الحالة:",
  "settings.aboutChipMate.port.label": "المنفذ:",
  "settings.aboutChipMate.versionInfo": "معلومات الإصدار",
  "settings.aboutChipMate.version.label": "الإصدار:",
  "settings.aboutChipMate.extensionName": "إضافة ChipMate",
  "settings.aboutChipMate.community": "المجتمع والدعم",
  "settings.aboutChipMate.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutChipMate.feedback.or": "أو",
  "settings.aboutChipMate.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutChipMate.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutChipMate.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutChipMate.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutChipMate.exportSettings": "تصدير",
  "settings.aboutChipMate.importSettings": "استيراد",
  "settings.aboutChipMate.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutChipMate.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات ChipMate صالحة.",
  "settings.aboutChipMate.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من ChipMate. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutChipMate.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة ChipMate. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "تمكين الإدخال الصوتي في حقول المطالبة باستخدام حساب ChipMate الخاص بك من خلال ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "قم بتمكين وتسجيل الدخول إلى مزود ChipMate لاستخدام Speech to Text. ميزة Speech to Text مدعومة حاليًا فقط مع ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "نموذج تحويل الصوت إلى نص",
  "settings.models.speechToTextModel.description": "اختر نموذج نسخ ChipMate Gateway للإدخال الصوتي.",
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر ChipMate Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم ChipMate مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في chipmate.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.sandboxing.enabled.description":
    "تشغيل أوامر shell الخاصة بالوكيل داخل sandbox على مستوى نظام التشغيل يقيّد الكتابة على مجلدات حالة المشروع و ChipMate",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ ChipMate بشكل مستقل عن VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutChipMate.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ ChipMate، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  "settings.aboutChipMate.rooImport.description": "استيراد سجل المحادثات من تثبيت Roo Code.",
  "settings.aboutChipMate.rooImport.button": "استيراد الجلسات من Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات ChipMate. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها ChipMate خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
