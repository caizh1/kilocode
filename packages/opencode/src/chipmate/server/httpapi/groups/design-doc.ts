...
import { Artifact, CreateJobInput, DesignDocJob, RetryWorkItemInput } from "@/chipmate/design-doc/domain"
import "@/chipmate/design-doc/event"
...
export const DesignDocApi = HttpApi.make("design-doc")
  ...
  .annotateMerge(OpenApi.annotations({ title: "chipmate HttpApi", version: "0.0.1", description: "ChipMate HttpApi surface." }))
