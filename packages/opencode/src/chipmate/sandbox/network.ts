...
import { assertNetwork, assertSandbox, networkHttpLayer } from "@chipmate/sandbox"
import { host, opaque } from "./network-tools"

const Builtin = Symbol("chipmate.sandbox.builtinTool")
const Remote = Symbol("chipmate.sandbox.remoteMcp")
