 ...
 * prompts (plain `chipmate run`). Permission asks originating from their child
 ...
 */
export namespace ChipMateHeadless {
  ...
  export const denies = Effect.fn("ChipMateHeadless.denies")(function* (id: string) {
