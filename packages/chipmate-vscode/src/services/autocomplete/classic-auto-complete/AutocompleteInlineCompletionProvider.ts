 ...
 */
export const INLINE_COMPLETION_ACCEPTED_COMMAND = "chipmate.v2.autocomplete.inline-completion.accepted"
...
export class AutocompleteInlineCompletionProvider implements vscode.InlineCompletionItemProvider {
  ...
  private connectionService: ChipMateConnectionService
  ...
  constructor(
    ...
    this.acceptedCommand = vscode.commands.registerCommand(INLINE_COMPLETION_ACCEPTED_COMMAND, () => {
      ...
      vscode.commands.executeCommand("setContext", "chipmate.v2.autocomplete.hasSuggestions", false)
    })
  }
  ...
  public async provideInlineCompletionItems_Internal(
    ...
    try {
      ...
      if (matchingResult !== null) {
        ...
        vscode.commands.executeCommand("setContext", "chipmate.v2.autocomplete.hasSuggestions", true)
  ...
  private async hasBalance(): Promise<boolean> {
    try {
      ...
      const result = await client.chipmate.profile().catch(() => null)
