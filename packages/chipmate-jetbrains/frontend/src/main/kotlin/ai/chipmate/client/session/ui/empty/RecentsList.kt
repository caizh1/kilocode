...
import ai.chipmate.client.session.history.HistoryActivitySnapshot
import ai.chipmate.client.session.history.HistoryTime
import ai.chipmate.client.session.history.LocalHistoryItem
import ai.chipmate.client.session.history.itemAt
import ai.chipmate.client.session.history.title
...
internal class RecentsList(
    ...
    private val title = JBLabel(ChipMateBundle.message("session.empty.recent")).apply {
