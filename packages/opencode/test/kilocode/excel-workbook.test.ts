...
import { createExcelWorkbook, type CreateExcelWorkbookSpec } from "../../src/kilocode/documents/excel"
...
describe("kilocode Excel workbook", () => {
        ...
        (dir) =>
          Effect.promise(() =>
            within(async () => {
              ...
              expect(created.path).toMatch(/^\.kilo(?:code)?\/artifacts\/.+\/季度__报告\.xlsx$/)
