...
export interface PopoverProps<T extends ValidComponent = "div">
  ...
  contentLabel?: string // chipmate_change
  title?: JSXElement
...
export function Popover<T extends ValidComponent = "div">(props: PopoverProps<T>) {
  ...
  const content = () => (
    <Kobalte.Content
      ...
      aria-label={local.contentLabel /* chipmate_change */}
      classList={{
        ...local.classList,
      ...
      onCloseAutoFocus={(event: Event) => {
        if (opened() || state.dismiss === "outside") event.preventDefault() // chipmate_change
