...
object ChatLogSummary {
    ...
    private fun mode(): Mode = when ((System.getProperty("chipmate.dev.log.chat.content") ?: "off").lowercase()) {
        "preview" -> Mode.PREVIEW
        "full" -> Mode.FULL
        else -> Mode.OFF
    }

    private fun max(): Int = (System.getProperty("chipmate.dev.log.chat.preview.max")?.toIntOrNull() ?: 160)
        .coerceIn(1, 2000)
