...
import { ChipMateEvent } from "@opencode-ai/protocol/groups/event" // chipmate_change - encode the full ChipMate event bus
...
function eventData(data: unknown): Sse.Event {
  return {
    ...
    event: "message",
    id: undefined,
    data: JSON.stringify(Schema.encodeUnknownSync(ChipMateEvent)(data)), // chipmate_change
  }
}
