...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instale o Anaconda Desktop nesta máquina e depois volte aqui. O ChipMate não executa o instalador para você.",
  ...
  "provider.anaconda.state.signedOut": "Abra o Anaconda Desktop e faça login antes de conectar o ChipMate.",
  "provider.anaconda.state.unauthorized":
    "O ChipMate não conseguiu acessar o Anaconda Desktop. Abra o Desktop, faça login novamente e reinicie-o se necessário.",
  ...
  "provider.anaconda.state.ready":
    "O ChipMate encontrou um servidor local saudável de geração de texto e pode importar suas configurações de conexão atuais.",
  ...
  "provider.anaconda.toast.refreshed.description": "O servidor local ativo e os modelos estão atualizados no ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "O ChipMate não conseguiu verificar as skills disponíveis.",
  "agentRequirements.error.mcpStatusFailed": "O ChipMate não conseguiu verificar o status do servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta verificação de requisitos do agente não está mais ativa.",
  "agentRequirements.error.requestFailed": "O ChipMate não conseguiu verificar os requisitos do agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no ChipMate.",
  ...
  "prompt.ultra.confirm.title": "Entrar no modo Ultra",
  "prompt.ultra.confirm.description":
    "O Ultra primeiro explora de forma mais ampla e depois apresenta conclusões apoiadas por evidências verificáveis.",
  "prompt.ultra.confirm.benefit.explore": "Explorar a base de código de forma mais completa",
  "prompt.ultra.confirm.benefit.verify": "Verificar primeiro as conclusões principais",
  "prompt.ultra.confirm.benefit.cost": "Geralmente requer mais tempo e tokens",
  "prompt.ultra.confirm.note":
    "Ideal para diagnósticos complexos, análise de arquitetura e revisões de alto risco.",
  "prompt.ultra.confirm.action": "Confirmar e entrar no Ultra",
  ...
  "prompt.panel.collapse": "Recolher painel de entrada",
  "prompt.panel.expand": "Expandir painel de entrada",
  "prompt.panel.collapsed": "Painel de entrada recolhido",
  "prompt.panel.responding": "Respondendo…",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ativado. Os comandos shell do agente estão limitados aos diretórios do projeto e do ChipMate.",
  "prompt.action.sandbox.disabled":
    "Sandbox desativado. Clique para limitar as escritas dos comandos shell do agente aos diretórios do projeto e do ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled":
    "As operações de escrita são limitadas aos diretórios do projeto e do ChipMate.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz com o ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Faça login no ChipMate para usar a entrada de voz.",
  ...
  "dialog.server.description": "Trocar para qual servidor ChipMate este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do ChipMate ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do ChipMate",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: ChipMate ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do ChipMate",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o ChipMate aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o ChipMate é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o ChipMate iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do ChipMate.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor ChipMate Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o ChipMate aberto, sem lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculte os modelos do ChipMate Gateway cujos provedores podem usar seus prompts para treinamento.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do ChipMate",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do ChipMate.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do ChipMate: {{message}}",
  "settings.config.source.xdg": "Configuração global do XDG",
  "settings.config.source.homeChipMate": "Configuração .chipmate da Home",
  "settings.config.source.homeOpencode": "Configuração .opencode da Home",
  "settings.config.source.envFile": "Arquivo de ambiente CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Configuração de ambiente embutida",
  "settings.config.source.projectChipMate": "Configuração .chipmate do projeto",
  ...
  "workStyle.onboarding.welcome": "Boas-vindas ao ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "O ChipMate pausa e mostra o plano enquanto trabalha.",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando chipmate import",
  ...
  "deviceAuth.title": "Entrar no ChipMate",
  ...
  "profile.action.login": "Entrar com ChipMate",
  ...
  "profile.pass.subscribe": "Obtenha o ChipMate Pass para adicionar créditos e ganhar bônus",
  ...
  "settings.indexing.chipmateModel.title": "Predefinição de modelo do ChipMate",
  "settings.indexing.chipmateModel.description": "Escolha um modelo de embedding hospedado pelo ChipMate compatível.",
  "settings.indexing.chipmateSignIn.title": "Login no ChipMate necessário",
  "settings.indexing.chipmateSignIn.description": "Entre no ChipMate para usar embeddings hospedados.",
  ...
  "settings.aboutChipMate.title": "Sobre o ChipMate",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "ChipMate é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutChipMate.status.connected": "Conectado",
  "settings.aboutChipMate.status.connecting": "Conectando...",
  "settings.aboutChipMate.status.disconnected": "Desconectado",
  "settings.aboutChipMate.status.error": "Erro",
  "settings.aboutChipMate.cliServer": "Servidor CLI",
  "settings.aboutChipMate.status.label": "Status:",
  "settings.aboutChipMate.port.label": "Porta:",
  "settings.aboutChipMate.versionInfo": "Informações da Versão",
  "settings.aboutChipMate.version.label": "Versão:",
  "settings.aboutChipMate.extensionName": "Extensão ChipMate",
  "settings.aboutChipMate.community": "Comunidade e Suporte",
  "settings.aboutChipMate.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutChipMate.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutChipMate.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutChipMate.exportSettings": "Exportar",
  "settings.aboutChipMate.importSettings": "Importar",
  "settings.aboutChipMate.importSettings.invalidJson":
    "Arquivo JSON inválido. Selecione um arquivo de configurações válido.",
  "settings.aboutChipMate.importSettings.invalidConfig": "O arquivo não contém configurações válidas do ChipMate.",
  ...
  "settings.aboutChipMate.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do ChipMate. Algumas configurações podem ser ignoradas.",
  "settings.aboutChipMate.importSettings.success":
    "Configurações importadas. Revise as alterações acima e clique em Salvar.",

  "settings.aboutChipMate.telemetry.title": "Telemetria",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do ChipMate. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Ative a entrada de voz nos campos de prompt usando sua conta do ChipMate por meio do ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Ative e faça login no provedor ChipMate para usar o Speech to Text. Atualmente, o Speech to Text é compatível apenas com o ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de fala para texto",
  "settings.models.speechToTextModel.description":
    "Escolha o modelo de transcrição do ChipMate Gateway para entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via ChipMate Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o ChipMate utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em chipmate.jsonc ou peça ao agente para adicioná-los.",
  ...
  "settings.sandboxing.enabled.description":
    "Executar os comandos shell do agente dentro de um sandbox a nível de sistema operacional que restringe escritas aos diretórios de estado do projeto e do ChipMate",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do ChipMate independentemente do VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Migração Legada",
  "settings.aboutChipMate.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do ChipMate, incluindo chaves de API de provedor e modelo padrão.",
  "settings.aboutChipMate.rooImport.description": "Importe o histórico de conversas de uma instalação do Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Importar sessões do Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos ChipMate. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo ChipMate durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
  ...
  "settings.experimental.dsml.title": "Reparo de chamadas de ferramenta DSML",
  "settings.experimental.dsml.description":
    "Repare chamadas DeepSeek DSML vazadas apenas para o provedor e modelo selecionados",
  "settings.experimental.dsmlModel.title": "Modelo de destino DSML",
  "settings.experimental.dsmlModel.description": "Selecione o único provedor e modelo autorizado a analisar DSML",
}
