...
Whether you're migrating from another OpenClaw provider to ChipMateClaw, moving between ChipMateClaw instances (e.g., individual to org or vice versa), or leaving ChipMateClaw for another OpenClaw provider, you should plan to migrate your workspace, memory, and context so your new Claw retains the same knowledge as before.
...
If you are on ChipMateClaw, you can use

**GitHub export** — make sure [GitHub is configured](/docs/chipmateclaw/development-tools/github) and ask your instance:

> Create a new GitHub repo and push your entire workspace there with the `gh` CLI. Tell me the URL of the repo you used.

**Google Drive** — make sure [Google Drive is configured](/docs/chipmateclaw/development-tools/google) and ask your instance:
