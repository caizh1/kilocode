...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installeer Anaconda Desktop op deze machine en kom hier dan terug. ChipMate voert het installatieprogramma niet voor je uit.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop en meld je aan voordat je ChipMate verbindt.",
  "provider.anaconda.state.unauthorized":
    "ChipMate kon geen toegang krijgen tot Anaconda Desktop. Open Desktop, meld je opnieuw aan en herstart het indien nodig.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate heeft een gezonde lokale tekstgeneratieserver gevonden en kan de huidige verbindingsinstellingen importeren.",
  ...
  "provider.anaconda.toast.refreshed.description": "De actieve lokale server en modellen zijn up-to-date in ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate kon de beschikbare skills niet controleren.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate kon de MCP-serverstatus niet controleren.",
  "agentRequirements.error.scopeMismatch": "Deze controle van agentvereisten is niet meer actief.",
  "agentRequirements.error.requestFailed": "ChipMate kon de agentvereisten niet controleren.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen aangeboden door ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in ChipMate.",
  ...
  "prompt.ultra.confirm.title": "Ultra-modus activeren",
  "prompt.ultra.confirm.description":
    "Ultra onderzoekt eerst breder en presenteert daarna conclusies die met verifieerbaar bewijs zijn onderbouwd.",
  "prompt.ultra.confirm.benefit.explore": "De codebase grondiger onderzoeken",
  "prompt.ultra.confirm.benefit.verify": "Belangrijke conclusies eerst verifiëren",
  "prompt.ultra.confirm.benefit.cost": "Vereist doorgaans meer tijd en tokens",
  "prompt.ultra.confirm.note":
    "Geschikt voor complexe probleemoplossing, architectuuranalyse en risicovolle reviews.",
  "prompt.ultra.confirm.action": "Bevestigen en Ultra activeren",
  ...
  "prompt.panel.collapse": "Invoerpaneel inklappen",
  "prompt.panel.expand": "Invoerpaneel uitklappen",
  "prompt.panel.collapsed": "Invoerpaneel ingeklapt",
  "prompt.panel.responding": "Beantwoorden…",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is ingeschakeld. Shell-opdrachten van de agent zijn beperkt tot de project- en ChipMate-mappen.",
  "prompt.action.sandbox.disabled":
    "Sandbox is uitgeschakeld. Klik om schrijfbewerkingen van shell-opdrachten van de agent te beperken tot de project- en ChipMate-mappen.",
  ...
  "prompt.action.sandbox.description.enabled": "Schrijfbewerkingen zijn beperkt tot de project- en ChipMate-mappen.",
  ...
  "speechToText.tooltip.start": "Spraakinvoer starten met ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Meld u aan bij ChipMate om spraakinvoer te gebruiken.",
  ...
  "dialog.server.description": "Wissel met welke ChipMate-server deze app verbinding maakt.",
  ...
  "toast.update.description": "Een nieuwe versie van ChipMate ({{version}}) is nu beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het ChipMate team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op, ChipMate ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor ChipMate",
  "settings.general.row.appearance.title": "Uiterlijk",
  "settings.general.row.appearance.description": "Pas aan hoe ChipMate eruitziet op je apparaat",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van ChipMate aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer ChipMate start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van ChipMate.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de ChipMate Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om ChipMate open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} ChipMate-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale ChipMate-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} ChipMate-configuratiebestand niet openen: {{message}}",
  "settings.config.source.xdg": "XDG globale configuratie",
  "settings.config.source.homeChipMate": "Home .chipmate-configuratie",
  "settings.config.source.homeOpencode": "Home .opencode-configuratie",
  "settings.config.source.envFile": "CHIPMATE_CONFIG omgevingsbestand",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Inline omgevingsconfiguratie",
  "settings.config.source.projectChipMate": "Project .chipmate-configuratie",
  ...
  "workStyle.onboarding.welcome": "Welkom bij ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate pauzeert en toont tijdens het werk zijn plan.",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of chipmate import commando",
  ...
  "deviceAuth.title": "Meld je aan bij ChipMate",
  ...
  "profile.action.login": "Inloggen met ChipMate",
  ...
  "profile.pass.subscribe": "Schaf ChipMate Pass aan om tegoed toe te voegen en bonussen te verdienen",
  ...
  "settings.aboutChipMate.title": "Over ChipMate",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "ChipMate is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutChipMate.status.connected": "Verbonden",
  "settings.aboutChipMate.status.connecting": "Verbinden...",
  "settings.aboutChipMate.status.disconnected": "Verbinding verbroken",
  "settings.aboutChipMate.status.error": "Fout",
  "settings.aboutChipMate.cliServer": "CLI Server",
  "settings.aboutChipMate.status.label": "Status:",
  "settings.aboutChipMate.port.label": "Poort:",
  "settings.aboutChipMate.versionInfo": "Versie-informatie",
  "settings.aboutChipMate.version.label": "Versie:",
  "settings.aboutChipMate.extensionName": "ChipMate Extensie",
  "settings.aboutChipMate.community": "Community & Ondersteuning",
  "settings.aboutChipMate.feedback.prefix": "Als je vragen of feedback hebt, voel je vrij om een issue aan te maken op",
  "settings.aboutChipMate.feedback.or": "of",
  "settings.aboutChipMate.support.prefix":
    "Voor vragen over facturering of je account, neem contact op met Klantenservice op",
  "settings.aboutChipMate.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutChipMate.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutChipMate.exportSettings": "Exporteren",
  "settings.aboutChipMate.importSettings": "Importeren",
  "settings.aboutChipMate.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Het bestand bevat geen geldige ChipMate-instellingen.",
  ...
  "settings.aboutChipMate.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van ChipMate. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutChipMate.telemetry.title": "Telemetrie",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de ChipMate UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.speechToText.description":
    "Schakel spraakinvoer in promptvelden in met uw ChipMate-account via ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Schakel de ChipMate-provider in en meld u aan om Speech to Text te gebruiken. Speech to Text wordt momenteel alleen ondersteund met ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Spraak-naar-tekst-model",
  "settings.models.speechToTextModel.description": "Kies het ChipMate Gateway-transcriptiemodel voor spraakinvoer.",
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via ChipMate Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-opdrachten van de agent uitvoeren in een sandbox op besturingssysteemniveau die schrijfbewerkingen beperkt tot de project- en ChipMate-statusmappen",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat ChipMate je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in chipmate.jsonc of vraag de agent om ze toe te voegen.",
  ...
  "settings.display.fontSize.description": "Pas de lettergrootte van de ChipMate webview UI onafhankelijk van VS Code aan.",
  ...
  "settings.models.hidePromptTraining.description":
    "Verberg ChipMate Gateway-modellen waarvan providers je prompts mogelijk voor training gebruiken.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Legacy Migratie",
  "settings.aboutChipMate.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van ChipMate, inclusief provider API-sleutels en standaard model.",
  "settings.aboutChipMate.rooImport.description": "Importeer gespreksgeschiedenis van een Roo Code installatie.",
  "settings.aboutChipMate.rooImport.button": "Sessies importeren uit Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk ChipMate-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate-model voorinstelling",
  "settings.indexing.chipmateModel.description": "Kies een ondersteund ChipMate-hosted embeddings model.",
  "settings.indexing.chipmateSignIn.title": "ChipMate-aanmelding vereist",
  "settings.indexing.chipmateSignIn.description": "Log in op ChipMate om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door ChipMate tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
