...
import { PROMPTS, AI_SDK_PROVIDERS } from "@chipmate/chipmate-gateway" // chipmate_change
...
export const Model = Schema.Struct({
  ...
  prompt: Schema.optional(Schema.Literals(PROMPTS)), // chipmate_change
  isFree: Schema.optional(Schema.Boolean), // chipmate_change
  ai_sdk_provider: Schema.optional(Schema.Literals(AI_SDK_PROVIDERS)), // chipmate_change
  release_date: Schema.optional(Schema.String),
  attachment: Schema.optional(Schema.Boolean),
  reasoning: Schema.optional(Schema.NullOr(Schema.Boolean)), // chipmate_change - allow null so reasoning can be removed via stripNulls on save
  ...
  variants: Schema.optional(
    Schema.Record(
      Schema.String,
      Schema.NullOr(
        // chipmate_change - allow null values so removed variants can be deleted via stripNulls on save
...
export const Info = Schema.Struct({
  ...
  models: Schema.optional(Schema.Record(Schema.String, Schema.NullOr(Model))), // chipmate_change - allow null values so removed models can be deleted via stripNulls on save
