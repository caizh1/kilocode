...
|---|---|---|
| `chipmate-auto/frontier` | Maximum capability with the best available models | Paid |
| `chipmate-auto/efficient` | Lowest cost per task, with capability matched to difficulty | Paid |
| `chipmate-auto/free` | The best free models available | Free |

## How It Works

1. Select an Auto Model tier (e.g. `chipmate-auto/frontier`) in the model dropdown
...
You can see which underlying models are used, as well as the cost, in the expanded model picker. Model mapping information is also available on the [Gateway Model page](/docs/gateway/models-and-providers#chipmate-autofrontier).
...
1. ChipMate observes your coding session in context
...
You can constrain `chipmate-auto/efficient` to the exact models you trust by configuring an **Efficient model pool** on the **Auto routing** card:

- **Personal** — your [profile page](https://app.chipmate.ai/profile)
...
Select an Auto Model tier from the model dropdown in the ChipMate chat interface. That's all you need to do.
{% /callout %}

1. Open ChipMate in VS Code or JetBrains
2. Click the model selector dropdown
3. Choose an Auto Model such as `chipmate-auto/frontier` or `chipmate-auto/efficient`
...
- **New ChipMate users** - Great defaults without needing to understand model differences
...
Auto Model is actively being improved. We'd love to hear how it's working for you! Share feedback in our [Discord](https://chipmate.ai/discord) or [open an issue on GitHub](https://github.com/ChipMate-Org/chipmate/issues).
{% /callout %}

## Related

- [Model Selection Guide](/docs/code-with-ai/agents/model-selection) - General guidance on choosing models
- [Using Agents](/docs/code-with-ai/agents/using-agents) - Learn about different ChipMate agents
- [Using ChipMate for Free](/docs/getting-started/using-chipmate-for-free) - Cost-effective alternatives
