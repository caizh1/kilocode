...
import { defaultEndpoint, resolveEndpoint } from "@/chipmate/session-export/worker/endpoint"
...
describe("session export endpoint", () => {
  ...
  test("allows approved production endpoint", () => {
    const endpoint = "https://supermassive-black-hole.chipmateapps.io/v1/session-export/batch"
