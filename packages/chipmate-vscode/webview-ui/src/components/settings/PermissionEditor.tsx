  ...
  return (
    ...
    >
      <div style={{ flex: 1, "min-width": 0 }}>
        <div style={{ "font-size": "var(--chipmate-font-size-13)", color: "var(--text-base, var(--vscode-foreground))" }}>
          {toolTitle(props.id)}
        </div>
        <div
          style={{
...
const GranularToolRow: Component<{
  ...
  return (
    <div style={{ padding: "12px 0", "border-bottom": "1px solid var(--border-weak-base)" }}>
      ...
      >
        <div style={{ flex: 1, "min-width": 0 }}>
          <div style={{ "font-size": "var(--chipmate-font-size-12)", color: "var(--text-base, #ccc)" }}>
      ...
      <Show
        ...
        fallback={
          ...
          >
            <span style={{ "font-size": "var(--chipmate-font-size-14)" }}>+</span>
