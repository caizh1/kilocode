...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installa Anaconda Desktop su questo computer, poi torna qui. ChipMate non esegue il programma di installazione per te.",
  ...
  "provider.anaconda.state.signedOut": "Apri Anaconda Desktop e accedi prima di connettere ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate non è riuscito ad accedere ad Anaconda Desktop. Apri Desktop, accedi di nuovo e riavvialo se necessario.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate ha trovato un server locale di generazione del testo integro e può importare le sue attuali impostazioni di connessione.",
  ...
  "provider.anaconda.toast.refreshed.description": "Il server locale attivo e i modelli sono aggiornati in ChipMate.",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua API key {{provider}} per connettere l'account e usare i modelli {{provider}} in ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere l'account e usare i modelli {{provider}} in ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere l'account e usare i modelli {{provider}} in ChipMate.",
  ...
  "prompt.ultra.confirm.title": "Entra in modalità Ultra",
  "prompt.ultra.confirm.description":
    "Ultra esplora prima in modo più ampio, poi presenta conclusioni supportate da prove verificabili.",
  "prompt.ultra.confirm.benefit.explore": "Esplora il codice in modo più completo",
  "prompt.ultra.confirm.benefit.verify": "Verifica prima le conclusioni chiave",
  "prompt.ultra.confirm.benefit.cost": "Di solito richiede più tempo e token",
  "prompt.ultra.confirm.note": "Ideale per diagnosi complesse, analisi dell’architettura e revisioni ad alto rischio.",
  "prompt.ultra.confirm.action": "Conferma ed entra in Ultra",
  ...
  "prompt.panel.collapse": "Comprimi pannello di input",
  "prompt.panel.expand": "Espandi pannello di input",
  "prompt.panel.collapsed": "Pannello di input compresso",
  "prompt.panel.responding": "Risposta in corso…",
  ...
  "dialog.server.description": "Cambia il server ChipMate a cui si connette questa app.",
  ...
  "toast.update.description": "Una nuova versione di ChipMate ({{version}}) è disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team ChipMate",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" non riuscito. Nota: ChipMate non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate include modelli gratuiti, così puoi iniziare subito.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione di ChipMate",
  "settings.general.row.appearance.title": "Aspetto",
  "settings.general.row.appearance.description": "Personalizza l'aspetto di ChipMate sul tuo dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di ChipMate.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti quando ChipMate si avvia",
  ...
  "settings.updates.toast.latest.description": "Stai usando la versione più recente di ChipMate.",
  ...
  "settings.providers.betaNotice":
    "Al momento solo il provider ChipMate Gateway può essere configurato dall'interfaccia delle impostazioni. Il supporto per altri provider arriverà durante il periodo beta. Nel frattempo puoi configurare i provider con la CLI o il file di configurazione. Ci impegniamo a mantenere ChipMate aperto, senza lock-in.",
  ...
  "settings.config.title": "Apri file config ChipMate {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config ChipMate locale.",
  "settings.config.openFailed": "Apertura file config ChipMate {{scope}} non riuscita: {{message}}",
  "settings.config.source.xdg": "Config globale XDG",
  "settings.config.source.homeChipMate": "Config home .chipmate",
  "settings.config.source.homeOpencode": "Config home .opencode",
  "settings.config.source.envFile": "File ambiente CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Config ambiente inline",
  "settings.config.source.projectChipMate": "Config progetto .chipmate",
  ...
  "workStyle.onboarding.welcome": "Ti diamo il benvenuto in ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate si mette in pausa e ti mostra il suo piano mentre lavora.",
  ...
  "session.cloud.import.placeholder": "ID sessione, URL o comando chipmate import",
  ...
  "deviceAuth.title": "Accedi a ChipMate",
  ...
  "profile.action.login": "Accedi con ChipMate",
  ...
  "profile.pass.subscribe": "Ottieni ChipMate Pass per aggiungere crediti e guadagnare bonus",
  ...
  "settings.aboutChipMate.title": "Informazioni su ChipMate",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "ChipMate è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutChipMate.status.connected": "Connesso",
  "settings.aboutChipMate.status.connecting": "Connessione...",
  "settings.aboutChipMate.status.disconnected": "Disconnesso",
  "settings.aboutChipMate.status.error": "Errore",
  "settings.aboutChipMate.cliServer": "Server CLI",
  "settings.aboutChipMate.status.label": "Stato:",
  "settings.aboutChipMate.port.label": "Porta:",
  "settings.aboutChipMate.versionInfo": "Informazioni versione",
  "settings.aboutChipMate.version.label": "Versione:",
  "settings.aboutChipMate.extensionName": "Estensione ChipMate",
  "settings.aboutChipMate.community": "Community e supporto",
  "settings.aboutChipMate.feedback.prefix": "Per domande o feedback, apri pure una issue su",
  "settings.aboutChipMate.feedback.or": "oppure",
  "settings.aboutChipMate.support.prefix": "Per domande su fatturazione o account, contatta il supporto clienti a",
  "settings.aboutChipMate.resetSettings.title": "Ripristina impostazioni",
  ...
  "settings.aboutChipMate.resetSettings.button": "Ripristina tutte le impostazioni",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Trasferimento impostazioni",
  "settings.aboutChipMate.settingsTransfer.description":
    "Esporta o importa le impostazioni per trasferirle tra istanze VS Code.",
  "settings.aboutChipMate.exportSettings": "Esporta",
  "settings.aboutChipMate.importSettings": "Importa",
  "settings.aboutChipMate.importSettings.invalidJson": "File JSON non valido. Seleziona un file impostazioni valido.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Il file non contiene impostazioni ChipMate valide.",
  "settings.aboutChipMate.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Questo file è stato esportato da una versione più recente di ChipMate. Alcune impostazioni potrebbero essere ignorate.",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Apri impostazioni telemetria",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia ChipMate. "Auto" usa la lingua di VS Code.',
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite ChipMate Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox abilitata. I comandi shell dell'agente sono limitati alle directory del progetto e di ChipMate.",
  "prompt.action.sandbox.disabled":
    "Sandbox disabilitata. Fai clic per limitare le scritture dei comandi shell dell'agente alle directory del progetto e di ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "Le scritture sono limitate alle directory del progetto e di ChipMate.",
  ...
  "settings.sandboxing.enabled.description":
    "Esegui i comandi shell dell'agente all'interno di un sandbox a livello di sistema operativo che limita le scritture alle directory di stato del progetto e di ChipMate",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che ChipMate usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nessun server MCP configurato. Aggiungi server MCP in chipmate.jsonc, o chiedi all'agente di aggiungerli per te.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview ChipMate indipendentemente da VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Migrazione legacy",
  "settings.aboutChipMate.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di ChipMate, incluse API key dei provider e modello predefinito.",
  "settings.aboutChipMate.rooImport.description":
    "Importa la cronologia delle conversazioni da una installazione di Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Importa sessioni da Roo Code",
  "migration.whatsNew.title": "Novità in ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un core piccolo ed efficiente per ogni prodotto ChipMate. Un'esperienza familiare comunque tu scelga di lavorare.",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da ChipMate durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.experimental.speechToText.description":
    "Abilita input vocale nei campi prompt usando il tuo account ChipMate tramite ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Abilita e accedi al provider ChipMate per usare Da voce a testo. Da voce a testo è attualmente supportato solo tramite ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Modello Da voce a testo",
  "settings.models.speechToTextModel.description": "Scegli il modello di trascrizione ChipMate Gateway per l'input vocale.",
  ...
  "settings.models.hidePromptTraining.description":
    "Nascondi i modelli ChipMate Gateway i cui provider potrebbero usare i tuoi prompt per l'addestramento.",
  ...
  "settings.indexing.chipmateModel.title": "Preset modello ChipMate",
  "settings.indexing.chipmateModel.description": "Scegli un modello embedding ospitato da ChipMate.",
  "settings.indexing.chipmateSignIn.title": "Accesso ChipMate richiesto",
  "settings.indexing.chipmateSignIn.description": "Accedi a ChipMate per usare gli embedding ospitati.",
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate non ha potuto controllare le skill disponibili.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate non ha potuto controllare lo stato del server MCP.",
  "agentRequirements.error.scopeMismatch": "Questo controllo dei requisiti dell’agente non è più attivo.",
  "agentRequirements.error.requestFailed": "ChipMate non ha potuto controllare i requisiti dell’agente.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a ChipMate per usare l'input vocale.",
