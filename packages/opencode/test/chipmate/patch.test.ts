// Tests the chipmate-specific patch module guarantees:
...
// These round-trip through the apply_patch tool so the ChipMate encoding layer is
...
describe("Patch encoding preservation", () => {
  ...
  beforeEach(async () => {
    dir = await fs.mkdtemp(path.join(tmpdir(), "chipmate-patch-"))
  })
