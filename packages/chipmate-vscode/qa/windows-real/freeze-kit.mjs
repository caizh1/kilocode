...
if (!(args.windows ?? args.vsix) || !args.macos || !args.output) {
  process.stderr.write(
    "Usage: node freeze-kit.mjs --windows <vsix> --macos <vsix> --output <zip> [--previous <vsix>] [--chipmate <vsix>]\n",
  )
  process.exit(2)
}
