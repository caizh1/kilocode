...
class BaseSettingsUiTest : BasePlatformTestCase() {
    ...
    override fun setUp() {
        ...
        app = ChipMateAppService(appScope, FakeAppRpcApi())
        workspaces = ChipMateWorkspaceService(appScope, FakeWorkspaceRpcApi())
    }
    ...
    fun `test login banner can be shown`() {
        ...
        edt { assertTrue(text(view).contains("Sign in to ChipMate")) }
    }
    ...
    fun `test login banner can be disabled`() {
        ...
        edt { assertFalse(text(view).contains("Sign in to ChipMate")) }
    }
    ...
    private class FakePanel(
        ...
        override fun draft(state: ChipMateAppStateDto): Draft = draft
