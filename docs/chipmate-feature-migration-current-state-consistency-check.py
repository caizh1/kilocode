...
AGENT_TERMINAL_ACCEPTANCE_ROLLUP = (
    "docs/chipmate-feature-migration-validation-runs/"
    "20260709-080000-agent-terminal-acceptance-rollup/"
    "summary.md"
)

AGENT_TERMINAL_VISIBLE_UX_REQUEST = (
    "docs/chipmate-feature-migration-validation-runs/"
    "20260709-095000-agent-terminal-visible-ux-request/"
    "agent-terminal-visible-ux-request.md"
)
AGENT_TERMINAL_VISIBLE_UX_INTAKE_SELF_CHECK = (
    "docs/chipmate-feature-migration-validation-runs/"
    "20260709-095500-agent-terminal-visible-ux-intake-self-check/"
    "summary.md"
)
