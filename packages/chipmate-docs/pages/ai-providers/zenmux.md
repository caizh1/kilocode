---
title: "Using ZenMux with ChipMate | Unified AI Gateway"
description: "Access OpenAI, Anthropic, Google, and other AI models through ZenMux in ChipMate with automatic routing and cost optimization."
sidebar_label: ZenMux
---

# Using ZenMux With ChipMate
...
3. **Configure in ChipMate:** Add your API key to ChipMate settings.
...
- Check the [ChipMate GitHub repository](https://github.com/ChipMate-Org/chipmate) for integration-specific issues
