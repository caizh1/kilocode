...
- Effect plugins import `@chipmate/plugin/v2/effect`, not `@opencode-ai/core`.
- Public domain values use generated `@chipmate/sdk` types.
...
- Define `PluginHost` domain capabilities in `@chipmate/plugin/v2/effect`.
