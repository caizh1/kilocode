...
import type { AssistantMessage, ToolPart } from "@chipmate/sdk/v2"
...
const shellPart: ToolPart = {
  ...
  state: {
    ...
    input: {
      ...
      command: `grep -n "migration\\|openMigration" packages/chipmate-vscode/webview-ui/src/types/messages.ts`,
    },
