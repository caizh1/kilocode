...
import { StatusTag } from "@chipmate/chipmate-web-ui/status-tag"
    ...
    <Show when={state.snap()}>
      {(_data) => (
        <ConfigPage
          ...
          description="Install, configure, and manage Model Context Protocol servers available to ChipMate agents."
          actions={
            <>
            ...
            <aside class="provider-drawer mcp-drawer" aria-label="Install MCP server">
              <header class="drawer-header">
                <div>
                  ...
                  <span>Browse the ChipMate Marketplace MCP catalog and install into the current settings scope.</span>
                </div>
