...
// 1. Imports DEFAULT_THEMES from our local default-themes (which includes ChipMate themes)
// 2. Default theme changed from "oc-1" to "chipmate"
...
const DEFAULT_THEME_ID = "chipmate"
