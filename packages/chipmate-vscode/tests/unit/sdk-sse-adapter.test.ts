...
import { ChipMateConnectionService } from "../../src/services/cli-backend/connection-service"
...
function client(open: (opts: Opts) => Stream): ChipMateClient {
  return {
    global: {
...
describe("ChipMateConnectionService backend crash", () => {
  it("invalidates the stale SDK client and reports a retryable error", () => {
    const service = new ChipMateConnectionService(context())
...
describe("ChipMateConnectionService SSE startup", () => {
...
function context(): vscode.ExtensionContext {
  return {
    subscriptions: [],
    globalStorageUri: { fsPath: "/tmp/chipmate-vscode-sdk-sse-test" },
