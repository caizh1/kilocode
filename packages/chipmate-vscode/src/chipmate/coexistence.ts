...
const OFFICIAL = "chipmate.chipmate-code"
...
export function registerCoexistence(context: vscode.ExtensionContext): Coexistence {
  ...
  const sync = async (notify: boolean) => {
    ...
    void vscode.window.showInformationMessage(
      "ChipMate detected ChipMate. ChipMate now owns autocomplete and global shortcuts; ChipMate chat and other features remain available.",
    )
  }
