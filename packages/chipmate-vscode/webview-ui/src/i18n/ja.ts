...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "このマシンに Anaconda Desktop をインストールしてから、ここに戻ってください。ChipMate はインストーラーを実行しません。",
  ...
  "provider.anaconda.state.signedOut": "ChipMate を接続する前に、Anaconda Desktop を開いてサインインしてください。",
  "provider.anaconda.state.unauthorized":
    "ChipMate は Anaconda Desktop にアクセスできませんでした。Desktop を開いて再度サインインし、必要に応じて再起動してください。",
  ...
  "provider.anaconda.state.ready":
    "ChipMate は正常なローカルのテキスト生成サーバーを見つけ、現在の接続設定をインポートできます。",
  ...
  "provider.anaconda.toast.refreshed.description": "アクティブなローカルサーバーとモデルが ChipMate で最新になりました。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate は利用可能なスキルを確認できませんでした。",
  "agentRequirements.error.mcpStatusFailed": "ChipMate は MCP サーバーの状態を確認できませんでした。",
  "agentRequirements.error.scopeMismatch": "このエージェント要件の確認はもう有効ではありません。",
  "agentRequirements.error.requestFailed": "ChipMate はエージェント要件を確認できませんでした。",
  ...
  "dialog.model.unpaid.freeModels.title": "ChipMateが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、ChipMateで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してChipMateで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、ChipMateで{{provider}}モデルを使用してください。",
  ...
  "prompt.panel.collapse": "入力パネルを折りたたむ",
  "prompt.panel.expand": "入力パネルを展開",
  "prompt.panel.collapsed": "入力パネルは折りたたまれています",
  "prompt.panel.responding": "回答中…",
  ...
  "prompt.action.sandbox.enabled":
    "サンドボックスが有効です。エージェントのシェルコマンドは、プロジェクトおよびChipMateディレクトリに制限されています。",
  "prompt.action.sandbox.disabled":
    "サンドボックスが無効です。クリックしてエージェントのシェルコマンドの書き込みをプロジェクトおよびChipMateディレクトリに制限します。",
  ...
  "prompt.action.sandbox.description.enabled": "書き込みはプロジェクトおよびChipMateディレクトリ内に制限されます。",
  ...
  "speechToText.tooltip.start": "ChipMate Gatewayで音声入力を開始",
  ...
  "speechToText.error.loginRequired": "音声入力を使用するにはChipMateにサインインしてください。",
  ...
  "dialog.server.description": "このアプリが接続するChipMateサーバーを切り替えます。",
  ...
  "toast.update.description": "ChipMateの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをChipMateチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ChipMateはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "ChipMateには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "ChipMateの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのChipMateの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "ChipMateのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "ChipMate の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "ChipMate は最新バージョンです。",
  ...
  "settings.indexing.chipmateModel.title": "ChipMateモデルプリセット",
  "settings.indexing.chipmateModel.description": "サポートされているChipMateホスト型埋め込みモデルを選択します。",
  "settings.indexing.chipmateSignIn.title": "ChipMateへのサインインが必要です",
  "settings.indexing.chipmateSignIn.description": "ホスト型埋め込みを使用するにはChipMateにサインインしてください。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはChipMate Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはChipMateをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.models.hidePromptTraining.description":
    "プロバイダーがプロンプトを学習に使用する可能性のある ChipMate Gateway モデルを非表示にします。",
  ...
  "settings.config.title": "{{scope}}のChipMate構成ファイルを開く",
  "settings.config.placeholder":
    "構成ファイルは順番にマージされます。読み込み済みとしてマークされているファイルが現在設定に影響しています。",
  "settings.config.noWorkspace": "ローカルのChipMate構成ファイルを編集するには、ワークスペースフォルダーを開いてください。",
  "settings.config.openFailed": "{{scope}}のChipMate構成ファイルを開けませんでした: {{message}}",
  "settings.config.source.xdg": "XDGグローバル構成",
  "settings.config.source.homeChipMate": "Homeの.chipmate構成",
  "settings.config.source.homeOpencode": "Homeの.opencode構成",
  "settings.config.source.envFile": "CHIPMATE_CONFIG環境ファイル",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "インライン環境構成",
  "settings.config.source.projectChipMate": "プロジェクトの.chipmate構成",
  ...
  "workStyle.onboarding.welcome": "ChipMateへようこそ",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMateは作業中に一時停止し、計画を表示します。",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはchipmate importコマンド",
  ...
  "deviceAuth.title": "ChipMateにサインイン",
  ...
  "settings.aboutChipMate.title": "ChipMateについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "ChipMateはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutChipMate.status.connected": "接続済み",
  "settings.aboutChipMate.status.connecting": "接続中...",
  "settings.aboutChipMate.status.disconnected": "切断",
  "settings.aboutChipMate.status.error": "エラー",
  "settings.aboutChipMate.cliServer": "CLIサーバー",
  "settings.aboutChipMate.status.label": "ステータス：",
  "settings.aboutChipMate.port.label": "ポート：",
  "settings.aboutChipMate.versionInfo": "バージョン情報",
  "settings.aboutChipMate.version.label": "バージョン：",
  "settings.aboutChipMate.extensionName": "ChipMate拡張機能",
  "settings.aboutChipMate.community": "コミュニティとサポート",
  "settings.aboutChipMate.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutChipMate.feedback.or": "または",
  "settings.aboutChipMate.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutChipMate.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutChipMate.resetSettings.button": "すべての設定をリセット",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "設定の移行",
  "settings.aboutChipMate.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutChipMate.exportSettings": "エクスポート",
  "settings.aboutChipMate.importSettings": "インポート",
  "settings.aboutChipMate.importSettings.invalidJson":
    "無効な JSON ファイルです。有効な設定ファイルを選択してください。",
  "settings.aboutChipMate.importSettings.invalidConfig": "ファイルに有効な ChipMate の設定が含まれていません。",
  "settings.aboutChipMate.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  "settings.aboutChipMate.importSettings.newerVersion":
    "このファイルはより新しいバージョンの ChipMate からエクスポートされたものです。一部の設定が無視される場合があります。",
  "settings.aboutChipMate.importSettings.success":
    "設定をインポートしました。上記の変更内容を確認してから、保存をクリックしてください。",

  "settings.aboutChipMate.telemetry.title": "テレメトリ",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "ChipMate UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.speechToText.description":
    "ChipMate Gateway経由でChipMateアカウントを使用して、プロンプトフィールドでの音声入力を有効にします。",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text を使用するには、ChipMate プロバイダーを有効にしてサインインしてください。現在、Speech to Text は ChipMate Gateway でのみサポートされています。",
  "settings.models.speechToTextModel.title": "音声認識モデル",
  "settings.models.speechToTextModel.description": "音声入力に使用するChipMate Gateway文字起こしモデルを選択します。",
  ...
  "settings.experimental.remote.description":
    "ChipMate Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。ChipMate に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。chipmate.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  ...
  "settings.sandboxing.enabled.description":
    "エージェントのシェルコマンドを、プロジェクトおよびChipMateの状態ディレクトリへの書き込みを制限するOSレベルのサンドボックス内で実行",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して ChipMate webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutChipMate.legacyMigration.title": "レガシー移行",
  "settings.aboutChipMate.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたChipMateから設定を移行します。",
  "settings.aboutChipMate.rooImport.description": "インストールしたRoo Codeから会話履歴を移行します。",
  "settings.aboutChipMate.rooImport.button": "Roo Codeからセッションをインポート",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ChipMateの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのChipMate製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に ChipMate が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
