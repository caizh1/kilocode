/**
 * ChipMate Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@chipmate/chipmate-gateway/tui"
...
interface DialogChipMateOrganizationProps {
...
export function DialogChipMateOrganization(props: DialogChipMateOrganizationProps) {
    ...
    <DialogSelect
      ...
      onSelect={async (option: any) => {
        try {
          ...
          await sdk.client.chipmate.organization.set({
