...
class ChipMateVirtualFile(
    val path: ChipMatePath,
) : VirtualFile(),
    ...
    override fun getFileSystem(): ChipMateVirtualFileSystem = ChipMateVirtualFileSystem.getInstance()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is ChipMateVirtualFile) return false
        return path == other.path
    }

    override fun hashCode(): Int = path.hashCode()

    private fun kind(): ChipMateVirtualFileKind? = service<ChipMateVirtualFileKindRegistry>().get(path.kind)
}
