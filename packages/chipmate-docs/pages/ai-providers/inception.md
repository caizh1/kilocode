---
title: "Using Inception Labs with ChipMate"
description: "Connect Inception Labs' Mercury diffusion LLMs to ChipMate for ultra-fast code generation. Setup guide for VS Code and the CLI."
sidebar_label: Inception
---

# Using Inception With ChipMate
...
3. **Create a Key:** Click "Create new API key". Give your key a descriptive name (e.g., "ChipMate").
4. **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

## Supported Models

ChipMate supports Inception's available models. Model selection and capabilities may vary based on your account tier.
...
- **Docs Feedback:** Report documentation issues at [ChipMate-Org/chipmate issues](https://github.com/ChipMate-Org/chipmate/issues/new?title=Documentation%20Issue:%20/docs/ai-providers/inception).
