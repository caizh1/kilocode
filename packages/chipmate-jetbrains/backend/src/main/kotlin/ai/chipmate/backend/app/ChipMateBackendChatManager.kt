 ...
 *
 * All JSON parsing is delegated to [ChipMateCliDataParser].
 */
class ChipMateBackendChatManager(
    ...
    private var normalizer = ChipMateCliDataParser.ChatEventNormalizer()
    ...
    fun start(http: OkHttpClient, port: Int, sse: SharedFlow<SseEvent>) {
        ...
        watcher = cs.launch {
            sse.collect { event ->
                val type = if (event.type in CHAT_EVENTS) event.type else ChipMateCliDataParser.extractEventType(event.data)
    ...
    fun stop() {
        ...
        client = null
        base = null
        normalizer = ChipMateCliDataParser.ChatEventNormalizer()
    ...
    suspend fun enhancePrompt(dir: String, text: String): String {
        ...
        val url = requireBase()
        val body = ChipMateCliDataParser.buildEnhancePromptJson(text)
        ...
        return call.await().use { response ->
            ...
            ChipMateCliDataParser.parseEnhancedPrompt(raw)
        }
    }
    ...
    fun prompt(id: String, dir: String, prompt: PromptDto) {
        ...
        val body = ChipMateCliDataParser.buildPromptJson(prompt)
    ...
    fun command(id: String, dir: String, command: String, args: String, prompt: PromptDto) {
        ...
        val body = ChipMateCliDataParser.buildCommandJson(command, args, prompt)
    ...
    fun compact(id: String, dir: String, model: ModelSelectionDto) {
        ...
        val http = requireClient()
        val url = requireBase()
        val body = ChipMateCliDataParser.buildSummarizeJson(model)
        val request = Request.Builder()
    ...
    suspend fun revert(id: String, dir: String, message: String, part: String?) {
        ...
        val body = ChipMateCliDataParser.buildRevertJson(message, part)
    ...
    fun messages(id: String, dir: String): List<MessageWithPartsDto> {
        ...
        return http.newCall(request).execute().use { response ->
            ...
            val parsed = ChipMateCliDataParser.parseMessages(raw)
    ...
    fun updateConfig(dir: String, update: ConfigUpdateDto) {
        ...
        val partial = ChipMateCliDataParser.buildConfigPartial(update)
    ...
    fun replyPermission(requestId: String, dir: String, reply: PermissionReplyDto) {
        ...
        val body = ChipMateCliDataParser.buildPermissionReplyJson(reply)
    ...
    fun savePermissionRules(requestId: String, dir: String, rules: PermissionAlwaysRulesDto) {
        ...
        val body = ChipMateCliDataParser.buildPermissionAlwaysRulesJson(rules)
    ...
    fun replyQuestion(requestId: String, dir: String, answers: QuestionReplyDto) {
        ...
        val body = ChipMateCliDataParser.buildQuestionReplyJson(answers)
    ...
    fun pendingPermissions(dir: String): List<PermissionRequestDto> {
        ...
        val parsed = ChipMateCliDataParser.parsePermissionRequests(raw)
    ...
    fun pendingQuestions(dir: String): List<QuestionRequestDto> {
        ...
        val parsed = ChipMateCliDataParser.parseQuestionRequests(raw)
