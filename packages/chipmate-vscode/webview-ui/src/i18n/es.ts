...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instala Anaconda Desktop en este equipo y luego vuelve aquí. ChipMate no ejecuta el instalador por ti.",
  ...
  "provider.anaconda.state.signedOut": "Abre Anaconda Desktop e inicia sesión antes de conectar ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate no pudo acceder a Anaconda Desktop. Abre Desktop, inicia sesión de nuevo y reinícialo si es necesario.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate encontró un servidor local de generación de texto en buen estado y puede importar su configuración de conexión actual.",
  ...
  "provider.anaconda.toast.refreshed.description": "El servidor local activo y los modelos están actualizados en ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate no pudo comprobar las habilidades disponibles.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate no pudo comprobar el estado del servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta comprobación de requisitos del agente ya no está activa.",
  "agentRequirements.error.requestFailed": "ChipMate no pudo comprobar los requisitos del agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en ChipMate.",
  ...
  "prompt.panel.collapse": "Contraer el panel de entrada",
  "prompt.panel.expand": "Expandir el panel de entrada",
  "prompt.panel.collapsed": "Panel de entrada contraído",
  "prompt.panel.responding": "Respondiendo…",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox activado. Los comandos de shell del agente están limitados a los directorios del proyecto y de ChipMate.",
  "prompt.action.sandbox.disabled":
    "Sandbox desactivado. Haz clic para limitar las escrituras de los comandos de shell del agente a los directorios del proyecto y de ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "Las escrituras se limitan a los directorios del proyecto y de ChipMate.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en ChipMate para usar la entrada de voz.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de ChipMate se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de ChipMate ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de ChipMate",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, ChipMate no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para ChipMate",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve ChipMate en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ChipMate.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia ChipMate",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de ChipMate.",
  ...
  "settings.indexing.chipmateModel.title": "Preajuste de modelo de ChipMate",
  "settings.indexing.chipmateModel.description": "Elige un modelo de embeddings alojado por ChipMate compatible.",
  "settings.indexing.chipmateSignIn.title": "Se requiere iniciar sesión en ChipMate",
  "settings.indexing.chipmateSignIn.description": "Inicia sesión en ChipMate para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor ChipMate Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener ChipMate abierto, sin ataduras.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculta los modelos de ChipMate Gateway cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.config.title": "Abrir archivo de configuración ChipMate {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración ChipMate local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración ChipMate {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeChipMate": "Configuración .chipmate de Home",
  "settings.config.source.homeOpencode": "Configuración .opencode de Home",
  "settings.config.source.envFile": "Archivo de entorno CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectChipMate": "Configuración .chipmate del proyecto",
  ...
  "workStyle.onboarding.welcome": "Te damos la bienvenida a ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate se detiene y te muestra su plan mientras trabaja.",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando chipmate import",
  ...
  "deviceAuth.title": "Iniciar sesión en ChipMate",
  ...
  "profile.action.login": "Iniciar sesión con ChipMate",
  ...
  "profile.pass.subscribe": "Obtén ChipMate Pass para añadir créditos y ganar bonificaciones",
  ...
  "settings.aboutChipMate.title": "Acerca de ChipMate",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "ChipMate es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutChipMate.status.label": "Estado:",
  "settings.aboutChipMate.port.label": "Puerto:",
  "settings.aboutChipMate.versionInfo": "Información de versión",
  "settings.aboutChipMate.version.label": "Versión:",
  "settings.aboutChipMate.extensionName": "Extensión ChipMate",
  "settings.aboutChipMate.community": "Comunidad y soporte",
  "settings.aboutChipMate.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutChipMate.feedback.or": "o",
  "settings.aboutChipMate.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutChipMate.resetSettings.title": "Restablecer configuración",
  ...
  "settings.aboutChipMate.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Transferencia de ajustes",
  ...
  "settings.aboutChipMate.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de ChipMate.",
  ...
  "settings.aboutChipMate.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de ChipMate. Algunos ajustes podrían ignorarse.",
  ...
  "settings.aboutChipMate.telemetry.title": "Telemetría",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de ChipMate. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Habilita la entrada de voz en los campos de prompt usando tu cuenta de ChipMate a través de ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor ChipMate para usar Speech to Text. Actualmente, Speech to Text solo es compatible con ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de voz a texto",
  "settings.models.speechToTextModel.description":
    "Elige el modelo de transcripción de ChipMate Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de ChipMate Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que ChipMate utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en chipmate.jsonc o pida al agente que los añada.",
  ...
  "settings.sandboxing.enabled.description":
    "Ejecutar los comandos de shell del agente dentro de un sandbox a nivel de sistema operativo que restringe las escrituras a los directorios de estado del proyecto y de ChipMate",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de ChipMate de forma independiente a VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Migración heredada",
  "settings.aboutChipMate.legacyMigration.description":
    "Migra la configuración de una instalación anterior de ChipMate, incluyendo las claves API de proveedores y el modelo predeterminado.",
  "settings.aboutChipMate.rooImport.description":
    "Importa el historial de conversaciones de una instalación de Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Importar sesiones desde Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos ChipMate. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por ChipMate durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
