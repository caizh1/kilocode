...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instalirajte Anaconda Desktop na ovom računaru, zatim se vratite ovdje. ChipMate ne pokreće instalacijski program umjesto vas.",
  ...
  "provider.anaconda.state.unauthorized":
    "ChipMate nije mogao pristupiti Anaconda Desktopu. Otvorite Desktop, ponovo se prijavite i ponovo ga pokrenite ako je potrebno.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate je pronašao ispravan lokalni server za generisanje teksta i može uvesti njegove trenutne postavke veze.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate nije mogao provjeriti dostupne vještine.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate nije mogao provjeriti status MCP servera.",
  "agentRequirements.error.scopeMismatch": "Ova provjera zahtjeva agenta više nije aktivna.",
  "agentRequirements.error.requestFailed": "ChipMate nije mogao provjeriti zahtjeve agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ChipMate-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ChipMate-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ChipMate-u.",
  ...
  "prompt.panel.collapse": "Skupi panel za unos",
  "prompt.panel.expand": "Proširi panel za unos",
  "prompt.panel.collapsed": "Panel za unos je skupljen",
  "prompt.panel.responding": "Odgovaranje…",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox je omogućen. Shell komande agenta su ograničene na direktorije projekta i ChipMate.",
  "prompt.action.sandbox.disabled":
    "Sandbox je onemogućen. Kliknite da ograničite pisanje shell komandi agenta na direktorije projekta i ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "Pisanje je ograničeno na direktorije projekta i ChipMate.",
  ...
  "speechToText.tooltip.start": "Započni glasovni unos sa ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Prijavite se na ChipMate da koristite glasovni unos.",
  ...
  "dialog.server.description": "Promijeni na koji se ChipMate server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija ChipMate-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ChipMate timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ChipMate još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ChipMate-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako ChipMate izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ChipMate-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ChipMate pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ChipMate-a.",
  ...
  "settings.indexing.chipmateModel.title": "Preset ChipMate modela",
  "settings.indexing.chipmateModel.description": "Odaberite podržani model embeddinga hostovan na ChipMate.",
  "settings.indexing.chipmateSignIn.title": "Potrebna je prijava na ChipMate",
  "settings.indexing.chipmateSignIn.description": "Prijavite se na ChipMate za korištenje hostovanih embeddinga.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo ChipMate Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da ChipMate ostane otvoren, bez vezivanja.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sakrij ChipMate Gateway modele čiji pružaoci mogu koristiti vaše promptove za treniranje.",
  ...
  "settings.config.title": "Otvori {{scope}} ChipMate konfiguracijsku datoteku",
  "settings.config.placeholder":
    "Konfiguracijske datoteke se spajaju po redu; datoteke označene kao učitane trenutno utiču na postavke.",
  "settings.config.noWorkspace": "Otvorite fasciklu radnog prostora da uredite lokalnu ChipMate konfiguracijsku datoteku.",
  "settings.config.openFailed": "Nije uspjelo otvaranje {{scope}} ChipMate konfiguracijske datoteke: {{message}}",
  "settings.config.source.xdg": "XDG globalna konfiguracija",
  "settings.config.source.homeChipMate": "Home .chipmate konfiguracija",
  "settings.config.source.homeOpencode": "Home .opencode konfiguracija",
  "settings.config.source.envFile": "CHIPMATE_CONFIG datoteka okruženja",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Ugrađena konfiguracija okruženja",
  "settings.config.source.projectChipMate": "Projektna .chipmate konfiguracija",
  ...
  "workStyle.onboarding.welcome": "Dobro došli u ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate zastaje i prikazuje vam svoj plan tokom rada.",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili chipmate import naredba",
  ...
  "deviceAuth.title": "Prijavite se u ChipMate",
  ...
  "profile.action.login": "Prijavite se putem ChipMate",
  ...
  "profile.pass.subscribe": "Nabavite ChipMate Pass da dodate kredite i zaradite bonuse",
  ...
  "settings.aboutChipMate.title": "O ChipMate-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "ChipMate je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutChipMate.status.connected": "Povezano",
  "settings.aboutChipMate.status.connecting": "Povezivanje...",
  "settings.aboutChipMate.status.disconnected": "Odspojeno",
  "settings.aboutChipMate.status.error": "Greška",
  ...
  "settings.aboutChipMate.versionInfo": "Informacije o verziji",
  "settings.aboutChipMate.version.label": "Verzija:",
  "settings.aboutChipMate.extensionName": "ChipMate ekstenzija",
  "settings.aboutChipMate.community": "Zajednica i podrška",
  "settings.aboutChipMate.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutChipMate.feedback.or": "ili",
  "settings.aboutChipMate.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutChipMate.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutChipMate.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutChipMate.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutChipMate.exportSettings": "Izvezi",
  "settings.aboutChipMate.importSettings": "Uvezi",
  "settings.aboutChipMate.importSettings.invalidJson": "Nevažeći JSON fajl. Odaberite važeći fajl s postavkama.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Fajl ne sadrži važeće ChipMate postavke.",
  "settings.aboutChipMate.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Ovaj fajl je izvezen iz novije verzije ChipMate-a. Neke postavke mogu biti zanemarene.",
  "settings.aboutChipMate.importSettings.success":
    "Postavke su uvezene. Pregledajte promjene iznad, a zatim kliknite Sačuvaj.",

  "settings.aboutChipMate.telemetry.title": "Telemetrija",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za ChipMate sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.speechToText.description":
    "Omogućite glasovni unos u poljima za promptove koristeći vaš ChipMate račun preko ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Omogućite i prijavite se na ChipMate provajder da biste koristili Speech to Text. Speech to Text je trenutno podržan samo uz ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Model govora u tekst",
  "settings.models.speechToTextModel.description": "Odaberite ChipMate Gateway model za transkripciju za glasovni unos.",
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem ChipMate Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da ChipMate koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u chipmate.jsonc ili zamolite agenta da ih doda.",
  ...
  "settings.sandboxing.enabled.description":
    "Pokrenite shell komande agenta unutar sandboxa na nivou operativnog sistema koji ograničava pisanje na direktorije stanja projekta i ChipMate",
  ...
  "settings.display.fontSize.description": "Prilagodite veličinu fonta za ChipMate webview UI nezavisno od VS Code-a.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutChipMate.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije ChipMate, uključujući API ključeve provajdera i podrazumijevani model.",
  "settings.aboutChipMate.rooImport.description": "Uvezite historiju razgovora iz instalacije Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Uvezi sesije iz Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve ChipMate proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je ChipMate promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
