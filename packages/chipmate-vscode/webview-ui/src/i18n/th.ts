...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ติดตั้ง Anaconda Desktop บนเครื่องนี้ แล้วกลับมาที่นี่ ChipMate จะไม่เรียกใช้ตัวติดตั้งให้คุณ",
  ...
  "provider.anaconda.state.signedOut": "เปิด Anaconda Desktop และลงชื่อเข้าใช้ก่อนเชื่อมต่อ ChipMate",
  "provider.anaconda.state.unauthorized":
    "ChipMate ไม่สามารถเข้าถึง Anaconda Desktop ได้ เปิด Desktop ลงชื่อเข้าใช้อีกครั้ง และรีสตาร์ทหากจำเป็น",
  ...
  "provider.anaconda.state.ready":
    "ChipMate พบเซิร์ฟเวอร์สร้างข้อความในเครื่องที่พร้อมใช้งาน และสามารถนำเข้าการตั้งค่าการเชื่อมต่อปัจจุบันได้",
  ...
  "provider.anaconda.toast.refreshed.description": "เซิร์ฟเวอร์ในเครื่องและโมเดลที่ใช้งานอยู่เป็นปัจจุบันใน ChipMate แล้ว",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate ไม่สามารถตรวจสอบสกิลที่มีอยู่ได้",
  "agentRequirements.error.mcpStatusFailed": "ChipMate ไม่สามารถตรวจสอบสถานะเซิร์ฟเวอร์ MCP ได้",
  "agentRequirements.error.scopeMismatch": "การตรวจสอบข้อกำหนดของเอเจนต์นี้ไม่ทำงานอีกต่อไป",
  "agentRequirements.error.requestFailed": "ChipMate ไม่สามารถตรวจสอบข้อกำหนดของเอเจนต์ได้",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย ChipMate",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน ChipMate",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน ChipMate",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน ChipMate",
  ...
  "prompt.panel.collapse": "ยุบแผงป้อนข้อมูล",
  "prompt.panel.expand": "ขยายแผงป้อนข้อมูล",
  "prompt.panel.collapsed": "ยุบแผงป้อนข้อมูลแล้ว",
  "prompt.panel.responding": "กำลังตอบ…",
  ...
  "prompt.action.sandbox.enabled":
    "เปิดใช้งาน sandbox แล้ว คำสั่ง shell ของ agent ถูกจำกัดไว้ที่โฟลเดอร์โปรเจ็กต์และ ChipMate",
  "prompt.action.sandbox.disabled":
    "ปิดใช้งาน sandbox อยู่ คลิกเพื่อจำกัดการเขียนคำสั่ง shell ของ agent ไว้ที่โฟลเดอร์โปรเจ็กต์และ ChipMate",
  ...
  "prompt.action.sandbox.description.enabled": "เขียนได้เฉพาะในโฟลเดอร์โปรเจ็กต์และ ChipMate",
  ...
  "speechToText.tooltip.start": "เริ่มการป้อนข้อมูลด้วยเสียงด้วย ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "ลงชื่อเข้าใช้ ChipMate เพื่อใช้การป้อนข้อมูลด้วยเสียง",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ ChipMate ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ ChipMate ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม ChipMate",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า ChipMate ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "ChipMate รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ ChipMate",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ ChipMate มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ ChipMate มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ ChipMate เปิดตัว",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้ ChipMate เวอร์ชันล่าสุด",
  ...
  "settings.indexing.chipmateModel.title": "พรีเซ็ตโมเดล ChipMate",
  "settings.indexing.chipmateModel.description": "เลือกโมเดลการฝังที่ ChipMate โฮสต์และรองรับ",
  "settings.indexing.chipmateSignIn.title": "ต้องลงชื่อเข้าใช้ ChipMate",
  "settings.indexing.chipmateSignIn.description": "ลงชื่อเข้าใช้ ChipMate เพื่อใช้การฝังแบบโฮสต์",
  ...
  "settings.providers.betaNotice":
    "ปัจจุบันสามารถตั้งค่าได้เฉพาะผู้ให้บริการ ChipMate Gateway ในหน้าการตั้งค่าเท่านั้น การรองรับการตั้งค่าผู้ให้บริการรายอื่นจะพร้อมใช้งานในเร็วๆ นี้ในช่วงเบต้า ในระหว่างนี้คุณสามารถตั้งค่าผู้ให้บริการผ่าน CLI หรือไฟล์คอนฟิกได้ เรามุ่งมั่นที่จะรักษาให้ ChipMate เปิดกว้างและไม่มีการผูกมัด",
  ...
  "settings.models.hidePromptTraining.description": "ซ่อนโมเดล ChipMate Gateway ที่ผู้ให้บริการอาจใช้พรอมต์ของคุณในการฝึก",
  ...
  "settings.config.title": "เปิดไฟล์การตั้งค่า ChipMate ({{scope}})",
  "settings.config.placeholder":
    "ไฟล์การตั้งค่าจะถูกผสานตามลำดับ ไฟล์ที่ถูกทำเครื่องหมายว่าโหลดแล้วจะมีผลกับการตั้งค่าในปัจจุบัน",
  "settings.config.noWorkspace": "เปิดโฟลเดอร์พื้นที่ทำงานเพื่อแก้ไขไฟล์การตั้งค่า ChipMate ภายใน",
  "settings.config.openFailed": "ไม่สามารถเปิดไฟล์การตั้งค่า ChipMate ({{scope}}): {{message}}",
  "settings.config.source.xdg": "การตั้งค่า XDG ทั่วโลก",
  "settings.config.source.homeChipMate": "การตั้งค่า .chipmate ของ Home",
  "settings.config.source.homeOpencode": "การตั้งค่า .opencode ของ Home",
  "settings.config.source.envFile": "ไฟล์สภาพแวดล้อม CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "การตั้งค่าสภาพแวดล้อมแบบอินไลน์",
  "settings.config.source.projectChipMate": "การตั้งค่า .chipmate ของโปรเจกต์",
  ...
  "workStyle.onboarding.welcome": "ยินดีต้อนรับสู่ ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate จะหยุดและแสดงแผนให้คุณเห็นระหว่างการทำงาน",
  ...
  "session.cloud.import.placeholder": "ID เซสชัน, URL หรือคำสั่ง chipmate import",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ ChipMate",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย ChipMate",
  ...
  "profile.pass.subscribe": "รับ ChipMate Pass เพื่อเพิ่มเครดิตและรับโบนัส",
  ...
  "settings.aboutChipMate.title": "เกี่ยวกับ ChipMate",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "ChipMate เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutChipMate.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutChipMate.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutChipMate.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutChipMate.status.error": "ข้อผิดพลาด",
  "settings.aboutChipMate.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutChipMate.status.label": "สถานะ:",
  "settings.aboutChipMate.port.label": "พอร์ต:",
  "settings.aboutChipMate.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutChipMate.version.label": "เวอร์ชัน:",
  "settings.aboutChipMate.extensionName": "ส่วนขยาย ChipMate",
  "settings.aboutChipMate.community": "ชุมชนและการสนับสนุน",
  "settings.aboutChipMate.feedback.prefix": "หากคุณมีคำถามหรือข้อเสนอแนะ สามารถเปิด issue ได้ที่",
  "settings.aboutChipMate.feedback.or": "หรือ",
  "settings.aboutChipMate.support.prefix": "สำหรับคำถามเกี่ยวกับการเรียกเก็บเงินหรือบัญชี ติดต่อฝ่ายสนับสนุนลูกค้าที่",
  "settings.aboutChipMate.resetSettings.title": "รีเซ็ตการตั้งค่า",
  ...
  "settings.aboutChipMate.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "ถ่ายโอนการตั้งค่า",
  "settings.aboutChipMate.settingsTransfer.description":
    "ส่งออกหรือนำเข้าการตั้งค่าเพื่อถ่ายโอนระหว่างอินสแตนซ์ VS Code",
  "settings.aboutChipMate.exportSettings": "ส่งออก",
  "settings.aboutChipMate.importSettings": "นำเข้า",
  "settings.aboutChipMate.importSettings.invalidJson": "ไฟล์ JSON ไม่ถูกต้อง กรุณาเลือกไฟล์การตั้งค่าที่ถูกต้อง",
  "settings.aboutChipMate.importSettings.invalidConfig": "ไฟล์ไม่มีการตั้งค่า ChipMate ที่ถูกต้อง",
  "settings.aboutChipMate.importSettings.tooLarge": "ไฟล์มีขนาดใหญ่เกินไป ไฟล์การตั้งค่าต้องมีขนาดไม่เกิน 1 MB",
  "settings.aboutChipMate.importSettings.newerVersion":
    "ไฟล์นี้ถูกส่งออกจาก ChipMate เวอร์ชันใหม่กว่า การตั้งค่าบางรายการอาจถูกข้ามไป",
  "settings.aboutChipMate.importSettings.success": "นำเข้าการตั้งค่าแล้ว ตรวจสอบการเปลี่ยนแปลงด้านบน จากนั้นคลิกบันทึก",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "เปิดการตั้งค่า Telemetry",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ ChipMate "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.experimental.speechToText.description":
    "เปิดใช้งานการป้อนข้อมูลด้วยเสียงในช่องพรอมต์โดยใช้บัญชี ChipMate ของคุณผ่าน ChipMate Gateway",
  "settings.models.speechToText.disabledDescription":
    "เปิดใช้งานและลงชื่อเข้าใช้ผู้ให้บริการ ChipMate เพื่อใช้ Speech to Text ปัจจุบัน Speech to Text รองรับเฉพาะกับ ChipMate Gateway เท่านั้น",
  "settings.models.speechToTextModel.title": "โมเดลแปลงเสียงเป็นข้อความ",
  "settings.models.speechToTextModel.description": "เลือกโมเดลการถอดเสียง ChipMate Gateway สำหรับการป้อนข้อมูลด้วยเสียง",
  ...
  "settings.experimental.remote.description":
    "เปิดใช้งานการควบคุม Remote ของเซสชันผ่าน ChipMate Cloud ซึ่งจะส่งผลต่อ CLI บนเครื่องนี้ด้วย",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "โหลดคำแนะนำและทักษะจาก CLAUDE.md ในไดเรกทอรีการกำหนดค่า Claude Code ของคุณลงในเซสชัน เปิดใช้งานตัวเลือกนี้หากคุณต้องการให้ ChipMate ใช้คำแนะนำและทักษะจาก Claude Code ของคุณ จำเป็นต้องรีสตาร์ท",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "ไม่ได้กำหนดค่าเซิร์ฟเวอร์ MCP เพิ่มเซิร์ฟเวอร์ MCP ใน chipmate.jsonc หรือขอให้เอเจนต์เพิ่มให้คุณ",
  ...
  "settings.sandboxing.enabled.description":
    "เรียกใช้คำสั่ง shell ของ agent ใน sandbox ระดับระบบปฏิบัติการที่จำกัดการเขียนไปยังโฟลเดอร์สถานะของโปรเจ็กต์และ ChipMate",
  ...
  "settings.display.fontSize.description": "ปรับขนาดฟอนต์ webview UI ของ ChipMate แยกเป็นอิสระจาก VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutChipMate.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง ChipMate ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",
  "settings.aboutChipMate.rooImport.description": "นำเข้าประวัติการสนทนาจากการติดตั้ง Roo Code",
  "settings.aboutChipMate.rooImport.button": "นำเข้าเซสชันจาก Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "แกนหลักขนาดเล็กและมีประสิทธิภาพเดียวกันในทุกผลิตภัณฑ์ ChipMate ประสบการณ์ที่คุ้นเคยไม่ว่าคุณจะเลือกทำงานอย่างไร",
  ...
  "diffViewer.source.session.tooltip":
    "ไฟล์ที่ ChipMate แก้ไขในช่วงเซสชันปัจจุบัน โดยอิงจากสแน็ปช็อตต่อเทิร์น จะรีเซ็ตเมื่อเริ่มเซสชันใหม่",
