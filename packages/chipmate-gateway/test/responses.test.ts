...
describe("Responses request sanitization", () => {
  test("strips item ids when storage is disabled", () => {
    ...
    const result = transformRequestBody("https://api.chipmate.ai/api/openrouter/responses", body)
  ...
  test("keeps item ids when storage is enabled", () => {
    ...
    expect(transformRequestBody("https://api.chipmate.ai/api/openrouter/responses", body)).toBe(body)
  })

  test("leaves non-responses requests unchanged", () => {
    const body = "not json"

    expect(transformRequestBody("https://api.chipmate.ai/api/openrouter/chat/completions", body)).toBe(body)
  })
  ...
  test("sanitizes responses and denies data collection in one transform", () => {
    ...
    const result = transformRequestBody("https://api.chipmate.ai/api/openrouter/responses", body, "deny")
  ...
  test("denies data collection for non-responses requests", () => {
    ...
    const result = transformRequestBody("https://api.chipmate.ai/api/openrouter/chat/completions", body, "deny")
