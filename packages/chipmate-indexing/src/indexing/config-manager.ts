...
export class CodeIndexConfigManager {
  ...
  private chipmateOptions?: { apiKey: string; baseUrl?: string; organizationId?: string }
  ...
  private applyInput(input: IndexingConfigInput): void {
    ...
    this.chipmateOptions = input.chipmateApiKey
      ? { apiKey: input.chipmateApiKey, baseUrl: input.chipmateBaseUrl, organizationId: input.chipmateOrganizationId }
      : undefined
  ...
  private captureSnapshot(): PreviousConfigSnapshot {
    return {
      ...
      chipmateApiKey: this.chipmateOptions?.apiKey ?? "",
      chipmateBaseUrl: this.chipmateOptions?.baseUrl ?? "",
      chipmateOrganizationId: this.chipmateOptions?.organizationId ?? "",
  ...
  public isConfigured(): boolean {
    ...
    if (provider === "chipmate")
      return !!(this.chipmateOptions?.apiKey && this.modelId && this.currentModelDimension && hasStore)
  ...
  doesConfigChangeRequireRestart(prev: PreviousConfigSnapshot): boolean {
    ...
    // Auth changes
    if ((prev.chipmateApiKey ?? "") !== (this.chipmateOptions?.apiKey ?? "")) return true
    if ((prev.chipmateBaseUrl ?? "") !== (this.chipmateOptions?.baseUrl ?? "")) return true
    if ((prev.chipmateOrganizationId ?? "") !== (this.chipmateOptions?.organizationId ?? "")) return true
  ...
  public getConfig(): CodeIndexConfig {
    return {
      ...
      dimensionMode: this.dimensionMode,
      chipmateOptions: this.chipmateOptions,
