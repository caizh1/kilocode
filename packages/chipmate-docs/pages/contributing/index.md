---
title: "Contributing"
description: "Contribute to ChipMate"
---

# Contributing Overview

{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [ChipMate-Org/chipmate](https://github.com/ChipMate-Org/chipmate)** (extension at `packages/chipmate-vscode`, CLI at `packages/opencode`). If you're looking to contribute to the extension or CLI, please head over to that repository.
{% /callout %}

ChipMate is an open-source project that welcomes contributions from developers of all skill levels. This guide will help you get started with contributing to ChipMate, whether you're fixing bugs, adding features, improving documentation, or sharing custom modes.

## Ways to Contribute

There are many ways to contribute to ChipMate:

1. **Code Contributions**: Implement new features or fix bugs
2. **Documentation**: Improve existing docs or create new guides
3. **Marketplace Contributions**: Create and share custom modes, skills, and MCP servers via the [ChipMate Marketplace](https://github.com/ChipMate-Org/chipmate-marketplace)
...
Before diving into the code, we recommend reviewing the [Architecture Overview](/docs/contributing/architecture) to understand how the different components of ChipMate fit together.
...
AI and coding agents are welcome in ChipMate contributions. Contributors still own the work they submit: you must personally understand the change, test it appropriately, be able to explain the diff, and understand how it interacts with the affected package and the rest of the repo.
...
- Run `bun run script/extract-source-links.ts` after adding or changing guarded URLs in `packages/chipmate-vscode/`, `packages/chipmate-vscode/webview-ui/`, or `packages/opencode/src/`.
...
- Use the root [TESTING.md](https://github.com/ChipMate-Org/chipmate/blob/main/TESTING.md) guide for backend/API validation with `bun dev serve` and `curl`-based requests.
...
2. Go to the [ChipMate repository](https://github.com/ChipMate-Org/chipmate)
...
## Contributing to the ChipMate Marketplace

The [ChipMate Marketplace](https://github.com/ChipMate-Org/chipmate-marketplace) is a community-driven repository of agent tooling that extends ChipMate's capabilities. You can contribute:
...
3. Submit a pull request to the [ChipMate Marketplace repository](https://github.com/ChipMate-Org/chipmate-marketplace)
...
When participating in the ChipMate community:

- Be respectful and inclusive
- Provide constructive feedback
- Help newcomers get started
- Follow the [Code of Conduct](https://github.com/ChipMate-Org/chipmate/blob/main/CODE_OF_CONDUCT.md)

## Getting Help

If you need help with your contribution:

- Join our [Discord community](https://chipmate.ai/discord) for real-time support
- Ask questions on [GitHub Discussions](https://github.com/ChipMate-Org/chipmate/discussions)
- Visit our [Reddit community](https://www.reddit.com/r/chipmate)

## Recognition

All contributors are valued members of the ChipMate community. Contributors are recognized in:

- Release notes
- The project's README
- The contributors list on GitHub

Thank you for contributing to ChipMate and helping make AI-powered coding assistance better for everyone!
