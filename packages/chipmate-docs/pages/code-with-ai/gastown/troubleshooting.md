...
**Fix:**
1. Check that the [ChipMate GitHub App](https://github.com/apps/chipmate-code) is installed on your repository
...
| Cause | Fix |
|---|---|
| GitHub App uninstalled | Reinstall at [github.com/apps/chipmate-code](https://github.com/apps/chipmate-code) |
...
3. **Contact support** — reach out at [chipmate.ai/discord](https://chipmate.ai/discord) with your town ID
