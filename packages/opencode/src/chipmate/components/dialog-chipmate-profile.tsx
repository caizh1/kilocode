/**
 * ChipMate Gateway Profile Dialog
 *
...
import type { ChipMateProfile, ChipMateBalance } from "@chipmate/chipmate-gateway"

interface DialogChipMateProfileProps {
  profile: ChipMateProfile
  balance: ChipMateBalance | null
  currentOrgId?: string | null
}

export function DialogChipMateProfile(props: DialogChipMateProfileProps) {
  ...
  const usageUrl = props.currentOrgId
    ? `https://app.chipmate.ai/organizations/${props.currentOrgId}/usage-details`
