...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "ChipMate Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "ChipMate Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "ChipMate",
  ...
  "kilocode:autocomplete.input.title": "ChipMate: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "ChipMate: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.commands.category": "ChipMate",
  "kilocode:autocomplete.codeAction.title": "ChipMate: Suggested Edits",
  "kilocode:autocomplete.chatParticipant.fullName": "ChipMate Agent",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "ChipMate Autocomplete has been paused because your account has no remaining credits. Add credits to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "ChipMate Autocomplete has been paused due to an authentication error. Please sign in again.",
}
