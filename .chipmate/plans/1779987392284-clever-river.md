...
## Findings
- Runtime colorization exists only in `frontend/src/main/kotlin/ai/chipmate/client/ui/SvgIconColorizer.kt`.
- The only production caller is `frontend/src/main/kotlin/ai/chipmate/client/session/scroll/ScrollButtonIcon.kt`.
...
- Other used frontend icons already have light/dark pairs:
  ...
  - `chipmate.svg` / `chipmate_dark.svg`
  - `chipmate-content.svg` / `chipmate-content_dark.svg`
  - `plus.svg` / `plus_dark.svg` exists, though no current direct source reference was found.
  - `chipmate@20x20.svg` / `chipmate@20x20_dark.svg` exists, though no current direct source reference was found.
...
2. Delete `frontend/src/main/kotlin/ai/chipmate/client/ui/SvgIconColorizer.kt` after confirming no callers remain.
...
6. Run the smallest relevant verification from `packages/chipmate-jetbrains/`:
   - `bun run typecheck` or `./gradlew typecheck`.

## Files Expected To Change
- `packages/chipmate-jetbrains/frontend/src/main/kotlin/ai/chipmate/client/session/scroll/ScrollButtonIcon.kt`
- `packages/chipmate-jetbrains/frontend/src/main/kotlin/ai/chipmate/client/session/ui/style/SessionUiStyle.kt`
- Delete `packages/chipmate-jetbrains/frontend/src/main/kotlin/ai/chipmate/client/ui/SvgIconColorizer.kt`
- Add `packages/chipmate-jetbrains/src/main/resources/META-INF/pluginIcon_dark.svg`
