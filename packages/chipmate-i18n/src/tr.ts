...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Daha fazla kullanım istatistiği için ",
  "provider.connect.chipmateGateway.byok.link": "ChipMate's Gateway üzerinden BYOK",
  "provider.connect.chipmateGateway.byok.suffix": " kullanın.",

  // Provider settings translations
  "settings.providers.group.recommended": "Önerilen",
  "settings.providers.note.chipmate": "500+ AI modeline erişim",
  ...
  "marketplace.install.about.mcp":
    "Bir MCP sunucusu, harici hizmetler veya yerel programlarla çalışmak için ChipMate'ya ek araçlar sağlar.",
  "marketplace.install.about.agent":
    "Bir ajan, kendi talimatları ve izinleri olan yeniden kullanılabilir bir rol ekler.",
  "marketplace.install.about.skill":
    "Bir yetenek, ChipMate'nun gerektiğinde yükleyebileceği göreve özel talimatlar ve kaynaklar ekler.",
  "marketplace.install.mcp.warning":
    "MCP sunucuları yerel komutları çalıştırabilir veya harici hizmetlere bağlanabilir. İzinleriniz otomatik olarak izin vermediği sürece ChipMate, araçlarını kullanmadan önce izin ister.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Bu proje için ChipMate anlık görüntülerini kapat. ChipMate değişiklikleri için geri alma/yeniden yapmayı kaybedersiniz, ancak git her şeyi izlemeye devam eder.",
  ...
  "marketplace.aligned.unpublish": "Skill yayından kaldır",
  "marketplace.aligned.unpublished": "Yayından kaldırıldı",
}
