...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Para más estadísticas de uso, utiliza ",
  "provider.connect.chipmateGateway.byok.link": "BYOK a través de ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recomendados",
  "settings.providers.note.chipmate": "Acceso a más de 500 modelos de IA",
  ...
  "marketplace.install.about.mcp":
    "Un servidor MCP proporciona a ChipMate herramientas adicionales para trabajar con servicios externos o programas locales.",
  "marketplace.install.about.agent": "Un agente añade un rol reutilizable con sus propias instrucciones y permisos.",
  "marketplace.install.about.skill":
    "Una habilidad añade instrucciones y recursos específicos para tareas que ChipMate puede cargar cuando sea necesario.",
  "marketplace.install.mcp.warning":
    "Los servidores MCP pueden ejecutar comandos locales o conectarse a servicios externos. ChipMate pedirá permiso antes de usar sus herramientas, a menos que tus permisos lo permitan automáticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Apaga las instantáneas de ChipMate para este proyecto. Perderás deshacer/rehacer de los cambios de ChipMate, pero git seguirá rastreando todo.",
  ...
  "marketplace.aligned.unpublish": "Retirar Skill",
  "marketplace.aligned.unpublished": "Retirado",
}
