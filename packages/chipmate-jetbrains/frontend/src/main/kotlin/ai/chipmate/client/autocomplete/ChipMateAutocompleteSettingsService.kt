package ai.chipmate.client.autocomplete
...
@State(
    name = "ChipMateAutocompleteSettings",
    storages = [Storage("chipmateAutocompleteSettings.xml")],
)
class ChipMateAutocompleteSettingsService : PersistentStateComponent<ChipMateAutocompleteSettingsService.State> {
    ...
    companion object {
        fun getInstance(): ChipMateAutocompleteSettingsService = service()
    }
}
