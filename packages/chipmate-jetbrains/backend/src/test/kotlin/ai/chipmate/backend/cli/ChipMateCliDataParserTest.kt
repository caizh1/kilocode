...
import ai.chipmate.rpc.dto.ChatEventDto
import ai.chipmate.rpc.dto.AgentConfigPatchDto
import ai.chipmate.rpc.dto.CompactionPatchDto
import ai.chipmate.rpc.dto.ConfigDto
import ai.chipmate.rpc.dto.ConfigPatchDto
import ai.chipmate.rpc.dto.ConfigUpdateDto
import ai.chipmate.rpc.dto.EditorContextDto
import ai.chipmate.rpc.dto.McpConfigDto
import ai.chipmate.rpc.dto.PermissionAlwaysRulesDto
import ai.chipmate.rpc.dto.PermissionReplyDto
import ai.chipmate.rpc.dto.PermissionRuleDto
import ai.chipmate.rpc.dto.ModelSelectionDto
import ai.chipmate.rpc.dto.ModelStateDto
import ai.chipmate.rpc.dto.PartSourceDto
import ai.chipmate.rpc.dto.PartSourceTextDto
import ai.chipmate.rpc.dto.PromptDto
import ai.chipmate.rpc.dto.PromptPartDto
import ai.chipmate.rpc.dto.QuestionReplyDto
import ai.chipmate.rpc.dto.SkillsPatchDto
import ai.chipmate.rpc.dto.WatcherPatchDto
...
/**
 * Pure unit tests for [ChipMateCliDataParser].
 *
 ...
 */
class ChipMateCliDataParserTest {
    ...
    inner class SseEvents {
        ...
        fun `extractEventType - parses type from JSON data`() {
            val result = ChipMateCliDataParser.extractEventType(
        ...
        fun `extractEventType - returns unknown for missing type`() {
            assertEquals("unknown", ChipMateCliDataParser.extractEventType("""{"data":"something"}"""))
        }

        @Test
        fun `extractEventType - returns unknown for empty string`() {
            assertEquals("unknown", ChipMateCliDataParser.extractEventType(""))
        }
        ...
        fun `parseChatEvent - message updated with GlobalEvent wrapper`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("message.updated", data)
        ...
        fun `parseChatEvent - message part delta`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("message.part.delta", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part updated`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("message.part.updated", data)
            assertNotNull(result)
        ...
        fun `ChatEventNormalizer - user part updated sanitizes text`() {
            val norm = ChipMateCliDataParser.ChatEventNormalizer()
        ...
        fun `parseChatEvent - todowrite part parses typed todo metadata`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("message.part.updated", data) as ChatEventDto.PartUpdated
        ...
        fun `parseChatEvent - turn open`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.turn.open", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - turn close`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.turn.close", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.error", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error preserves nested named error details`() {
            val data = globalEvent("""
                ...
                "properties": {
                    ...
                    "error": {
                        "name": "UnknownError",
                        "data": {
                            "message": "Cannot find module '@chipmate/plugin' from '/workspace/.opencode/tool/github-triage.ts'",
                            "ref": "err_123"
                        }
                    }
                }
            ...
            assertEquals("Cannot find module '@chipmate/plugin' from '/workspace/.opencode/tool/github-triage.ts'", result.error?.message)
        ...
        fun `parseChatEvent - message removed`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("message.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part removed`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("message.part.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session idle`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = ChipMateCliDataParser.parseChatEvent("session.idle", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session compacted`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = ChipMateCliDataParser.parseChatEvent("session.compacted", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session queue changed`() {
            ...
            """)
            val result = ChipMateCliDataParser.parseChatEvent("session.queue.changed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session updated`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session created`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.created", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.diff", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff clamps large counts`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.diff", data) as ChatEventDto.SessionDiffChanged
        ...
        fun `parseChatEvent - todo updated`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("todo.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session status idle`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("session.status", data) as ChatEventDto.SessionStatusChanged
        ...
        fun `parseChatEvent - permission asked`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("permission.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - permission replied`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("permission.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question asked`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("question.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question replied`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("question.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question rejected`() {
            ...
            val result = ChipMateCliDataParser.parseChatEvent("question.rejected", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - unknown type returns null`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            assertNull(ChipMateCliDataParser.parseChatEvent("some.unknown.event", data))
        }

        @Test
        fun `parseChatEvent - malformed JSON returns null`() {
            assertNull(ChipMateCliDataParser.parseChatEvent("message.updated", "not json"))
        }

        @Test
        fun `parseChatEvent - missing properties returns null`() {
            assertNull(ChipMateCliDataParser.parseChatEvent("message.updated", """{"payload":{"type":"x"}}"""))
        }
        ...
        fun `parseChatEvent - missing sessionID returns null`() {
            ...
            """)
            assertNull(ChipMateCliDataParser.parseChatEvent("message.updated", data))
        }
        ...
        fun `parseSessionStatus - valid status event`() {
            ...
            val result = ChipMateCliDataParser.parseSessionStatus(data)
            assertNotNull(result)
        ...
        fun `parseSessionStatus - missing sessionID returns null`() {
            ...
            assertNull(ChipMateCliDataParser.parseSessionStatus(data))
        }
        ...
        fun `parsePermissionRequests - parses list`() {
            ...
            val result = ChipMateCliDataParser.parsePermissionRequests(raw)
        ...
        fun `parsePermissionRequests - empty list`() {
            assertEquals(emptyList(), ChipMateCliDataParser.parsePermissionRequests("[]"))
        }
        ...
        fun `parseQuestionRequests - parses list`() {
            ...
            val result = ChipMateCliDataParser.parseQuestionRequests(raw)
            assertEquals(1, result.size)
    ...
    inner class HttpResponses {
        ...
        fun `parseConfig - local mcp server`() {
            val cfg = ChipMateCliDataParser.parseConfig(
        ...
        fun `parseConfig - disabled mcp form remains present`() {
            val cfg = ChipMateCliDataParser.parseConfig("""{"mcp":{"sample":{"enabled":false}}}""")
            val mcp = cfg.mcp["sample"]
        ...
        fun `parseConfig - scalars instructions and skills`() {
            val cfg = ChipMateCliDataParser.parseConfig(
                """{
                    ...
                    "skills":{"paths":[".chipmate/skills"],"urls":["https://example.test/skill.md"]}
                }"""
            )
            ...
            assertEquals(listOf(".chipmate/skills"), cfg.skills?.paths)
        ...
        fun `parseConfig - malformed body returns empty config`() {
            assertEquals(ConfigDto(), ChipMateCliDataParser.parseConfig("not json"))
            assertEquals(ConfigDto(), ChipMateCliDataParser.parseConfig("[]"))
        }
            ...
            val cfg = ChipMateCliDataParser.parseConfig(
                """{
                    ...
                    "mcp":{
                        "sample":{
                            "type":"local",
                            "command":["node",".chipmate/mcp/sample-server.js"],
                            "environment":{"TOKEN":"x"},
                            "enabled":true,
                            "timeout":12000
                        }
        ...
        fun `parseSession - full session response`() {
            ...
            val result = ChipMateCliDataParser.parseSession(raw)
        ...
        fun `parseMessages - empty array`() {
            assertEquals(emptyList(), ChipMateCliDataParser.parseMessages("[]"))
        }
        ...
        fun `parseMessages - user and assistant messages`() {
            ...
            val result = ChipMateCliDataParser.parseMessages(raw)
        ...
        fun `parseMessages - preserves synthetic and source metadata`() {
            ...
            val result = ChipMateCliDataParser.parseMessages(raw).single()
        ...
        fun `parseMessages - step finish part with tokens`() {
            ...
            val part = ChipMateCliDataParser.parseMessages(raw)[0].parts[0]
        ...
        fun `parseMessages - malformed JSON returns empty`() {
            assertEquals(emptyList(), ChipMateCliDataParser.parseMessages("not json"))
        }
        ...
        fun `parseCloudSessions maps cloud session list`() {
            ...
            val result = ChipMateCliDataParser.parseCloudSessions(raw)
        ...
        fun `parseCloudSessions tolerates malformed response`() {
            assertEquals(emptyList(), ChipMateCliDataParser.parseCloudSessions("not json").sessions)
            assertNull(ChipMateCliDataParser.parseCloudSessions("{}").nextCursor)
        }
        ...
        fun `parseProviders - maps provider id, name, source, connected, and defaults`() {
            ...
            val result = ChipMateCliDataParser.parseProviders(raw)
        ...
        fun `parseProviders - maps model capabilities, limit, and recommendedIndex`() {
            ...
            val provider = ChipMateCliDataParser.parseProviders(raw).providers[0]
        ...
        fun `parseProviders - maps model preview metadata`() {
            val raw = """{
                "all": [{
                    "id": "chipmate", "name": "ChipMate", "source": "api", "env": [], "options": {},
                    "models": {
                        "auto": {
                            "id": "auto",
                            "name": "ChipMate Auto",
            ...
            val model = ChipMateCliDataParser.parseProviders(raw).providers.single().models.getValue("auto")
        ...
        fun `parseProviders - malformed optional preview metadata is ignored`() {
            ...
            val model = ChipMateCliDataParser.parseProviders(raw).providers.single().models.getValue("m")
        ...
        fun `parseProviders - orders variants by effort rank then name`() {
            ...
            val model = ChipMateCliDataParser.parseProviders(raw).providers[0].models["m"]
            assertNotNull(model)
        ...
        fun `parseProviders - missing collections default to empty`() {
            val result = ChipMateCliDataParser.parseProviders("""{"all":[],"default":{},"connected":[]}""")
        ...
        fun `parseProviderSettingsProviders - preserves provider metadata and unknown fields`() {
            ...
            val result = ChipMateCliDataParser.parseProviderSettingsProviders(raw)
        ...
        fun `parseProviderSettingsProviders - malformed metadata becomes null`() {
            ...
            val provider = ChipMateCliDataParser.parseProviderSettingsProviders(raw).first.single()
        ...
        fun `parseProviders - throws for malformed JSON`() {
            assertFailsWith<Exception> {
                ChipMateCliDataParser.parseProviders("not json")
            }
        }
        ...
        fun `parseProviders - throws for non-object JSON`() {
            assertFailsWith<Exception> {
                ChipMateCliDataParser.parseProviders("""[1,2,3]""")
            }
        }
        ...
        fun `parseProviderAuth - maps structured select options`() {
            ...
            val prompt = ChipMateCliDataParser.parseProviderAuth(raw).getValue("azure").single().prompts.single()
        ...
        fun `parseCommands - maps name, description, source, and hints`() {
            ...
            val result = ChipMateCliDataParser.parseCommands(raw)
        ...
        fun `parseCommands - empty array`() {
            assertEquals(emptyList<CommandInfo>(), ChipMateCliDataParser.parseCommands("[]"))
        }
        ...
        fun `parsePathState - extracts state from valid path response`() {
            val raw = """{"home":"/home/user","state":"/home/user/.local/state/chipmate","config":"/home/user/.config/chipmate","worktree":"/project","directory":"/project"}"""
            assertEquals("/home/user/.local/state/chipmate", ChipMateCliDataParser.parsePathState(raw))
            assertEquals("/home/user/.config/chipmate", ChipMateCliDataParser.parsePathConfig(raw))
            assertEquals("/home/user", ChipMateCliDataParser.parsePathHome(raw))
        }

        @Test
        fun `parsePathState - returns null for missing state field`() {
            assertNull(ChipMateCliDataParser.parsePathState("""{"home":"/home/user"}"""))
        }

        @Test
        fun `parsePathState - returns null for malformed JSON`() {
            assertNull(ChipMateCliDataParser.parsePathState("not json"))
        }

        @Test
        fun `parsePathState - returns null for non-string state value`() {
            assertNull(ChipMateCliDataParser.parsePathState("""{"state":42}"""))
            assertNull(ChipMateCliDataParser.parsePathState("""{"state":null}"""))
            assertNull(ChipMateCliDataParser.parsePathState("""{"state":{}}"""))
        }
    }
    ...
    inner class RequestBuilders {
        ...
        fun `buildPromptJson - text only`() {
            ...
            val result = ChipMateCliDataParser.buildPromptJson(prompt)
        ...
        fun `buildProviderOAuthJson - numeric method index`() {
            val result = ChipMateCliDataParser.buildProviderOAuthJson("0", mapOf("deploymentType" to "github.com"))
        ...
        fun `buildCommandJson - file part includes source metadata`() {
            ...
            val result = ChipMateCliDataParser.buildCommandJson("review", "", prompt)
        ...
        fun `buildCommandJson - includes agent variant model and arguments`() {
            ...
            val result = ChipMateCliDataParser.buildCommandJson("review", "src/", prompt)

            assertEquals(
                """{"command":"review","arguments":"src/","agent":"code","variant":"high","model":"chipmate/gpt-5"}""",
                result,
            )
        }
        ...
        fun `buildSummarizeJson - writes provider and model`() {
            val result = ChipMateCliDataParser.buildSummarizeJson(ModelSelectionDto("anthropic", "claude-4"))
        ...
        fun `buildRevertJson - writes message only`() {
            val result = ChipMateCliDataParser.buildRevertJson("m1", null)
            assertEquals("""{"messageID":"m1"}""", result)
        }

        @Test
        fun `buildRevertJson - writes message and part`() {
            val result = ChipMateCliDataParser.buildRevertJson("m1", "p1")
            assertEquals("""{"messageID":"m1","partID":"p1"}""", result)
        }

        @Test
        fun `buildRevertJson - escapes ids`() {
            val result = ChipMateCliDataParser.buildRevertJson("m\"\\1", "p\"\\1")
        ...
        fun `buildConfigPartial - model only`() {
            val result = ChipMateCliDataParser.buildConfigPartial(ConfigUpdateDto(model = "anthropic/claude-4"))
            assertEquals("""{"model":"anthropic/claude-4"}""", result)
        }

        @Test
        fun `buildConfigPartial - agent and temperature`() {
            val result = ChipMateCliDataParser.buildConfigPartial(
        ...
        fun `buildConfigPartial - empty update`() {
            val result = ChipMateCliDataParser.buildConfigPartial(ConfigUpdateDto())
            assertEquals("{}", result)
        }
        ...
        fun `buildConfigPatch - top-level model set`() {
            ...
            assertEquals("{\"model\":\"anthropic/claude\"}", ChipMateCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - top-level model clear emits null`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to null))
            assertEquals("{\"model\":null}", ChipMateCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - small and subagent values`() {
            val patch = ConfigPatchDto(values = linkedMapOf("small_model" to "chipmate/auto-small", "subagent_model" to null, "subagent_variant" to null))
            assertEquals("{\"small_model\":\"chipmate/auto-small\",\"subagent_model\":null,\"subagent_variant\":null}", ChipMateCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - per-agent model set`() {
            val patch = ConfigPatchDto(agents = linkedMapOf("code" to AgentConfigPatchDto(model = "chipmate/gpt-5")))
            assertEquals("{\"agent\":{\"code\":{\"model\":\"chipmate/gpt-5\"}}}", ChipMateCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent model clear emits null`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"model\":null}}}", ChipMateCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent description patch does not clear model`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"description\":\"New description\"}}}", ChipMateCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - agent behavior top-level fields`() {
            val patch = ConfigPatchDto(
                ...
                skills = SkillsPatchDto(paths = listOf(".chipmate/skills"), urls = listOf("https://example.com/skill")),
            )

            assertEquals(
                "{\"default_agent\":\"build\",\"instructions\":[\"AGENTS.md\"],\"skills\":{\"paths\":[\".chipmate/skills\"],\"urls\":[\"https://example.com/skill\"]}}",
                ChipMateCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - full agent permission object`() {
            ...
            assertEquals(
                "{\"agent\":{\"custom\":{\"model\":\"chipmate/gpt-5\",\"mode\":\"primary\",\"hidden\":false,\"temperature\":0.2,\"top_p\":0.9,\"steps\":12,\"permission\":{\"bash\":{\"*\":\"ask\",\"npm test\":\"allow\"},\"read\":null}}}}",
                ChipMateCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - empty patch`() {
            assertEquals("{}", ChipMateCliDataParser.buildConfigPatch(ConfigPatchDto()))
        }

        @Test
        fun `buildConfigPatch - escapes special characters`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to "chipmate/a\\b\"c"))
            assertEquals("{\"model\":\"chipmate/a\\\\b\\\"c\"}", ChipMateCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPartial - temperature without agent defaults to ask`() {
            val result = ChipMateCliDataParser.buildConfigPartial(ConfigUpdateDto(temperature = 0.5))
        ...
        fun `buildPermissionReplyJson - once reply`() {
            val result = ChipMateCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once"))
            assertEquals("""{"reply":"once"}""", result)
        }

        @Test
        fun `buildPermissionReplyJson - always reply with message`() {
            val result = ChipMateCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "always", message = "approved"))
        ...
        fun `buildPermissionReplyJson - interactive reply serializes interactive true`() {
            ...
            val result = ChipMateCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once", interactive = true))
        ...
        fun `buildPermissionReplyJson - non-interactive reply omits the interactive field`() {
            val result = ChipMateCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once", interactive = false))
        ...
        fun `buildPermissionAlwaysRulesJson - approved list`() {
            val result = ChipMateCliDataParser.buildPermissionAlwaysRulesJson(
        ...
        fun `buildQuestionReplyJson - single question single answer`() {
            val result = ChipMateCliDataParser.buildQuestionReplyJson(QuestionReplyDto(answers = listOf(listOf("A"))))
            assertEquals("""{"answers":[["A"]]}""", result)
        }

        @Test
        fun `buildQuestionReplyJson - multiple questions`() {
            val result = ChipMateCliDataParser.buildQuestionReplyJson(
        ...
        fun `parseModelState - parses favorites`() {
            val result = ChipMateCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"chipmate","modelID":"auto"},{"providerID":"openai","modelID":"gpt"}]}""",
            )
            assertEquals(listOf("chipmate/auto", "openai/gpt"), result.favorite.map { "${it.providerID}/${it.modelID}" })
        }
        ...
        fun `parseModelState - parses model selections and variants`() {
            val result = ChipMateCliDataParser.parseModelState(
                """{"model":{"code":{"providerID":"chipmate","modelID":"auto"}},"variant":{"chipmate/auto":"medium"}}""",
            )
            assertEquals("chipmate", result.model["code"]?.providerID)
            assertEquals("auto", result.model["code"]?.modelID)
            assertEquals("medium", result.variant["chipmate/auto"])
        }

        @Test
        fun `parseModelState - drops malformed favorites`() {
            val result = ChipMateCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"chipmate"},false,{"providerID":"openai","modelID":"gpt"}]}""",
            )
        ...
        fun `parseModelState - malformed inputs return empty favorites`() {
            for (raw in listOf("", "not-json", "[]", "42", "null")) {
                assertTrue(ChipMateCliDataParser.parseModelState(raw).favorite.isEmpty(), raw)
            }
        }
        ...
        fun `parseModelState - drops malformed model selections and variants`() {
            val result = ChipMateCliDataParser.parseModelState(
                """{"model":{"bad":false,"ok":{"providerID":"chipmate","modelID":"auto"}},"variant":{"":"low","chipmate/auto":false,"openai/gpt":"high"}}""",
            )
        ...
        fun `buildModelStateJson - preserves unrelated keys and replaces favorites`() {
            val raw = """{"model":{"code":{"providerID":"chipmate","modelID":"auto"}},"recent":[{"providerID":"old","modelID":"recent"}],"variant":{"chipmate/auto":"fast"},"extra":true,"favorite":[]}"""
            val result = ChipMateCliDataParser.buildModelStateJson(raw, listOf(ModelSelectionDto("anthropic", "claude")))
            ...
            assertEquals(listOf("anthropic/claude"), ChipMateCliDataParser.parseModelState(result).favorite.map { "${it.providerID}/${it.modelID}" })
        }

        @Test
        fun `buildModelStateJson - writes model selections and variants`() {
            val raw = """{"recent":[],"extra":true}"""
            val result = ChipMateCliDataParser.buildModelStateJson(
                raw,
                ModelStateDto(
                    model = mapOf("code" to ModelSelectionDto("chipmate", "auto")),
                    variant = mapOf("chipmate/auto" to "medium"),
                    recent = listOf(ModelSelectionDto("anthropic", "claude")),
                ),
            )

            val state = ChipMateCliDataParser.parseModelState(result)
            assertEquals("auto", state.model["code"]?.modelID)
            assertEquals("medium", state.variant["chipmate/auto"])
    ...
    fun `sanitizeUserPromptText - removes read payload lines`() {
        ...
        assertEquals("before\nafter", ChipMateCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - preserves ordinary prose without path key`() {
        ...
        assertEquals(text, ChipMateCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - collapses only blanks introduced by payload removal`() {
        ...
        assertEquals("before\n\nafter\n\n\nkeep", ChipMateCliDataParser.sanitizeUserPromptText(text))
    }
