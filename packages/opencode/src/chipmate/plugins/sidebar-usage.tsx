...
import { fmtAttemptCost, fmtScore } from "@/chipmate/components/model-info-panel-utils"
import {
  aggregateMetrics,
  failed,
  formatCost,
  ...
  type StepMetrics,
  type UsageResult,
} from "@/chipmate/plugins/model-usage"
import { ModelRow, UsageRow } from "@/chipmate/plugins/sidebar-usage-row"

const id = "internal:chipmate-sidebar-usage"
...
function View(props: { api: TuiPluginApi; session_id: string }) {
  ...
  const [result, { refetch }] = createResource(
    ...
    (sessionID): Promise<UsageResult> =>
      props.api.client.chipmate.sessionModelUsage({ sessionID }).then(
