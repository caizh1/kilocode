import type { ChipmateSessionModelUsageResponse, Session, StepFinishPart } from "@chipmate/sdk/v2"

export type SessionModelUsage = ChipmateSessionModelUsageResponse
...
//
// When samples carry `elapsedMs` (chipmate_change: persisted on the
