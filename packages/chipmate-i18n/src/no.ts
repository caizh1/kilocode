...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "For mer bruksstatistikk, bruk ",
  ...
  "settings.providers.note.chipmate": "Tilgang til 500+ AI-modeller",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server gir ChipMate flere verktøy for å arbeide med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent legger til en gjenbrukbar rolle med egne instruksjoner og tillatelser.",
  "marketplace.install.about.skill":
    "En ferdighet legger til oppgavespesifikke instruksjoner og ressurser som ChipMate kan laste inn ved behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan kjøre lokale kommandoer eller koble til eksterne tjenester. ChipMate ber om tillatelse før verktøyene brukes, med mindre tillatelsene dine automatisk tillater det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå av ChipMates snapshots for dette prosjektet. Du mister angre/gjør om for ChipMate-endringer, men git fortsetter å spore alt.",
  ...
  "marketplace.aligned.unpublish": "Avpubliser Skill",
  "marketplace.aligned.unpublished": "Avpublisert",
}
