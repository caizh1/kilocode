...
import { ChipMateMemory } from "./index"
...
type ConfigureInput = ChipMateMemory.Input & {
  settings: Partial<Pick<MemorySchema.State, "autoConsolidate" | "verbose">>
}

type ApplyInput = ChipMateMemory.Input & {
...
type RememberInput = ChipMateMemory.Input & {
  text: string
  key?: string
...
type CorrectInput = ChipMateMemory.Input & {
  text: string
  key?: string
}

type ForgetInput = ChipMateMemory.Input & {
  query: string
}

type RecallInput = ChipMateMemory.Input & {
  query: string
  sessionID?: string
}
...
type RecordInput = ChipMateMemory.Input & {
  sessionID: string
  topic?: string
  summary: string
  time?: number
...
export namespace MemoryService {
  ...
  export interface Interface {
    readonly prepare: (input: ChipMateMemory.Input) => Effect.Effect<string, Failure>
    readonly status: (input: ChipMateMemory.Input) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.status>>, Failure>
    readonly show: (input: ChipMateMemory.Input) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.show>>, Failure>
    readonly enable: (input: ChipMateMemory.Input) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.enable>>, Failure>
    readonly disable: (
      input: ChipMateMemory.Input,
    ) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.disable>>, Failure>
    readonly rebuild: (
      input: ChipMateMemory.Input,
    ) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.rebuild>>, Failure>
    readonly configure: (
      input: ConfigureInput,
    ) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.configure>>, Failure>
    readonly apply: (input: ApplyInput) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.apply>>, Failure>
    readonly remember: (input: RememberInput) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.remember>>, Failure>
    readonly correct: (input: CorrectInput) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.correct>>, Failure>
    readonly forget: (input: ForgetInput) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.forget>>, Failure>
    readonly purge: (input: ChipMateMemory.Input) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.purge>>, Failure>
    readonly recall: (input: RecallInput) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.recall>>, Failure>
    ...
    readonly recordSession: (
      input: RecordInput,
    ) => Effect.Effect<Awaited<ReturnType<typeof ChipMateMemory.recordSession>>, Failure>
  ...
  export class Service extends Context.Service<Service, Interface>()("@chipmate/MemoryService") {}

  export function make() {
    const locks = new Map<SessionID, { sema: Semaphore.Semaphore; holders: number }>()
    let settle = IDLE_SETTLE_MS
    return Service.of({
      prepare: (input) => bridge(() => ChipMateMemory.prepare(input)),
      status: (input) => bridge(() => ChipMateMemory.status(input)),
      show: (input) => bridge(() => ChipMateMemory.show(input)),
      enable: (input) => bridge(() => ChipMateMemory.enable(input)),
      disable: (input) => bridge(() => ChipMateMemory.disable(input)),
      rebuild: (input) => bridge(() => ChipMateMemory.rebuild(input)),
      configure: (input) => bridge(() => ChipMateMemory.configure(input)),
      apply: (input) => bridge(() => ChipMateMemory.apply(input)),
      remember: (input) => bridge(() => ChipMateMemory.remember(input)),
      correct: (input) => bridge(() => ChipMateMemory.correct(input)),
      forget: (input) => bridge(() => ChipMateMemory.forget(input)),
      purge: (input) => bridge(() => ChipMateMemory.purge(input)),
      recall: (input) => bridge(() => ChipMateMemory.recall(input)),
      search: (input) => bridge(() => MemoryRecall.search(input)),
      recordSession: (input) => bridge(() => ChipMateMemory.recordSession(input)),
