export const defaultEndpoint = "https://supermassive-black-hole.chipmateapps.io/v1/session-export/batch"

const hosts = new Set(["supermassive-black-hole.chipmateapps.io"])
