...
const files = [
  "src/chipmate/cli/cmd/tui/feature-plugins/home/tips.ts",
  "src/cli/cmd/run.ts",
...
describe("ChipMate command branding", () => {
  test("user-facing command help uses the `chipmate` binary name", async () => {
