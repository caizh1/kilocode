 ...
 * [ai.chipmate.client.session.ui.style.SessionUiStyle.View.Tool.DIFF_MAX_LINES]. Building an editor
...
internal fun diffOverflowPanel(open: () -> Unit): JComponent {
    val message = JBLabel(ChipMateBundle.message("diff.overflow.message")).apply {
        foreground = UiStyle.Colors.weak()
    }
    val link = HyperlinkLabel(ChipMateBundle.message("diff.overflow.open")).apply {
