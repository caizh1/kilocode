 ...
 */
@Rpc
interface ChipMateSessionRpcApi : RemoteApi<Unit> {
    companion object {
        suspend fun getInstance(): ChipMateSessionRpcApi {
            return RemoteApiProviderService.resolve(remoteApiDescriptor<ChipMateSessionRpcApi>())
        }
    }
