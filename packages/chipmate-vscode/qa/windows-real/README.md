...
- optional `1.0.8` and ChipMate VSIX files for upgrade and coexistence lanes.
...
cd packages\chipmate-vscode\qa\windows-real
...
.\cli-startup-matrix.ps1 `
  -Cli C:\qa\installed-extension\bin\chipmate-arm64.exe `
