---
title: "Integrations"
description: "Overview of ChipMate integrations"
---

# ChipMate Integrations

ChipMate Integrations lets you connect GitHub or GitLab for repository workflows and DoltHub for Dolt-versioned data. Once connected, ChipMate can access authorized resources securely, enabling features like **Code Reviews**, **Cloud Agents**, **ChipMate Deploy**, and data workflows through **ChipMate Connect**.
...
- **Connect GitHub, GitLab, or DoltHub to ChipMate** in a few clicks
- **Enable advanced features** like Cloud Agents, Code Reviews, and ChipMate Deploy
- **Authorize GitHub or GitLab repository access** so ChipMate can analyze and work with your code
...
- For GitHub: You need permission to install GitHub Apps for the repositories you want ChipMate to access.
...
Go to your **Personal** or **Organization Dashboard**, and navigate to the [Integrations](https://app.chipmate.ai/integrations) tab.

### 2. Start the Connection Flow

1. Click **Configure** on the GitHub panel.
2. You'll be redirected to GitHub to authorize the **ChipMateConnect** App.
3. Select the GitHub account or organization you want to connect.

### 3. Choose Repository Access

GitHub will ask which repositories you want ChipMate to access:
...
- You'll return to the ChipMate Integrations page.
- GitHub will show a **Connected** status.
- Your ChipMate workspace can now access GitHub repositories securely.
...
1. Go to the **Integrations** page:
   - **Personal**: [app.chipmate.ai/integrations/gitlab](https://app.chipmate.ai/integrations/gitlab)
   - **Organization**: Your organization → Integrations → GitLab
2. Click **Connect GitLab**
3. Authorize the application on GitLab
4. You'll be redirected back to ChipMate with the connection active
...
2. Create a new application:
   - **Name**: `ChipMate`
   - **Redirect URI**: `https://app.chipmate.ai/api/integrations/gitlab/callback`
   - **Scopes**: `api`, `read_user`, `read_repository`, `write_repository`
   - **Confidential**: Yes
3. Copy the **Application ID** and **Secret**
4. In ChipMate, go to the GitLab integration page
...
> PAT tokens cannot be refreshed automatically. When your token expires, create a new one in GitLab and reconnect in ChipMate.
...
Use the DoltHub integration page to connect your DoltHub account. ChipMate uses this OAuth connection for [ChipMate Connect](/docs/code-with-ai/platforms/chipmate-connect) and as the default auth method for [Gas Town Wasteland](/docs/code-with-ai/gastown/wasteland).

1. Go to the **Integrations** page:
   - **Personal**: [app.chipmate.ai/integrations/dolthub](https://app.chipmate.ai/integrations/dolthub)
   - **Organization**: Your organization → Integrations → DoltHub
2. Click **Connect DoltHub**.
3. Approve ChipMate on DoltHub.
4. Return to ChipMate and confirm DoltHub shows a **Connected** status.

{% image src="/docs/img/integrations/dolthub/connect.png" alt="DoltHub integration page before OAuth connection" width="900" caption="DoltHub integration page in ChipMate" /%}

{% image src="/docs/img/integrations/dolthub/authorize.png" alt="DoltHub OAuth authorization screen for ChipMate" width="700" caption="DoltHub OAuth authorization screen" /%}
...
Once your integrations are connected, the following features are enabled in ChipMate:

### Cloud Agents

- Run ChipMate in the cloud from any device
...
- Deploy Next.js 14 & 15 apps directly from ChipMate
...
- Update which repositories ChipMate has access to
...
> Disconnecting from ChipMate does not revoke OAuth tokens on GitLab's side. You can manually revoke them from **GitLab → User Settings → Applications → Authorized Applications**.
...
- Disconnect DoltHub from ChipMate
...
Ensure the ChipMateConnect App is installed for the correct GitHub org and that repo access includes the repositories you need.
...
- **PAT**: Create a new token in GitLab and reconnect in ChipMate.
...
- Verify the redirect URI matches: `https://app.chipmate.ai/api/integrations/gitlab/callback`
