...
Audit Logs record key actions that occur in the management of your ChipMate seats, including user logins, adding or removing models, providers, and modes, and role changes.
...
Here is the list of all events included in the ChipMate audit logs:
