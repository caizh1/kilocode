...
const opencodeClient = process.env.CHIPMATE_CLIENT

afterEach(() => {
  if (otelResourceAttributes === undefined) delete process.env.OTEL_RESOURCE_ATTRIBUTES
  else process.env.OTEL_RESOURCE_ATTRIBUTES = otelResourceAttributes

  if (opencodeClient === undefined) delete process.env.CHIPMATE_CLIENT
  else process.env.CHIPMATE_CLIENT = opencodeClient
})
