...
import { ChipMateSessionOverflow } from "./overflow"

const SAFETY = 2048
const MIN_OUTPUT = 1024

export namespace ChipMateLLM {
  ...
  export function capOutputTokens(input: {
    ...
    usage?: ReturnType<typeof ChipMateSessionOverflow.measure>
    reported?: number
  }): number | undefined {
    ...
    const estimated =
      ...
      ChipMateSessionOverflow.measure({ messages: input.messages, tools: input.tools }).normalized
