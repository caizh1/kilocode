...
const DOCS = new Map<string, string[]>([
  [
    ...
    [
      "packages/chipmate-docs/pages/code-with-ai/features/task-todo-list.md:/docs/img/screenshot-tests/chipmate-vscode/visual-regression/chat/task-header-with-todos-chromium-linux.png",
    ],
  ],
  [
    "composite-webview--todo-write-docs-overview",
    [
      "packages/chipmate-docs/pages/code-with-ai/features/task-todo-list.md:/docs/img/screenshot-tests/chipmate-vscode/visual-regression/composite-webview/todo-write-docs-overview-chromium-linux.png",
    ],
  ],
  [
    "settings--agent-behaviour-workflows",
    [
      "packages/chipmate-docs/pages/customize/workflows.md:/docs/img/screenshot-tests/chipmate-vscode/visual-regression/settings/agent-behaviour-workflows-chromium-linux.png",
    ],
  ],
])
...
for (const story of stories) {
  test(`${story.title} / ${story.name}`, async ({ page }) => {
    ...
    await page.goto(
      `/iframe.html?id=${story.id}&viewMode=story&globals=colorScheme:dark;theme:chipmate-vscode;vscodeTheme:dark-modern`,
      { waitUntil: "load" },
    )
