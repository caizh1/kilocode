...
class MdViewHybridTest : BasePlatformTestCase() {
    ...
    fun `test prose inline code is styled without code chrome or editor`() {
        ...
        assertTrue(view.html().contains("<code style=\"color: $color\"><a class=\"chipmate-file-ref\" href=\"packages/opencode/src/session/prompt.ts\">packages/opencode/src/session/prompt.ts</a></code>"))
    ...
    fun `test prose file refs are styled as file links`() {
        ...
        assertTrue(html.contains("<a class=\"chipmate-file-ref\" href=\"packages/opencode/src/session/prompt.ts\">packages/opencode/src/session/prompt.ts</a>"))
        assertTrue(view.overrideSheet().contains("a.chipmate-file-ref, code a.chipmate-file-ref"))
    ...
    fun `test file ref links include line suffix and exclude punctuation`() {
        view.set("See chipmate/session/prompt.ts:302, native-plan-prompt.txt:37-38.")
        val html = view.html()

        assertTrue(html.contains("href=\"chipmate/session/prompt.ts:302\">chipmate/session/prompt.ts:302</a>,"))
    ...
    fun `test existing links are not nested as file refs`() {
        ...
        assertFalse(html.contains("chipmate-file-ref"))
    }
    ...
    fun `test fenced code file refs are not linkified`() {
        ...
        assertFalse(view.html().substringBefore("</pre>").contains("chipmate-file-ref"))
        assertTrue(htmls().single().text.contains("chipmate-file-ref"))
    }
    ...
    fun `test shell output renders plain text with semantic highlighters`() {
        val output = """
            ...
            e8b9785 Add second change
             packages/chipmate-jetbrains/frontend/src/main/kotlin/App.kt | 14 ++++++++++----
