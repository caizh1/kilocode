    ...
    fun reloadLocal() {
        ...
        cs.launch {
            try {
                ...
                edt { local.fail(e.message ?: ChipMateBundle.message("history.error.local")) }
            }
        }
    }
        ...
        edt {
            ...
            cs.launch {
                try {
                    ...
                    edt {
                        deleting.remove(item.id)
                        local.fail(e.message ?: ChipMateBundle.message("history.error.local.delete"))
                    }
                }
            }
        }
    ...
    fun rename(item: LocalHistoryItem, title: String) {
        ...
        cs.launch {
            try {
                ...
                edt { local.fail(e.message ?: ChipMateBundle.message("history.error.local.rename")) }
            }
        }
    }
    ...
    private fun loadCloud(reset: Boolean) {
        ...
        cs.launch {
            ...
            try {
                ...
                edt { cloud.fail(e.message ?: ChipMateBundle.message("history.error.cloud")) }
            }
        }
    }
