...
} from "@/chipmate/design-doc/product-contract"
import { productJSONSchema, validateProductSection } from "@/chipmate/design-doc/product-validator"
import { assertProductDocumentReaderSafe } from "@/chipmate/design-doc/product-document"
import type { WordSection } from "@/chipmate/documents/word"
...
describe("产品级详细设计 V2", () => {
  ...
  test("发布检查忽略不可见的内部图片路径但拒绝可见机器字段", () => {
    ...
    sections[2]!.blocks = [
      {
        type: "image",
        path: ".chipmate/artifacts/design-doc/work-items/WI-internal/render.png",
        altText: "总体结构图",
        caption: "总体结构图",
      },
    ]
