...
// chipmate_change start - report images rejected before native decode allocation
...
export interface Interface {
  readonly normalize: (
    ...
    ResizerUnavailableError | DecodeError | SizeError | PixelLimitError // chipmate_change
  >
}
