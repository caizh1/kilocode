...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Установите Anaconda Desktop на этом компьютере, затем вернитесь сюда. ChipMate не запускает установщик за вас.",
  ...
  "provider.anaconda.state.signedOut": "Откройте Anaconda Desktop и войдите в систему перед подключением ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate не удалось получить доступ к Anaconda Desktop. Откройте Desktop, войдите снова и при необходимости перезапустите его.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate обнаружил исправный локальный сервер генерации текста и может импортировать его текущие настройки подключения.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активный локальный сервер и модели актуальны в ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate не смог проверить доступные навыки.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate не смог проверить состояние сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Эта проверка требований агента больше не активна.",
  "agentRequirements.error.requestFailed": "ChipMate не смог проверить требования агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в ChipMate.",
  ...
  "prompt.panel.collapse": "Свернуть панель ввода",
  "prompt.panel.expand": "Развернуть панель ввода",
  "prompt.panel.collapsed": "Панель ввода свернута",
  "prompt.panel.responding": "Формируется ответ…",
  ...
  "prompt.action.sandbox.enabled": "Песочница включена. Команды оболочки агента ограничены каталогами проекта и ChipMate.",
  "prompt.action.sandbox.disabled":
    "Песочница отключена. Нажмите, чтобы ограничить запись команд оболочки агента каталогами проекта и ChipMate.",
  ...
  "prompt.action.sandbox.description.enabled": "Запись разрешена только в каталогах проекта и ChipMate.",
  ...
  "speechToText.tooltip.start": "Начать голосовой ввод с ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Войдите в ChipMate, чтобы использовать голосовой ввод.",
  ...
  "dialog.server.description": "Переключите сервер ChipMate к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия ChipMate ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде ChipMate",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что ChipMate пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения ChipMate",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как ChipMate выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление ChipMate.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске ChipMate",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию ChipMate.",
  ...
  "settings.indexing.chipmateModel.title": "Предустановка модели ChipMate",
  "settings.indexing.chipmateModel.description": "Выберите поддерживаемую модель эмбеддингов, размещенную в ChipMate.",
  "settings.indexing.chipmateSignIn.title": "Требуется вход в ChipMate",
  "settings.indexing.chipmateSignIn.description": "Войдите в ChipMate, чтобы использовать размещенные эмбеддинги.",
  ...
  "settings.providers.betaNotice":
    "В настоящее время в интерфейсе настроек можно настроить только провайдер ChipMate Gateway. Поддержка настройки других провайдеров скоро появится в период бета-тестирования. А пока вы можете настраивать провайдеров с помощью CLI или конфигурационного файла. Мы стремимся сохранить ChipMate открытым — без привязки к поставщикам.",
  ...
  "settings.models.hidePromptTraining.description":
    "Скрывать модели ChipMate Gateway, поставщики которых могут использовать ваши запросы для обучения.",
  ...
  "settings.config.title": "Открыть файл конфигурации ChipMate ({{scope}})",
  ...
  "settings.config.noWorkspace":
    "Откройте папку рабочей области для редактирования локального файла конфигурации ChipMate.",
  "settings.config.openFailed": "Не удалось открыть файл конфигурации ChipMate ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальная конфигурация XDG",
  "settings.config.source.homeChipMate": "Конфигурация .chipmate (Home)",
  "settings.config.source.homeOpencode": "Конфигурация .opencode (Home)",
  "settings.config.source.envFile": "Файл среды CHIPMATE_CONFIG",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "Встроенная конфигурация среды",
  "settings.config.source.projectChipMate": "Конфигурация .chipmate проекта",
  ...
  "workStyle.onboarding.welcome": "Добро пожаловать в ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate приостанавливается и показывает свой план по ходу работы.",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда chipmate import",
  ...
  "deviceAuth.title": "Войти в ChipMate",
  ...
  "profile.action.login": "Войти через ChipMate",
  ...
  "profile.pass.subscribe": "Оформите ChipMate Pass, чтобы добавить кредиты и получать бонусы",
  ...
  "settings.aboutChipMate.title": "О ChipMate",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "ChipMate — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutChipMate.status.connected": "Подключено",
  "settings.aboutChipMate.status.connecting": "Подключение...",
  "settings.aboutChipMate.status.disconnected": "Отключено",
  "settings.aboutChipMate.status.error": "Ошибка",
  ...
  "settings.aboutChipMate.versionInfo": "Информация о версии",
  "settings.aboutChipMate.version.label": "Версия:",
  "settings.aboutChipMate.extensionName": "Расширение ChipMate",
  "settings.aboutChipMate.community": "Сообщество и поддержка",
  "settings.aboutChipMate.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutChipMate.feedback.or": "или",
  "settings.aboutChipMate.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutChipMate.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutChipMate.resetSettings.button": "Сбросить все настройки",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutChipMate.exportSettings": "Экспорт",
  "settings.aboutChipMate.importSettings": "Импорт",
  "settings.aboutChipMate.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Файл не содержит допустимых настроек ChipMate.",
  "settings.aboutChipMate.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии ChipMate. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutChipMate.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutChipMate.telemetry.title": "Телеметрия",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса ChipMate. «Авто» использует язык отображения VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Включите голосовой ввод в полях запросов, используя вашу учетную запись ChipMate через ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Включите провайдер ChipMate и выполните вход, чтобы использовать Speech to Text. В настоящее время Speech to Text поддерживается только с ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Модель речи в текст",
  "settings.models.speechToTextModel.description": "Выберите модель транскрипции ChipMate Gateway для голосового ввода.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через ChipMate Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы ChipMate использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в chipmate.jsonc или попросите агента добавить их.",
  ...
  "settings.sandboxing.enabled.description":
    "Выполнять команды оболочки агента в песочнице на уровне ОС, которая ограничивает запись в каталоги состояния проекта и ChipMate",
  ...
  "settings.display.fontSize.description": "Настройте размер шрифта webview UI для ChipMate независимо от VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutChipMate.legacyMigration.description":
    "Перенос настроек из предыдущей установки ChipMate, включая API-ключи провайдеров и модель по умолчанию.",
  "settings.aboutChipMate.rooImport.description": "Импорт истории переписки из установки Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Импортировать сеансы из Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов ChipMate. Знакомый опыт независимо от выбранного способа работы.",
  ...
  "diffViewer.source.session.tooltip":
    "Файлы, изменённые ChipMate в текущей сессии, на основе снимков по ходу. Сбрасывается при начале новой сессии.",
