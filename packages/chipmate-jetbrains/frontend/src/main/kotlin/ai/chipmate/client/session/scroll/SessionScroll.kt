package ai.chipmate.client.session.scroll
...
internal class SessionScroll(
    ...
    init {
        jump = JBLabel(ScrollButtonIcon.create()).apply {
            ...
            toolTipText = ChipMateBundle.message("session.scroll.bottom")
            isVisible = false
    ...
    private fun syncIcon() {
        ...
        jump.toolTipText = ChipMateBundle.message(if (question) "session.scroll.question" else "session.scroll.bottom")
    }
