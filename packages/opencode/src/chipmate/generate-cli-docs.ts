...
const TABLE_PATH = root + "packages/chipmate-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/chipmate-docs/pages/code-with-ai/platforms/cli-reference.md"
...
// them here as well to keep chipmate.ai/docs in sync with the shipped binary.
