...
def render_dashboard(args: argparse.Namespace) -> str:
    ...
    lines.append("| Terminal / Agent Terminal | No terminal implementation change | Visible installed UX evidence remains pending |\n")
    ...
    lines.append("- Return visible Agent Terminal UX evidence from an installed VSIX run.\n")
