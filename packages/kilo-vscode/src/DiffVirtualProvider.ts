...
export class DiffVirtualProvider implements vscode.Disposable {
  ...
  constructor(private readonly extensionUri: vscode.Uri) {
    this.outputChannel = vscode.window.createOutputChannel("ChipMate Diff Virtual")
  }
  ...
  public open(diff: DiffVirtualFile): void {
    ...
    const panel = vscode.window.createWebviewPanel("chipmate.v2.DiffVirtualPanel", title, vscode.ViewColumn.One, {
      enableScripts: true,
