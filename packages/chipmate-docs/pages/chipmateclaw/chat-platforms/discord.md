---
title: "Discord"
description: "Use ChipMateClaw with Discord: setup, DM access control, and channel configuration"
---

# Discord

This page covers everything you need to use ChipMateClaw with Discord: connecting your bot, controlling who can DM it, and adding it to specific channels.

## Connecting ChipMateClaw to Discord

Create a bot in the Discord Developer Portal and link it to your ChipMateClaw dashboard.
...
2. Copy the token that appears and paste it into the **Discord Bot Token** field in your ChipMateClaw dashboard.

{% image src="/docs/img/chipmateclaw/discord.png" alt="Connect account screen" width="800" caption="Discord bot token entry" /%}

Enter the token in the Settings tab and click **Save**. You can remove or replace a configured token at any time.

## Redeploy to Apply Changes

After saving your token, click **Redeploy** (the yellow button at the top of the ChipMateClaw dashboard) to apply the changes. The server will restart in about 30–45 seconds. Wait for the redeploy to complete before pairing.
...
4. Return to [app.chipmate.ai/claw](https://app.chipmate.ai/claw) and confirm the pairing code and approve
5. You should now be able to chat with the bot from Discord

## Restricting ChipMateClaw to DMs Only (Just You)

By default, ChipMateClaw will respond to any DMs. To lock it down to only DMs with you:
...
## Adding ChipMateClaw to a Specific Discord Channel

By default, your ChipMateClaw will not respond in channels, even if added. To have ChipMateClaw participate in a specific channel:
