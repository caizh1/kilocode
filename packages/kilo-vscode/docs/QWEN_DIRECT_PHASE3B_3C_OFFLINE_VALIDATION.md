...
- `/kilo/fim`, `/kilo/edit`, `/v1/chat/completions`.
...
```json
{
  ...
  "kilo.autocomplete.qwen.context.importDefinitions.injectIntoPrompt": false,
  "kilo.autocomplete.qwen.context.rootPath.enabled": false,
  "kilo.autocomplete.qwen.context.rootPath.injectIntoPrompt": false,
...
when the rebuilt multifile prompt still exceeds budget; this is a qwen/Kilo
