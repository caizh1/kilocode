...
describe("getChatAutocompleteModel", () => {
  it("uses the matching FIM model for Next Edit settings", () => {
    expect(getChatAutocompleteModel("chipmate", "inception/mercury-next-edit").id).toBe("chipmate/inception/mercury-edit-2")
  ...
  it("keeps FIM settings unchanged", () => {
    expect(getChatAutocompleteModel("chipmate", "mistralai/codestral-2508").id).toBe("chipmate/mistralai/codestral-2508")
  })
})
