...
export namespace ChipMateCostPropagation {
  /**
   ...
   */
  export const childCost = Effect.fn("ChipMateCostPropagation.childCost")(function* (
   ...
   */
  export const propagate = Effect.fn("ChipMateCostPropagation.propagate")(function* (
    sessions: Session.Interface,
    sid: SessionID,
    mid: MessageID,
    amount: number,
