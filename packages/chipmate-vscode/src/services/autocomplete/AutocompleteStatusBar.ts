...
export class AutocompleteStatusBar {
  ...
  private init() {
    this.statusBar.text = t("chipmate:autocomplete.statusBar.enabled")
    this.statusBar.tooltip = this.createMarkdownTooltip(t("chipmate:autocomplete.statusBar.tooltip.basic"))
    this.statusBar.show()
  }
  ...
  private renderDefault() {
    ...
    const snoozedSuffix = this.props.snoozed ? ` (${t("chipmate:autocomplete.statusBar.snoozed")})` : ""
    this.statusBar.text = `${t("chipmate:autocomplete.statusBar.enabled")} (${this.props.completionCount})${snoozedSuffix}`

    this.statusBar.tooltip = this.createMarkdownTooltip(
      [
        t("chipmate:autocomplete.statusBar.tooltip.completionSummary", {
        ...
        this.props.model && this.props.provider
          ? t("chipmate:autocomplete.statusBar.tooltip.providerInfo", {
  ...
  private renderNoUsableProviderError() {
    this.statusBar.text = t("chipmate:autocomplete.statusBar.warning")
    this.statusBar.tooltip = this.createMarkdownTooltip(
      t("chipmate:autocomplete.statusBar.tooltip.noUsableProvider", {
