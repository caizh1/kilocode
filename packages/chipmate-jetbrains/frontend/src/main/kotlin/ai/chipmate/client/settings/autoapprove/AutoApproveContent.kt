...
internal class AutoApproveContent(
    ...
    private val tools = SettingsInlineList(
        empty = ChipMateBundle.message("settings.autoApprove.tools.empty"),
    ...
    init {
        ...
        section(ChipMateBundle.message("settings.autoApprove.title")).row(tools)
    }
    ...
    private fun granularSection(tool: String, kind: ExceptionKind): GranularToolSection {
        ...
        return GranularToolSection(
            tool,
            ChipMateBundle.message("settings.autoApprove.tool.$tool"),
            ChipMateBundle.message("settings.autoApprove.wildcardLabel.$wildcardKey"),
            ChipMateBundle.message("settings.autoApprove.filters.empty.$emptyKey"),
            ChipMateBundle.message("settings.autoApprove.$addKey"),
            ChipMateBundle.message("settings.autoApprove.$placeholderKey"),
            picker,
    ...
    private fun toolRow(draft: PermissionDraft, tool: String) = PermissionListRow(
        ...
        description = ChipMateBundle.message("settings.autoApprove.tool.$tool"),
    ...
    private fun groupedRow(draft: PermissionDraft) = PermissionListRow(
        ...
        description = ChipMateBundle.message("settings.autoApprove.tool.todoreadwrite"),
