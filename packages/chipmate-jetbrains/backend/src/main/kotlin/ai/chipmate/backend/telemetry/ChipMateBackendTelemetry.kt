...
class ChipMateBackendTelemetry(
    private val log: ChipMateLog = ChipMateLog.create(ChipMateBackendTelemetry::class.java),
) {
    companion object {
    ...
    private fun base(): Map<String, JsonPrimitive> =
        ChipMateLog.payload(log).mapValues { JsonPrimitive(it.value) }
}
