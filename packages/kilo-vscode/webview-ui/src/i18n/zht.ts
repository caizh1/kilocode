...
export const dict = {
  ...
  "settings.aboutKiloCode.title": "關於 ChipMate",
  ...
  "settings.aboutKiloCode.extensionName": "ChipMate 擴充功能",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "檔案不包含有效的 ChipMate 設定。",
  "settings.aboutKiloCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此檔案由較新版本的 ChipMate 匯出。部分設定可能會被忽略。",
  ...
  "settings.indexing.kiloModel.title": "ChipMate 模型預設",
  "settings.indexing.kiloModel.description": "選擇支援的 ChipMate 託管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登入 ChipMate",
  "settings.indexing.kiloSignIn.description": "登入 ChipMate 以使用託管嵌入。",
