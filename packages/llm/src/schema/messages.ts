import { Schema, SchemaGetter } from "effect" // chipmate_change
...
export { StoredToolContent } from "@opencode-ai/schema/llm" // chipmate_change - shared with the durable event schema

// chipmate_change start - ChipMate keeps a tolerant tool-result value union
