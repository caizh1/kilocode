...
object ChipMatePluginSettings {
    private const val AUTO_APPROVE_KEY = "chipmate.session.autoApprove"
    private const val AUTO_EDITOR_CONTEXT_KEY = "chipmate.session.autoEditorContext"
    private const val PERMISSION_RULES_EXPANDED_KEY = "chipmate.session.permissionRulesExpanded"
