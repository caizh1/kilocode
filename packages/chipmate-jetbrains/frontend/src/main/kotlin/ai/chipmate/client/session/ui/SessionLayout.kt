...
class SessionLayout(
     ...
     * [ai.chipmate.client.session.views.TurnView.isValidateRoot]) can be re-validated independently
...
open class SessionLayoutPanel(
     ...
     *
     * A validate root, such as a settled [ai.chipmate.client.session.views.TurnView], can be laid out
