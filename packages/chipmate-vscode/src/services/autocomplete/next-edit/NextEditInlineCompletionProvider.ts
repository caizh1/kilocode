...
const INLINE_COMPLETION_ACCEPTED_COMMAND = "chipmate.v2.autocomplete.nextEdit.accepted"
const DEFAULT_DEBOUNCE_MS = 250

export interface NextEditProviderDeps {
  /** Routes Mercury calls through the local ChipMate gateway (handles auth + BYOK). */
  connectionService: ChipMateConnectionService
  /** Optional source of recently-viewed snippets (chipmate's VisibleCodeTracker can adapt to this). */
