/** Provider id and `chipmate.json` key (see https://atomic.chat and models.dev). */
...
export const LOG_PREFIX = "[@chipmate/plugin-atomic-chat]" as const

export const ATOMIC_CHAT_PLUGIN = "@chipmate/plugin-atomic-chat" as const
