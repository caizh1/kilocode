...
internal class BranchChangesBadge(
    ...
    init {
        ...
        toolTipText = ChipMateBundle.message("diff.editor.branch.tooltip")
        getAccessibleContext().accessibleName = ChipMateBundle.message("diff.editor.branch.tooltip")
    ...
    fun update(next: List<DiffFileDto>): Boolean {
        ...
        val text = ChipMateBundle.message(
    ...
    private companion object {
        const val ACTIVATE = "chipmate.branch.changes.activate"
    }
}
