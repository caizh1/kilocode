...
import { RecallPartIndex } from "../chipmate/session/recall-part-index" // chipmate_change
...
export const SessionTable = sqliteTable(
  "session",
  {
    ...
    // chipmate_change - ChipMate also persists a workspace restore status on the revert record
...
export const PartTable = sqliteTable(
  ...
  (table) => [
    ...
    RecallPartIndex.make(table), // chipmate_change
  ],
)
...
export const SessionMessageTable = sqliteTable(
  "session_message",
  {
    ...
    seq: integer(), // chipmate_change - allow released clients to share databases with newer schemas
    ...Timestamps,
