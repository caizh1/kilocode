---
title: "Code with AI"
description: "Learn how to code with AI using ChipMate across different platforms and interfaces"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
ChipMate is your AI pair programmer that works in your IDE, terminal, or browser. Generate code, refactor, debug, and ship faster with AI that understands your codebase and context.
{% /callout %}

## Getting Started

New to ChipMate? Start here to understand the core concepts:

- [**Install ChipMate**](/docs/getting-started/installing) — Get started in VS Code, JetBrains, CLI, or mobile
...
Use ChipMate wherever you work:
...
- [**Cloud Agent**](/docs/code-with-ai/platforms/cloud-agent) — Run ChipMate in the cloud
- [**Mobile Apps**](/docs/code-with-ai/platforms/mobile) — iOS and Android support
- [**Slack**](/docs/code-with-ai/platforms/slack) — Chat with ChipMate in your workspace
- [**App Builder**](/docs/code-with-ai/app-builder) — Create full-stack applications with AI

## Working with Agents

ChipMate uses specialized agents to help with different tasks:
...
- Explore [**Customize**](/docs/customize) to tailor ChipMate to your workflow
