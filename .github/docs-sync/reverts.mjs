...
/**
 * Parse revert targets from a PR body. `defaultRepo` ("ChipMate-Org/chipmate") resolves bare `#N`.
 ...
 * e.g. `Reverts #12249 and #12481.`, `Reverts ChipMate-Org/cloud#42.`, comma-separated lists,
