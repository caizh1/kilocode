...
description: "How ChipMateClaw instances are structured"
---

# Architecture Notes

For advanced users — how ChipMateClaw instances are structured:
...
- **Network isolation** — OpenClaw binds to loopback only; external traffic is proxied through a ChipMate controller.
