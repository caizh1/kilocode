...
@Rpc
interface ChipMateAgentBehaviorRpcApi : RemoteApi<Unit> {
    companion object {
        suspend fun getInstance(): ChipMateAgentBehaviorRpcApi {
            return RemoteApiProviderService.resolve(remoteApiDescriptor<ChipMateAgentBehaviorRpcApi>())
        }
    }
