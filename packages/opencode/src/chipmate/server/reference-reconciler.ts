...
import { ReferenceReconciler } from "@opencode-ai/server/chipmate/reference-reconciler"
...
const reconcile = Effect.gen(function* () {
  ...
  return Effect.gen(function* () {
    ...
    yield* (yield* PluginV2.Service).wait(PluginV2.ID.make("core/config-reference")) // chipmate_change
