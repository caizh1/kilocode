...
import { kitty, sequences } from "../../src/chipmate/cli/cmd/tui/util/terminal"

const keys = ["TERM_PROGRAM", "MSYSTEM", "CHIPMATE_DISABLE_KITTY_KEYBOARD", "CHIPMATE_ENABLE_KITTY_KEYBOARD"] as const
...
test("allows explicitly enabling Kitty keyboard", () => {
  env({ CHIPMATE_ENABLE_KITTY_KEYBOARD: "1", MSYSTEM: "MINGW64" })
...
test("allows explicitly disabling Kitty keyboard", () => {
  env({ CHIPMATE_DISABLE_KITTY_KEYBOARD: "1", CHIPMATE_ENABLE_KITTY_KEYBOARD: "1" })
...
test("resets common terminal input modes", () => {
  env({ CHIPMATE_DISABLE_KITTY_KEYBOARD: "1" })
