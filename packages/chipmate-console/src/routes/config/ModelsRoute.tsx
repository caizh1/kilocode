...
import { IconButton } from "@chipmate/chipmate-web-ui/icon-button"
import type { Model } from "@chipmate/sdk/v2/client"
  ...
  return (
    <Show when={state.snap()}>
      <ConfigPage
        ...
        description="The models ChipMate uses when an agent or command doesn't pin its own."
      >
        ...
        <Card class="ui-card" padding={0}>
          <header class="ui-card-header">
            <div>
              ...
              <p>Control which ChipMate Gateway models appear in model lists.</p>
            </div>
          ...
          <div class="ui-form">
            ...
            >
              <span>
                ...
                <small>Hide ChipMate Gateway models whose providers may use your prompts for training.</small>
            ...
            <Show when={state.gateway()}>
              <div class="models-privacy-filter-group">
                ...
                <button
                  ...
                  type="button"
                  aria-label="Hide ChipMate Gateway models whose providers may use prompts for training"
