 ...
 *
 * Minimal inline port of `@chipmate/chipmate-chat/client` (cloud monorepo)
 * tailored to what the TUI needs. The chipmate-chat worker validates payloads
...
export class ChipMateChatApiError extends Error {
  constructor(
    ...
    super(`ChipMateChat request failed: ${status}${formatBodyDetail(body)}`)
