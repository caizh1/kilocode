...
export namespace ChipMateSessionRevert {
  ...
  export const apply = Effect.fn("ChipMateSessionRevert.apply")(function* <A, E, R>(
  ...
  export const restore = Effect.fn("ChipMateSessionRevert.restore")(function* (
    snap: Snapshot.Interface,
    hash: string,
    files: string[],
  ) {
