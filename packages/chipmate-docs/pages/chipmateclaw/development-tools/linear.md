...
description: "Connect Linear to your ChipMateClaw agent to create and manage issues automatically"
---

# Linear Integration

Connect Linear to your ChipMateClaw agent so it can create issues, update their status, read project backlogs, and track work — all automatically. Linear is a project management tool popular with software teams for planning and tracking features, bugs, and tasks.
...
- A **Linear account** with access to the workspace you want ChipMateClaw to use
...
4. Click **Create key**
5. Give the key a descriptive label (for example, `chipmateclaw-bot`) and click **Create**
...
Once connected, your ChipMateClaw agent can interact with Linear on your behalf:
