...
/**
 * ChipMate-specific home footer plugin.
 *
...
import { RemoteIndicator } from "@/chipmate/remote-tui"

const id = "internal:chipmate-home-footer"

// ---------------------------------------------------------------------------
// Sub-components (mirror upstream home/footer with chipmate additions)
// ---------------------------------------------------------------------------
...
function View(props: { api: TuiPluginApi }) {
  const chipmate = createMemo(() => props.api.state.provider.some((p) => p.id === "chipmate"))
