...
import { formatTable, formatMarkdown, handle, isTextModel, outputLimit } from "../../../src/chipmate/cli/cmd/roll-call"
...
describe("formatTable", () => {
  test("formats simple table correctly", () => {
    const rows = [
      ["chipmate/test-model", "YES", "Hello!", "1000ms"],
      ["chipmate/another-model", "NO", "(Error)", "500ms"],
    ]
