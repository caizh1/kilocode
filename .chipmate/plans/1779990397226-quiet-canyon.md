...
- The relevant files are `packages/chipmate-jetbrains/frontend/src/main/kotlin/ai/chipmate/client/session/SessionUi.kt`, `.../scroll/SessionScroll.kt`, `.../views/question/QuestionView.kt`, `.../views/permission/PermissionView.kt`, `.../views/LoginRequiredView.kt`, `.../views/base/BaseQuestionView.kt`, and `frontend/src/test/kotlin/ai/chipmate/client/session/SessionScrollTest.kt`.
...
- From `packages/chipmate-jetbrains/`, run `./gradlew test --tests "ai.chipmate.client.session.SessionScrollTest"`.
- From `packages/chipmate-jetbrains/`, run `./gradlew typecheck`.
