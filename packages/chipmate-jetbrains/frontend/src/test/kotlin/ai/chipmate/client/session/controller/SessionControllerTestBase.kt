...
/**
 * Base class for [ai.chipmate.client.session.controller.SessionController] tests.
 *
...
abstract class SessionControllerTestBase : BasePlatformTestCase() {
    ...
    protected data class Snapshot(
        ...
        val diff: List<ai.chipmate.rpc.dto.DiffFileDto>,
        val todos: List<ai.chipmate.rpc.dto.TodoDto>,
        val compacted: Int,
    ) {
    ...
    protected lateinit var sessions: ChipMateSessionService
    protected lateinit var app: ChipMateAppService
    protected lateinit var workspaces: ChipMateWorkspaceService
    ...
    override fun setUp() {
        ...
        app = ChipMateAppService(scope, appRpc)
        workspaces = ChipMateWorkspaceService(scope, projectRpc)
    ...
    protected fun controller(
        ...
        val m = SessionController(
            ...
            timers = timers,
            log = log ?: ChipMateLog.create(SessionController::class.java),
        )
        controllers.add(m)
        roots[m] = root
        return m
    ...
    protected fun assertQuestionReply(expected: String, replies: List<Triple<String, String, ai.chipmate.rpc.dto.QuestionReplyDto>>) {
    ...
    protected fun workspaceReady(
        ...
        connected: List<String> = listOf("chipmate"),
        defaults: Map<String, String> = emptyMap(),
    ) = ChipMateWorkspaceStateDto(
