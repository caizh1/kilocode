...
import type { BrowserSettings, Config, FeatureFlags, IndexingStatus, ChipMateEmbeddingModelCatalog } from "./config"
import type { WorkStyle, WorkStyleState } from "../../../../src/shared/work-style-presets"
import type { ChipMateNotification, ProfileData } from "./profile"
import type {
...
export interface SelectChipMateModelMessage {
  type: "selectChipMateModel"
  modelID?: string
  agent?: string
}
...
export interface ChipMateEmbeddingModelsLoadedMessage {
  type: "chipmateEmbeddingModelsLoaded"
  catalog: ChipMateEmbeddingModelCatalog
}
...
export type ExtensionMessage =
  ...
  | ChipMateEmbeddingModelsLoadedMessage
