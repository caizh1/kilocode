/**
 * Conversation selector for the ChipMateClaw chat.
 *
...
export function DialogConversationList(props: Props) {
  ...
  return (
    <DialogSelect
      title="ChipMateClaw Conversations"
      options={options()}
      ...
      actions={[
        ...
        {
          command: "chipmateclaw.conversation.new",
          title: "new",
          side: "right",
          onTrigger: async () => {
      ...
      bindings={[{ key: "ctrl+n", cmd: "chipmateclaw.conversation.new" }]}
    />
  )
}
