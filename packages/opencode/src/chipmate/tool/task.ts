...
export namespace ChipMateTask {
  ...
  /** ChipMate keeps delegation one level deep, except for the internal Code baseline author. */
   ...
   * ChipMate intentionally differs: parent denials remain hard ceilings for Plan Mode
  ...
  const saved = Effect.fn("ChipMateTask.savedModel")(function* (name: string) {
    if (Flag.CHIPMATE_CLIENT !== "cli") return undefined
  ...
  export const resolveModel = Effect.fn("ChipMateTask.resolveModel")(function* (input: {
    name: string
