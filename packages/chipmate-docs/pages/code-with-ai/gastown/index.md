---
title: "Gas Town by ChipMate"
description: "Autonomous AI agent orchestration for your codebase"
---

# {% $markdoc.frontmatter.title %}

Gastown by ChipMate is an autonomous agent orchestration platform that manages teams of AI agents working on your codebase. Built on [Gastown](https://github.com/gastownhall/gastown) — the open protocol for agent orchestration — ChipMate's implementation coordinates coding agents, a code review agent, and a conversational coordinator to ship features, fix bugs, and maintain your projects with minimal human intervention.
...
{% browserFrame url="app.chipmate.ai/gastown/town" caption="A Gas Town with active agents, convoy progress, and Mayor chat" %}
...
{% browserFrame url="app.chipmate.ai/gastown/town/rigs/main" caption="A staged convoy ready to be kicked off" %}
...
{% browserFrame url="app.chipmate.ai/gastown/town/rigs/main" caption="Agents working on a convoy — beads flowing through the pipeline" %}
...
{% browserFrame url="app.chipmate.ai/gastown/town/beads" caption="The beads page — all work items with status, type, and history" %}
...
{% browserFrame url="app.chipmate.ai/gastown/town/rigs/main" caption="Staged convoy detail — review the plan before agents start" %}
