...
export const DEFAULT_CLOUD_AGENT_ORIGIN = "https://cloud-agent-next.chipmatesessions.ai"
export const DEFAULT_WEB_APP_ORIGIN = "https://chipmate.ai"
...
export function resolveWebAppOrigin(env: CloudEnvironment = process.env) {
  const value = env.CHIPMATE_WEB_APP_URL
