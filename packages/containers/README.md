...
- `jetbrains`: `bun-node` plus Java 21, JBR font libraries, and pre-cached Gradle and Bun packages <!-- chipmate_change -->
...
```
REGISTRY=ghcr.io/chipmate-org TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/chipmate-org TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/chipmate-org/build/bun-node:24.04
```
