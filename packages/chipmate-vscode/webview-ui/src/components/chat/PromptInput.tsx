...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  window.addEventListener("chipmate:prepare-mermaid-repair", prepareMermaid)
  onCleanup(() => window.removeEventListener("chipmate:prepare-mermaid-repair", prepareMermaid))
  ...
  window.addEventListener("chipmate:prepare-plantuml-repair", preparePlantUml)
  onCleanup(() => window.removeEventListener("chipmate:prepare-plantuml-repair", preparePlantUml))
