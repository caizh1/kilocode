...
const mainNavItems: NavItem[] = [
  ...
  { label: "ChipMate Gateway", href: "/gateway" },
  { label: "ChipMateClaw", href: "/chipmateclaw" },
  { label: "Contributing", href: "/contributing" },
]

const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to ChipMate" },
  {
    label: "Code of Conduct",
    href: "https://github.com/ChipMate-Org/chipmate?tab=coc-ov-file",
    description: "Our community guidelines",
  },
  { label: "GitHub Repository", href: "https://github.com/ChipMate-Org/", description: "View source and issues" },
  { label: "Discord Community", href: "https://chipmate.ai/discord", description: "Join our community" },
]
...
const helpItems: DropdownItem[] = [
  ...
  { label: "Support", href: "https://chipmate.ai/support", description: "Get help from the team" },
  {
    label: "Changelog",
    href: "https://github.com/ChipMate-Org/chipmate/releases",
...
function preview(url: string) {
  ...
  if (value.hostname !== "chipmate.ai" || !value.pathname.startsWith("/docs")) return url
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">ChipMate</span>
        ...
        <div className="right-actions">
          ...
          <ThemeToggle />
          <Link href="https://chipmate.ai/github" className="github-link desktop-nav">
            GitHub
          </Link>
          <Link href="https://app.chipmate.ai" className="signin-btn desktop-nav">
            Sign in
          </Link>
        </div>
      </div>
      ...
      <div className="announcement-banner">
        <p>
          The all-new ChipMate extension is here, rebuilt on the{" "}
          <Link href="/code-with-ai/platforms/vscode/whats-new">ChipMate CLI</Link> for speed, flexibility, and continued
          access to 500+ models via the ChipMate Gateway →
        </p>
      </div>
