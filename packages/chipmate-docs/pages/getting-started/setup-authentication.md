...
description: "Configure ChipMate and connect to your AI providers"
---

# Authentication

When you install ChipMate, you'll be prompted to sign in or create a free account. This automatically configures everything you need to get started.

## Quick Start with ChipMate Account

{% tabs %}
{% tab label="VS Code" %}

The extension prompts you to sign in when you first open ChipMate in VS Code. Click **Sign In** and complete the browser-based flow. Sign-in applies across extension surfaces, including the sidebar and Agent Manager.
...
[Add credits to your account](https://app.chipmate.ai/profile), or sign up for [ChipMate Pass](https://chipmate.ai/pricing/chipmate-pass).
{% /callout %}

## ChipMate Gateway API Key

If you're using the [ChipMate AI Gateway](/docs/gateway/) outside of the ChipMate extension (for example, with the Vercel AI SDK or OpenAI SDK), you'll need an API key:

1. Go to [app.chipmate.ai](https://app.chipmate.ai)
...
If you prefer to use your own API key or existing subscription, ChipMate supports **over 30 providers**. Here are some popular options to get started:
...
These are just a few examples! ChipMate supports many more providers including Google Gemini, DeepSeek, Mistral, Ollama (for local models), AWS Bedrock, Google Vertex, and more. See the complete list at [AI Providers](/docs/ai-providers/).
{% /callout %}

### ChatGPT Plus/Pro Subscription

Already have a ChatGPT subscription? You can use it with ChipMate through the [OpenAI ChatGPT provider](/docs/ai-providers/openai-chatgpt-plus-pro)—no API key needed.
...
These settings apply across the extension, including the sidebar and Agent Manager. Agent Manager does not need separate provider or ChipMate CLI authentication setup.
...
Or use `chipmate auth login` for providers that support OAuth, such as GitHub Copilot or ChatGPT Plus/Pro.
...
Reach out to our [support team](mailto:hi@chipmate.ai) or join our [Discord community](https://chipmate.ai/discord).
{% /callout %}
