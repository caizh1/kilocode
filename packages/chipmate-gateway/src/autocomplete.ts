export type AutocompleteProviderID = "chipmate" | "mistral" | "inception"
export type DirectAutocompleteProviderID = Exclude<AutocompleteProviderID, "chipmate">
...
interface AutocompleteModelBase {
  ...
  /** Provider key to use for direct BYOK. Empty means ChipMate Gateway. */
...
export type AutocompleteModelDef = AutocompleteModelBase &
  (
    | {
        /** Route through `/chipmate/edit` using the Next Edit pipeline. */
        readonly kind: "edit"
...
const models: AutocompleteModelDef[] = [
  {
    id: "chipmate/mistralai/codestral-2508",
    modelID: "mistralai/codestral-2508",
    label: "Codestral",
    providerID: "chipmate",
    provider: "ChipMate Gateway",
    requestModel: "mistralai/codestral-2508",
    temperature: 0.2,
  },
  {
    id: "chipmate/inception/mercury-edit-2",
  ...
  {
    // Same wire-level model as `chipmate/inception/mercury-edit-2`, but routed
    // through the ChipMate Gateway's Next Edit endpoint instead of FIM. Picked by
    // users who want multi-line next-edit predictions with the jump-to-edit UX.
    id: "chipmate/inception/mercury-next-edit",
    ...
    temperature: 0,
    kind: "edit",
    fimModelID: "chipmate/inception/mercury-edit-2",
  },
  {
...
export const DEFAULT_AUTOCOMPLETE_PROVIDER_ID: AutocompleteProviderID = "chipmate"
...
export function getAutocompleteModel(provider?: string, model?: string): AutocompleteModelDef {
  // When provider is unset, always default to ChipMate Gateway. Direct-provider
