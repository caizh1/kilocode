 ...
 * ## Why this exists
 *
 * The sidebar ChipMateProvider always uses `getWorkspaceDirectory()`, which returns
 ...
 *
 * ## How ChipMateProvider uses this
 *
 * Each ChipMateProvider instance can receive an explicit `projectDirectory` via
 * `ChipMateProviderOptions`. When set:
 *
...
/**
 * Resolve the effective project directory for a ChipMateProvider instance.
 *
 * @param override - Explicit directory from ChipMateProviderOptions. `undefined`
 ...
 *   `getWorkspaceDirectory(sessionId)` from ChipMateProvider).
 */
