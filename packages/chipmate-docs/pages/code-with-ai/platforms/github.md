---
title: "GitHub"
description: "Using ChipMate in GitHub issues, pull requests, and review comments"
---

# ChipMate for GitHub

**ChipMate for GitHub** lets you interact with ChipMate directly from your GitHub issues, pull requests, and review comments. Mention the bot and it will:
...
{% image src="/docs/img/connect/github/github-review.png" alt="Asking @chipmate-bot a question on a GitHub pull request review comment" width="800" /%}
...
{% image src="/docs/img/connect/github/github-issue.png" alt="Asking @chipmate-bot to fix a GitHub issue" width="800" /%}
...
```
@chipmate-bot what could be the cause of this issue?
```
...
{% image src="/docs/img/connect/github/github-bug.png" alt="Asking @chipmate-bot to diagnose a bug report on a GitHub issue" width="800" /%}

---

## How It Works

1. **Mention `@chipmate-bot`** on an issue, pull request, or review comment
2. **ChipMate reads the context** — the issue description, PR diff, review thread, and connected repository code
3. **A Cloud Agent spins up** to process the request
4. **ChipMate responds** with an answer, analysis, or a pull request containing the implementation
...
- Your GitHub integration configured via the Integrations tab at [app.chipmate.ai](https://app.chipmate.ai)
- The ChipMate Bot GitHub App installed on the relevant repositories

---

## Setup

1. Go to [app.chipmate.ai](https://app.chipmate.ai) and navigate to the **Integrations** tab
2. Connect your GitHub account through the **ChipMateConnect** GitHub App if you haven't already
3. Install the **ChipMate Bot** GitHub App on your repositories at [github.com/apps/chipmate-code-bot](https://github.com/apps/chipmate-code-bot/)

Once installed, `@chipmate-bot` is available on any issue or PR in the repositories you've authorized.
...
ChipMate credits are consumed the same way as any other ChipMate interface. Credit usage depends on the model selected and the complexity of the task.
...
Make sure the ChipMate Bot GitHub App is installed on the repository and that you're mentioning `@chipmate-bot` (not `@chipmate`).

**The bot can't access the repository.**
Verify that both the ChipMateConnect App and the ChipMate Bot App are installed and have access to the repository in question.
