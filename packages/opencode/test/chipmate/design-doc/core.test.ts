...
} from "@chipmate/chipmate-indexing/design-doc"
...
} from "../../../src/chipmate/design-doc/evidence"
import {
  consumedAttempts,
  ...
  type LifecycleIR,
  type StructureIR,
} from "../../../src/chipmate/design-doc/domain"
import { codeStructureMermaid, lifecycleMermaid, structureMermaid } from "../../../src/chipmate/design-doc/renderer"
import { DesignDocStore, JobStoreError } from "../../../src/chipmate/design-doc/store"
import { validateLifecycle } from "../../../src/chipmate/design-doc/validator"
import { validateStructure } from "../../../src/chipmate/design-doc/structure-validator"
import { validateCodeStructure } from "../../../src/chipmate/design-doc/code-structure-validator"
import {
...
} from "../../../src/chipmate/design-doc/session-runner"
import { DESIGN_DOC_STRUCTURED_OUTPUT_TOOL, DESIGN_DOC_WORKER, hardenSystemAgents } from "../../../src/chipmate/agent"
...
describe("DesignDoc Worker 权限", () => {
  ...
  test("Prompt 工具开关不会把 StructuredOutput 从最终请求中移除", () => {
    ...
    const session = ChipMateSessionPrompt.mergeToolPermissions({ existing: worker.permission, toggles })
  ...
  test("DeepSeek thinking 使用 auto，其他结构化模型保持 required", () => {
    expect(
      ChipMateSessionPrompt.structuredOutputToolChoice({
        format: "json_schema",
