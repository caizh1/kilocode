...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Для получения дополнительной статистики использования используйте ",
  "provider.connect.chipmateGateway.byok.link": "BYOK через ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Рекомендуемые",
  "settings.providers.note.chipmate": "Доступ к 500+ моделям ИИ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер предоставляет ChipMate дополнительные инструменты для работы с внешними сервисами или локальными программами.",
  ...
  "marketplace.install.about.skill":
    "Навык добавляет инструкции и ресурсы для определённых задач, которые ChipMate может загрузить при необходимости.",
  "marketplace.install.mcp.warning":
    "MCP-серверы могут выполнять локальные команды или подключаться к внешним сервисам. ChipMate запросит разрешение перед использованием их инструментов, если только ваши разрешения не допускают это автоматически.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Выключите снимки ChipMate для этого проекта. Вы потеряете отмену/повтор изменений ChipMate, но git по-прежнему отслеживает всё.",
  ...
  "marketplace.aligned.unpublish": "Снять Skill с публикации",
  "marketplace.aligned.unpublished": "Снято с публикации",
}
