...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "이 컴퓨터에 Anaconda Desktop을 설치한 후 여기로 돌아오세요. ChipMate는 설치 프로그램을 대신 실행하지 않습니다.",
  ...
  "provider.anaconda.state.signedOut": "ChipMate를 연결하기 전에 Anaconda Desktop을 열고 로그인하세요.",
  "provider.anaconda.state.unauthorized":
    "ChipMate가 Anaconda Desktop에 접근할 수 없습니다. Desktop을 열고 다시 로그인한 후 필요하면 다시 시작하세요.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate가 정상적인 로컬 텍스트 생성 서버를 찾았으며 현재 연결 설정을 가져올 수 있습니다.",
  ...
  "provider.anaconda.toast.refreshed.description": "활성 로컬 서버와 모델이 ChipMate에서 최신 상태입니다.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate가 사용 가능한 스킬을 확인하지 못했습니다.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate가 MCP 서버 상태를 확인하지 못했습니다.",
  "agentRequirements.error.scopeMismatch": "이 에이전트 요구 사항 확인은 더 이상 활성 상태가 아닙니다.",
  "agentRequirements.error.requestFailed": "ChipMate가 에이전트 요구 사항을 확인하지 못했습니다.",
  ...
  "dialog.model.unpaid.freeModels.title": "ChipMate에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 ChipMate에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 ChipMate에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 ChipMate에서 {{provider}} 모델을 사용하세요.",
  ...
  "prompt.panel.collapse": "입력 패널 접기",
  "prompt.panel.expand": "입력 패널 펼치기",
  "prompt.panel.collapsed": "입력 패널이 접혀 있습니다",
  "prompt.panel.responding": "답변 중…",
  ...
  "prompt.action.sandbox.enabled":
    "샌드박스가 활성화되어 있습니다. 에이전트 셸 명령은 프로젝트 및 ChipMate 디렉터리로 제한됩니다.",
  "prompt.action.sandbox.disabled":
    "샌드박스가 비활성화되어 있습니다. 클릭하여 에이전트 셸 명령 쓰기를 프로젝트 및 ChipMate 디렉터리로 제한합니다.",
  ...
  "prompt.action.sandbox.description.enabled": "쓰기는 프로젝트 및 ChipMate 디렉터리로 제한됩니다.",
  ...
  "speechToText.tooltip.start": "ChipMate Gateway로 음성 입력 시작",
  ...
  "speechToText.error.loginRequired": "음성 입력을 사용하려면 ChipMate에 로그인하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 ChipMate 서버를 전환합니다.",
  ...
  "toast.update.description": "ChipMate의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 ChipMate 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: ChipMate는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "ChipMate 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 ChipMate가 보이는 방식 사용자 지정",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "ChipMate 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "ChipMate를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 ChipMate를 사용 중입니다.",
  ...
  "settings.providers.betaNotice":
    "현재 설정 인터페이스에서는 ChipMate Gateway 제공자만 설정할 수 있습니다. 다른 제공자 설정에 대한 지원은 베타 기간 동안 곧 제공될 예정입니다. 그동안에는 CLI 또는 설정 파일을 사용하여 제공자를 설정할 수 있습니다. 우리는 종속(lock-in) 없이 ChipMate를 개방적으로 유지하기 위해 최선을 다하고 있습니다.",
  ...
  "settings.models.hidePromptTraining.description":
    "제공업체가 사용자의 프롬프트를 학습에 사용할 수 있는 ChipMate Gateway 모델을 숨깁니다.",
  ...
  "settings.config.title": "{{scope}} ChipMate 구성 파일 열기",
  "settings.config.placeholder":
    "구성 파일은 순서대로 병합됩니다. 로드됨으로 표시된 파일이 현재 설정에 영향을 미칩니다.",
  "settings.config.noWorkspace": "로컬 ChipMate 구성 파일을 편집하려면 작업 영역 폴더를 엽니다.",
  "settings.config.openFailed": "{{scope}} ChipMate 구성 파일을 열지 못했습니다: {{message}}",
  "settings.config.source.xdg": "XDG 글로벌 구성",
  "settings.config.source.homeChipMate": "Home .chipmate 구성",
  "settings.config.source.homeOpencode": "Home .opencode 구성",
  "settings.config.source.envFile": "CHIPMATE_CONFIG 환경 파일",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "인라인 환경 구성",
  "settings.config.source.projectChipMate": "프로젝트 .chipmate 구성",
  ...
  "workStyle.onboarding.welcome": "ChipMate에 오신 것을 환영합니다",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate가 작업 중에 잠시 멈추고 계획을 보여줍니다.",
  ...
  "session.cloud.import.placeholder": "세션 ID, URL 또는 chipmate import 명령어",
  ...
  "deviceAuth.title": "ChipMate에 로그인",
  ...
  "settings.aboutChipMate.title": "ChipMate 정보",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate 모델 프리셋",
  "settings.indexing.chipmateModel.description": "지원되는 ChipMate 호스팅 임베딩 모델을 선택하세요.",
  "settings.indexing.chipmateSignIn.title": "ChipMate 로그인이 필요합니다",
  "settings.indexing.chipmateSignIn.description": "호스팅 임베딩을 사용하려면 ChipMate에 로그인하세요.",
  ...
  "session.messages.welcome":
    "ChipMate는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutChipMate.status.connected": "연결됨",
  "settings.aboutChipMate.status.connecting": "연결 중...",
  "settings.aboutChipMate.status.disconnected": "연결 끊김",
  "settings.aboutChipMate.status.error": "오류",
  "settings.aboutChipMate.cliServer": "CLI 서버",
  "settings.aboutChipMate.status.label": "상태:",
  "settings.aboutChipMate.port.label": "포트:",
  "settings.aboutChipMate.versionInfo": "버전 정보",
  "settings.aboutChipMate.version.label": "버전:",
  "settings.aboutChipMate.extensionName": "ChipMate 확장 프로그램",
  "settings.aboutChipMate.community": "커뮤니티 및 지원",
  "settings.aboutChipMate.feedback.prefix": "질문이나 피드백이 있으시면 다음에서 이슈를 열어주세요",
  "settings.aboutChipMate.feedback.or": "또는",
  "settings.aboutChipMate.support.prefix": "결제 또는 계정 관련 문의는 고객 지원팀에 문의하세요",
  "settings.aboutChipMate.resetSettings.title": "설정 초기화",
  ...
  "settings.aboutChipMate.resetSettings.button": "모든 설정 초기화",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "설정 이전",
  "settings.aboutChipMate.settingsTransfer.description":
    "VS Code 인스턴스 간에 설정을 전송하려면 내보내기 또는 가져오기하세요.",
  "settings.aboutChipMate.exportSettings": "내보내기",
  "settings.aboutChipMate.importSettings": "가져오기",
  "settings.aboutChipMate.importSettings.invalidJson":
    "유효하지 않은 JSON 파일입니다. 올바른 설정 파일을 선택해 주세요.",
  "settings.aboutChipMate.importSettings.invalidConfig": "파일에 유효한 ChipMate 설정이 포함되어 있지 않습니다.",
  "settings.aboutChipMate.importSettings.tooLarge": "파일이 너무 큽니다. 설정 파일은 1 MB 이하여야 합니다.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "이 파일은 더 최신 버전의 ChipMate에서 내보낸 것입니다. 일부 설정이 무시될 수 있습니다.",
  "settings.aboutChipMate.importSettings.success": "설정을 가져왔습니다. 위의 변경 사항을 확인한 후 저장을 클릭하세요.",

  "settings.aboutChipMate.telemetry.title": "원격 측정",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "원격 측정 설정 열기",
  ...
  "settings.language.description": 'ChipMate UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.experimental.speechToText.description":
    "ChipMate Gateway를 통해 ChipMate 계정을 사용하여 프롬프트 필드에서 음성 입력을 활성화합니다.",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text를 사용하려면 ChipMate 제공자를 활성화하고 로그인하세요. 현재 Speech to Text는 ChipMate Gateway에서만 지원됩니다.",
  "settings.models.speechToTextModel.title": "음성 텍스트 변환 모델",
  "settings.models.speechToTextModel.description": "음성 입력에 사용할 ChipMate Gateway 변환 모델을 선택하세요.",
  ...
  "settings.experimental.remote.description":
    "ChipMate Cloud를 통한 세션의 Remote 제어를 활성화합니다. 이는 이 컴퓨터의 CLI에도 영향을 미칩니다.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code 설정 디렉터리에서 세션으로 CLAUDE.md 지침 및 스킬을 로드합니다. ChipMate가 Claude Code 지침 및 스킬을 사용하게 하려면 활성화하세요. 다시 시작해야 합니다.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP 서버가 구성되지 않았습니다. chipmate.jsonc에서 MCP 서버를 추가하거나 에이전트에게 추가를 요청하세요.",
  ...
  "settings.sandboxing.enabled.description":
    "에이전트 셸 명령을 프로젝트 및 ChipMate 상태 디렉터리에 대한 쓰기를 제한하는 OS 수준의 샌드박스 내에서 실행",
  ...
  "settings.display.fontSize.description": "VS Code와 독립적으로 ChipMate webview UI 글꼴 크기를 조정합니다.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "레거시 마이그레이션",
  "settings.aboutChipMate.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 ChipMate 설치에서 설정을 마이그레이션합니다.",
  "settings.aboutChipMate.rooImport.description": "Roo Code 설치에서 대화 기록을 가져옵니다.",
  "settings.aboutChipMate.rooImport.button": "Roo Code에서 세션 가져오기",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ChipMate의 새로운 기능",
  ...
  "migration.whatsNew.features.foundation.detail":
    "모든 ChipMate 제품에 걸쳐 하나의 작고 효율적인 코어. 어떤 방식으로 작업하든 익숙한 경험을 제공합니다.",
  ...
  "diffViewer.source.session.tooltip":
    "현재 세션 동안 ChipMate가 변경한 파일로, 턴별 스냅샷을 기반으로 합니다. 새 세션을 시작하면 초기화됩니다.",
