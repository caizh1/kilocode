...
import { applyInternalIndexingDefaults, isInternalOffline } from "@/chipmate/internal-offline"
...
export const guard = Effect.fn("AgentRequirements.guard")(function* (
  ...
  const unsupported = Flag.CHIPMATE_CLIENT !== "vscode" && result.vscode_extensions.length > 0
