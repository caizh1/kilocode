...
$global:__chipmate_token = $env:CHIPMATE_AGENT_CONSOLE_TOKEN
Remove-Item Env:CHIPMATE_AGENT_CONSOLE -ErrorAction SilentlyContinue
Remove-Item Env:CHIPMATE_AGENT_CONSOLE_TOKEN -ErrorAction SilentlyContinue
