...
// chipmate_change start - support every reasoning summary mode in the OpenAI Responses API
...
const REASONING_SUMMARIES = new Set<string>(OpenAIReasoningSummaries) // chipmate_change
const TEXT_VERBOSITY = new Set<string>(["low", "medium", "high"])
const INCLUDABLES = new Set<string>(OpenAIResponseIncludables)
const SERVICE_TIERS = new Set<string>(OpenAIServiceTiers)

export const OpenAIReasoningEffort = Schema.Literals(OpenAIReasoningEfforts)
export const OpenAIReasoningSummary = Schema.Literals(OpenAIReasoningSummaries) // chipmate_change
...
// chipmate_change start - preserve every reasoning summary mode supported by OpenAI Responses
