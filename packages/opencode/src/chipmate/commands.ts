...
import { ChipMateConsoleCommand } from "./cli/cmd/console"
...
// from `chipmate help --all` and the docs table. They're also guarded the same way
// at the yargs registration site in src/index.ts, so the commands-in-sync
// regex in test/chipmate/help.test.ts sees DevSetup/DevAlias on neither side.
