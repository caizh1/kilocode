...
export namespace TestCli {
  export const ENV = "CHIPMATE_TEST_CLI_PATH"
  ...
  async function fingerprint(root: string): Promise<string> {
    ...
    const ignored = new Set(["chipmate-vscode", "chipmate-jetbrains", "chipmate-docs"])
  ...
  export async function build(root: string, targetDir?: string) {
    ...
    const result = await Bun.build({
      ...
      external: ["node-gyp", "@opentui/core-*", "@chipmate/chipmate-memory", "@chipmate/chipmate-memory/*"],
