...
export interface ToolDeps {
  ...
  sessionMetadata: (client: ChipMateClient, dir: string) => Promise<Record<string, unknown>>
...
async function prompt(client: ChipMateClient, sid: string, dir: string, task: ToolTask) {
...
async function local(deps: ToolDeps, client: ChipMateClient, task: ToolTask, directory?: string, source?: ToolSource) {
