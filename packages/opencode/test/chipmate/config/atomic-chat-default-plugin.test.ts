...
import { hasAtomicChatPlugin } from "@/chipmate/atomic-chat-feature"
import { ChipMateDefaultPlugins } from "@/chipmate/config/default-plugins"
import { PluginLoader } from "@/plugin/loader"

const atomic = "@chipmate/plugin-atomic-chat"

describe("chipmate default atomic chat plugin", () => {
  test("injects atomic chat without registering an external plugin origin", () => {
    ...
    ChipMateDefaultPlugins.apply(cfg, { disabled: false })
  ...
  test("does not add atomic chat plugin when default plugins are disabled", () => {
    ...
    ChipMateDefaultPlugins.apply(cfg, { disabled: true })
