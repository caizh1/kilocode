...
class SessionMessageListPanel(
    ...
    private val openAttachment: (String, FileAttachment) -> Unit = { _, item -> ai.chipmate.client.session.views.AttachmentView.openDefault(item, openFile, openUrl) },
    ...
    private fun onTurnAdded(turn: ai.chipmate.client.session.model.Turn) {
    ...
    private fun onTurnUpdated(turn: ai.chipmate.client.session.model.Turn) {
    ...
    private fun diffsOf(turn: ai.chipmate.client.session.model.Turn) =
