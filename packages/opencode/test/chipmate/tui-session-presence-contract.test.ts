/**
 * Contract test for the TUI presence snapshot in chipmate/cli/cmd/tui/app.tsx.
 *
...
const APP_FILE = path.resolve(import.meta.dir, "../../src/chipmate/cli/cmd/tui/app.tsx")
