package ai.chipmate.client.session.ui.editor
...
internal open class SessionEditorTextField(
    ...
    private val undo = action(ChipMateBundle.message("session.editor.undo"), true)
    private val redo = action(ChipMateBundle.message("session.editor.redo"), false)
