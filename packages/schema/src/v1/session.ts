...
export const SubtaskPart = Schema.Struct({
  ...
  variant: Schema.optional(Schema.String), // chipmate_change - preserve workflow subtask variant
...
// chipmate_change start - editor context captured by the VS Code client
