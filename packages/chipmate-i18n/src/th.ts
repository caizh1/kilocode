...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "สำหรับสถิติการใช้งานเพิ่มเติม โปรดใช้ ",
  "provider.connect.chipmateGateway.byok.link": "BYOK ผ่าน ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": "",

  // Provider settings translations
  "settings.providers.group.recommended": "แนะนำ",
  "settings.providers.note.chipmate": "เข้าถึงโมเดล AI มากกว่า 500 รายการ",
  ...
  "marketplace.install.about.mcp":
    "เซิร์ฟเวอร์ MCP เพิ่มเครื่องมือให้ ChipMate สำหรับทำงานกับบริการภายนอกหรือโปรแกรมในเครื่อง",
  "marketplace.install.about.agent": "เอเจนต์เพิ่มบทบาทที่นำกลับมาใช้ใหม่ได้พร้อมคำสั่งและสิทธิ์ของตนเอง",
  "marketplace.install.about.skill": "ทักษะเพิ่มคำสั่งและทรัพยากรเฉพาะงานที่ ChipMate สามารถโหลดได้เมื่อจำเป็น",
  "marketplace.install.mcp.warning":
    "เซิร์ฟเวอร์ MCP สามารถเรียกใช้คำสั่งในเครื่องหรือเชื่อมต่อกับบริการภายนอกได้ ChipMate จะขออนุญาตก่อนใช้เครื่องมือ เว้นแต่สิทธิ์ของคุณจะอนุญาตโดยอัตโนมัติ",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "ปิดสแน็ปช็อตของ ChipMate สำหรับโปรเจกต์นี้ คุณจะสูญเสียการยกเลิก/ทำซ้ำสำหรับการเปลี่ยนแปลงของ ChipMate แต่ git ยังคงติดตามทุกอย่าง",
  ...
  "marketplace.aligned.unpublish": "ยกเลิกการเผยแพร่ Skill",
  "marketplace.aligned.unpublished": "ยกเลิกการเผยแพร่แล้ว",
}
