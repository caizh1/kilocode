      ...
      .add(
        HttpApiEndpoint.get("get", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the current ChipMate configuration settings and preferences.", // chipmate_change
          }),
        ),
        HttpApiEndpoint.patch("update", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Update ChipMate configuration settings and preferences.", // chipmate_change
          }),
        ),
        // chipmate_change start
