...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskine, og vend derefter tilbage hertil. ChipMate kører ikke installationsprogrammet for dig.",
  ...
  "provider.anaconda.state.signedOut": "Åbn Anaconda Desktop og log ind, før du forbinder ChipMate.",
  "provider.anaconda.state.unauthorized":
    "ChipMate kunne ikke få adgang til Anaconda Desktop. Åbn Desktop, log ind igen, og genstart den om nødvendigt.",
  ...
  "provider.anaconda.state.ready":
    "ChipMate fandt en sund lokal tekstgenereringsserver og kan importere dens aktuelle forbindelsesindstillinger.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale server og modeller er opdaterede i ChipMate.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate kunne ikke kontrollere de tilgængelige skills.",
  "agentRequirements.error.mcpStatusFailed": "ChipMate kunne ikke kontrollere MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne agentkravskontrol er ikke længere aktiv.",
  "agentRequirements.error.requestFailed": "ChipMate kunne ikke kontrollere agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ChipMate",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i ChipMate.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i ChipMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i ChipMate.",
  ...
  "prompt.panel.collapse": "Skjul inputpanel",
  "prompt.panel.expand": "Vis inputpanel",
  "prompt.panel.collapsed": "Inputpanelet er skjult",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktiveret. Shell-kommandoer for agenten er begrænset til projekt- og ChipMate-mapperne.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktiveret. Klik for at begrænse skrivning af shell-kommandoer for agenten til projekt- og ChipMate-mapperne.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivning er begrænset til projekt- og ChipMate-mapperne.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med ChipMate Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på ChipMate for at bruge stemmeinput.",
  ...
  "dialog.server.description": "Skift hvilken ChipMate-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af ChipMate ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ChipMate-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ChipMate understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ChipMate inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ChipMate",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan ChipMate ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan ChipMate er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ChipMate starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ChipMate.",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate-modelpreset",
  "settings.indexing.chipmateModel.description": "Vælg en understøttet ChipMate-hostet embedding-model.",
  "settings.indexing.chipmateSignIn.title": "ChipMate-login kræves",
  "settings.indexing.chipmateSignIn.description": "Log ind på ChipMate for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun ChipMate Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde ChipMate åben, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul ChipMate Gateway-modeller, hvis udbydere muligvis bruger dine prompts til træning.",
  ...
  "settings.config.title": "Åbn {{scope}} ChipMate konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale ChipMate konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} ChipMate konfigurationsfil: {{message}}",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate holder pause og viser dig sin plan undervejs.",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller chipmate import-kommando",
  ...
  "deviceAuth.title": "Log ind på ChipMate",
  ...
  "profile.action.login": "Log ind med ChipMate",
  ...
  "profile.pass.subscribe": "Få ChipMate Pass for at tilføje kredit og optjene bonusser",
  ...
  "session.messages.welcome":
    "ChipMate er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutChipMate.status.connected": "Forbundet",
  "settings.aboutChipMate.status.connecting": "Forbinder...",
  "settings.aboutChipMate.status.disconnected": "Afbrudt",
  "settings.aboutChipMate.status.error": "Fejl",
  ...
  "settings.aboutChipMate.versionInfo": "Versionsinformation",
  "settings.aboutChipMate.version.label": "Version:",
  "settings.aboutChipMate.extensionName": "ChipMate-udvidelse",
  "settings.aboutChipMate.community": "Fællesskab og support",
  ...
  "settings.aboutChipMate.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutChipMate.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutChipMate.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutChipMate.exportSettings": "Eksportér",
  "settings.aboutChipMate.importSettings": "Importér",
  "settings.aboutChipMate.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutChipMate.importSettings.invalidConfig": "Filen indeholder ikke gyldige ChipMate-indstillinger.",
  "settings.aboutChipMate.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutChipMate.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af ChipMate. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutChipMate.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til ChipMate-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivér stemmeinput i prompt-felter ved hjælp af din ChipMate-konto gennem ChipMate Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivér og log ind på ChipMate-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med ChipMate Gateway.",
  "settings.models.speechToTextModel.title": "Model til tale til tekst",
  "settings.models.speechToTextModel.description": "Vælg ChipMate Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via ChipMate Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have ChipMate til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i chipmate.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.sandboxing.enabled.description":
    "Kør shell-kommandoer for agenten i en sandbox på operativsystemniveau, der begrænser skrivning til projekt- og ChipMate-tilstandsmapperne",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for ChipMate webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutChipMate.legacyMigration.title": "Legacy-migrering",
  "settings.aboutChipMate.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af ChipMate, herunder udbyder API-nøgler og standardmodel.",
  "settings.aboutChipMate.rooImport.description": "Importer samtalehistorik fra en installation af Roo Code.",
  "settings.aboutChipMate.rooImport.button": "Importer sessioner fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i ChipMate",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle ChipMate-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af ChipMate i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
