---
title: "Customize"
description: "Make ChipMate work your way with custom modes, rules, instructions, and more"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
ChipMate is highly customizable. Tailor its behavior to match your workflow, team standards, and project requirements with custom modes, rules, instructions, and more.
{% /callout %}

## Customization

Configure how ChipMate behaves and responds:
...
- [**Skills**](/docs/customize/skills) - Extend ChipMate's capabilities with reusable skill definitions
- [**Prompt Engineering**](/docs/customize/prompt-engineering) - Write effective prompts for better results

## Context & Indexing

Help ChipMate understand your codebase better:
...
1. **Start with Custom Instructions** — Set up instructions in the [Custom Instructions](/docs/customize/custom-instructions) section to guide ChipMate's behavior
2. **Explore Custom Modes** — Try the built-in modes first, then create your own
3. **Enable Codebase Indexing** — Help ChipMate understand your project structure
...
- Check out [**Code with AI**](/docs/code-with-ai) to learn how to use ChipMate effectively
