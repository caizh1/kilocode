// ChipMate-specific translations and overrides
...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "Per ulteriori statistiche sull'utilizzo, utilizza ",
  "provider.connect.chipmateGateway.byok.link": "BYOK tramite ChipMate's Gateway",
  "provider.connect.chipmateGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Consigliati",
  "settings.providers.note.chipmate": "Accesso a oltre 500 modelli AI",
  ...
  "marketplace.install.about.mcp":
    "Un server MCP fornisce a ChipMate strumenti aggiuntivi per interagire con servizi esterni o programmi locali.",
  "marketplace.install.about.agent":
    "Un agente aggiunge un ruolo riutilizzabile con istruzioni e autorizzazioni proprie.",
  "marketplace.install.about.skill":
    "Una skill aggiunge istruzioni e risorse specifiche per un'attività che ChipMate può caricare quando necessario.",
  "marketplace.install.mcp.warning":
    "I server MCP possono eseguire comandi locali o connettersi a servizi esterni. ChipMate chiederà l'autorizzazione prima di usare i loro strumenti, a meno che le tue autorizzazioni non lo consentano automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Disattiva gli snapshot di ChipMate per questo progetto. Perderai annulla/ripeti sulle modifiche ai file fatte da ChipMate, ma git continuerà a tracciare tutto.",
  ...
  "marketplace.aligned.unpublish": "Annulla pubblicazione Skill",
  "marketplace.aligned.unpublished": "Non pubblicato",
}
