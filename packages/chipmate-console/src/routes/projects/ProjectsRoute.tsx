    ...
    <section class="route-empty">
      <div class="projects-page">
        <header class="projects-header">
          ...
          <p>Projects opened with this ChipMate server. Selecting a project opens its console.</p>
        </header>
        ...
        <Show when={query() && !items.loading && rows().length === 0 && !items.error}>
          <Card class="empty">No projects have been opened with this ChipMate server yet.</Card>
        </Show>
        ...
        <ul class="project-list" aria-label="ChipMate projects">
          <For each={filtered()}>
            {(item) => (
              <li>
