...
export const dict = {
  ...
  "provider.connect.chipmateGateway.byok.prefix": "더 많은 사용 통계를 보려면 ",
  "provider.connect.chipmateGateway.byok.link": "ChipMate's Gateway를 통해 BYOK",
  "provider.connect.chipmateGateway.byok.suffix": "를 사용하세요.",

  // Provider settings translations
  "settings.providers.group.recommended": "추천",
  "settings.providers.note.chipmate": "500개 이상의 AI 모델 이용 가능",
  ...
  "marketplace.install.about.mcp":
    "MCP 서버는 외부 서비스나 로컬 프로그램과 작업할 수 있는 추가 도구를 ChipMate에 제공합니다.",
  "marketplace.install.about.agent": "에이전트는 자체 지침과 권한을 가진 재사용 가능한 역할을 추가합니다.",
  "marketplace.install.about.skill": "스킬은 필요할 때 ChipMate가 불러올 수 있는 작업별 지침과 리소스를 추가합니다.",
  "marketplace.install.mcp.warning":
    "MCP 서버는 로컬 명령을 실행하거나 외부 서비스에 연결할 수 있습니다. 권한 설정에서 자동으로 허용하지 않는 한 ChipMate는 도구를 사용하기 전에 권한을 요청합니다.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "이 프로젝트의 ChipMate 스냅샷을 끕니다. ChipMate 변경에 대한 실행 취소/다시 실행은 사용할 수 없지만 git은 여전히 모든 것을 추적합니다.",
  ...
  "marketplace.aligned.unpublish": "Skill 게시 취소",
  "marketplace.aligned.unpublished": "게시 취소됨",
}
