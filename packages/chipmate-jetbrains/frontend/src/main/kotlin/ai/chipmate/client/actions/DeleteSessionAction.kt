...
class DeleteSessionAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val msg = if (items.size == 1)
            ChipMateBundle.message("history.delete.confirm.message", ai.chipmate.client.session.history.title(items[0]))
        else
            ChipMateBundle.message("history.delete.confirm.message.multiple", items.size)
