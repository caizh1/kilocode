...
/**
 * ChipMateClaw Upgrade Dialog
 *
 * Shown when the user has an active ChipMateClaw instance but no chat credentials,
...
export function DialogClawUpgrade(props: { orgId?: string | null }) {
  ...
  const url = props.orgId ? `https://app.chipmate.ai/organizations/${props.orgId}/claw` : "https://app.chipmate.ai/claw"
  ...
  return (
    <box paddingLeft={2} paddingRight={2} gap={1}>
      <box flexDirection="row" justifyContent="space-between">
        <text fg={theme.text}>
          <span style={{ bold: true }}>ChipMateClaw Chat requires an upgrade</span>
        </text>
      ...
      <box paddingBottom={1} gap={1}>
        ...
        <text fg={theme.textMuted} wrapMode="word">
          Use the <span style={{ fg: theme.warning, bold: true }}>↻ Upgrade to Latest</span> button on the ChipMateClaw
