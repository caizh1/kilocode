 ...
 *
 * Batching bounds each `chipmate run` context (a replay window can yield dozens
 ...
 *
 * Env: EDIT_MODEL (provider/model), CHIPMATE_API_KEY + CHIPMATE_ORG_ID (set by workflow; read natively by the chipmate provider).
...
import { backoffMsForAttempt, deadline, remainingMs, runChipMate, sleepSync } from "./lib.mjs"
