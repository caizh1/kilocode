...
import { ChipMateTitleIcon } from "@/chipmate/cli/cmd/tui/title-icon" // chipmate_change
...
export const Info = Schema.Struct({
  ...
  title_icon: Schema.optional(ChipMateTitleIcon.Value), // chipmate_change
  prompt: Schema.optional(Prompt),
  scroll_speed: Schema.optional(ScrollSpeed).annotate({ description: "TUI scroll speed" }),
  scroll_acceleration: Schema.optional(ScrollAcceleration),
  diff_style: Schema.optional(DiffStyle),
  mouse: Schema.optional(Schema.Boolean).annotate({ description: "Enable or disable mouse capture (default: true)" }),
  vim: Schema.optional(Schema.Boolean), // chipmate_change - retain ChipMate prompt editing mode
})
...
export function resolve(input: Info, options: ResolveOptions): Resolved {
  ...
  return {
    ...
    attention: {
      ...
      sound_pack: input.attention?.sound_pack ?? "chipmate.default", // chipmate_change
