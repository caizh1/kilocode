...
import { ensureChipMateDiffTheme, CHIPMATE_DIFF_THEME } from "./chipmate-diff-theme" // chipmate_change

// chipmate_change start: register the "ChipMate" theme as a precondition of creating
...
// loader for ChipMate". Doing it here means every diff component (which imports this
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for ChipMate, as I think 8 might be
