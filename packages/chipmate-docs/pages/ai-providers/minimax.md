---
title: "Using MiniMax with ChipMate"
description: "Configure MiniMax AI models in ChipMate. Guide to getting an API key and setup for VS Code and the CLI."
sidebar_label: MiniMax
---

# Using MiniMax With ChipMate
...
3. **Create a Key:** Click to generate a new API key and give it a descriptive name (e.g., "ChipMate").
