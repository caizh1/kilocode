...
import { SKILL_SHELL_DISABLED, SKILL_SHELL_UNTRUSTED } from "@/chipmate/skills/display"
...
// kill-switch (CHIPMATE_DISABLE_SKILL_SHELL), and one batch bash ask naming every command
