...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "請在此機器上安裝 Anaconda Desktop，然後返回此處。ChipMate 不會為您執行安裝程式。",
  ...
  "provider.anaconda.state.signedOut": "請開啟 Anaconda Desktop 並登入，然後再連接 ChipMate。",
  "provider.anaconda.state.unauthorized":
    "ChipMate 無法存取 Anaconda Desktop。請開啟 Desktop，重新登入，並在需要時重新啟動它。",
  ...
  "provider.anaconda.state.ready": "ChipMate 找到了一個正常運作的本機文字生成伺服器，並可匯入其目前的連接設定。",
  ...
  "provider.anaconda.toast.refreshed.description": "使用中的本機伺服器與模型在 ChipMate 中已是最新狀態。",
...
export const dict = {
  ...
  "session.compaction.confirm.title": "精簡此工作階段的上下文？",
  "session.compaction.confirm.description": "精簡會將較早內容轉換為摘要，讓目前工作獲得更多可用上下文。",
  "session.compaction.confirm.flowLabel": "精簡前後的工作階段上下文變化",
  "session.compaction.confirm.before": "精簡前",
  "session.compaction.confirm.beforeDescription": "較早對話 + 最近對話",
  "session.compaction.confirm.after": "精簡後",
  "session.compaction.confirm.afterDescription": "模型摘要 + 最近對話",
  "session.compaction.confirm.riskDetails": "摘要可能遺漏細節、約束或中間結論。",
  "session.compaction.confirm.riskToolsAndUsage": "較早的工具輸出可能被清理，並會產生模型用量。",
  "session.compaction.confirm.acknowledge": "我已瞭解精簡可能遺失細節",
  "session.compaction.confirm.confirm": "確認並精簡",
  ...
  "agentRequirements.error.discoveryFailed": "ChipMate 無法檢查可用技能。",
  "agentRequirements.error.mcpStatusFailed": "ChipMate 無法檢查 MCP 伺服器狀態。",
  "agentRequirements.error.scopeMismatch": "此代理需求檢查已不再有效。",
  "agentRequirements.error.requestFailed": "ChipMate 無法檢查代理需求。",
  ...
  "dialog.model.unpaid.freeModels.title": "ChipMate 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 ChipMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 ChipMate 中使用 {{provider}} 模型。",
  ...
  "prompt.ultra.confirm.description": "Ultra 讓三個 Explore 會話並行驗證凍結的 Code 答案，最後獨立綜合。",
  "prompt.ultra.confirm.flow.label":
    "Code 生成並凍結完整答案，三個互相隔離的 Explore 會話並行驗證，最後由獨立 Ask 會話綜合全部報告並生成最終答案。",
  "prompt.ultra.confirm.flow.question": "使用者問題",
  "prompt.ultra.confirm.flow.code": "Code 生成完整答案",
  "prompt.ultra.confirm.flow.frozen": "凍結 Code 答案",
  "prompt.ultra.confirm.flow.verify": "獨立驗證",
  "prompt.ultra.confirm.flow.ask": "獨立 Ask 綜合會話",
  "prompt.ultra.confirm.flow.final": "最終答案",
  "prompt.ultra.confirm.flow.finalNote": "綜合三份獨立驗證",
  ...
  "prompt.ultra.confirm.note": "適合複雜疑難排解、架構分析和高風險審查，通常需要更多時間與 Token。",
  "prompt.ultra.confirm.action": "確認並進入 Ultra",
  "prompt.embeddedReview.title": "嵌入式審查",
  "prompt.embeddedReview.experimental": "實驗性",
  "prompt.embeddedReview.summary": "僅覆蓋 C/C++ 變更中的高可信嚴重問題和 6 項機械編碼規則。",
  "prompt.embeddedReview.scope": "嵌入式審查範圍",
  "prompt.embeddedReview.fact.logic": "5 類嚴重邏輯",
  "prompt.embeddedReview.fact.rules": "6 項機械規則",
  "prompt.embeddedReview.fact.lines": "僅變更行",
  "prompt.embeddedReview.supported.title": "可檢查",
  "prompt.embeddedReview.supported.integer": "整數溢位與邊界",
  "prompt.embeddedReview.supported.condition": "條件與實際使用矛盾",
  "prompt.embeddedReview.supported.resource": "區域資源閉環",
  "prompt.embeddedReview.supported.error": "錯誤碼衝突",
  "prompt.embeddedReview.supported.unit": "單位/位元寬度/端序衝突",
  "prompt.embeddedReview.unsupported.title": "不檢查 · 需人工審查",
  "prompt.embeddedReview.unsupported.badge": "6 類盲區",
  "prompt.embeddedReview.unsupported.description": "以下風險不會被本次審查覆蓋",
  "prompt.embeddedReview.unsupported.concurrent": "並行與中斷",
  "prompt.embeddedReview.unsupported.state": "複雜狀態機",
  "prompt.embeddedReview.unsupported.power": "斷電恢復",
  "prompt.embeddedReview.unsupported.hardware": "硬體隱含行為",
  "prompt.embeddedReview.unsupported.toolchain": "IAR/GCC 工具鏈",
  "prompt.embeddedReview.unsupported.requirements": "需求符合性",
  "prompt.embeddedReview.warning": "PASS 不代表整體安全，仍須人工覆核、編譯和硬體驗證。",
  "prompt.embeddedReview.action.collapse": "收起審查範圍",
  "prompt.embeddedReview.action.expand": "展開審查範圍",
  ...
  "prompt.action.send.selectModel": "請先選擇模型再傳送",
  "prompt.action.send.recording": "轉錄並傳送",
  "prompt.action.stop": "停止",
  "prompt.panel.collapse": "收起輸入面板",
  "prompt.panel.expand": "展開輸入面板",
  "prompt.panel.collapsed": "輸入面板已收起",
  ...
  "prompt.action.sandbox.enabled": "沙盒已啟用。代理 shell 指令被限制在專案和 ChipMate 目錄內。",
  "prompt.action.sandbox.disabled": "沙盒已停用。點擊以將代理 shell 指令的寫入限制在專案和 ChipMate 目錄內。",
  ...
  "prompt.action.sandbox.description.enabled": "寫入僅限於專案和 ChipMate 目錄。",
  ...
  "speechToText.tooltip.start": "使用 ChipMate Gateway 開始語音輸入",
  ...
  "speechToText.error.loginRequired": "登入 ChipMate 以使用語音輸入。",
  ...
  "dialog.server.description": "切換此應用程式連線的 ChipMate 伺服器。",
  ...
  "toast.update.description": "ChipMate 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 ChipMate 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：ChipMate 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "ChipMate 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 ChipMate 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 ChipMate 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 ChipMate 的主題。",
  ...
  "settings.updates.row.startup.description": "在 ChipMate 啟動時自動檢查更新",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 ChipMate Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 ChipMate 開放，絕不綁定。",
  ...
  "settings.models.hidePromptTraining.description": "隱藏供應商可能會使用您的提示詞進行訓練的 ChipMate Gateway 模型。",
  ...
  "provider.custom.error.apiKey.originChanged": "請為此位址重新輸入 API Key 或環境變數憑據",
  ...
  "settings.config.title": "開啟 {{scope}} ChipMate 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 ChipMate 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} ChipMate 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeChipMate": "主目錄 .chipmate 設定",
  "settings.config.source.homeOpencode": "主目錄 .opencode 設定",
  "settings.config.source.envFile": "CHIPMATE_CONFIG 環境變數檔案",
  "settings.config.source.envDir": "CHIPMATE_CONFIG_DIR",
  "settings.config.source.envContent": "內聯環境設定",
  "settings.config.source.projectChipMate": "專案 .chipmate 設定",
  ...
  "session.surface.owner.main": "目前介面擁有會話操作權",
  "session.surface.mirror": "即時鏡像 · 操作權在主編輯區",
  "session.surface.focusMain": "前往主區",
  "session.surface.returnSidebar": "收回側欄",
  "session.surface.status.opening": "正在準備主編輯區…",
  "session.surface.status.returning": "正在收回側欄…",
  "session.surface.status.restoring": "正在恢復目前工作階段…",
  "session.surface.status.disconnected": "連線已中斷，完成核對前不可編輯",
  "session.surface.status.deleted": "目前工作階段已刪除",
  "session.surface.deleted.title": "工作階段已刪除",
  "session.surface.deleted.detail": "此分頁已進入唯讀終態，可以安全關閉。",
  ...
  "workStyle.onboarding.welcome": "歡迎使用 ChipMate",
  ...
  "workStyle.choice.human-in-the-loop.description": "ChipMate 會在工作過程中暫停並向你顯示其計畫。",
  ...
  "session.cloud.import.placeholder": "工作階段 ID、URL 或 chipmate import 指令",
  ...
  "settings.indexing.documents.description": "將目前工作區及已授權外部目錄中的文字文件索引到獨立的 RAG 儲存中。",
  "settings.indexing.documents.workspace.title": "目前工作區",
  "settings.indexing.documents.workspace.description": "啟用文件 RAG 後一律索引。",
  "settings.indexing.documents.folders.title": "額外目錄",
  "settings.indexing.documents.folders.description": "在目前工作區之外，額外索引已授權的外部目錄。",
  "settings.indexing.documents.folders.empty": "尚未新增額外目錄",
  "settings.indexing.documents.folders.add": "新增外部目錄",
  ...
  "settings.aboutChipMate.title": "關於 ChipMate",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "ChipMate 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "session.compaction.retryingWithoutThinking": "本次壓縮未產生有效摘要，正在關閉思考後重試…",
  "session.compaction.status.running": "正在精簡工作階段…",
  "session.compaction.status.autoRunning": "正在自動精簡工作階段…",
  "session.compaction.status.retrying": "正在重試精簡…",
  "session.compaction.status.runningDescription": "正在將較早內容轉換為摘要。",
  "session.compaction.status.succeeded": "工作階段精簡完成",
  "session.compaction.status.autoSucceeded": "已自動精簡工作階段",
  "session.compaction.status.succeededDescription": "較早內容已轉換為摘要，最近對話已保留。",
  "session.compaction.status.failed": "工作階段精簡失敗",
  "session.compaction.status.failedDescription": "本次精簡未完成，請勿將其視為已成功壓縮。",
  "session.compaction.status.interrupted": "工作階段精簡已中斷",
  "session.compaction.status.interruptedDescription": "本次精簡未完成。",
  "session.compaction.phase.preparing": "正在分析工作階段並規劃壓縮工作。",
  "session.compaction.phase.generating": "模型正在產生摘要；此階段無法預測剩餘時間。",
  "session.compaction.phase.chunk": "正在並行壓縮較早內容。",
  "session.compaction.phase.reduce": "正在合併第 {{depth}} 層摘要。",
  "session.compaction.phase.replay": "正在壓縮需要在精簡後繼續處理的請求。",
  "session.compaction.phase.retrying": "正在關閉思考並從頭重新啟動完整壓縮流程。",
  "session.compaction.phase.committing": "摘要已產生，正在提交壓縮邊界。",
  "session.compaction.phase.splitting": "目前摘要單元超出模型上下文，正在安全細分。",
  "session.compaction.progress.stage": "目前階段 {{completed}}/{{total}} · {{percent}}%",
  "session.compaction.elapsed.running": "已等待 {{duration}}",
  "session.compaction.elapsed.completed": "總耗時 {{duration}}",
  ...
  "context.usage.billing.pending": "計費中…",
  "context.usage.billing.unavailable": "費用暫時無法取得",
  "context.usage.billing.group": "實際群組",
  "context.usage.billing.steps": "{{count}} 次請求",
  ...
  "settings.aboutChipMate.status.connected": "已連線",
  "settings.aboutChipMate.status.connecting": "連線中...",
  "settings.aboutChipMate.status.disconnected": "已中斷",
  "settings.aboutChipMate.status.error": "錯誤",
  "settings.aboutChipMate.cliServer": "CLI 伺服器",
  "settings.aboutChipMate.status.label": "狀態：",
  "settings.aboutChipMate.port.label": "連接埠：",
  "settings.aboutChipMate.versionInfo": "版本資訊",
  "settings.aboutChipMate.version.label": "版本：",
  "settings.aboutChipMate.extensionName": "ChipMate 擴充功能",
  "settings.aboutChipMate.community": "社群與支援",
  "settings.aboutChipMate.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutChipMate.feedback.or": "或",
  "settings.aboutChipMate.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutChipMate.resetSettings.title": "重置設定",
  "settings.aboutChipMate.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutChipMate.resetSettings.button": "重置所有設定",
  "settings.aboutChipMate.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutChipMate.settingsTransfer.title": "設定轉移",
  "settings.aboutChipMate.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutChipMate.exportSettings": "匯出",
  "settings.aboutChipMate.importSettings": "匯入",
  "settings.aboutChipMate.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutChipMate.importSettings.invalidConfig": "檔案不包含有效的 ChipMate 設定。",
  "settings.aboutChipMate.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutChipMate.importSettings.newerVersion": "此檔案由較新版本的 ChipMate 匯出。部分設定可能會被忽略。",
  "settings.aboutChipMate.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutChipMate.telemetry.title": "遙測",
  "settings.aboutChipMate.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutChipMate.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 ChipMate 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.models.speechToTextModel.description": "選擇用於語音輸入的 ChipMate Gateway 轉錄模型。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 ChipMate 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。在 chipmate.jsonc 中新增 MCP 伺服器，或請代理為您新增。",
  ...
  "settings.sandboxing.enabled.description":
    "在作業系統層級沙盒中執行代理 shell 指令，將寫入限制在專案和 ChipMate 狀態目錄內",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 ChipMate webview UI 的字體大小。",
  ...
  "dialog.model.noneSelected": "未選擇模型",
  ...
  "settings.indexing.chipmateModel.title": "ChipMate 模型預設",
  "settings.indexing.chipmateModel.description": "選擇支援的 ChipMate 託管嵌入模型。",
  "settings.indexing.chipmateSignIn.title": "需要登入 ChipMate",
  "settings.indexing.chipmateSignIn.description": "登入 ChipMate 以使用託管嵌入。",
  ...
  "settings.patentCenter.title": "專利中心",
  "settings.patentCenter.description": "集中設定內網專利庫、本機 Patent Radar 掃描、評審操作和資料邊界。",
  "settings.patentCenter.connection.title": "內網專利庫",
  "settings.patentCenter.connection.description": "ChipMate 只向唯讀服務傳送技術檢索特徵，不傳送完整工作區快照。",
  "settings.patentCenter.localOnly": "原始碼證據留在本機",
  "settings.patentCenter.server.title": "Patent Server 位址",
  "settings.patentCenter.server.description": "支援 HTTP 和 HTTPS；HTTP 僅建議用於受控內網。",
  "settings.patentCenter.server.placeholder": "http://patent-server.company.example:6020",
  "settings.patentCenter.test.action": "測試連線",
  "settings.patentCenter.test.testing": "正在測試…",
  "settings.patentCenter.automation.title": "掃描與隱私",
  "settings.patentCenter.automation.description": "修改後透過頁面底部的設定儲存列統一儲存。",
  "settings.patentCenter.enabled.title": "自動補跑掃描",
  "settings.patentCenter.enabled.description": "開啟工作區時，如果掃描已過期且專利庫已設定，則自動補跑。",
  "settings.patentCenter.schedule.title": "掃描間隔",
  "settings.patentCenter.schedule.description": "兩次自動補跑之間的最少天數。",
  "settings.patentCenter.schedule.unit": "天",
  "settings.patentCenter.analysisModel.title": "分析模型",
  "settings.patentCenter.analysisModel.description": "從已連線的提供商中選擇 Patent Radar 使用的模型。",
  "settings.patentCenter.analysisModel.empty": "請先連線模型提供商",
  "settings.patentCenter.analysisModel.helper": "由提供商統一管理連線與憑證",
  "settings.patentCenter.snapshot.title": "完整工作區快照上傳（預留）",
  "settings.patentCenter.snapshot.description":
    "為未來上傳流程預留的專案級明確開關。目前 Patent Server 沒有原始碼上傳介面，開啟後也不會上傳原始碼。",
  "settings.patentCenter.actions.title": "Patent Radar",
  "settings.patentCenter.actions.description": "無需開啟命令面板，直接在這裡完成常用流程。",
  "settings.patentCenter.actions.scan": "掃描目前工作區",
  "settings.patentCenter.actions.scanModule": "掃描模組",
  "settings.patentCenter.actions.manageModules": "管理模組",
  "settings.patentCenter.actions.open": "檢視候選",
  "settings.patentCenter.actions.research": "重新檢索",
  "settings.patentCenter.actions.export": "匯出證據包",
  "settings.patentCenter.actions.importReviews": "匯入盲審結果",
  "settings.patentCenter.status.ready": "專利語料已就緒，可以進行檢索。",
  "settings.patentCenter.status.notReady": "連線成功，但語料狀態為 {{state}}；正面結論將保持關閉。",
  "settings.patentCenter.status.http": "Patent Server 回傳 HTTP {{status}}。",
  "settings.patentCenter.status.timeout": "連線 Patent Server 逾時。",
  "settings.patentCenter.status.network": "無法連線 Patent Server。",
  "settings.patentCenter.status.identity": "該位址不是 ChipMate Patent Server。",
  "settings.patentCenter.status.unhealthy": "Patent Server 可以存取，但資料庫或檢索索引目前不可用。",
  "settings.patentCenter.status.invalidJson": "Patent Server 回傳的狀態資料無效。",
  "settings.patentCenter.status.invalid": "Patent Server 設定無效。",
  "settings.patentCenter.status.documents": "{{count}} 篇專利文件",
  "settings.patentCenter.status.jurisdictions": "{{ready}}/{{total}} 個地區具備歷史基線",
  "settings.patentCenter.status.vectorCoverage": "向量覆蓋率 {{percent}}%",
  "settings.patentCenter.status.generation": "索引代次 {{generation}}",
  "settings.patentCenter.status.quarantined": "{{count}} 個匯入批次處於隔離狀態",
  ...
  "settings.aboutChipMate.legacyMigration.title": "舊版遷移",
  "settings.aboutChipMate.legacyMigration.description": "從舊版 ChipMate 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
  "settings.aboutChipMate.rooImport.description": "從 Roo Code 安裝匯入對話歷史記錄。",
  "settings.aboutChipMate.rooImport.button": "從 Roo Code 匯入工作階段",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 ChipMate 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "settings.saveBar.protocolMismatch": "擴充功能與後端版本不一致",
  "settings.saveBar.protocolMismatchDetails": "請重新載入 VS Code 視窗或安裝相符版本。所有變更仍保留在草稿中。",
  ...
  "diffViewer.source.session.tooltip": "ChipMate 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
  ...
  "chat.navigation.title": "對話導覽",
  "chat.navigation.close": "關閉對話導覽",
  "chat.navigation.inputs": "我的輸入",
  "chat.navigation.search": "全文搜尋",
  "chat.navigation.count": "{{count}} 筆輸入",
  "chat.navigation.filter": "篩選我的輸入…",
  "chat.navigation.attachment": "附件",
  "chat.navigation.today": "今天",
  "chat.navigation.yesterday": "昨天",
  "chat.navigation.justNow": "剛剛",
  "chat.navigation.loadingEarlier": "正在載入更早的輸入…",
  "chat.navigation.empty": "目前對話尚無使用者輸入",
  "chat.navigation.noMatches": "沒有相符的輸入",
  "chat.deepseekHarness.session.opening": "正在開啟官方會話…",
  "chat.deepseekHarness.session.untitled": "未命名官方會話",
