  ...
  return (
    <div>
      ...
      >
        ...
        >
          <label
            style={{ "font-size": "var(--chipmate-font-size-12)", "font-weight": "500", color: "var(--text-weak-base)" }}
          >
      ...
      <Show when={props.m.reasoning}>
        <Show when={props.m.variants.length > 0}>
          <div style={{ display: "flex", "flex-direction": "column", gap: "0" }}>
            <label
              style={{ "font-size": "var(--chipmate-font-size-11)", "font-weight": "500", color: "var(--text-weak-base)" }}
            >
