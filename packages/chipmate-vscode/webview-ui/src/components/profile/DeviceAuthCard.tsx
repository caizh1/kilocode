    ...
    <Switch>
      ...
      <Match when={props.status === "initiating"}>
        <Card>
          <div style={{ display: "flex", "align-items": "center", gap: "8px" }}>
            ...
            <span style={{ "font-size": "var(--chipmate-font-size-13)", color: "var(--vscode-descriptionForeground)" }}>
      ...
      <Match when={props.status === "pending"}>
        <Card>
          <h3
            style={{
              "font-size": "var(--chipmate-font-size-15)",
              "font-weight": "600",
              color: "var(--vscode-foreground)",
              margin: "0 0 16px 0",
              "text-align": "center",
          ...
          <Show when={props.code}>
            <div style={{ "margin-bottom": "16px" }}>
              ...
              >
                <span
                  style={{
                    "font-size": "var(--chipmate-font-size-24)",
                    "font-weight": "700",
      ...
      <Match when={props.status === "success"}>
        <Card>
          <div style={{ "text-align": "center" }}>
            <span style={{ "font-size": "var(--chipmate-font-size-24)" }}>✅</span>
            <p
              style={{
