export const CHIPMATE_PROVIDER_ID = "chipmate"
export const CHIPMATE_AUTO_FREE_ID = "chipmate-auto/free"
...
export function createChipMateFallbackProvider() {
  return {
