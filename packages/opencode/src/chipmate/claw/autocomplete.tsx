/**
 * ChipMateClaw chat slash-command autocomplete.
 *
 ...
 * with chipmateclaw's own `/new` for conversations.
 *
...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "ChipMateClaw", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "ChipMateClaw", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "ChipMateClaw", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "ChipMateClaw", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "ChipMateClaw", cmd: hide },
      { key: "return", desc: "Select command", group: "ChipMateClaw", cmd: select },
      { key: "tab", desc: "Select command", group: "ChipMateClaw", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
