...
const codeStyle = {
  ...styleVariables,
  "--diffs-line-height": "var(--chipmate-font-size-24)",
}

function lineHeight() {
  if (typeof window === "undefined") return codeMetrics.lineHeight
  const value = Number.parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--chipmate-font-size-24"))
