...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/ChipMate-Org/chipmate/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for ChipMate-Org/chipmate...\n")
