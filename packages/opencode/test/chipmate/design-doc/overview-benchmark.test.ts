...
import { discoverDesignDocModule, extractOverviewEvidence } from "@chipmate/chipmate-indexing/design-doc"
import { buildOverviewEvidencePack, hasSufficientOverviewEvidence } from "../../../src/chipmate/design-doc/evidence"
...
const root = await mkdtemp(path.join(tmpdir(), "chipmate-design-doc-overview-benchmark-"))
