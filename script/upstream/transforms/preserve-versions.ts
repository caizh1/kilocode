#!/usr/bin/env bun
/**
 * Preserve ChipMate package versions during upstream merge
 *
 * This script ensures that ChipMate's package versions are not overwritten
...
/**
 * Get the current ChipMate version from the main package.json
 */
