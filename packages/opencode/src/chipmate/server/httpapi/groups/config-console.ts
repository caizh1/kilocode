...
import { ChipMateTitleIcon } from "@/chipmate/cli/cmd/tui/title-icon"
...
const TuiConfigShape = {
  ...
  title_icon: Schema.optional(ChipMateTitleIcon.Value),
...
export const TuiKeybindListResponse = Schema.Struct({ keybinds: Schema.Array(ChipMateKeybinds.Info) }).annotate({
...
export const ConfigConsoleApi = HttpApi.make("config-console")
  .add(
    HttpApiGroup.make("config-console")
      .add(
        ...
        HttpApiEndpoint.get("rules", ConfigConsolePaths.rules, {
          ...
          OpenApi.annotations({
            ...
            description: "List project instruction files used by ChipMate and return their current contents.",
          }),
        ),
        ...
        HttpApiEndpoint.patch("modelStateUpdate", ConfigConsolePaths.modelState, {
          ...
          OpenApi.annotations({
            ...
            description: "Patch TUI-compatible model selections shared with ChipMate Console.",
          }),
        ),
      ...
      .annotateMerge(OpenApi.annotations({ title: "config-console", description: "ChipMate Console config routes." }))
