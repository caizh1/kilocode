...
const cache = process.env.CHIPMATE_BWRAP_CACHE ?? path.join(os.tmpdir(), "chipmate-bubblewrap", commit)
...
#define PACKAGE_STRING "bubblewrap ${version} for ChipMate"
...
ChipMate distributes Bubblewrap as a separate executable. The complete license text is
